...
class AsyncIOBackend(AsyncBackend):
    ...
    def run_async_from_thread(
        ...
        f: concurrent.futures.Future[T_Retval] = context.run(asyncio.run_coroutine_threadsafe, task_wrapper(), loop=loop)
        return f.result()
    ...
    def setup_process_pool_exit_at_shutdown(cls, workers: set[abc.Process]) -> None:
        ...
        find_root_task().add_done_callback(partial(_forcibly_shutdown_process_pool_on_exit, workers))  # type: ignore[arg-type]
