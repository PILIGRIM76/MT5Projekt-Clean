    ...
    def readRules(self):
        ...
        if rulesElement is not None:
            ...
            if processingValue not in {"first", "last"}:
                raise DesignSpaceDocumentError(
                    "<rules> processing attribute value is not valid: %r, " "expected 'first' or 'last'" % processingValue
                )
        ...
        for values in valueCombinations:
            ...
            variableFonts.append(
                VariableFontDescriptor(
                    ...
                    + [
                        ValueAxisSubsetDescriptor(name=axis.name, userValue=value) for axis, value in zip(discreteAxes, values)
                    ],
                )
            )
