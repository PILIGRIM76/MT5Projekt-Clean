...
def main(args=None):
    ...
    if len(args.inputs) == 1:
        ...
        if args.inputs[0].endswith(".designspace"):
            ...
            axis_triples = {a.name: (a.minimum, a.default, a.maximum) for a in designspace.axes if a.name not in discrete_axes}
                ...
                for glyphname in glyphs:
                    for var in gvar.variations[glyphname]:
                        ...
                        if locTuple not in ttGlyphSets:
                            ttGlyphSets[locTuple] = font.getGlyphSet(location=locDict, normalized=True, recalcBounds=False)
