...
pcputimes = nt("pcputimes", ("user", "system", "children_user", "children_system"))
...
if LINUX:
    ...
    pmmap_ext = nt("pmmap_ext", "addr perms " + " ".join(pmmap_grouped._fields))
...
# ===================================================================
    ...
    # psutil.Process.memory_maps(grouped=True)
    pmmap_grouped = nt("pmmap_grouped", "path rss, private, ref_count, shadow_count")

    # psutil.Process.memory_maps(grouped=False)
    pmmap_ext = nt("pmmap_ext", "addr, perms path rss, private, ref_count, shadow_count")
