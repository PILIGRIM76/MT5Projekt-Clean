...
class ClusterMultiKeyCommands(ClusterCommandsProtocol):
    ...
    def _reorder_keys_by_command(
        ...
        results = {
            k: v for slot_values, response in zip(slots_to_args.values(), responses) for k, v in zip(slot_values, response)
        }
...
class ClusterManagementCommands(ManagementCommands):
    ...
    def hotkeys_start(
        ...
        **kwargs,
        ...
        """
        raise NotImplementedError("HOTKEYS commands are not supported in cluster mode. Please use the non-cluster client.")
...
class AsyncClusterManagementCommands(ClusterManagementCommands, AsyncManagementCommands):
    ...
    async def hotkeys_get(self, **kwargs) -> Awaitable[list[dict[Union[str, bytes], Any]]]:
        """
        Cluster client does not support hotkeys command. Please use the non-cluster client.
