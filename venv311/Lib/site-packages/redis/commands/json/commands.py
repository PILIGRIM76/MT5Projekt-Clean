...
class JSONCommands:
    ...
    def arrappend(self, name: str, path: Optional[str] = Path.root_path(), *args: JsonType) -> List[Optional[int]]:
    ...
    def arrinsert(self, name: str, path: str, index: int, *args: JsonType) -> List[Optional[int]]:
