...
VSimResult = Optional[List[Union[List[EncodableT], Dict[EncodableT, Number], Dict[EncodableT, Dict[str, Any]]]]]
...
class VectorSetCommands(CommandsProtocol):
    ...
    def vemb(self, key: KeyT, element: str, raw: Optional[bool] = False) -> Union[
        ...
        if raw:
            ...
            if (
                hasattr(self.client, "connection_pool") and self.client.connection_pool.connection_kwargs["decode_responses"]
            ) or (hasattr(self.client, "nodes_manager") and self.client.nodes_manager.connection_kwargs["decode_responses"]):
    ...
    def vsetattr(self, key: KeyT, element: str, attributes: Optional[Union[dict, str]] = None) -> Union[Awaitable[int], int]:
        """
    ...
    def vrange(self, key: KeyT, start: str, end: str, count: Optional[int] = None) -> Union[Awaitable[List[str]], List[str]]:
        """
