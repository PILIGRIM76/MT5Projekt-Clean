...
class SearchCommands:
    ...
    def get_params_args(self, query_params: Optional[Dict[str, Union[str, int, float, bytes]]]):
    ...
    def _mk_query_args(self, query, query_params: Optional[Dict[str, Union[str, int, float, bytes]]]):
    ...
    def _get_aggregate_result(self, raw: List, query: Union[AggregateRequest, Cursor], has_cursor: bool):
        if has_cursor:
