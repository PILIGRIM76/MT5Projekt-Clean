...
def _validate_no_invalid_chars(value: str, field_name: str) -> None:
    ...
    for ch in value:
        ...
        if ord(ch) < 0x21 or ord(ch) > 0x7E or ch in _BRACES:
            raise ValueError(f"{field_name} must not contain spaces, newlines, non-printable characters, or braces")
...
class DriverInfo:
    ...
    def add_upstream_driver(self, driver_name: str, driver_version: str) -> "DriverInfo":
