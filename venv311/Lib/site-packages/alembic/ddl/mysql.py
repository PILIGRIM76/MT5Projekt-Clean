...
class MySQLImpl(DefaultImpl):
    ...
    def render_ddl_sql_expr(
        ...
        **kw: Any,
        ...
        if is_index and (
            ...
            or (isinstance(expr, elements.UnaryExpression) and expr.modifier not in (operators.desc_op, operators.asc_op))
    ...
    def alter_column(
        ...
        *,
        ...
        existing_server_default: Optional[Union[_ServerDefaultType, Literal[False]]] = None,
        ...
        if name is not None or self._is_mysql_allowed_functional_default(
            ...
            self._exec(
                MySQLChangeColumn(
                    ...
                    nullable=(
                        nullable if nullable is not None else (existing_nullable if existing_nullable is not None else True)
                    ),
