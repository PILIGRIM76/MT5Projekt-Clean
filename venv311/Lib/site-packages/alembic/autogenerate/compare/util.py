...
class _InspectorConv:
    ...
    def get_unique_constraints(self, tname: str, schema: str | None) -> list[ReflectedUniqueConstraint]:
        raise NotImplementedError()

    def get_indexes(self, tname: str, schema: str | None) -> list[ReflectedIndex]:
        raise NotImplementedError()

    def get_foreign_keys(self, tname: str, schema: str | None) -> list[ReflectedForeignKeyConstraint]:
        raise NotImplementedError()
...
class _LegacyInspectorConv(_InspectorConv):
    ...
    def get_unique_constraints(self, tname: str, schema: str | None) -> list[ReflectedUniqueConstraint]:
        return self._apply_reflectinfo_conv(self.inspector.get_unique_constraints(tname, schema=schema))
...
class _SQLA2InspectorConv(_InspectorConv):
    ...
    def _pre_cache(
        ...
        if fraction is None or fraction <= 0.5 or not self.inspector.dialect._overrides_default(inspector_method.__name__):
