...
class AbstractOperations(util.ModuleClsProxy):
    ...
    def register_operation(cls, name: str, sourcename: Optional[str] = None) -> Callable[[Type[_T]], Type[_T]]:
        ...
        def register(op_cls: Type[_T]) -> Type[_T]:
            ...
            fn.__func__.__doc__ = "This method is proxied on " "the :class:`.%s` class, via the :meth:`.%s.%s` method." % (
                cls.__name__,
                cls.__name__,
                name,
            )
    ...
    if TYPE_CHECKING:
        ...
        def alter_column(
            ...
            *,
            ...
            existing_server_default: Union[_ServerDefaultType, None, Literal[False]] = False,
