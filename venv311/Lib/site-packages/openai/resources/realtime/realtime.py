...
class RealtimeConversationItemResource(BaseRealtimeConnectionResource):
    ...
    def create(self, *, item: ConversationItemParam, event_id: str | Omit = omit, previous_item_id: str | Omit = omit) -> None:
        """
...
class AsyncRealtimeResponseResource(BaseAsyncRealtimeConnectionResource):
    async def create(self, *, event_id: str | Omit = omit, response: RealtimeResponseCreateParamsParam | Omit = omit) -> None:
        """
        This event instructs the server to create a Response, which means triggering
        model inference. When in Server VAD mode, the server will create Responses
        automatically.
...
class AsyncRealtimeConversationItemResource(BaseAsyncRealtimeConnectionResource):
    ...
    async def truncate(self, *, audio_end_ms: int, content_index: int, item_id: str, event_id: str | Omit = omit) -> None:
        """Send this event to truncate a previous assistant message’s audio.
