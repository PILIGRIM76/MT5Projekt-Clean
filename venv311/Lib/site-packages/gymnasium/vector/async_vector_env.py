...
class AsyncVectorEnv(VectorEnv):
    ...
    def __init__(
        ...
        daemon: bool = True,
        worker: Callable[[int, Callable[[], Env], Connection, Connection, bool, Queue], None] | None = None,
        ...
        self.autoreset_mode = autoreset_mode if isinstance(autoreset_mode, AutoresetMode) else AutoresetMode(autoreset_mode)
    ...
    def _raise_if_errors(self, successes: list[bool] | tuple[bool]):
        ...
        for i in range(num_errors):
            ...
            logger.error(f"Received the following error from Worker-{index} - Shutting it down")
