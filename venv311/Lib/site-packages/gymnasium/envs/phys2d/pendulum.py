...
class PendulumFunctional(FuncEnv[StateType, jax.Array, int, float, bool, RenderStateType, PendulumParams]):
    ...
    def initial(self, rng: PRNGKeyType, params: PendulumParams = PendulumParams) -> StateType:
    ...
    def observation(self, state: StateType, rng: Any, params: PendulumParams = PendulumParams) -> jax.Array:
    ...
    def terminal(self, state: StateType, rng: Any, params: PendulumParams = PendulumParams) -> bool:
    ...
    def render_image(
        ...
        return (screen, clock, last_u), np.transpose(np.array(pygame.surfarray.pixels3d(screen)), axes=(1, 0, 2))
