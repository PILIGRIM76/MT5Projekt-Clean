...
class BlackjackFunctional(FuncEnv[EnvState, jax.Array, int, float, bool, RenderStateType, BlackJackParams]):
    ...
    * v0: Initial version release (0.0.0), adapted from original gym blackjack v1
    ...
    def initial(self, rng: PRNGKeyType, params: BlackJackParams = BlackJackParams) -> EnvState:
    ...
    def render_image(
        ...
        try:
            ...
            raise DependencyNotInstalled('pygame is not installed, run `pip install "gymnasium[toy_text]"`')
        ...
        player_text_rect = screen.blit(player_text, (spacing, dealer_card_rect.bottom + 1.5 * spacing))
        ...
        return render_state, np.transpose(np.array(pygame.surfarray.pixels3d(screen)), axes=(1, 0, 2))
