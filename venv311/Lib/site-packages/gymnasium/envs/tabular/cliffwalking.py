...
class CliffWalkingFunctional(FuncEnv[EnvState, jax.Array, int, float, bool, RenderStateType, None]):
    ...
    def render_init(self, screen_width: int = 600, screen_height: int = 500) -> RenderStateType:
        ...
        elf_images = [pygame.transform.scale(pygame.image.load(f_name), cell_size) for f_name in hikers]
        ...
        mountain_bg_img = [pygame.transform.scale(pygame.image.load(f_name), cell_size) for f_name in bg_imgs]
        near_cliff_imgs = [
        ...
        near_cliff_img = [pygame.transform.scale(pygame.image.load(f_name), cell_size) for f_name in near_cliff_imgs]
