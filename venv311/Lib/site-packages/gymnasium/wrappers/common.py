...
class TimeLimit(gym.Wrapper[ObsType, ActType, ObsType, ActType], gym.utils.RecordConstructorArgs):
    ...
    def spec(self) -> EnvSpec | None:
        ...
        if env_spec is not None:
            try:
                ...
                gym.logger.warn(f"An exception occurred ({e}) while copying the environment spec={env_spec}")
                return None
...
class Autoreset(gym.Wrapper[ObsType, ActType, ObsType, ActType], gym.utils.RecordConstructorArgs):
...
class PassiveEnvChecker(gym.Wrapper[ObsType, ActType, ObsType, ActType], gym.utils.RecordConstructorArgs):
...
class OrderEnforcing(gym.Wrapper[ObsType, ActType, ObsType, ActType], gym.utils.RecordConstructorArgs):
    ...
    def __init__(
        ...
        """
        gym.utils.RecordConstructorArgs.__init__(self, disable_render_order_enforcing=disable_render_order_enforcing)
        gym.Wrapper.__init__(self, env)
...
class RecordEpisodeStatistics(gym.Wrapper[ObsType, ActType, ObsType, ActType], gym.utils.RecordConstructorArgs):
