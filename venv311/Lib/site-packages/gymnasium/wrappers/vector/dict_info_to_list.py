...
class DictInfoToList(VectorWrapper):
    ...
    def step(self, actions: ActType) -> tuple[ObsType, ArrayType, ArrayType, ArrayType, list[dict[str, Any]]]:
        ...
        for key, value in vector_infos.items():
            ...
            if isinstance(value, dict):
                ...
                if binary_key in vector_infos:
                    ...
                    for env_num, (env_info, has_info) in enumerate(zip(value_list_info, vector_infos[binary_key])):
                        if has_info:
