...
from ..tl import functions as fn
from ..tl import types as tl
from .session import ChannelState, SessionState
    ...
    def apply_pts_info(
        ...
        *,
        ...
        if pts.entry in self.map:
            ...
            self.map[pts.entry] = State(pts=(pts.pts - (0 if pts.pts_count else 1)) or 1, deadline=next_updates_deadline())
