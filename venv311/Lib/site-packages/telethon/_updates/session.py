...
from ..tl.types import InputPeerChannel, InputPeerChat, InputPeerUser
...
class SessionState:
    ...
    * takeout_id: 64-bit-number holding the identifier of the current takeout session.
    ...
    def __init__(
        self, user_id: int, dc_id: int, bot: bool, pts: int, qts: int, date: int, seq: int, takeout_id: Optional[int]
    ):
