...
if not _libssl:
    ...
    def decrypt_ige(cipher_text, key, iv):
        ...
        _libssl.AES_ige_encrypt(
            ctypes.byref(in_ptr), ctypes.byref(out_ptr), in_len, ctypes.byref(aes_key), ctypes.byref(iv), AES_DECRYPT
        )
    ...
    def encrypt_ige(plain_text, key, iv):
        ...
        _libssl.AES_ige_encrypt(
            ctypes.byref(in_ptr), ctypes.byref(out_ptr), in_len, ctypes.byref(aes_key), ctypes.byref(iv), AES_ENCRYPT
        )
