...
class File:
    ...
    def ext(self):
        ...
        """
        return mimetypes.guess_extension(self.mime_type) or os.path.splitext(self.name or "")[-1] or None
    ...
    def width(self):
        ...
        return self._from_attr((types.DocumentAttributeImageSize, types.DocumentAttributeVideo), "w")
    ...
    def height(self):
        ...
        return self._from_attr((types.DocumentAttributeImageSize, types.DocumentAttributeVideo), "h")
    ...
    def duration(self):
        ...
        """
        return self._from_attr((types.DocumentAttributeAudio, types.DocumentAttributeVideo), "duration")
