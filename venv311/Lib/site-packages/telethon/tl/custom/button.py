...
class Button:
    ...
    def _get_style(style=None, icon=None):
        ...
        if style is not None and (
            not isinstance(style, str) or (style := style.lower()) not in {"primary", "danger", "success"}
        ):
            raise ValueError(
    ...
    @classmethod
    def text(
        cls, text, *, resize=None, single_use=None, selective=None, persistent=None, placeholder=None, style=None, icon=None
    ):
        """
    ...
    def request_location(
        cls, text, style=None, icon=None, *, resize=None, single_use=None, selective=None, persistent=None, placeholder=None
    ):
        """
