...
class InlineResults(list):
    ...
    def __init__(self, client, original, *, entity=None):
        super().__init__(InlineResult(client, x, original.query_id, entity=entity) for x in original.results)
    ...
    def _to_str(self, item_function):
        return "[{}, query_id={}, cache_time={}, users={}, gallery={}, " "next_offset={}, switch_pm={}]".format(
