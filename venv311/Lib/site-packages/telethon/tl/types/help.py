...
class AppConfigNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "AppConfigNotModified"}

    def _bytes(self):
        return b"".join((b"\x1dd\xde|",))
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.can_not_skip is None or self.can_not_skip is False else 1)
                    | (0 if self.document is None or self.document is False else 2)
                    | (0 if self.url is None or self.url is False else 4)
                    | (0 if self.sticker is None or self.sticker is False else 8),
                ),
...
class CountriesList(TLObject):
    ...
    def to_dict(self):
        return {
            "_": "CountriesList",
            "countries": (
                [] if self.countries is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.countries]
            ),
            "hash": self.hash,
        }
    ...
    def to_dict(self):
        return {
            ...
            "country_codes": (
                ...
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.country_codes]
            ),
            "hidden": self.hidden,
            "name": self.name,
        }
...
class PassportConfig(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "hash": self.hash,
            "countries_langs": (
                self.countries_langs.to_dict() if isinstance(self.countries_langs, TLObject) else self.countries_langs
            ),
        }
...
class PeerColorOption(TLObject):
    ...
    def __init__(
        ...
        color_id: int,
        hidden: Optional[bool] = None,
        colors: Optional["TypePeerColorSet"] = None,
        dark_colors: Optional["TypePeerColorSet"] = None,
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.hidden is None or self.hidden is False else 1)
                    | (0 if self.colors is None or self.colors is False else 2)
                    | (0 if self.dark_colors is None or self.dark_colors is False else 4)
                    | (0 if self.channel_min_level is None or self.channel_min_level is False else 8)
                    | (0 if self.group_min_level is None or self.group_min_level is False else 16),
                ),
                ...
                (
                    b""
                    if self.channel_min_level is None or self.channel_min_level is False
                    else (struct.pack("<i", self.channel_min_level))
                ),
                (
                    b""
                    if self.group_min_level is None or self.group_min_level is False
                    else (struct.pack("<i", self.group_min_level))
                ),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            channel_min_level=_channel_min_level,
            group_min_level=_group_min_level,
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                b"\xeba}v",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.palette_colors)),
                b"".join(struct.pack("<i", x) for x in self.palette_colors),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.bg_colors)),
                b"".join(struct.pack("<i", x) for x in self.bg_colors),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.story_colors)),
                b"".join(struct.pack("<i", x) for x in self.story_colors),
            )
        )
...
class PeerColorSet(TLObject):
    ...
    def to_dict(self):
        return {"_": "PeerColorSet", "colors": [] if self.colors is None else self.colors[:]}
    ...
    def _bytes(self):
        return b"".join(
            (
                b"X\x9a!&",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.colors)),
                b"".join(struct.pack("<i", x) for x in self.colors),
            )
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.colors)),
                b"".join(x._bytes() for x in self.colors),
            )
        )
...
class PeerColorsNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "PeerColorsNotModified"}

    def _bytes(self):
        return b"".join((b"\xce\xf5\xa1+",))
...
class PremiumPromo(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "status_entities": (
                []
                if self.status_entities is None
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.status_entities]
            ),
            ...
            "period_options": (
                ...
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.period_options]
            ),
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.status_entities)),
                b"".join(x._bytes() for x in self.status_entities),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.video_sections)),
                b"".join(self.serialize_bytes(x) for x in self.video_sections),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.videos)),
                b"".join(x._bytes() for x in self.videos),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.period_options)),
                b"".join(x._bytes() for x in self.period_options),
                b"\x15\xc4\xb5\x1c",
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            status_entities=_status_entities,
            video_sections=_video_sections,
            videos=_videos,
...
class PromoData(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "custom_pending_suggestion": (
                self.custom_pending_suggestion.to_dict()
                if isinstance(self.custom_pending_suggestion, TLObject)
                else self.custom_pending_suggestion
            ),
        }
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.psa_message is None or self.psa_message is False else 4)
                    | (0 if self.custom_pending_suggestion is None or self.custom_pending_suggestion is False else 16),
                ),
                self.serialize_datetime(self.expires),
                ...
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.pending_suggestions)),
                b"".join(self.serialize_bytes(x) for x in self.pending_suggestions),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.dismissed_suggestions)),
                b"".join(self.serialize_bytes(x) for x in self.dismissed_suggestions),
                (
                    b""
                    if self.custom_pending_suggestion is None or self.custom_pending_suggestion is False
                    else (self.custom_pending_suggestion._bytes())
                ),
                b"\x15\xc4\xb5\x1c",
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            expires=_expires,
            pending_suggestions=_pending_suggestions,
            dismissed_suggestions=_dismissed_suggestions,
            chats=_chats,
            users=_users,
            proxy=_proxy,
            peer=_peer,
            ...
            custom_pending_suggestion=_custom_pending_suggestion,
        )
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.min_age_confirm is None or self.min_age_confirm is False else 2),
                ),
                self.id._bytes(),
                self.serialize_bytes(self.text),
                b"\x15\xc4\xb5\x1c",
...
class TimezonesList(TLObject):
    ...
    def to_dict(self):
        return {
            "_": "TimezonesList",
            "timezones": (
                [] if self.timezones is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.timezones]
            ),
            "hash": self.hash,
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                b"q\xedt{",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.timezones)),
                b"".join(x._bytes() for x in self.timezones),
                struct.pack("<i", self.hash),
            )
        )
...
class TimezonesListNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "TimezonesListNotModified"}

    def _bytes(self):
        return b"".join((b"\xcc\x08\x07\x97",))
