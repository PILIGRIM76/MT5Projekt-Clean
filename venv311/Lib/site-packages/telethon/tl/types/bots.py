...
class BotInfo(TLObject):
    ...
    def to_dict(self):
        return {"_": "BotInfo", "name": self.name, "about": self.about, "description": self.description}
...
class ExportedBotToken(TLObject):
    ...
    def to_dict(self):
        return {"_": "ExportedBotToken", "token": self.token}
...
class RequestedButton(TLObject):
    ...
    def to_dict(self):
        return {"_": "RequestedButton", "webapp_req_id": self.webapp_req_id}
