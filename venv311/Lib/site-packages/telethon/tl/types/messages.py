...
class AffectedHistory(TLObject):
    ...
    def to_dict(self):
        return {"_": "AffectedHistory", "pts": self.pts, "pts_count": self.pts_count, "offset": self.offset}
...
class AvailableEffects(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "documents": (
                [] if self.documents is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.documents]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.effects)),
                b"".join(x._bytes() for x in self.effects),
                b"\x15\xc4\xb5\x1c",
...
class AvailableEffectsNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "AvailableEffectsNotModified"}

    def _bytes(self):
        return b"".join((b"[\x9a\xed\xd1",))
...
class AvailableReactions(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "hash": self.hash,
            "reactions": (
                [] if self.reactions is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.reactions]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack("<i", self.hash),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.reactions)),
                b"".join(x._bytes() for x in self.reactions),
            )
        )
...
class AvailableReactionsNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "AvailableReactionsNotModified"}

    def _bytes(self):
        return b"".join((b"W\x19\x07\x9f",))
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.inactive is None or self.inactive is False else 1)
                    | (0 if self.request_write_access is None or self.request_write_access is False else 2)
                    | (0 if self.has_settings is None or self.has_settings is False else 4),
                ),
                self.app._bytes(),
            )
        )
...
class BotPreparedInlineMessage(TLObject):
    ...
    def to_dict(self):
        return {"_": "BotPreparedInlineMessage", "id": self.id, "expire_date": self.expire_date}
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.next_offset is None or self.next_offset is False else 2)
                    | (0 if self.switch_pm is None or self.switch_pm is False else 4)
                    | (0 if self.switch_webview is None or self.switch_webview is False else 8),
                ),
...
class ChannelMessages(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "count": self.count,
            "messages": (
                [] if self.messages is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.messages]
            ),
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.offset_id_offset is None or self.offset_id_offset is False else 4),
                ),
                struct.pack("<i", self.pts),
                struct.pack("<i", self.count),
                (
                ...
                b"".join(x._bytes() for x in self.topics),
                b"\x15\xc4\xb5\x1c",
...
class ChatInviteImporters(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "count": self.count,
            "importers": (
                [] if self.importers is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.importers]
            ),
            "users": [] if self.users is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.users],
        }
...
class DhConfig(TLObject):
    ...
    def to_dict(self):
        return {"_": "DhConfig", "g": self.g, "p": self.p, "version": self.version, "random": self.random}
...
class Dialogs(TLObject):
    ...
    def __init__(
        self, dialogs: List["TypeDialog"], messages: List["TypeMessage"], chats: List["TypeChat"], users: List["TypeUser"]
    ):
        """
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.read_inbox_max_id is None or self.read_inbox_max_id is False else 2)
                    | (0 if self.read_outbox_max_id is None or self.read_outbox_max_id is False else 4),
                ),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.messages)),
                b"".join(x._bytes() for x in self.messages),
...
class EmojiGameDiceInfo(TLObject):
    ...
    def __init__(
        self, game_hash: str, prev_stake: int, current_streak: int, params: List[int], plays_left: Optional[int] = None
    ):
        """
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.params)),
                b"".join(struct.pack("<i", x) for x in self.params),
    ...
    def from_reader(cls, reader):
        ...
        if flags & 1:
            ...
            _plays_left = None
        return cls(
            game_hash=_game_hash,
            prev_stake=_prev_stake,
...
class EmojiGameUnavailable(TLObject):
    ...
    def to_dict(self):
        return {"_": "EmojiGameUnavailable"}

    def _bytes(self):
        return b"".join((b"5S\xe6Y",))
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack("<i", self.hash),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.groups)),
                b"".join(x._bytes() for x in self.groups),
            )
        )
...
class EmojiGroupsNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "EmojiGroupsNotModified"}

    def _bytes(self):
        return b"".join((b"\x87\xad\xb4o",))
...
class FavedStickers(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "stickers": (
                [] if self.stickers is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.stickers]
            ),
        }
...
class FeaturedStickers(TLObject):
    ...
    def __init__(
        self, hash: int, count: int, sets: List["TypeStickerSetCovered"], unread: List[int], premium: Optional[bool] = None
    ):
        """
...
class ForumTopics(TLObject):
    ...
    def __init__(
        ...
        users: List["TypeUser"],
        pts: int,
        order_by_create_date: Optional[bool] = None,
    ):
        """
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            users=_users,
            pts=_pts,
            order_by_create_date=_order_by_create_date,
        )
...
class FoundStickersNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "FoundStickersNotModified", "next_offset": self.next_offset}
...
class HistoryImportParsed(TLObject):
    ...
    def to_dict(self):
        return {"_": "HistoryImportParsed", "pm": self.pm, "group": self.group, "title": self.title}
...
class InvitedUsers(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "missing_invitees": (
                []
                if self.missing_invitees is None
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.missing_invitees]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                self.updates._bytes(),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.missing_invitees)),
                b"".join(x._bytes() for x in self.missing_invitees),
            )
        )
...
class Messages(TLObject):
    ...
    def __init__(
        self, messages: List["TypeMessage"], topics: List["TypeForumTopic"], chats: List["TypeChat"], users: List["TypeUser"]
    ):
        """
        Constructor for messages.Messages: Instance of either Messages, MessagesSlice, ChannelMessages, MessagesNotModified.
        """
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.offset_id_offset is None or self.offset_id_offset is False else 4)
                    | (0 if self.search_flood is None or self.search_flood is False else 8),
                ),
                struct.pack("<i", self.count),
    ...
    def to_dict(self):
        return {
            ...
            "quick_replies": (
                ...
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.quick_replies]
            ),
            "messages": (
                [] if self.messages is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.messages]
            ),
    ...
    def _bytes(self):
        return b"".join(
            (
                b"\x95f\x8d\xc6",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.quick_replies)),
                b"".join(x._bytes() for x in self.quick_replies),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.messages)),
                b"".join(x._bytes() for x in self.messages),
                b"\x15\xc4\xb5\x1c",
...
class QuickRepliesNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "QuickRepliesNotModified"}

    def _bytes(self):
        return b"".join((b"[\xeb\x91_",))
...
class ReactionsNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "ReactionsNotModified"}

    def _bytes(self):
        return b"".join((b"\xdf\xdbo\xb0",))
...
class SavedDialogs(TLObject):
    ...
    def __init__(
        self, dialogs: List["TypeSavedDialog"], messages: List["TypeMessage"], chats: List["TypeChat"], users: List["TypeUser"]
    ):
        """
...
class SavedDialogsNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "SavedDialogsNotModified", "count": self.count}
    ...
    def _bytes(self):
        return b"".join(
            (
                b"\n\x95Y2",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.tags)),
                b"".join(x._bytes() for x in self.tags),
                struct.pack("<q", self.hash),
            )
        )
...
class SavedReactionTagsNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "SavedReactionTagsNotModified"}

    def _bytes(self):
        return b"".join((b"\xefY\x9b\x88",))
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.inexact is None or self.inexact is False else 1)
                    | (0 if self.offset_id_offset is None or self.offset_id_offset is False else 2),
                ),
                struct.pack("<i", self.count),
                ...
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.periods)),
                b"".join(x._bytes() for x in self.periods),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.messages)),
                b"".join(x._bytes() for x in self.messages),
                b"\x15\xc4\xb5\x1c",
...
class SearchResultsPositions(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "count": self.count,
            "positions": (
                [] if self.positions is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.positions]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack("<i", self.count),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.positions)),
                b"".join(x._bytes() for x in self.positions),
            )
        )
...
class SponsoredMessages(TLObject):
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.posts_between is None or self.posts_between is False else 1)
                    | (0 if self.start_delay is None or self.start_delay is False else 2)
                    | (0 if self.between_delay is None or self.between_delay is False else 4),
                ),
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            chats=_chats,
            users=_users,
            posts_between=_posts_between,
            start_delay=_start_delay,
            between_delay=_between_delay,
        )
...
class StickerSet(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "packs": [] if self.packs is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.packs],
            "keywords": (
                [] if self.keywords is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.keywords]
            ),
            "documents": (
                [] if self.documents is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.documents]
            ),
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"".join(x._bytes() for x in self.packs),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.keywords)),
                b"".join(x._bytes() for x in self.keywords),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.documents)),
                b"".join(x._bytes() for x in self.documents),
            )
...
class StickerSetNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "StickerSetNotModified"}

    def _bytes(self):
        return b"".join((b"\xeb$\xf9\xd3",))
...
class TranscribedAudio(TLObject):
    ...
    def _bytes(self):
        assert (
            (self.trial_remains_num or self.trial_remains_num is not None)
            and (self.trial_remains_until_date or self.trial_remains_until_date is not None)
        ) or (
            (self.trial_remains_num is None or self.trial_remains_num is False)
            and (self.trial_remains_until_date is None or self.trial_remains_until_date is False)
        ), "trial_remains_num, trial_remains_until_date parameters must all be False-y (like None) or all be True-y"
        return b"".join(
            (
                b"W\xd9\xb9\xcf",
                struct.pack(
                    "<I",
                    (0 if self.pending is None or self.pending is False else 1)
                    | (0 if self.trial_remains_num is None or self.trial_remains_num is False else 2)
                    | (0 if self.trial_remains_until_date is None or self.trial_remains_until_date is False else 2),
                ),
                struct.pack("<q", self.transcription_id),
                self.serialize_bytes(self.text),
                (
                    b""
                    if self.trial_remains_num is None or self.trial_remains_num is False
                    else (struct.pack("<i", self.trial_remains_num))
                ),
                (
                    b""
                    if self.trial_remains_until_date is None or self.trial_remains_until_date is False
                    else (self.serialize_datetime(self.trial_remains_until_date))
                ),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            text=_text,
            pending=_pending,
            trial_remains_num=_trial_remains_num,
            trial_remains_until_date=_trial_remains_until_date,
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                b"\xf82\xdb3",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.result)),
                b"".join(x._bytes() for x in self.result),
            )
        )
