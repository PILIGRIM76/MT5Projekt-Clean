    ...
    def to_dict(self):
        return {
            ...
            "required_types": (
                ...
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.required_types]
            ),
    ...
    def to_dict(self):
        return {
            ...
            "authorizations": (
                ...
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.authorizations]
            ),
        }
...
class AutoSaveSettings(TLObject):
    ...
    def to_dict(self):
        return {
            "_": "AutoSaveSettings",
            "users_settings": (
                self.users_settings.to_dict() if isinstance(self.users_settings, TLObject) else self.users_settings
            ),
            "chats_settings": (
                self.chats_settings.to_dict() if isinstance(self.chats_settings, TLObject) else self.chats_settings
            ),
            "broadcasts_settings": (
                self.broadcasts_settings.to_dict()
                if isinstance(self.broadcasts_settings, TLObject)
                else self.broadcasts_settings
            ),
            "exceptions": (
                [] if self.exceptions is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.exceptions]
            ),
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.exceptions)),
                b"".join(x._bytes() for x in self.exceptions),
                b"\x15\xc4\xb5\x1c",
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            users_settings=_users_settings,
            chats_settings=_chats_settings,
            broadcasts_settings=_broadcasts_settings,
    ...
    def _bytes(self):
        return b"".join(
            (
                b"\xd1\xa2C\xec",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.links)),
                b"".join(x._bytes() for x in self.links),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.chats)),
                b"".join(x._bytes() for x in self.chats),
                b"\x15\xc4\xb5\x1c",
...
class ChatThemesNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "ChatThemesNotModified"}

    def _bytes(self):
        return b"".join((b"\xc4\xe1\x11\xe0",))
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.sensitive_enabled is None or self.sensitive_enabled is False else 1)
                    | (0 if self.sensitive_can_change is None or self.sensitive_can_change is False else 2),
                ),
            )
        )
...
class EmailVerified(TLObject):
    ...
    def to_dict(self):
        return {"_": "EmailVerified", "email": self.email}
...
class EmojiStatuses(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "hash": self.hash,
            "statuses": (
                [] if self.statuses is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.statuses]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack("<q", self.hash),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.statuses)),
                b"".join(x._bytes() for x in self.statuses),
            )
        )
...
class EmojiStatusesNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "EmojiStatusesNotModified"}

    def _bytes(self):
        return b"".join((b"E\xe6\x8c\xd0",))
...
class PaidMessagesRevenue(TLObject):
    ...
    def to_dict(self):
        return {"_": "PaidMessagesRevenue", "stars_amount": self.stars_amount}
...
class Passkeys(TLObject):
    ...
    def to_dict(self):
        return {
            "_": "Passkeys",
            "passkeys": (
                [] if self.passkeys is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.passkeys]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                b"\x1c\xaa\xe0\xf8",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.passkeys)),
                b"".join(x._bytes() for x in self.passkeys),
            )
        )
...
class Password(TLObject):
    ...
    def __init__(
        ...
        pending_reset_date: Optional[datetime] = None,
    ...
    def to_dict(self):
        return {
            ...
            "new_secure_algo": (
                self.new_secure_algo.to_dict() if isinstance(self.new_secure_algo, TLObject) else self.new_secure_algo
            ),
    ...
    def _bytes(self):
        ...
        ), "has_password, current_algo, srp_B, srp_id parameters must all be False-y (like None) or all be True-y"
        return b"".join(
            (
                b"\xfbP{\x95",
                struct.pack(
                    "<I",
                    (0 if self.has_recovery is None or self.has_recovery is False else 1)
                    | (0 if self.has_secure_values is None or self.has_secure_values is False else 2)
                    | (0 if self.has_password is None or self.has_password is False else 4)
                    | (0 if self.current_algo is None or self.current_algo is False else 4)
                    ...
                    | (0 if self.email_unconfirmed_pattern is None or self.email_unconfirmed_pattern is False else 16)
                    | (0 if self.pending_reset_date is None or self.pending_reset_date is False else 32)
                    | (0 if self.login_email_pattern is None or self.login_email_pattern is False else 64),
                ),
                ...
                (
                    b""
                    if self.email_unconfirmed_pattern is None or self.email_unconfirmed_pattern is False
                ...
                (
                    b""
                    if self.pending_reset_date is None or self.pending_reset_date is False
                    else (self.serialize_datetime(self.pending_reset_date))
                ),
                (
                    b""
                    if self.login_email_pattern is None or self.login_email_pattern is False
                    else (self.serialize_bytes(self.login_email_pattern))
                ),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            pending_reset_date=_pending_reset_date,
            login_email_pattern=_login_email_pattern,
        )
...
class PasswordInputSettings(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "email": self.email,
            "new_secure_settings": (
                self.new_secure_settings.to_dict()
    ...
    def _bytes(self):
        ...
        ), "new_algo, new_password_hash, hint parameters must all be False-y (like None) or all be True-y"
        return b"".join(
            (
                b"\xc9'7\xc2",
                struct.pack(
                    ...
                    | (0 if self.new_password_hash is None or self.new_password_hash is False else 1)
                    | (0 if self.hint is None or self.hint is False else 1)
                    | (0 if self.email is None or self.email is False else 2)
                    | (0 if self.new_secure_settings is None or self.new_secure_settings is False else 4),
                ),
...
class PasswordSettings(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "email": self.email,
            "secure_settings": (
                self.secure_settings.to_dict() if isinstance(self.secure_settings, TLObject) else self.secure_settings
            ),
        }
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.secure_settings is None or self.secure_settings is False else 2),
                ),
                b"" if self.email is None or self.email is False else (self.serialize_bytes(self.email)),
...
class ResetPasswordFailedWait(TLObject):
    ...
    def to_dict(self):
        return {"_": "ResetPasswordFailedWait", "retry_date": self.retry_date}
...
class ResetPasswordOk(TLObject):
    ...
    def to_dict(self):
        return {"_": "ResetPasswordOk"}

    def _bytes(self):
        return b"".join((b">\xd6&\xe9",))
...
class ResetPasswordRequestedWait(TLObject):
    ...
    def to_dict(self):
        return {"_": "ResetPasswordRequestedWait", "until_date": self.until_date}
...
class SavedMusicIds(TLObject):
    ...
    def to_dict(self):
        return {"_": "SavedMusicIds", "ids": [] if self.ids is None else self.ids[:]}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"".join(struct.pack("<q", x) for x in self.ids),
            )
        )
...
class SavedMusicIdsNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "SavedMusicIdsNotModified"}

    def _bytes(self):
        return b"".join((b"n\x1d\xc8O",))
...
class SavedRingtone(TLObject):
    ...
    def to_dict(self):
        return {"_": "SavedRingtone"}

    def _bytes(self):
        return b"".join((b"m?&\xb7",))
...
class SavedRingtones(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "hash": self.hash,
            "ringtones": (
                [] if self.ringtones is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.ringtones]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack("<q", self.hash),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.ringtones)),
                b"".join(x._bytes() for x in self.ringtones),
            )
        )
...
class SavedRingtonesNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "SavedRingtonesNotModified"}

    def _bytes(self):
        return b"".join((b"\xb1\xe8\xf6\xfb",))
...
class SentEmailCode(TLObject):
    ...
    def to_dict(self):
        return {"_": "SentEmailCode", "email_pattern": self.email_pattern, "length": self.length}
...
class TmpPassword(TLObject):
    ...
    def to_dict(self):
        return {"_": "TmpPassword", "tmp_password": self.tmp_password, "valid_until": self.valid_until}
