...
class ChannelDifference(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "pts": self.pts,
            "new_messages": (
                [] if self.new_messages is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.new_messages]
            ),
            "other_updates": (
                []
                if self.other_updates is None
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.other_updates]
            ),
...
class ChannelDifferenceEmpty(TLObject):
    ...
    def to_dict(self):
        return {"_": "ChannelDifferenceEmpty", "pts": self.pts, "final": self.final, "timeout": self.timeout}
    ...
    def to_dict(self):
        return {
            ...
            "new_encrypted_messages": (
                ...
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.new_encrypted_messages]
            ),
            "other_updates": (
                []
                if self.other_updates is None
...
class DifferenceSlice(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "users": [] if self.users is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.users],
            "intermediate_state": (
                self.intermediate_state.to_dict() if isinstance(self.intermediate_state, TLObject) else self.intermediate_state
            ),
        }
