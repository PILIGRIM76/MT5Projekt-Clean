...
class BroadcastStats(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "views_per_post": (
                self.views_per_post.to_dict() if isinstance(self.views_per_post, TLObject) else self.views_per_post
            ),
            "shares_per_post": (
                self.shares_per_post.to_dict() if isinstance(self.shares_per_post, TLObject) else self.shares_per_post
            ),
            "reactions_per_post": (
                self.reactions_per_post.to_dict() if isinstance(self.reactions_per_post, TLObject) else self.reactions_per_post
            ),
            "views_per_story": (
                self.views_per_story.to_dict() if isinstance(self.views_per_story, TLObject) else self.views_per_story
            ),
            "shares_per_story": (
                self.shares_per_story.to_dict() if isinstance(self.shares_per_story, TLObject) else self.shares_per_story
            ),
            "reactions_per_story": (
                self.reactions_per_story.to_dict()
                if isinstance(self.reactions_per_story, TLObject)
                else self.reactions_per_story
            ),
            "enabled_notifications": (
                self.enabled_notifications.to_dict()
            ...
            "followers_graph": (
                self.followers_graph.to_dict() if isinstance(self.followers_graph, TLObject) else self.followers_graph
            ),
            ...
            "interactions_graph": (
                self.interactions_graph.to_dict() if isinstance(self.interactions_graph, TLObject) else self.interactions_graph
            ),
            "iv_interactions_graph": (
                self.iv_interactions_graph.to_dict()
                if isinstance(self.iv_interactions_graph, TLObject)
                else self.iv_interactions_graph
            ),
            "views_by_source_graph": (
                self.views_by_source_graph.to_dict()
                if isinstance(self.views_by_source_graph, TLObject)
                else self.views_by_source_graph
            ),
            "new_followers_by_source_graph": (
                self.new_followers_by_source_graph.to_dict()
                if isinstance(self.new_followers_by_source_graph, TLObject)
                else self.new_followers_by_source_graph
            ),
            "languages_graph": (
                self.languages_graph.to_dict() if isinstance(self.languages_graph, TLObject) else self.languages_graph
            ),
            "reactions_by_emotion_graph": (
                self.reactions_by_emotion_graph.to_dict()
                if isinstance(self.reactions_by_emotion_graph, TLObject)
                else self.reactions_by_emotion_graph
            ),
            "story_interactions_graph": (
                self.story_interactions_graph.to_dict()
                if isinstance(self.story_interactions_graph, TLObject)
                else self.story_interactions_graph
            ),
            "story_reactions_by_emotion_graph": (
                self.story_reactions_by_emotion_graph.to_dict()
                if isinstance(self.story_reactions_by_emotion_graph, TLObject)
                else self.story_reactions_by_emotion_graph
            ),
            "recent_posts_interactions": (
                []
                if self.recent_posts_interactions is None
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.recent_posts_interactions]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.recent_posts_interactions)),
                b"".join(x._bytes() for x in self.recent_posts_interactions),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            reactions_per_post=_reactions_per_post,
            views_per_story=_views_per_story,
            shares_per_story=_shares_per_story,
            reactions_per_story=_reactions_per_story,
            ...
            reactions_by_emotion_graph=_reactions_by_emotion_graph,
            story_interactions_graph=_story_interactions_graph,
            story_reactions_by_emotion_graph=_story_reactions_by_emotion_graph,
    ...
    def to_dict(self):
        return {
            ...
            "new_members_by_source_graph": (
                self.new_members_by_source_graph.to_dict()
            ...
            "messages_graph": (
                self.messages_graph.to_dict() if isinstance(self.messages_graph, TLObject) else self.messages_graph
            ),
            ...
            "weekdays_graph": (
                self.weekdays_graph.to_dict() if isinstance(self.weekdays_graph, TLObject) else self.weekdays_graph
            ),
            "top_posters": (
                [] if self.top_posters is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.top_posters]
            ),
            "top_admins": (
                [] if self.top_admins is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.top_admins]
            ),
            "top_inviters": (
                [] if self.top_inviters is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.top_inviters]
            ),
...
class PublicForwards(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "count": self.count,
            "forwards": (
                [] if self.forwards is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.forwards]
            ),
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.forwards)),
                b"".join(x._bytes() for x in self.forwards),
