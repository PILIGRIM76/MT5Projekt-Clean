...
class ChannelParticipants(TLObject):
    ...
    def __init__(
        self, count: int, participants: List["TypeChannelParticipant"], chats: List["TypeChat"], users: List["TypeUser"]
    ):
        """
...
class SponsoredMessageReportResultAdsHidden(TLObject):
    ...
    def to_dict(self):
        return {"_": "SponsoredMessageReportResultAdsHidden"}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"".join(x._bytes() for x in self.options),
            )
        )
...
class SponsoredMessageReportResultReported(TLObject):
    ...
    def to_dict(self):
        return {"_": "SponsoredMessageReportResultReported"}

    def _bytes(self):
        return b"".join((b"I\x88y\xad",))
