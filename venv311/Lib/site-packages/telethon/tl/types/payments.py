...
if TYPE_CHECKING:
    from ...tl.types import (
        ...
        TypeShippingOption,
        TypeStarGift,
        TypeStarGiftActiveAuctionState,
        TypeStarGiftAttribute,
        TypeStarGiftAttributeCounter,
        TypeStarGiftAuctionAcquiredGift,
        TypeStarGiftAuctionState,
        TypeStarGiftAuctionUserState,
...
class BankCardData(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "title": self.title,
            "open_urls": (
                [] if self.open_urls is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.open_urls]
            ),
        }
...
class CheckCanSendGiftResultOk(TLObject):
    ...
    def to_dict(self):
        return {"_": "CheckCanSendGiftResultOk"}

    def _bytes(self):
        return b"".join((b"\xad\xa7O7",))
...
class CheckedGiftCode(TLObject):
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.via_giveaway is None or self.via_giveaway is False else 4)
                    | (0 if self.from_id is None or self.from_id is False else 16)
                    | (0 if self.giveaway_msg_id is None or self.giveaway_msg_id is False else 8)
                    | (0 if self.to_id is None or self.to_id is False else 1)
                    | (0 if self.used_date is None or self.used_date is False else 2),
                ),
                b"" if self.from_id is None or self.from_id is False else (self.from_id._bytes()),
                (
                    b""
                    if self.giveaway_msg_id is None or self.giveaway_msg_id is False
                    else (struct.pack("<i", self.giveaway_msg_id))
                ),
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            chats=_chats,
            users=_users,
            via_giveaway=_via_giveaway,
            from_id=_from_id,
            giveaway_msg_id=_giveaway_msg_id,
            to_id=_to_id,
...
class ConnectedStarRefBots(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "connected_bots": (
                []
                if self.connected_bots is None
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.connected_bots]
            ),
            "users": [] if self.users is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.users],
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.connected_bots)),
                b"".join(x._bytes() for x in self.connected_bots),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.users)),
                b"".join(x._bytes() for x in self.users),
            )
...
class ExportedInvoice(TLObject):
    ...
    def to_dict(self):
        return {"_": "ExportedInvoice", "url": self.url}
...
class GiveawayInfo(TLObject):
    ...
    def __init__(
        ...
        preparing_results: Optional[bool] = None,
        joined_too_early_date: Optional[datetime] = None,
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.participating is None or self.participating is False else 1)
                    | (0 if self.preparing_results is None or self.preparing_results is False else 8)
                    | (0 if self.joined_too_early_date is None or self.joined_too_early_date is False else 2)
                    | (0 if self.admin_disallowed_chat_id is None or self.admin_disallowed_chat_id is False else 4)
                    | (0 if self.disallowed_country is None or self.disallowed_country is False else 16),
                ),
                self.serialize_datetime(self.start_date),
                (
                    b""
                    if self.joined_too_early_date is None or self.joined_too_early_date is False
                    else (self.serialize_datetime(self.joined_too_early_date))
                ),
                (
                    b""
                    if self.admin_disallowed_chat_id is None or self.admin_disallowed_chat_id is False
                    else (struct.pack("<q", self.admin_disallowed_chat_id))
                ),
                (
                    b""
                    if self.disallowed_country is None or self.disallowed_country is False
                    else (self.serialize_bytes(self.disallowed_country))
                ),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            preparing_results=_preparing_results,
            joined_too_early_date=_joined_too_early_date,
            admin_disallowed_chat_id=_admin_disallowed_chat_id,
            disallowed_country=_disallowed_country,
        )
...
class GiveawayInfoResults(TLObject):
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.winner is None or self.winner is False else 1)
                    | (0 if self.refunded is None or self.refunded is False else 2)
                    | (0 if self.gift_code_slug is None or self.gift_code_slug is False else 8)
                    | (0 if self.stars_prize is None or self.stars_prize is False else 16)
                    | (0 if self.activated_count is None or self.activated_count is False else 4),
                ),
                self.serialize_datetime(self.start_date),
                (
                    b""
                    if self.gift_code_slug is None or self.gift_code_slug is False
                    else (self.serialize_bytes(self.gift_code_slug))
                ),
                ...
                (
                    b""
                    if self.activated_count is None or self.activated_count is False
                    else (struct.pack("<i", self.activated_count))
                ),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            winner=_winner,
            refunded=_refunded,
            gift_code_slug=_gift_code_slug,
            stars_prize=_stars_prize,
            activated_count=_activated_count,
        )
...
class PaymentForm(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "additional_methods": (
                ...
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.additional_methods]
            ),
            ...
            "saved_credentials": (
                ...
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.saved_credentials]
            ),
        }
    ...
    def _bytes(self):
        ...
        ), "native_provider, native_params parameters must all be False-y (like None) or all be True-y"
        return b"".join(
            (
                b"Q\x87\x05\xa0",
                struct.pack(
                    "<I",
                    (0 if self.can_save_credentials is None or self.can_save_credentials is False else 4)
                    | (0 if self.password_missing is None or self.password_missing is False else 8)
                    | (0 if self.photo is None or self.photo is False else 32)
                    | (0 if self.native_provider is None or self.native_provider is False else 16)
                    | (0 if self.native_params is None or self.native_params is False else 16)
                    | (0 if self.additional_methods is None or self.additional_methods is False else 64)
                    | (0 if self.saved_info is None or self.saved_info is False else 1)
                    | (0 if self.saved_credentials is None or self.saved_credentials is False else 2),
                ),
                ...
                (
                    b""
                    if self.additional_methods is None or self.additional_methods is False
                    else b"".join(
                        (
                            b"\x15\xc4\xb5\x1c",
                            struct.pack("<i", len(self.additional_methods)),
                            b"".join(x._bytes() for x in self.additional_methods),
                        )
                    )
                ),
                ...
                (
                    ...
                    if self.saved_credentials is None or self.saved_credentials is False
                        ...
                        (
                            b"\x15\xc4\xb5\x1c",
                            struct.pack("<i", len(self.saved_credentials)),
                            b"".join(x._bytes() for x in self.saved_credentials),
                        )
                    )
                ),
                b"\x15\xc4\xb5\x1c",
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            additional_methods=_additional_methods,
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.photo is None or self.photo is False else 4)
                    | (0 if self.info is None or self.info is False else 1)
                    | (0 if self.shipping is None or self.shipping is False else 2)
                    | (0 if self.tip_amount is None or self.tip_amount is False else 8),
                ),
                self.serialize_datetime(self.date),
                struct.pack("<q", self.bot_id),
                struct.pack("<q", self.provider_id),
...
class ResaleStarGifts(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "attributes": (
                [] if self.attributes is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.attributes]
            ),
            "attributes_hash": self.attributes_hash,
            "counters": (
                [] if self.counters is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.counters]
            ),
        }

    def _bytes(self):
        assert (
            (self.attributes or self.attributes is not None) and (self.attributes_hash or self.attributes_hash is not None)
        ) or (
            (self.attributes is None or self.attributes is False)
            and (self.attributes_hash is None or self.attributes_hash is False)
        ), "attributes, attributes_hash parameters must all be False-y (like None) or all be True-y"
        return b"".join(
            (
                b"\xdf\x12z\x94",
                struct.pack(
                    ...
                    | (0 if self.attributes is None or self.attributes is False else 2)
                    | (0 if self.attributes_hash is None or self.attributes_hash is False else 2)
                    | (0 if self.counters is None or self.counters is False else 4),
                ),
                struct.pack("<i", self.count),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.gifts)),
                ...
                (
                    b""
                    if self.attributes is None or self.attributes is False
                    else b"".join(
                        (
                            b"\x15\xc4\xb5\x1c",
                            struct.pack("<i", len(self.attributes)),
                            b"".join(x._bytes() for x in self.attributes),
                        )
                    )
                ),
                (
                    b""
                    if self.attributes_hash is None or self.attributes_hash is False
                    else (struct.pack("<q", self.attributes_hash))
                ),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.chats)),
                b"".join(x._bytes() for x in self.chats),
                (
                    b""
                    if self.counters is None or self.counters is False
                    else b"".join(
                        (
                            b"\x15\xc4\xb5\x1c",
                            struct.pack("<i", len(self.counters)),
                            b"".join(x._bytes() for x in self.counters),
                        )
                    )
                ),
                b"\x15\xc4\xb5\x1c",
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            attributes_hash=_attributes_hash,
            counters=_counters,
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.has_saved_credentials is None or self.has_saved_credentials is False else 2)
                    | (0 if self.saved_info is None or self.saved_info is False else 1),
                ),
                b"" if self.saved_info is None or self.saved_info is False else (self.saved_info._bytes()),
            )
...
class SavedStarGifts(TLObject):
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.chat_notifications_enabled is None else 2)
                    | (0 if self.next_offset is None or self.next_offset is False else 1),
                ),
                struct.pack("<i", self.count),
                (
                    b""
                    if self.chat_notifications_enabled is None
                    else (b"\xb5ur\x99" if self.chat_notifications_enabled else b"7\x97y\xbc")
                ),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.gifts)),
                b"".join(x._bytes() for x in self.gifts),
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            chats=_chats,
            users=_users,
            chat_notifications_enabled=_chat_notifications_enabled,
            next_offset=_next_offset,
        )
...
class StarGiftActiveAuctions(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "auctions": (
                [] if self.auctions is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.auctions]
            ),
            "users": [] if self.users is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.users],
            "chats": [] if self.chats is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.chats],
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                b"\xbc\xab\xf6\xae",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.auctions)),
                b"".join(x._bytes() for x in self.auctions),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.users)),
                b"".join(x._bytes() for x in self.users),
                b"\x15\xc4\xb5\x1c",
...
class StarGiftActiveAuctionsNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "StarGiftActiveAuctionsNotModified"}

    def _bytes(self):
        return b"".join((b"\xd0\xda3\xdb",))
...
class StarGiftAuctionState(TLObject):
    ...
    def __init__(
        ...
        user_state: "TypeStarGiftAuctionUserState",
        timeout: int,
        users: List["TypeUser"],
        chats: List["TypeChat"],
    ):
...
class StarGiftCollections(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "collections": (
                [] if self.collections is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.collections]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                b"\xf32)\x8a",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.collections)),
                b"".join(x._bytes() for x in self.collections),
            )
        )
...
class StarGiftCollectionsNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "StarGiftCollectionsNotModified"}

    def _bytes(self):
        return b"".join((b"\x17O\xba\xa0",))
...
class StarGiftUpgradePreview(TLObject):
    ...
    def __init__(
        ...
        prices: List["TypeStarGiftUpgradePrice"],
        next_prices: List["TypeStarGiftUpgradePrice"],
    ):
        """
    ...
    def to_dict(self):
        return {
            ...
            "sample_attributes": (
                ...
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.sample_attributes]
            ),
            "prices": [] if self.prices is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.prices],
            "next_prices": (
                [] if self.next_prices is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.next_prices]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                b"\xed\xdf\xe1=",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.sample_attributes)),
                b"".join(x._bytes() for x in self.sample_attributes),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.prices)),
                b"".join(x._bytes() for x in self.prices),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.next_prices)),
                b"".join(x._bytes() for x in self.next_prices),
            )
        )
...
class StarGiftWithdrawalUrl(TLObject):
    ...
    def to_dict(self):
        return {"_": "StarGiftWithdrawalUrl", "url": self.url}
...
class StarGiftsNotModified(TLObject):
    ...
    def to_dict(self):
        return {"_": "StarGiftsNotModified"}

    def _bytes(self):
        return b"".join((b"h\xa3\x88\xa3",))
...
class StarsRevenueAdsAccountUrl(TLObject):
    ...
    def to_dict(self):
        return {"_": "StarsRevenueAdsAccountUrl", "url": self.url}
...
class StarsRevenueStats(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "top_hours_graph": (
                self.top_hours_graph.to_dict() if isinstance(self.top_hours_graph, TLObject) else self.top_hours_graph
            ),
        }
...
class StarsRevenueWithdrawalUrl(TLObject):
    ...
    def to_dict(self):
        return {"_": "StarsRevenueWithdrawalUrl", "url": self.url}
...
class StarsStatus(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "subscriptions": (
                ...
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.subscriptions]
            ),
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.subscriptions is None or self.subscriptions is False else 2)
                    | (0 if self.subscriptions_next_offset is None or self.subscriptions_next_offset is False else 4)
                    | (0 if self.subscriptions_missing_balance is None or self.subscriptions_missing_balance is False else 16)
                    | (0 if self.history is None or self.history is False else 8)
                    | (0 if self.next_offset is None or self.next_offset is False else 1),
                ),
                self.balance._bytes(),
                (
                    b""
                    if self.subscriptions is None or self.subscriptions is False
                    else b"".join(
                        (
                            b"\x15\xc4\xb5\x1c",
                            struct.pack("<i", len(self.subscriptions)),
                            b"".join(x._bytes() for x in self.subscriptions),
                        )
                    )
                ),
                (
                    b""
                    if self.subscriptions_next_offset is None or self.subscriptions_next_offset is False
                    else (self.serialize_bytes(self.subscriptions_next_offset))
                ),
                (
                    b""
                    if self.subscriptions_missing_balance is None or self.subscriptions_missing_balance is False
                    else (struct.pack("<q", self.subscriptions_missing_balance))
                ),
                (
                    b""
                    if self.history is None or self.history is False
                    else b"".join(
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            subscriptions_next_offset=_subscriptions_next_offset,
            subscriptions_missing_balance=_subscriptions_missing_balance,
            history=_history,
            next_offset=_next_offset,
        )
...
class SuggestedStarRefBots(TLObject):
    ...
    def to_dict(self):
        return {
            ...
            "suggested_bots": (
                []
                if self.suggested_bots is None
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.suggested_bots]
            ),
            "users": [] if self.users is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.users],
            "next_offset": self.next_offset,
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack("<i", self.count),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.suggested_bots)),
                b"".join(x._bytes() for x in self.suggested_bots),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.users)),
                b"".join(x._bytes() for x in self.users),
                b"" if self.next_offset is None or self.next_offset is False else (self.serialize_bytes(self.next_offset)),
...
class UniqueStarGiftValueInfo(TLObject):
    ...
    def __init__(
        ...
        currency: str,
        value: int,
        initial_sale_date: Optional[datetime],
        initial_sale_stars: int,
        initial_sale_price: int,
        last_sale_on_fragment: Optional[bool] = None,
        value_is_average: Optional[bool] = None,
    ...
    def _bytes(self):
        assert (
            (self.last_sale_date or self.last_sale_date is not None)
            and (self.last_sale_price or self.last_sale_price is not None)
        ) or (
            (self.last_sale_date is None or self.last_sale_date is False)
            and (self.last_sale_price is None or self.last_sale_price is False)
        ), "last_sale_date, last_sale_price parameters must all be False-y (like None) or all be True-y"
        assert (
            (self.fragment_listed_count or self.fragment_listed_count is not None)
            and (self.fragment_listed_url or self.fragment_listed_url is not None)
        ) or (
            (self.fragment_listed_count is None or self.fragment_listed_count is False)
            and (self.fragment_listed_url is None or self.fragment_listed_url is False)
        ), "fragment_listed_count, fragment_listed_url parameters must all be False-y (like None) or all be True-y"
        return b"".join(
            (
                b"F\xe4/Q",
                struct.pack(
                    "<I",
                    (0 if self.last_sale_on_fragment is None or self.last_sale_on_fragment is False else 2)
                    | (0 if self.value_is_average is None or self.value_is_average is False else 64)
                    | (0 if self.last_sale_date is None or self.last_sale_date is False else 1)
                    | (0 if self.last_sale_price is None or self.last_sale_price is False else 1)
                    | (0 if self.floor_price is None or self.floor_price is False else 4)
                    | (0 if self.average_price is None or self.average_price is False else 8)
                    | (0 if self.listed_count is None or self.listed_count is False else 16)
                    | (0 if self.fragment_listed_count is None or self.fragment_listed_count is False else 32)
                    | (0 if self.fragment_listed_url is None or self.fragment_listed_url is False else 32),
                ),
                self.serialize_bytes(self.currency),
                ...
                (
                    b""
                    if self.last_sale_date is None or self.last_sale_date is False
                    else (self.serialize_datetime(self.last_sale_date))
                ),
                (
                    b""
                    if self.last_sale_price is None or self.last_sale_price is False
                    else (struct.pack("<q", self.last_sale_price))
                ),
                ...
                (
                    b""
                    if self.fragment_listed_count is None or self.fragment_listed_count is False
                    else (struct.pack("<i", self.fragment_listed_count))
                ),
                (
                    b""
                    if self.fragment_listed_url is None or self.fragment_listed_url is False
                    else (self.serialize_bytes(self.fragment_listed_url))
                ),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            currency=_currency,
            value=_value,
            initial_sale_date=_initial_sale_date,
            initial_sale_stars=_initial_sale_stars,
            initial_sale_price=_initial_sale_price,
            last_sale_on_fragment=_last_sale_on_fragment,
            value_is_average=_value_is_average,
            last_sale_date=_last_sale_date,
            last_sale_price=_last_sale_price,
            floor_price=_floor_price,
            average_price=_average_price,
            listed_count=_listed_count,
            fragment_listed_count=_fragment_listed_count,
