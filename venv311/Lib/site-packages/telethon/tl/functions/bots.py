...
class AllowSendMessageRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "AllowSendMessageRequest", "bot": self.bot.to_dict() if isinstance(self.bot, TLObject) else self.bot}
...
class CanSendMessageRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "CanSendMessageRequest", "bot": self.bot.to_dict() if isinstance(self.bot, TLObject) else self.bot}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                self.serialize_bytes(self.lang_code),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.media)),
                b"".join(x._bytes() for x in self.media),
            )
        )
...
class GetAdminedBotsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetAdminedBotsRequest"}

    def _bytes(self):
        return b"".join((b"\x83\x1dq\xb0",))
...
class GetBotRecommendationsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetBotRecommendationsRequest", "bot": self.bot.to_dict() if isinstance(self.bot, TLObject) else self.bot}
...
class GetPopularAppBotsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetPopularAppBotsRequest", "offset": self.offset, "limit": self.limit}
...
class GetPreviewMediasRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetPreviewMediasRequest", "bot": self.bot.to_dict() if isinstance(self.bot, TLObject) else self.bot}
...
class SetBotCommandsRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "lang_code": self.lang_code,
            "commands": (
                [] if self.commands is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.commands]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.bot is None or self.bot is False else 4)
                    | (0 if self.name is None or self.name is False else 8)
                    | (0 if self.about is None or self.about is False else 1)
                    | (0 if self.description is None or self.description is False else 2),
                ),
                b"" if self.bot is None or self.bot is False else (self.bot._bytes()),
                self.serialize_bytes(self.lang_code),
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.enabled is None or self.enabled is False else 2)
                    | (0 if self.bot is None or self.bot is False else 1)
                    | (0 if self.custom_description is None or self.custom_description is False else 4),
                ),
                b"" if self.bot is None or self.bot is False else (self.bot._bytes()),
                self.peer._bytes(),
                (
                    b""
                    if self.custom_description is None or self.custom_description is False
                    else (self.serialize_bytes(self.custom_description))
                ),
            )
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                (
                    b""
                    if self.duration_months is None or self.duration_months is False
                    else (struct.pack("<i", self.duration_months))
                ),
            )
        )
