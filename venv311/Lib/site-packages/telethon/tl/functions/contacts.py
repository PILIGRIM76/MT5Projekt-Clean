...
class AcceptContactRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "AcceptContactRequest", "id": self.id.to_dict() if isinstance(self.id, TLObject) else self.id}
...
class AddContactRequest(TLRequest):
    ...
    def __init__(
        ...
        note: Optional["TypeTextWithEntities"] = None,
    ):
        """
        :returns Updates: Instance of either UpdatesTooLong, UpdateShortMessage, UpdateShortChatMessage, UpdateShort, UpdatesCombined, Updates, UpdateShortSentMessage.
        """
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.add_phone_privacy_exception is None or self.add_phone_privacy_exception is False else 1)
                    | (0 if self.note is None or self.note is False else 2),
                ),
                self.id._bytes(),
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.delete_message is None or self.delete_message is False else 1)
                    | (0 if self.delete_history is None or self.delete_history is False else 2)
                    | (0 if self.report_spam is None or self.report_spam is False else 4),
                ),
...
class DeleteByPhonesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "DeleteByPhonesRequest", "phones": [] if self.phones is None else self.phones[:]}
...
class EditCloseFriendsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "EditCloseFriendsRequest", "id": [] if self.id is None else self.id[:]}
...
class ExportContactTokenRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ExportContactTokenRequest"}

    def _bytes(self):
        return b"".join((b"'@e\xf8",))
...
class GetBirthdaysRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetBirthdaysRequest"}

    def _bytes(self):
        return b"".join((b"d\xa8\xed\xda",))
...
class GetBlockedRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetBlockedRequest", "offset": self.offset, "limit": self.limit, "my_stories_from": self.my_stories_from}
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.self_expires is None or self.self_expires is False else 1),
                ),
...
class GetSponsoredPeersRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetSponsoredPeersRequest", "q": self.q}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.correspondents is None or self.correspondents is False else 1)
                    | (0 if self.bots_pm is None or self.bots_pm is False else 2)
                    | (0 if self.bots_inline is None or self.bots_inline is False else 4)
                    | (0 if self.phone_calls is None or self.phone_calls is False else 8)
                    | (0 if self.forward_users is None or self.forward_users is False else 16)
                    | (0 if self.forward_chats is None or self.forward_chats is False else 32)
                    ...
                    | (0 if self.bots_app is None or self.bots_app is False else 65536),
                ),
                struct.pack("<i", self.offset),
                struct.pack("<i", self.limit),
                struct.pack("<q", self.hash),
...
class ImportContactTokenRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ImportContactTokenRequest", "token": self.token}
...
class ImportContactsRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "contacts": (
                [] if self.contacts is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.contacts]
            ),
        }
...
class ResolvePhoneRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ResolvePhoneRequest", "phone": self.phone}
...
class ResolveUsernameRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ResolveUsernameRequest", "username": self.username, "referer": self.referer}
