...
class AcceptUrlAuthRequest(TLRequest):
    ...
    def __init__(
        ...
        share_phone_number: Optional[bool] = None,
    ...
    def _bytes(self):
        ...
        ), "peer, msg_id, button_id parameters must all be False-y (like None) or all be True-y"
        return b"".join(
            (
                b"\xde\xf0\xa3g",
                struct.pack(
                    "<I",
                    (0 if self.write_allowed is None or self.write_allowed is False else 1)
                    | (0 if self.share_phone_number is None or self.share_phone_number is False else 8)
                    ...
                    | (0 if self.match_code is None or self.match_code is False else 16),
                ),
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            share_phone_number=_share_phone_number,
            peer=_peer,
            msg_id=_msg_id,
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack("<i", self.msg_id),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.list)),
                b"".join(x._bytes() for x in self.list),
            )
        )
...
class CheckQuickReplyShortcutRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "CheckQuickReplyShortcutRequest", "shortcut": self.shortcut}
...
class CheckUrlAuthMatchCodeRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "CheckUrlAuthMatchCodeRequest", "url": self.url, "match_code": self.match_code}
...
class ClearRecentReactionsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ClearRecentReactionsRequest"}

    def _bytes(self):
        return b"".join((b"\xb4\xef\xfe\x9d",))
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.media is None or self.media is False else 1)
                    | (0 if self.fullscreen is None or self.fullscreen is False else 2),
                ),
...
class ComposeMessageWithAIRequest(TLRequest):
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.proofread is None or self.proofread is False else 1)
                    | (0 if self.emojify is None or self.emojify is False else 8)
                    | (0 if self.translate_to_lang is None or self.translate_to_lang is False else 2)
                    | (0 if self.change_tone is None or self.change_tone is False else 4),
                ),
                self.text._bytes(),
                (
                    b""
                    if self.translate_to_lang is None or self.translate_to_lang is False
                    else (self.serialize_bytes(self.translate_to_lang))
                ),
    ...
    def from_reader(cls, reader):
        ...
        if flags & 4:
            ...
            _change_tone = None
        return cls(
            text=_text, proofread=_proofread, emojify=_emojify, translate_to_lang=_translate_to_lang, change_tone=_change_tone
        )
...
class CreateForumTopicRequest(TLRequest):
    ...
    def __init__(
        ...
        peer: "TypeInputPeer",
        title: str,
        title_missing: Optional[bool] = None,
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.title_missing is None or self.title_missing is False else 16)
                    | (0 if self.icon_color is None or self.icon_color is False else 1)
                    | (0 if self.icon_emoji_id is None or self.icon_emoji_id is False else 8)
                    | (0 if self.send_as is None or self.send_as is False else 4),
                ),
                self.peer._bytes(),
                self.serialize_bytes(self.title),
...
class DeclineUrlAuthRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "DeclineUrlAuthRequest", "url": self.url}
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.min_date is None or self.min_date is False else 4)
                    | (0 if self.max_date is None or self.max_date is False else 8),
                ),
                self.peer._bytes(),
...
class DeleteMessagesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "DeleteMessagesRequest", "id": [] if self.id is None else self.id[:], "revoke": self.revoke}
...
class DeleteQuickReplyShortcutRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "DeleteQuickReplyShortcutRequest", "shortcut_id": self.shortcut_id}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.parent_peer is None or self.parent_peer is False else 1)
                    | (0 if self.min_date is None or self.min_date is False else 4)
                    | (0 if self.max_date is None or self.max_date is False else 8),
                ),
...
class DiscardEncryptionRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "DiscardEncryptionRequest", "chat_id": self.chat_id, "delete_history": self.delete_history}
...
class EditChatTitleRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "EditChatTitleRequest", "chat_id": self.chat_id, "title": self.title}
...
class EditExportedChatInviteRequest(TLRequest):
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.expire_date is None or self.expire_date is False else 1)
                    | (0 if self.usage_limit is None or self.usage_limit is False else 2)
                    | (0 if self.request_needed is None else 8)
                    | (0 if self.title is None or self.title is False else 16),
                ),
                self.peer._bytes(),
                self.serialize_bytes(self.link),
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            request_needed=_request_needed,
            title=_title,
        )
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.icon_emoji_id is None or self.icon_emoji_id is False else 2)
                    | (0 if self.closed is None else 4)
                    | (0 if self.hidden is None else 8),
                ),
                self.peer._bytes(),
...
class EditInlineBotMessageRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "entities": (
                [] if self.entities is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.entities]
            ),
        }
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.reply_markup is None or self.reply_markup is False else 4)
                    | (0 if self.entities is None or self.entities is False else 8)
                    | (0 if self.schedule_date is None or self.schedule_date is False else 32768)
                    | (0 if self.schedule_repeat_period is None or self.schedule_repeat_period is False else 262144)
                    | (0 if self.quick_reply_shortcut_id is None or self.quick_reply_shortcut_id is False else 131072),
                ),
                self.peer._bytes(),
                ...
                (
                    b""
                    if self.schedule_repeat_period is None or self.schedule_repeat_period is False
                    else (struct.pack("<i", self.schedule_repeat_period))
                ),
                (
                    b""
                    if self.quick_reply_shortcut_id is None or self.quick_reply_shortcut_id is False
                    else (struct.pack("<i", self.quick_reply_shortcut_id))
                ),
            )
        )
...
class EditQuickReplyShortcutRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "EditQuickReplyShortcutRequest", "shortcut_id": self.shortcut_id, "shortcut": self.shortcut}
...
class ExportChatInviteRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "subscription_pricing": (
                self.subscription_pricing.to_dict()
                if isinstance(self.subscription_pricing, TLObject)
                else self.subscription_pricing
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.legacy_revoke_permanent is None or self.legacy_revoke_permanent is False else 4)
                    | (0 if self.request_needed is None or self.request_needed is False else 8)
                    | (0 if self.expire_date is None or self.expire_date is False else 1)
                    | (0 if self.usage_limit is None or self.usage_limit is False else 2)
                    | (0 if self.title is None or self.title is False else 16)
                    | (0 if self.subscription_pricing is None or self.subscription_pricing is False else 32),
                ),
                self.peer._bytes(),
                b"" if self.expire_date is None or self.expire_date is False else (self.serialize_datetime(self.expire_date)),
                b"" if self.usage_limit is None or self.usage_limit is False else (struct.pack("<i", self.usage_limit)),
                ...
                (
                    b""
                    if self.subscription_pricing is None or self.subscription_pricing is False
                    else (self.subscription_pricing._bytes())
                ),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            usage_limit=_usage_limit,
            title=_title,
            subscription_pricing=_subscription_pricing,
        )
...
class ForwardMessagesRequest(TLRequest):
    ...
    def __init__(
        ...
        allow_paid_floodskip: Optional[bool] = None,
        ...
        self.random_id = (
            random_id if random_id is not None else [int.from_bytes(os.urandom(8), "big", signed=True) for _ in range(len(id))]
        )
        self.top_msg_id = top_msg_id
    ...
    def to_dict(self):
        return {
            ...
            "quick_reply_shortcut": (
                self.quick_reply_shortcut.to_dict()
                if isinstance(self.quick_reply_shortcut, TLObject)
                else self.quick_reply_shortcut
            ),
            "effect": self.effect,
            "video_timestamp": self.video_timestamp,
            "allow_paid_stars": self.allow_paid_stars,
            "suggested_post": (
                self.suggested_post.to_dict() if isinstance(self.suggested_post, TLObject) else self.suggested_post
            ),
        }
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.with_my_score is None or self.with_my_score is False else 256)
                    | (0 if self.drop_author is None or self.drop_author is False else 2048)
                    | (0 if self.drop_media_captions is None or self.drop_media_captions is False else 4096)
                    ...
                    | (0 if self.top_msg_id is None or self.top_msg_id is False else 512)
                    | (0 if self.reply_to is None or self.reply_to is False else 4194304)
                    ...
                    | (0 if self.video_timestamp is None or self.video_timestamp is False else 1048576)
                    | (0 if self.allow_paid_stars is None or self.allow_paid_stars is False else 2097152)
                    | (0 if self.suggested_post is None or self.suggested_post is False else 8388608),
                ),
                ...
                (
                    b""
                    if self.quick_reply_shortcut is None or self.quick_reply_shortcut is False
                    else (self.quick_reply_shortcut._bytes())
                ),
                b"" if self.effect is None or self.effect is False else (struct.pack("<q", self.effect)),
                (
                    b""
                    if self.video_timestamp is None or self.video_timestamp is False
                    else (struct.pack("<i", self.video_timestamp))
                ),
                (
                    b""
                    if self.allow_paid_stars is None or self.allow_paid_stars is False
                    else (struct.pack("<q", self.allow_paid_stars))
                ),
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            drop_author=_drop_author,
            drop_media_captions=_drop_media_captions,
            noforwards=_noforwards,
            allow_paid_floodskip=_allow_paid_floodskip,
            random_id=_random_id,
            ...
            schedule_repeat_period=_schedule_repeat_period,
            send_as=_send_as,
            quick_reply_shortcut=_quick_reply_shortcut,
            effect=_effect,
            video_timestamp=_video_timestamp,
            allow_paid_stars=_allow_paid_stars,
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.emojis is None or self.emojis is False else 2),
                ),
...
class GetAttachMenuBotRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetAttachMenuBotRequest", "bot": self.bot.to_dict() if isinstance(self.bot, TLObject) else self.bot}
...
class GetAttachMenuBotsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetAttachMenuBotsRequest", "hash": self.hash}
...
class GetAvailableEffectsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetAvailableEffectsRequest", "hash": self.hash}
...
class GetAvailableReactionsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetAvailableReactionsRequest", "hash": self.hash}
...
class GetChatInviteImportersRequest(TLRequest):
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.requested is None or self.requested is False else 1)
                    | (0 if self.subscription_expired is None or self.subscription_expired is False else 8)
                    | (0 if self.link is None or self.link is False else 2)
                    | (0 if self.q is None or self.q is False else 4),
                ),
                self.peer._bytes(),
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            subscription_expired=_subscription_expired,
            link=_link,
            q=_q,
        )
...
class GetCustomEmojiDocumentsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetCustomEmojiDocumentsRequest", "document_id": [] if self.document_id is None else self.document_id[:]}
    ...
    def _bytes(self):
        return b"".join(
            (
                b"T\x0f\xab\xd9",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.document_id)),
                b"".join(struct.pack("<q", x) for x in self.document_id),
            )
        )
...
class GetDefaultHistoryTTLRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetDefaultHistoryTTLRequest"}

    def _bytes(self):
        return b"".join((b"\x88q\x8be",))
...
class GetDefaultTagReactionsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetDefaultTagReactionsRequest", "hash": self.hash}
...
class GetDhConfigRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetDhConfigRequest", "version": self.version, "random_length": self.random_length}
...
class GetDialogFiltersRequest(TLRequest):
    ...
    def _bytes(self):
        return b"".join((b"\x89\x8c\xd4\xef",))
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.exclude_pinned is None or self.exclude_pinned is False else 1)
...
class GetDocumentByHashRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetDocumentByHashRequest", "sha256": self.sha256, "size": self.size, "mime_type": self.mime_type}
...
class GetEmojiGameInfoRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetEmojiGameInfoRequest"}

    def _bytes(self):
        return b"".join((b"\xa7\x8c~\xfb",))
...
class GetEmojiGroupsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetEmojiGroupsRequest", "hash": self.hash}
...
class GetEmojiKeywordsDifferenceRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetEmojiKeywordsDifferenceRequest", "lang_code": self.lang_code, "from_version": self.from_version}
...
class GetEmojiKeywordsLanguagesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetEmojiKeywordsLanguagesRequest", "lang_codes": [] if self.lang_codes is None else self.lang_codes[:]}
...
class GetEmojiProfilePhotoGroupsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetEmojiProfilePhotoGroupsRequest", "hash": self.hash}
...
class GetEmojiStatusGroupsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetEmojiStatusGroupsRequest", "hash": self.hash}
...
class GetEmojiStickerGroupsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetEmojiStickerGroupsRequest", "hash": self.hash}
...
class GetEmojiStickersRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetEmojiStickersRequest", "hash": self.hash}
...
class GetExportedChatInvitesRequest(TLRequest):
    ...
    def _bytes(self):
        assert ((self.offset_date or self.offset_date is not None) and (self.offset_link or self.offset_link is not None)) or (
            (self.offset_date is None or self.offset_date is False) and (self.offset_link is None or self.offset_link is False)
        ), "offset_date, offset_link parameters must all be False-y (like None) or all be True-y"
        return b"".join(
            (
                b"\xf6\xa3\xb5\xa2",
                struct.pack(
                    ...
                    | (0 if self.offset_date is None or self.offset_date is False else 4)
                    | (0 if self.offset_link is None or self.offset_link is False else 4),
                ),
                self.peer._bytes(),
                self.admin_id._bytes(),
    ...
    def from_reader(cls, reader):
        ...
        _limit = reader.read_int()
        return cls(
            peer=_peer, admin_id=_admin_id, limit=_limit, revoked=_revoked, offset_date=_offset_date, offset_link=_offset_link
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                self.peer._bytes(),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.msg_id)),
                b"".join(struct.pack("<i", x) for x in self.msg_id),
            )
        )
...
class GetFeaturedEmojiStickersRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetFeaturedEmojiStickersRequest", "hash": self.hash}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"".join(struct.pack("<i", x) for x in self.topics),
            )
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.reaction is None or self.reaction is False else 1)
...
class GetMyStickersRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetMyStickersRequest", "offset_id": self.offset_id, "limit": self.limit}
...
class GetOldFeaturedStickersRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetOldFeaturedStickersRequest", "offset": self.offset, "limit": self.limit, "hash": self.hash}
...
class GetOnlinesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetOnlinesRequest", "peer": self.peer.to_dict() if isinstance(self.peer, TLObject) else self.peer}
...
class GetPaidReactionPrivacyRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetPaidReactionPrivacyRequest"}

    def _bytes(self):
        return b"".join((b"\xaaU$G",))
...
class GetPeerSettingsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetPeerSettingsRequest", "peer": self.peer.to_dict() if isinstance(self.peer, TLObject) else self.peer}
...
class GetPinnedSavedDialogsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetPinnedSavedDialogsRequest"}

    def _bytes(self):
        return b"".join((b"\xe0\x94=\xd6",))
...
class GetPollVotesRequest(TLRequest):
    ...
    def __init__(
        self, peer: "TypeInputPeer", id: int, limit: int, option: Optional[bytes] = None, offset: Optional[str] = None
    ):
        """
...
class GetQuickRepliesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetQuickRepliesRequest", "hash": self.hash}
...
class GetRecentReactionsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetRecentReactionsRequest", "limit": self.limit, "hash": self.hash}
...
class GetRecentStickersRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetRecentStickersRequest", "hash": self.hash, "attached": self.attached}
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.exclude_pinned is None or self.exclude_pinned is False else 1)
                    | (0 if self.parent_peer is None or self.parent_peer is False else 2),
                ),
                b"" if self.parent_peer is None or self.parent_peer is False else (self.parent_peer._bytes()),
                self.serialize_datetime(self.offset_date),
                struct.pack("<i", self.offset_id),
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.saved_peer_id is None or self.saved_peer_id is False else 4)
...
class GetTopReactionsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetTopReactionsRequest", "limit": self.limit, "hash": self.hash}
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.top_msg_id is None or self.top_msg_id is False else 1)
                    | (0 if self.saved_peer_id is None or self.saved_peer_id is False else 2),
                ),
                self.peer._bytes(),
                b"" if self.top_msg_id is None or self.top_msg_id is False else (struct.pack("<i", self.top_msg_id)),
                b"" if self.saved_peer_id is None or self.saved_peer_id is False else (self.saved_peer_id._bytes()),
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.approved is None or self.approved is False else 1)
                    | (0 if self.link is None or self.link is False else 2),
                ),
                self.peer._bytes(),
                b"" if self.link is None or self.link is False else (self.serialize_bytes(self.link)),
...
class MarkDialogUnreadRequest(TLRequest):
    ...
    def __init__(
        self, peer: "TypeInputDialogPeer", unread: Optional[bool] = None, parent_peer: Optional["TypeInputPeer"] = None
    ):
        """
        :returns Bool: This type has no constructors.
        """
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.unread is None or self.unread is False else 1)
                    | (0 if self.parent_peer is None or self.parent_peer is False else 2),
                ),
                b"" if self.parent_peer is None or self.parent_peer is False else (self.parent_peer._bytes()),
                self.peer._bytes(),
...
class ReadFeaturedStickersRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ReadFeaturedStickersRequest", "id": [] if self.id is None else self.id[:]}
...
class ReadMessageContentsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ReadMessageContentsRequest", "id": [] if self.id is None else self.id[:]}
...
class ReadReactionsRequest(TLRequest):
    ...
    def __init__(
        self, peer: "TypeInputPeer", top_msg_id: Optional[int] = None, saved_peer_id: Optional["TypeInputPeer"] = None
    ):
        """
        :returns messages.AffectedHistory: Instance of AffectedHistory.
        """
...
class ReorderQuickRepliesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ReorderQuickRepliesRequest", "order": [] if self.order is None else self.order[:]}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"".join(x._bytes() for x in self.metrics),
            )
        )
...
class ReportSpamRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ReportSpamRequest", "peer": self.peer.to_dict() if isinstance(self.peer, TLObject) else self.peer}
...
class ReportSponsoredMessageRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ReportSponsoredMessageRequest", "option": self.option, "random_id": self.random_id}
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.write_allowed is None or self.write_allowed is False else 1)
                    | (0 if self.compact is None or self.compact is False else 128)
                    | (0 if self.fullscreen is None or self.fullscreen is False else 256)
                    | (0 if self.start_param is None or self.start_param is False else 2)
                    | (0 if self.theme_params is None or self.theme_params is False else 4),
                ),
                self.peer._bytes(),
                self.app._bytes(),
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.fullscreen is None or self.fullscreen is False else 256)
                    | (0 if self.start_param is None or self.start_param is False else 2)
                    | (0 if self.theme_params is None or self.theme_params is False else 1),
                ),
                self.peer._bytes(),
                self.bot._bytes(),
                b"" if self.start_param is None or self.start_param is False else (self.serialize_bytes(self.start_param)),
...
class RequestSimpleWebViewRequest(TLRequest):
    ...
    def __init__(
        ...
        bot: "TypeInputUser",
        platform: str,
        from_switch_webview: Optional[bool] = None,
        from_side_menu: Optional[bool] = None,
        compact: Optional[bool] = None,
        fullscreen: Optional[bool] = None,
        url: Optional[str] = None,
        start_param: Optional[str] = None,
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.from_switch_webview is None or self.from_switch_webview is False else 2)
                    | (0 if self.from_side_menu is None or self.from_side_menu is False else 4)
                    | (0 if self.compact is None or self.compact is False else 128)
                    | (0 if self.fullscreen is None or self.fullscreen is False else 256)
                    | (0 if self.url is None or self.url is False else 8)
                    | (0 if self.start_param is None or self.start_param is False else 16)
                    | (0 if self.theme_params is None or self.theme_params is False else 1),
                ),
                self.bot._bytes(),
                b"" if self.url is None or self.url is False else (self.serialize_bytes(self.url)),
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            bot=_bot,
            platform=_platform,
            from_switch_webview=_from_switch_webview,
            from_side_menu=_from_side_menu,
            compact=_compact,
            fullscreen=_fullscreen,
            url=_url,
            start_param=_start_param,
...
class RequestUrlAuthRequest(TLRequest):
    ...
    def __init__(
        ...
        button_id: Optional[int] = None,
        url: Optional[str] = None,
        in_app_origin: Optional[str] = None,
    ):
        """
        :returns UrlAuthResult: Instance of either UrlAuthResultRequest, UrlAuthResultAccepted, UrlAuthResultDefault.
        """
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.button_id is None or self.button_id is False else 2)
                    | (0 if self.url is None or self.url is False else 4)
                    | (0 if self.in_app_origin is None or self.in_app_origin is False else 8),
                ),
                b"" if self.peer is None or self.peer is False else (self.peer._bytes()),
                b"" if self.msg_id is None or self.msg_id is False else (struct.pack("<i", self.msg_id)),
                b"" if self.button_id is None or self.button_id is False else (struct.pack("<i", self.button_id)),
                ...
                (
                    b""
                    if self.in_app_origin is None or self.in_app_origin is False
                    else (self.serialize_bytes(self.in_app_origin))
                ),
            )
        )
...
class RequestWebViewRequest(TLRequest):
    ...
    def __init__(
        ...
        bot: "TypeInputUser",
        platform: str,
        from_bot_menu: Optional[bool] = None,
        silent: Optional[bool] = None,
        compact: Optional[bool] = None,
        fullscreen: Optional[bool] = None,
        url: Optional[str] = None,
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.from_bot_menu is None or self.from_bot_menu is False else 16)
                    | (0 if self.silent is None or self.silent is False else 32)
                    | (0 if self.compact is None or self.compact is False else 128)
                    | (0 if self.fullscreen is None or self.fullscreen is False else 256)
                    | (0 if self.url is None or self.url is False else 2)
                    | (0 if self.start_param is None or self.start_param is False else 8)
                    | (0 if self.theme_params is None or self.theme_params is False else 4)
                    | (0 if self.reply_to is None or self.reply_to is False else 1)
                    | (0 if self.send_as is None or self.send_as is False else 8192),
                ),
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.no_webpage is None or self.no_webpage is False else 2)
                    | (0 if self.invert_media is None or self.invert_media is False else 64)
                    | (0 if self.reply_to is None or self.reply_to is False else 16)
                    | (0 if self.entities is None or self.entities is False else 8)
                    | (0 if self.media is None or self.media is False else 32)
                    | (0 if self.effect is None or self.effect is False else 128)
                    | (0 if self.suggested_post is None or self.suggested_post is False else 256),
                ),
                b"" if self.reply_to is None or self.reply_to is False else (self.reply_to._bytes()),
                self.peer._bytes(),
                self.serialize_bytes(self.message),
...
class SavePreparedInlineMessageRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "user_id": self.user_id.to_dict() if isinstance(self.user_id, TLObject) else self.user_id,
            "peer_types": (
                [] if self.peer_types is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.peer_types]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                (
                    b""
                    if self.peer_types is None or self.peer_types is False
                    else b"".join(
                        (
                            b"\x15\xc4\xb5\x1c",
                            struct.pack("<i", len(self.peer_types)),
                            b"".join(x._bytes() for x in self.peer_types),
                        )
                    )
                ),
            )
...
class SearchRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "saved_reaction": (
                []
                if self.saved_reaction is None
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.saved_reaction]
            ),
            "top_msg_id": self.top_msg_id,
        }
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.saved_peer_id is None or self.saved_peer_id is False else 4)
                    | (0 if self.saved_reaction is None or self.saved_reaction is False else 8)
                ...
                (
                    b""
                    if self.saved_reaction is None or self.saved_reaction is False
                    else b"".join(
                        (
                            b"\x15\xc4\xb5\x1c",
                            struct.pack("<i", len(self.saved_reaction)),
                            b"".join(x._bytes() for x in self.saved_reaction),
                        )
                    )
                ),
                b"" if self.top_msg_id is None or self.top_msg_id is False else (struct.pack("<i", self.top_msg_id)),
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            from_id=_from_id,
            saved_peer_id=_saved_peer_id,
            saved_reaction=_saved_reaction,
            top_msg_id=_top_msg_id,
        )
...
class SearchCustomEmojiRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "SearchCustomEmojiRequest", "emoticon": self.emoticon, "hash": self.hash}
...
class SearchGlobalRequest(TLRequest):
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.broadcasts_only is None or self.broadcasts_only is False else 2)
                    | (0 if self.groups_only is None or self.groups_only is False else 4)
                    | (0 if self.users_only is None or self.users_only is False else 8)
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            offset_id=_offset_id,
            limit=_limit,
            broadcasts_only=_broadcasts_only,
            groups_only=_groups_only,
            users_only=_users_only,
            folder_id=_folder_id,
        )
...
class SearchStickerSetsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "SearchStickerSetsRequest", "q": self.q, "hash": self.hash, "exclude_featured": self.exclude_featured}
...
class SearchStickersRequest(TLRequest):
    ...
    def __init__(
        self, q: str, emoticon: str, lang_code: List[str], offset: int, limit: int, hash: int, emojis: Optional[bool] = None
    ):
        """
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                self.serialize_bytes(self.emoticon),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.lang_code)),
                b"".join(self.serialize_bytes(x) for x in self.lang_code),
                struct.pack("<i", self.offset),
                struct.pack("<i", self.limit),
                struct.pack("<q", self.hash),
            )
...
class SendBotRequestedPeerRequest(TLRequest):
    ...
    def __init__(
        ...
        msg_id: Optional[int] = None,
        webapp_req_id: Optional[str] = None,
    ):
        """
        :returns Updates: Instance of either UpdatesTooLong, UpdateShortMessage, UpdateShortChatMessage, UpdateShort, UpdatesCombined, Updates, UpdateShortSentMessage.
        """
    ...
    def to_dict(self):
        return {
            ...
            "requested_peers": (
                []
                if self.requested_peers is None
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.requested_peers]
            ),
            "msg_id": self.msg_id,
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.msg_id is None or self.msg_id is False else 1)
                    | (0 if self.webapp_req_id is None or self.webapp_req_id is False else 2),
                ),
                self.peer._bytes(),
                b"" if self.msg_id is None or self.msg_id is False else (struct.pack("<i", self.msg_id)),
                (
                    b""
                    if self.webapp_req_id is None or self.webapp_req_id is False
                    else (self.serialize_bytes(self.webapp_req_id))
                ),
                struct.pack("<i", self.button_id),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.requested_peers)),
                b"".join(x._bytes() for x in self.requested_peers),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            peer=_peer, button_id=_button_id, requested_peers=_requested_peers, msg_id=_msg_id, webapp_req_id=_webapp_req_id
        )
...
class SendMediaRequest(TLRequest):
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            clear_draft=_clear_draft,
            noforwards=_noforwards,
            update_stickersets_order=_update_stickersets_order,
            invert_media=_invert_media,
            allow_paid_floodskip=_allow_paid_floodskip,
            reply_to=_reply_to,
            random_id=_random_id,
...
class SendMultiMediaRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "peer": self.peer.to_dict() if isinstance(self.peer, TLObject) else self.peer,
            "multi_media": (
                [] if self.multi_media is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.multi_media]
            ),
            "silent": self.silent,
            "background": self.background,
            "clear_draft": self.clear_draft,
...
class SendReactionRequest(TLRequest):
    ...
    def __init__(
        ...
        add_to_recent: Optional[bool] = None,
    ...
    def to_dict(self):
        return {
            ...
            "reaction": (
                [] if self.reaction is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.reaction]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.big is None or self.big is False else 2)
                    | (0 if self.add_to_recent is None or self.add_to_recent is False else 4)
                    | (0 if self.reaction is None or self.reaction is False else 1),
                ),
                self.peer._bytes(),
                struct.pack("<i", self.msg_id),
                (
                    b""
                    if self.reaction is None or self.reaction is False
                    else b"".join(
                        (
                            b"\x15\xc4\xb5\x1c",
                            struct.pack("<i", len(self.reaction)),
                            b"".join(x._bytes() for x in self.reaction),
                        )
                    )
                ),
            )
...
class SetBotShippingResultsRequest(TLRequest):
    ...
    def __init__(
        self, query_id: int, error: Optional[str] = None, shipping_options: Optional[List["TypeShippingOption"]] = None
    ):
        """
        :returns Bool: This type has no constructors.
        """
    ...
    def to_dict(self):
        return {
            ...
            "shipping_options": (
                ...
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.shipping_options]
            ),
        }
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.error is None or self.error is False else 1)
                    | (0 if self.shipping_options is None or self.shipping_options is False else 2),
                ),
                struct.pack("<q", self.query_id),
                b"" if self.error is None or self.error is False else (self.serialize_bytes(self.error)),
                (
...
class SetChatAvailableReactionsRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "peer": self.peer.to_dict() if isinstance(self.peer, TLObject) else self.peer,
            "available_reactions": (
                self.available_reactions.to_dict()
                if isinstance(self.available_reactions, TLObject)
                else self.available_reactions
            ),
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.reactions_limit is None or self.reactions_limit is False else 1)
                    | (0 if self.paid_enabled is None else 2),
                ),
                self.peer._bytes(),
                self.available_reactions._bytes(),
                (
                    b""
                    if self.reactions_limit is None or self.reactions_limit is False
                    else (struct.pack("<i", self.reactions_limit))
                ),
    ...
    def from_reader(cls, reader):
        ...
        if flags & 2:
            ...
            _paid_enabled = None
        return cls(
            peer=_peer, available_reactions=_available_reactions, reactions_limit=_reactions_limit, paid_enabled=_paid_enabled
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.for_both is None or self.for_both is False else 8)
                    | (0 if self.revert is None or self.revert is False else 16)
                    | (0 if self.wallpaper is None or self.wallpaper is False else 1)
                    | (0 if self.settings is None or self.settings is False else 4)
                    | (0 if self.id is None or self.id is False else 2),
                ),
                self.peer._bytes(),
...
class SetDefaultHistoryTTLRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "SetDefaultHistoryTTLRequest", "period": self.period}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.edit_message is None or self.edit_message is False else 1)
...
class SetInlineBotResultsRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "switch_webview": (
                self.switch_webview.to_dict() if isinstance(self.switch_webview, TLObject) else self.switch_webview
            ),
        }
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.next_offset is None or self.next_offset is False else 4)
                    | (0 if self.switch_pm is None or self.switch_pm is False else 8)
                    | (0 if self.switch_webview is None or self.switch_webview is False else 16),
                ),
                struct.pack("<q", self.query_id),
                b"\x15\xc4\xb5\x1c",
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            switch_webview=_switch_webview,
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.to_lang is None or self.to_lang is False else 1)
                    | (0 if self.tone is None or self.tone is False else 4),
                ),
                self.peer._bytes(),
                struct.pack("<i", self.id),
...
class ToggleDialogFilterTagsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ToggleDialogFilterTagsRequest", "enabled": self.enabled}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                (
                    b""
                    if self.request_msg_id is None or self.request_msg_id is False
                    else (struct.pack("<i", self.request_msg_id))
                ),
            )
        )
...
class ToggleStickerSetsRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "stickersets": (
                [] if self.stickersets is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.stickersets]
            ),
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.reject is None or self.reject is False else 2)
                    | (0 if self.schedule_date is None or self.schedule_date is False else 1)
                    | (0 if self.reject_comment is None or self.reject_comment is False else 4),
                ),
                self.peer._bytes(),
                struct.pack("<i", self.msg_id),
                (
                ...
                (
                    b""
                    if self.reject_comment is None or self.reject_comment is False
                    else (self.serialize_bytes(self.reject_comment))
                ),
            )
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack("<i", self.msg_id),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.completed)),
                b"".join(struct.pack("<i", x) for x in self.completed),
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.incompleted)),
                b"".join(struct.pack("<i", x) for x in self.incompleted),
            )
        )
...
class TranslateTextRequest(TLRequest):
    ...
    def _bytes(self):
        assert ((self.peer or self.peer is not None) and (self.id or self.id is not None)) or (
            (self.peer is None or self.peer is False) and (self.id is None or self.id is False)
        ), "peer, id parameters must all be False-y (like None) or all be True-y"
        return b"".join(
            (
                b"E\xc3\xee\xa5",
                struct.pack(
                    ...
                    | (0 if self.text is None or self.text is False else 2)
                    | (0 if self.tone is None or self.tone is False else 4),
                ),
                b"" if self.peer is None or self.peer is False else (self.peer._bytes()),
                (
                ...
                (
                    b""
                    if self.text is None or self.text is False
                    else b"".join(
                        (b"\x15\xc4\xb5\x1c", struct.pack("<i", len(self.text)), b"".join(x._bytes() for x in self.text))
                    )
                ),
...
class UpdateDialogFiltersOrderRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "UpdateDialogFiltersOrderRequest", "order": [] if self.order is None else self.order[:]}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                (
                    b""
                    if self.business_connection_id is None or self.business_connection_id is False
                    else (self.serialize_bytes(self.business_connection_id))
                ),
                self.peer._bytes(),
                self.media._bytes(),
            )
...
class ViewSponsoredMessageRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ViewSponsoredMessageRequest", "random_id": self.random_id}
