...
class AcceptAuthorizationRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "value_hashes": (
                [] if self.value_hashes is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.value_hashes]
            ),
...
class ChangeAuthorizationSettingsRequest(TLRequest):
    ...
    def __init__(
        ...
        encrypted_requests_disabled: Optional[bool] = None,
        call_requests_disabled: Optional[bool] = None,
    ):
        """
        :returns Bool: This type has no constructors.
        """
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.confirmed is None or self.confirmed is False else 8)
                    | (0 if self.encrypted_requests_disabled is None else 1)
                    | (0 if self.call_requests_disabled is None else 2),
                ),
                struct.pack("<q", self.hash),
                (
                    b""
                    if self.encrypted_requests_disabled is None
                    else (b"\xb5ur\x99" if self.encrypted_requests_disabled else b"7\x97y\xbc")
                ),
                (
                    b""
                    if self.call_requests_disabled is None
                    else (b"\xb5ur\x99" if self.call_requests_disabled else b"7\x97y\xbc")
                ),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            encrypted_requests_disabled=_encrypted_requests_disabled,
            call_requests_disabled=_call_requests_disabled,
        )
...
class ClearRecentEmojiStatusesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ClearRecentEmojiStatusesRequest"}

    def _bytes(self):
        return b"".join((b"\xae\x1a \x18",))
...
class ConfirmPhoneRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ConfirmPhoneRequest", "phone_code_hash": self.phone_code_hash, "phone_code": self.phone_code}
...
class CreateThemeRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "settings": (
                [] if self.settings is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.settings]
            ),
        }
            ...
            (
                ...
                (
                    ...
                    if self.settings is None or self.settings is False
                        ...
                        (
                            b"\x15\xc4\xb5\x1c",
                            struct.pack("<i", len(self.settings)),
                            b"".join(x._bytes() for x in self.settings),
                        )
                    )
                ),
            )
...
class DeclinePasswordResetRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "DeclinePasswordResetRequest"}

    def _bytes(self):
        return b"".join((b"\xf6\t\x94L",))
...
class DeleteAutoSaveExceptionsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "DeleteAutoSaveExceptionsRequest"}

    def _bytes(self):
        return b"".join((b" \x00\xbcS",))
...
class DeleteBusinessChatLinkRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "DeleteBusinessChatLinkRequest", "slug": self.slug}
...
class DeletePasskeyRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "DeletePasskeyRequest", "id": self.id}
...
class GetAuthorizationFormRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetAuthorizationFormRequest", "bot_id": self.bot_id, "scope": self.scope, "public_key": self.public_key}
...
class GetAutoSaveSettingsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetAutoSaveSettingsRequest"}

    def _bytes(self):
        return b"".join((b"\xda\xbc\xcb\xad",))
...
class GetBotBusinessConnectionRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetBotBusinessConnectionRequest", "connection_id": self.connection_id}
...
class GetBusinessChatLinksRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetBusinessChatLinksRequest"}

    def _bytes(self):
        return b"".join((b"\xe1\xddpo",))
...
class GetChannelDefaultEmojiStatusesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetChannelDefaultEmojiStatusesRequest", "hash": self.hash}
...
class GetChannelRestrictedStatusEmojisRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetChannelRestrictedStatusEmojisRequest", "hash": self.hash}
...
class GetChatThemesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetChatThemesRequest", "hash": self.hash}
...
class GetCollectibleEmojiStatusesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetCollectibleEmojiStatusesRequest", "hash": self.hash}
...
class GetConnectedBotsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetConnectedBotsRequest"}

    def _bytes(self):
        return b"".join((b"\x0f\xc8\xa4N",))
...
class GetDefaultBackgroundEmojisRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetDefaultBackgroundEmojisRequest", "hash": self.hash}
...
class GetDefaultEmojiStatusesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetDefaultEmojiStatusesRequest", "hash": self.hash}
...
class GetDefaultGroupPhotoEmojisRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetDefaultGroupPhotoEmojisRequest", "hash": self.hash}
...
class GetDefaultProfilePhotoEmojisRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetDefaultProfilePhotoEmojisRequest", "hash": self.hash}
...
class GetMultiWallPapersRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "wallpapers": (
                [] if self.wallpapers is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.wallpapers]
            ),
        }
...
class GetNotifyExceptionsRequest(TLRequest):
    ...
    def __init__(
        ...
        compare_stories: Optional[bool] = None,
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.compare_sound is None or self.compare_sound is False else 2)
                    | (0 if self.compare_stories is None or self.compare_stories is False else 4)
...
class GetNotifySettingsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetNotifySettingsRequest", "peer": self.peer.to_dict() if isinstance(self.peer, TLObject) else self.peer}
...
class GetPasskeysRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetPasskeysRequest"}

    def _bytes(self):
        return b"".join((b"R\x0c\x1f\xea",))
...
class GetPrivacyRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetPrivacyRequest", "key": self.key.to_dict() if isinstance(self.key, TLObject) else self.key}
...
class GetReactionsNotifySettingsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetReactionsNotifySettingsRequest"}

    def _bytes(self):
        return b"".join((b"Le\xdd\x06",))
...
class GetRecentEmojiStatusesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetRecentEmojiStatusesRequest", "hash": self.hash}
...
class GetSavedMusicIdsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetSavedMusicIdsRequest", "hash": self.hash}
...
class GetSavedRingtonesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetSavedRingtonesRequest", "hash": self.hash}
...
class GetUniqueGiftChatThemesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetUniqueGiftChatThemesRequest", "offset": self.offset, "limit": self.limit, "hash": self.hash}
...
class InitPasskeyRegistrationRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "InitPasskeyRegistrationRequest"}

    def _bytes(self):
        return b"".join((b"\xe8G\x95B",))
...
class InitTakeoutSessionRequest(TLRequest):
    ...
    def _bytes(self):
        assert ((self.files or self.files is not None) and (self.file_max_size or self.file_max_size is not None)) or (
            (self.files is None or self.files is False) and (self.file_max_size is None or self.file_max_size is False)
        ), "files, file_max_size parameters must all be False-y (like None) or all be True-y"
        return b"".join(
            (
                b"\xb0\xea\xf3\x8e",
                struct.pack(
                    ...
                    | (0 if self.message_users is None or self.message_users is False else 2)
                    | (0 if self.message_chats is None or self.message_chats is False else 4)
                    | (0 if self.message_megagroups is None or self.message_megagroups is False else 8)
                    | (0 if self.message_channels is None or self.message_channels is False else 16)
                    | (0 if self.files is None or self.files is False else 32)
                    | (0 if self.file_max_size is None or self.file_max_size is False else 32),
                ),
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.format is None or self.format is False else 4)
                    | (0 if self.base_theme is None or self.base_theme is False else 8),
                ),
...
class InvalidateSignInCodesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "InvalidateSignInCodesRequest", "codes": [] if self.codes is None else self.codes[:]}
    ...
    def _bytes(self):
        return b"".join(
            (
                b"\xba\xe8\x8a\xca",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.codes)),
                b"".join(self.serialize_bytes(x) for x in self.codes),
            )
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"".join(struct.pack("<q", x) for x in self.other_uids),
            )
        )
...
class ReorderUsernamesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ReorderUsernamesRequest", "order": [] if self.order is None else self.order[:]}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"".join(self.serialize_bytes(x) for x in self.order),
            )
        )
...
class ResetPasswordRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ResetPasswordRequest"}

    def _bytes(self):
        return b"".join((b"\x1b\xce\x08\x93",))
...
class ResolveBusinessChatLinkRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ResolveBusinessChatLinkRequest", "slug": self.slug}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.users is None or self.users is False else 1)
                    | (0 if self.chats is None or self.chats is False else 2)
                    | (0 if self.broadcasts is None or self.broadcasts is False else 4)
                    | (0 if self.peer is None or self.peer is False else 8),
                ),
                b"" if self.peer is None or self.peer is False else (self.peer._bytes()),
                self.settings._bytes(),
            )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.unsave is None or self.unsave is False else 1)
                    | (0 if self.after_id is None or self.after_id is False else 2),
                ),
                self.id._bytes(),
...
class SetAccountTTLRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "SetAccountTTLRequest", "ttl": self.ttl.to_dict() if isinstance(self.ttl, TLObject) else self.ttl}
...
class SetAuthorizationTTLRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "SetAuthorizationTTLRequest", "authorization_ttl_days": self.authorization_ttl_days}
...
class SetContentSettingsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "SetContentSettingsRequest", "sensitive_enabled": self.sensitive_enabled}
...
class SetMainProfileTabRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "SetMainProfileTabRequest", "tab": self.tab.to_dict() if isinstance(self.tab, TLObject) else self.tab}
...
class ToggleNoPaidMessagesExceptionRequest(TLRequest):
    ...
    def __init__(
        ...
        refund_charged: Optional[bool] = None,
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.refund_charged is None or self.refund_charged is False else 1)
                    | (0 if self.require_payment is None or self.require_payment is False else 4)
    ...
    def from_reader(cls, reader):
        ...
        _user_id = reader.tgread_object()
        return cls(
            user_id=_user_id, refund_charged=_refund_charged, require_payment=_require_payment, parent_peer=_parent_peer
        )
...
class ToggleSponsoredMessagesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ToggleSponsoredMessagesRequest", "enabled": self.enabled}
...
class ToggleUsernameRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ToggleUsernameRequest", "username": self.username, "active": self.active}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.geo_point is None or self.geo_point is False else 2)
                    | (0 if self.address is None or self.address is False else 1),
                ),
...
class UpdateBusinessWorkHoursRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "business_work_hours": (
                self.business_work_hours.to_dict()
                if isinstance(self.business_work_hours, TLObject)
                else self.business_work_hours
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                (
                    b""
                    if self.business_work_hours is None or self.business_work_hours is False
                    else (self.business_work_hours._bytes())
                ),
            )
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.for_profile is None or self.for_profile is False else 2)
                    | (0 if self.color is None or self.color is False else 4),
                ),
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.deleted is None or self.deleted is False else 2)
                    | (0 if self.rights is None or self.rights is False else 1),
                ),
...
class UpdateProfileRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "UpdateProfileRequest", "first_name": self.first_name, "last_name": self.last_name, "about": self.about}
...
class UploadWallPaperRequest(TLRequest):
    ...
    def __init__(
        self, file: "TypeInputFile", mime_type: str, settings: "TypeWallPaperSettings", for_chat: Optional[bool] = None
    ):
        """
        :returns WallPaper: Instance of either WallPaper, WallPaperNoFile.
        """
