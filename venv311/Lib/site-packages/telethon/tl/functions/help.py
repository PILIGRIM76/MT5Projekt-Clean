...
class AcceptTermsOfServiceRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "AcceptTermsOfServiceRequest", "id": self.id.to_dict() if isinstance(self.id, TLObject) else self.id}
...
class GetAppConfigRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetAppConfigRequest", "hash": self.hash}
...
class GetCountriesListRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetCountriesListRequest", "lang_code": self.lang_code, "hash": self.hash}
...
class GetPeerColorsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetPeerColorsRequest", "hash": self.hash}
...
class GetPeerProfileColorsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetPeerProfileColorsRequest", "hash": self.hash}
...
class GetPremiumPromoRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetPremiumPromoRequest"}

    def _bytes(self):
        return b"".join((b"\xd4\x93\x1b\xb8",))
...
class GetTimezonesListRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetTimezonesListRequest", "hash": self.hash}
...
class HidePromoDataRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "HidePromoDataRequest", "peer": self.peer.to_dict() if isinstance(self.peer, TLObject) else self.peer}
