...
class GetLangPackRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetLangPackRequest", "lang_pack": self.lang_pack, "lang_code": self.lang_code}
...
class GetLanguageRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetLanguageRequest", "lang_pack": self.lang_pack, "lang_code": self.lang_code}
