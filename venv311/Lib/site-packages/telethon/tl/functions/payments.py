...
class ApplyGiftCodeRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ApplyGiftCodeRequest", "slug": self.slug}
...
class CheckCanSendGiftRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "CheckCanSendGiftRequest", "gift_id": self.gift_id}
...
class CheckGiftCodeRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "CheckGiftCodeRequest", "slug": self.slug}
...
class ClearSavedInfoRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ClearSavedInfoRequest", "credentials": self.credentials, "info": self.info}
...
class CraftStarGiftRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "stargift": (
                [] if self.stargift is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.stargift]
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                b"Oh\xf9\xb0",
                b"\x15\xc4\xb5\x1c",
                struct.pack("<i", len(self.stargift)),
                b"".join(x._bytes() for x in self.stargift),
            )
        )
...
class GetConnectedStarRefBotsRequest(TLRequest):
    ...
    def __init__(
        self, peer: "TypeInputPeer", limit: int, offset_date: Optional[datetime] = None, offset_link: Optional[str] = None
    ):
        """
        :returns payments.ConnectedStarRefBots: Instance of ConnectedStarRefBots.
        """
...
class GetCraftStarGiftsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetCraftStarGiftsRequest", "gift_id": self.gift_id, "offset": self.offset, "limit": self.limit}
...
class GetResaleStarGiftsRequest(TLRequest):
    ...
    def __init__(
        ...
        sort_by_num: Optional[bool] = None,
        for_craft: Optional[bool] = None,
        stars_only: Optional[bool] = None,
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.sort_by_price is None or self.sort_by_price is False else 2)
                    | (0 if self.sort_by_num is None or self.sort_by_num is False else 4)
                    | (0 if self.for_craft is None or self.for_craft is False else 16)
                    | (0 if self.stars_only is None or self.stars_only is False else 32)
                    | (0 if self.attributes_hash is None or self.attributes_hash is False else 1)
                    | (0 if self.attributes is None or self.attributes is False else 8),
                ),
                (
                    b""
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            offset=_offset,
            limit=_limit,
            sort_by_price=_sort_by_price,
            sort_by_num=_sort_by_num,
            for_craft=_for_craft,
            stars_only=_stars_only,
...
class GetSavedStarGiftsRequest(TLRequest):
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.exclude_unsaved is None or self.exclude_unsaved is False else 1)
                    | (0 if self.exclude_saved is None or self.exclude_saved is False else 2)
                    | (0 if self.exclude_unlimited is None or self.exclude_unlimited is False else 4)
                    | (0 if self.exclude_unique is None or self.exclude_unique is False else 16)
                    | (0 if self.sort_by_value is None or self.sort_by_value is False else 32)
                    | (0 if self.exclude_upgradable is None or self.exclude_upgradable is False else 128)
                    | (0 if self.exclude_unupgradable is None or self.exclude_unupgradable is False else 256)
                    | (0 if self.peer_color_available is None or self.peer_color_available is False else 512)
                    | (0 if self.exclude_hosted is None or self.exclude_hosted is False else 1024)
                    | (0 if self.collection_id is None or self.collection_id is False else 64),
                ),
                self.peer._bytes(),
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            offset=_offset,
            limit=_limit,
            exclude_unsaved=_exclude_unsaved,
            exclude_saved=_exclude_saved,
            exclude_unlimited=_exclude_unlimited,
            exclude_unique=_exclude_unique,
            sort_by_value=_sort_by_value,
            exclude_upgradable=_exclude_upgradable,
            exclude_unupgradable=_exclude_unupgradable,
            peer_color_available=_peer_color_available,
            exclude_hosted=_exclude_hosted,
...
class GetStarGiftActiveAuctionsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetStarGiftActiveAuctionsRequest", "hash": self.hash}
...
class GetStarGiftAuctionAcquiredGiftsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetStarGiftAuctionAcquiredGiftsRequest", "gift_id": self.gift_id}
...
class GetStarGiftUpgradeAttributesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetStarGiftUpgradeAttributesRequest", "gift_id": self.gift_id}
...
class GetStarGiftUpgradePreviewRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetStarGiftUpgradePreviewRequest", "gift_id": self.gift_id}
...
class GetStarsGiveawayOptionsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetStarsGiveawayOptionsRequest"}

    def _bytes(self):
        return b"".join((b">\xfd\x1e\xbd",))
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.ton is None or self.ton is False else 2),
                ),
                self.peer._bytes(),
            )
        )
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.ton is None or self.ton is False else 1)
                    | (0 if self.amount is None or self.amount is False else 2),
                ),
                self.peer._bytes(),
...
class GetStarsTopupOptionsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetStarsTopupOptionsRequest"}

    def _bytes(self):
        return b"".join((b"\xd3\xc7\x0e\xc0",))
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.inbound is None or self.inbound is False else 1)
                    | (0 if self.outbound is None or self.outbound is False else 2)
                    | (0 if self.ascending is None or self.ascending is False else 4)
                    | (0 if self.ton is None or self.ton is False else 16)
                    | (0 if self.subscription_id is None or self.subscription_id is False else 8),
                ),
                (
                    b""
                    if self.subscription_id is None or self.subscription_id is False
                    else (self.serialize_bytes(self.subscription_id))
                ),
                self.peer._bytes(),
                self.serialize_bytes(self.offset),
                struct.pack("<i", self.limit),
...
class GetSuggestedStarRefBotsRequest(TLRequest):
    ...
    def __init__(
        ...
        offset: str,
        limit: int,
        order_by_revenue: Optional[bool] = None,
        order_by_date: Optional[bool] = None,
    ):
        """
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.order_by_revenue is None or self.order_by_revenue is False else 1)
                    | (0 if self.order_by_date is None or self.order_by_date is False else 2),
                ),
                self.peer._bytes(),
                self.serialize_bytes(self.offset),
                struct.pack("<i", self.limit),
...
class GetUniqueStarGiftRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetUniqueStarGiftRequest", "slug": self.slug}
...
class GetUniqueStarGiftValueInfoRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetUniqueStarGiftValueInfoRequest", "slug": self.slug}
...
class ResolveStarGiftOfferRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ResolveStarGiftOfferRequest", "offer_msg_id": self.offer_msg_id, "decline": self.decline}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.requested_info_id is None or self.requested_info_id is False else 1)
                    | (0 if self.shipping_option_id is None or self.shipping_option_id is False else 2)
                    | (0 if self.tip_amount is None or self.tip_amount is False else 4),
                ),
...
class SendStarGiftOfferRequest(TLRequest):
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            peer=_peer, slug=_slug, price=_price, duration=_duration, random_id=_random_id, allow_paid_stars=_allow_paid_stars
        )
...
class UpdateStarGiftCollectionRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "delete_stargift": (
                []
                if self.delete_stargift is None
                else [x.to_dict() if isinstance(x, TLObject) else x for x in self.delete_stargift]
            ),
            "add_stargift": (
                [] if self.add_stargift is None else [x.to_dict() if isinstance(x, TLObject) else x for x in self.add_stargift]
            ),
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.delete_stargift is None or self.delete_stargift is False else 2)
                    | (0 if self.add_stargift is None or self.add_stargift is False else 4)
                    | (0 if self.order is None or self.order is False else 8),
                ),
                self.peer._bytes(),
                struct.pack("<i", self.collection_id),
                ...
                (
                    b""
                    if self.delete_stargift is None or self.delete_stargift is False
                    else b"".join(
                        (
                            b"\x15\xc4\xb5\x1c",
                            struct.pack("<i", len(self.delete_stargift)),
                            b"".join(x._bytes() for x in self.delete_stargift),
                        )
                    )
                ),
                (
                    b""
                    if self.add_stargift is None or self.add_stargift is False
                    else b"".join(
                        (
                            b"\x15\xc4\xb5\x1c",
                            struct.pack("<i", len(self.add_stargift)),
                            b"".join(x._bytes() for x in self.add_stargift),
                        )
                    )
                ),
                (
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            collection_id=_collection_id,
            title=_title,
            delete_stargift=_delete_stargift,
            add_stargift=_add_stargift,
            order=_order,
        )
