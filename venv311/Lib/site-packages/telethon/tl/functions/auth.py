...
class BindTempAuthKeyRequest(TLRequest):
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            perm_auth_key_id=_perm_auth_key_id, nonce=_nonce, expires_at=_expires_at, encrypted_message=_encrypted_message
        )
...
class CancelCodeRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "CancelCodeRequest", "phone_number": self.phone_number, "phone_code_hash": self.phone_code_hash}
...
class CheckRecoveryPasswordRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "CheckRecoveryPasswordRequest", "code": self.code}
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                b"".join(struct.pack("<q", x) for x in self.except_ids),
            )
        )
...
class FinishPasskeyLoginRequest(TLRequest):
    ...
    def __init__(
        ...
        from_dc_id: Optional[int] = None,
        from_auth_key_id: Optional[int] = None,
    ):
        """
        :returns auth.Authorization: Instance of either Authorization, AuthorizationSignUpRequired.
        """
    ...
    def _bytes(self):
        assert (
            (self.from_dc_id or self.from_dc_id is not None) and (self.from_auth_key_id or self.from_auth_key_id is not None)
        ) or (
            (self.from_dc_id is None or self.from_dc_id is False)
            and (self.from_auth_key_id is None or self.from_auth_key_id is False)
        ), "from_dc_id, from_auth_key_id parameters must all be False-y (like None) or all be True-y"
        return b"".join(
            (
                b"\x07\xadW\x98",
                struct.pack(
                    "<I",
                    (0 if self.from_dc_id is None or self.from_dc_id is False else 1)
                    | (0 if self.from_auth_key_id is None or self.from_auth_key_id is False else 1),
                ),
                self.credential._bytes(),
                b"" if self.from_dc_id is None or self.from_dc_id is False else (struct.pack("<i", self.from_dc_id)),
                (
                    b""
                    if self.from_auth_key_id is None or self.from_auth_key_id is False
                    else (struct.pack("<q", self.from_auth_key_id))
                ),
            )
        )
...
class InitPasskeyLoginRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "InitPasskeyLoginRequest", "api_id": self.api_id, "api_hash": self.api_hash}
...
class RequestFirebaseSmsRequest(TLRequest):
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.safety_net_token is None or self.safety_net_token is False else 1)
                    | (0 if self.play_integrity_token is None or self.play_integrity_token is False else 4)
                    | (0 if self.ios_push_secret is None or self.ios_push_secret is False else 2),
                ),
                self.serialize_bytes(self.phone_number),
                self.serialize_bytes(self.phone_code_hash),
                (
                    b""
                    if self.safety_net_token is None or self.safety_net_token is False
                    else (self.serialize_bytes(self.safety_net_token))
                ),
                (
                    b""
                    if self.play_integrity_token is None or self.play_integrity_token is False
                    else (self.serialize_bytes(self.play_integrity_token))
                ),
                (
                    b""
                    if self.ios_push_secret is None or self.ios_push_secret is False
                    else (self.serialize_bytes(self.ios_push_secret))
                ),
            )
        )
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            safety_net_token=_safety_net_token,
            play_integrity_token=_play_integrity_token,
            ios_push_secret=_ios_push_secret,
        )
...
class ResetLoginEmailRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ResetLoginEmailRequest", "phone_number": self.phone_number, "phone_code_hash": self.phone_code_hash}
...
class SignInRequest(TLRequest):
    ...
    def to_dict(self):
        return {
            ...
            "email_verification": (
                self.email_verification.to_dict() if isinstance(self.email_verification, TLObject) else self.email_verification
            ),
        }
    ...
    def _bytes(self):
        return b"".join(
            (
                ...
                struct.pack(
                    "<I",
                    (0 if self.phone_code is None or self.phone_code is False else 1)
                    | (0 if self.email_verification is None or self.email_verification is False else 2),
                ),
                self.serialize_bytes(self.phone_number),
                self.serialize_bytes(self.phone_code_hash),
                ...
                (
                    b""
                    if self.email_verification is None or self.email_verification is False
                    else (self.email_verification._bytes())
                ),
            )
        )
...
class SignUpRequest(TLRequest):
    ...
    def __init__(
        ...
        first_name: str,
        last_name: str,
        no_joined_notifications: Optional[bool] = None,
    ):
        """
        :returns auth.Authorization: Instance of either Authorization, AuthorizationSignUpRequired.
        """
    ...
    def from_reader(cls, reader):
        ...
        return cls(
            ...
            no_joined_notifications=_no_joined_notifications,
        )
