...
class FinishJobRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "FinishJobRequest", "job_id": self.job_id, "error": self.error}
...
class GetSmsJobRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetSmsJobRequest", "job_id": self.job_id}
...
class GetStatusRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetStatusRequest"}

    def _bytes(self):
        return b"".join((b"\xe8\x98\xa6\x10",))
...
class IsEligibleToJoinRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "IsEligibleToJoinRequest"}

    def _bytes(self):
        return b"".join((b"\xd09\xdc\x0e",))
...
class JoinRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "JoinRequest"}

    def _bytes(self):
        return b"".join((b"-\xceN\xa7",))
...
class UpdateSettingsRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "UpdateSettingsRequest", "allow_international": self.allow_international}
