...
class GetCdnFileRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetCdnFileRequest", "file_token": self.file_token, "offset": self.offset, "limit": self.limit}
...
class GetCdnFileHashesRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "GetCdnFileHashesRequest", "file_token": self.file_token, "offset": self.offset}
        ...
        return b"".join(
            (
                ...
                struct.pack(
                    ...
                    | (0 if self.cdn_supported is None or self.cdn_supported is False else 2),
                ),
...
class ReuploadCdnFileRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "ReuploadCdnFileRequest", "file_token": self.file_token, "request_token": self.request_token}
...
class SaveFilePartRequest(TLRequest):
    ...
    def to_dict(self):
        return {"_": "SaveFilePartRequest", "file_id": self.file_id, "file_part": self.file_part, "bytes": self.bytes}
