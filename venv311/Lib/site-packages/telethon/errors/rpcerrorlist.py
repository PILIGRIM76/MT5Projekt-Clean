...
class ActiveUserRequiredError(UnauthorizedError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The method is only available to already activated users" + self._fmt_request(self.request)
        )
...
class AdminRankInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The given admin title or rank was invalid (possibly larger than 16 characters)" + self._fmt_request(self.request)
        )
...
class ApiIdPublishedFloodError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "This API id was published somewhere, you can't use it now" + self._fmt_request(self.request)
        )
...
class AudioContentUrlEmptyError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The remote URL specified in the content field is empty" + self._fmt_request(self.request)
        )
...
class BotCommandDescriptionInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The command description was empty, too long or had invalid characters used" + self._fmt_request(self.request)
        )
...
class BotResponseTimeoutError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The bot did not answer to the callback query in time" + self._fmt_request(self.request)
        )
...
class BroadcastPublicVotersForbiddenError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You cannot broadcast polls where the voters are public" + self._fmt_request(self.request)
        )
...
class BroadcastRequiredError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The request can only be used with a broadcast channel" + self._fmt_request(self.request)
        )
...
class ButtonTypeInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The type of one of the buttons you provided is invalid" + self._fmt_request(self.request)
        )
...
class CallOccupyFailedError(ServerError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The call failed because the user is already making another call" + self._fmt_request(self.request)
        )
...
class CdnUploadTimeoutError(ServerError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "A server-side timeout occurred while reuploading the file to the CDN DC" + self._fmt_request(self.request)
        )
...
class ChatInvitePermanentError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You can't set an expiration date on permanent invite links" + self._fmt_request(self.request)
        )
...
class ChatLinkExistsError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The chat is linked to a channel and cannot be used in that request" + self._fmt_request(self.request)
        )
...
class ChatRestrictedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The chat is restricted and cannot be used in that request" + self._fmt_request(self.request)
        )
...
class ChatRevokeDateUnsupportedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "`min_date` and `max_date` are not available for using with non-user peers" + self._fmt_request(self.request)
        )
...
class ConnectionLayerInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The very first request must always be InvokeWithLayerRequest" + self._fmt_request(self.request)
        )
...
class ConnectionSystemLangCodeEmptyError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The system language string was empty during connection" + self._fmt_request(self.request)
        )
...
class DocumentInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The document file was invalid and can't be used in inline mode" + self._fmt_request(self.request)
        )
...
class EditBotInviteForbiddenError(ForbiddenError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Normal users can't edit invites that were created by bots" + self._fmt_request(self.request)
        )
...
class EmailHashExpiredError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The email hash expired and cannot be used to verify it" + self._fmt_request(self.request)
        )
...
class EmailUnconfirmedError(BadRequestError):
    def __init__(self, request, capture=0):
        ...
        super(Exception, self).__init__(
            "Email unconfirmed, the length of the code must be {code_length}".format(code_length=self.code_length)
            + self._fmt_request(self.request)
        )
...
class EmoticonInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The specified emoticon cannot be used or was not a emoticon" + self._fmt_request(self.request)
        )
...
class EmoticonStickerpackMissingError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The emoticon sticker pack you are trying to get is missing" + self._fmt_request(self.request)
        )
...
class FilerefUpgradeNeededError(AuthKeyError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The file reference needs to be refreshed before being used again" + self._fmt_request(self.request)
        )
...
class FileMigrateError(InvalidDCError):
    def __init__(self, request, capture=0):
        ...
        super(Exception, self).__init__(
            "The file to be accessed is currently stored in DC {new_dc}".format(new_dc=self.new_dc)
            + self._fmt_request(self.request)
        )
...
class FilePartSizeChangedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The file part size (chunk size) cannot change during upload" + self._fmt_request(self.request)
        )
...
class FilePartMissingError(BadRequestError):
    def __init__(self, request, capture=0):
        ...
        super(Exception, self).__init__(
            "Part {which} of the file is missing from storage".format(which=self.which) + self._fmt_request(self.request)
        )
...
class FileReferenceEmptyError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The file reference must exist to access the media and it cannot be empty" + self._fmt_request(self.request)
        )
...
class FileReferenceInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The file reference is invalid or you can't do that operation on such message" + self._fmt_request(self.request)
        )
...
class FilterNotSupportedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The specified filter cannot be used in this context" + self._fmt_request(self.request)
        )
...
class FloodTestPhoneWaitError(FloodError):
    def __init__(self, request, capture=0):
        ...
        self.seconds = int(capture)
        super(Exception, self).__init__(
            "A wait of {seconds} seconds is required in the test servers".format(seconds=self.seconds)
            + self._fmt_request(self.request)
        )
...
class FloodWaitError(FloodError):
    def __init__(self, request, capture=0):
        ...
        self.seconds = int(capture)
        super(Exception, self).__init__(
            "A wait of {seconds} seconds is required".format(seconds=self.seconds) + self._fmt_request(self.request)
        )
...
class FloodPremiumWaitError(FloodError):
    def __init__(self, request, capture=0):
        ...
        self.seconds = int(capture)
        super(Exception, self).__init__(
            "A wait of {seconds} seconds is required in non-premium accounts".format(seconds=self.seconds)
            + self._fmt_request(self.request)
        )
...
class FreshChangeAdminsForbiddenError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Recently logged-in users cannot add or change admins" + self._fmt_request(self.request)
        )
...
class FromPeerInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The given from_user peer cannot be used for the parameter" + self._fmt_request(self.request)
        )
...
class GraphExpiredReloadError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "This graph has expired, please obtain a new graph token" + self._fmt_request(self.request)
        )
...
class GraphOutdatedReloadError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Data can't be used for the channel statistics, graphs outdated" + self._fmt_request(self.request)
        )
...
class GroupcallSsrcDuplicateMuchError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The app needs to retry joining the group call with a new SSRC value" + self._fmt_request(self.request)
        )
...
class HideRequesterMissingError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The join request was missing or was already handled" + self._fmt_request(self.request)
        )
...
class InlineBotRequiredError(ForbiddenError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The action must be performed through an inline bot callback" + self._fmt_request(self.request)
        )
...
class InputFetchErrorError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "An error occurred while deserializing TL parameters" + self._fmt_request(self.request)
        )
...
class InputMethodInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The invoked method does not exist anymore or has never existed" + self._fmt_request(self.request)
        )
...
class InterdcCallErrorError(ServerError):
    def __init__(self, request, capture=0):
        ...
        self.dc = int(capture)
        super(Exception, self).__init__(
            "An error occurred while communicating with DC {dc}".format(dc=self.dc) + self._fmt_request(self.request)
        )
...
class InterdcCallRichErrorError(ServerError):
    def __init__(self, request, capture=0):
        ...
        self.dc = int(capture)
        super(Exception, self).__init__(
            "A rich error occurred while communicating with DC {dc}".format(dc=self.dc) + self._fmt_request(self.request)
        )
...
class InviteHashExpiredError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The chat the user tried to join has expired and is not valid anymore" + self._fmt_request(self.request)
        )
...
class InviteRequestSentError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You have successfully requested to join this chat or channel" + self._fmt_request(self.request)
        )
...
class InviteRevokedMissingError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The specified invite link was already revoked or is invalid" + self._fmt_request(self.request)
        )
...
class JoinAsPeerInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The specified peer cannot be used to join a group call" + self._fmt_request(self.request)
        )
...
class MediaGroupedInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You tried to send media of different types in an album" + self._fmt_request(self.request)
        )
...
class MegagroupPrehistoryHiddenError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You can't set this discussion group because it's history is hidden" + self._fmt_request(self.request)
        )
...
class MegagroupRequiredError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The request can only be used with a megagroup channel" + self._fmt_request(self.request)
        )
...
class MemberNoLocationError(ServerError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "An internal failure occurred while fetching user info (couldn't find location)" + self._fmt_request(self.request)
        )
...
class MsgidDecreaseRetryError(ServerError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The request should be retried with a lower message ID" + self._fmt_request(self.request)
        )
...
class MultiMediaTooLongError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Too many media files were included in the same album" + self._fmt_request(self.request)
        )
...
class NeedMemberInvalidError(ServerError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The provided member is invalid or does not exist (for example a thumb size)" + self._fmt_request(self.request)
        )
...
class NetworkMigrateError(InvalidDCError):
    def __init__(self, request, capture=0):
        ...
        self.new_dc = int(capture)
        super(Exception, self).__init__(
            "The source IP address is associated with DC {new_dc}".format(new_dc=self.new_dc) + self._fmt_request(self.request)
        )
...
class OptionInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The option specified is invalid and does not exist in the target poll" + self._fmt_request(self.request)
        )
...
class PasswordHashInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The password (and thus its hash value) you entered is invalid" + self._fmt_request(self.request)
        )
...
class PaymentProviderInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The payment provider was not recognised or its token was invalid" + self._fmt_request(self.request)
        )
...
class PhoneHashExpiredError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "An invalid or expired `phone_code_hash` was provided" + self._fmt_request(self.request)
        )
...
class PhoneNotOccupiedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "No user is associated to the specified phone number" + self._fmt_request(self.request)
        )
...
class PinRestrictedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You can't pin messages in private chats with other people" + self._fmt_request(self.request)
        )
...
class PollAnswersInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The poll did not have enough answers or had too many" + self._fmt_request(self.request)
        )
...
class PollOptionInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "A poll option used invalid data (the data may be too long)" + self._fmt_request(self.request)
        )
...
class PollUnsupportedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "This layer does not support polls in the issued method" + self._fmt_request(self.request)
        )
...
class PremiumAccountRequiredError(ForbiddenError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "A premium account is required to execute this action" + self._fmt_request(self.request)
        )
...
class PreviousChatImportActiveWaitMinError(AuthKeyError):
    def __init__(self, request, capture=0):
        ...
        super(Exception, self).__init__(
            "Similar to a flood wait, must wait {minutes} minutes".format(minutes=self.minutes)
            + self._fmt_request(self.request)
        )
...
class PublicChannelMissingError(ForbiddenError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You can only export group call invite links for public chats or channels" + self._fmt_request(self.request)
        )
...
class ReplyMarkupTooLongError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The data embedded in the reply markup buttons was too much" + self._fmt_request(self.request)
        )
...
class ResultIdDuplicateError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Duplicated IDs on the sent results. Make sure to use unique IDs" + self._fmt_request(self.request)
        )
...
class ResultIdInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The given result cannot be used to send the selection to the bot" + self._fmt_request(self.request)
        )
...
class RightsNotModifiedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The new admin rights are equal to the old rights, no change was made" + self._fmt_request(self.request)
        )
...
class RpcCallFailError(ServerError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Telegram is having internal issues, please try again later." + self._fmt_request(self.request)
        )
...
class SearchWithLinkNotSupportedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You cannot provide a search query and an invite link at the same time" + self._fmt_request(self.request)
        )
...
class SecondsInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Slow mode only supports certain values (e.g. 0, 10s, 30s, 1m, 5m, 15m and 1h)" + self._fmt_request(self.request)
        )
...
class SensitiveChangeForbiddenError(ForbiddenError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Your sensitive content settings cannot be changed at this time" + self._fmt_request(self.request)
        )
...
class SessionPasswordNeededError(UnauthorizedError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Two-steps verification is enabled and a password is required" + self._fmt_request(self.request)
        )
...
class SlowModeMultiMsgsDisabledError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Slowmode is enabled, you cannot forward multiple messages to this group" + self._fmt_request(self.request)
        )
...
class SlowModeWaitError(FloodError):
    def __init__(self, request, capture=0):
        ...
        self.seconds = int(capture)
        super(Exception, self).__init__(
            "A wait of {seconds} seconds is required before sending another message in this chat".format(seconds=self.seconds)
            + self._fmt_request(self.request)
        )
...
class StatsMigrateError(InvalidDCError):
    def __init__(self, request, capture=0):
        ...
        self.dc = int(capture)
        super(Exception, self).__init__(
            "The channel statistics must be fetched from DC {dc}".format(dc=self.dc) + self._fmt_request(self.request)
        )
...
class StickerpackStickersTooMuchError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "There are too many stickers in this stickerpack, you can't add any more" + self._fmt_request(self.request)
        )
...
class StickerMimeInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Make sure to pass a valid image file for the right InputFile parameter" + self._fmt_request(self.request)
        )
...
class StickerPngNopngError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Stickers must be a png file but the used image was not a png" + self._fmt_request(self.request)
        )
...
class StickerTgsNotgsError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Stickers must be a tgs file but the used file was not a tgs" + self._fmt_request(self.request)
        )
...
class StickerThumbPngNopngError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Stickerset thumb must be a png file but the used file was not png" + self._fmt_request(self.request)
        )
...
class StickerThumbTgsNotgsError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Stickerset thumb must be a tgs file but the used file was not tgs" + self._fmt_request(self.request)
        )
...
class TakeoutInitDelayError(FloodError):
    def __init__(self, request, capture=0):
        ...
        self.seconds = int(capture)
        super(Exception, self).__init__(
            "A wait of {seconds} seconds is required before being able to initiate the takeout".format(seconds=self.seconds)
            + self._fmt_request(self.request)
        )
...
class TakeoutInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The takeout session has been invalidated by another data export session" + self._fmt_request(self.request)
        )
...
class TempAuthKeyAlreadyBoundError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The passed temporary key is already bound to another **perm_auth_key_id**" + self._fmt_request(self.request)
        )
...
class ThemeMimeInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You cannot create this theme, the mime-type is invalid" + self._fmt_request(self.request)
        )
...
class TimeoutError(ServerError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "A timeout occurred while fetching data from the worker" + self._fmt_request(self.request)
        )
...
class UnknownMethodError(ServerError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The method you tried to call cannot be called on non-CDN DCs" + self._fmt_request(self.request)
        )
...
class UntilDateInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "That date cannot be specified in this request (try using None)" + self._fmt_request(self.request)
        )
...
class UsernameInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Nobody is using this username or the username is unacceptable" + self._fmt_request(self.request)
        )
...
class UsernameNotModifiedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The username is not different from the current username" + self._fmt_request(self.request)
        )
...
class UserpicUploadRequiredError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You must have a profile picture before using this method" + self._fmt_request(self.request)
        )
...
class UsersTooMuchError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The maximum number of users has been exceeded (to create a chat, for example)" + self._fmt_request(self.request)
        )
...
class UserAdminInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Either you're not an admin or you tried to ban an admin that you didn't promote" + self._fmt_request(self.request)
        )
...
class UserAlreadyParticipantError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The authenticated user is already a participant of the chat" + self._fmt_request(self.request)
        )
...
class UserBannedInChannelError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You're banned from sending messages in supergroups/channels" + self._fmt_request(self.request)
        )
...
class UserChannelsTooMuchError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "One of the users you tried to add is already in too many channels/supergroups" + self._fmt_request(self.request)
        )
...
class UserCreatorError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You can't leave this channel, because you're its creator" + self._fmt_request(self.request)
        )
...
class UserNotParticipantError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The target user is not a member of the specified megagroup or channel" + self._fmt_request(self.request)
        )
...
class UserPrivacyRestrictedError(ForbiddenError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The user's privacy settings do not allow you to do this" + self._fmt_request(self.request)
        )
...
class UserRestrictedError(ForbiddenError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You're spamreported, you can't create channels or chats." + self._fmt_request(self.request)
        )
...
class VoiceMessagesForbiddenError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "This user's privacy settings forbid you from sending voice messages" + self._fmt_request(self.request)
        )
...
class WebpushAuthInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The specified web push authentication secret is invalid" + self._fmt_request(self.request)
        )
...
class WebpushKeyInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "The specified web push elliptic curve Diffie-Hellman public key is invalid" + self._fmt_request(self.request)
        )
...
class WorkerBusyTooLongRetryError(ServerError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "Telegram workers are too busy to respond immediately" + self._fmt_request(self.request)
        )
...
class FrozenMethodInvalidError(FloodError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__(
            "You tried to use a method that is not available for frozen accounts" + self._fmt_request(self.request)
        )
