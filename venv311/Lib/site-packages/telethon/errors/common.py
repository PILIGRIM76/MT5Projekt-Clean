...
class InvalidChecksumError(Exception):
    ...
    def __init__(self, checksum, valid_checksum):
        super().__init__(
            "Invalid checksum ({} when {} was expected). " "This packet should be skipped.".format(checksum, valid_checksum)
        )
...
class AlreadyInConversationError(Exception):
    ...
    def __init__(self):
        super().__init__("Cannot open exclusive conversation in a " "chat that already has one open conversation")
...
class BadMessageError(Exception):
    ...
    def __init__(self, request, code):
        super().__init__(
            request, self.ErrorMessages.get(code, "Unknown error code (this should not happen): {}.".format(code))
        )
