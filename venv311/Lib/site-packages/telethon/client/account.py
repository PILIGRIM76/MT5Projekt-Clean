...
from ..tl import TLRequest, functions
...
class _TakeoutClient:
    ...
    async def __aenter__(self):
        ...
        if client.session.takeout_id is None:
            ...
            raise ValueError(
                "Can't send a takeout request while another " "takeout for the current session still not been finished yet."
            )
        return self
    ...
    async def __call__(self, request, ordered=False):
        ...
        if takeout_id is None:
            raise ValueError("Takeout mode has not been initialized " '(are you calling outside of "with"?)')
