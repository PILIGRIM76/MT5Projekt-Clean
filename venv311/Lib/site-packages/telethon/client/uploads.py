...
from .. import helpers, hints, utils
    ...
    async def send_file(
        ...
        *,
        ...
        formatting_entities: typing.Optional[
            typing.Union[typing.List[types.TypeMessageEntity], typing.List[typing.List[types.TypeMessageEntity]]]
        ] = None,
        ...
        **kwargs,
        ...
        if utils.is_list_like(file):
            sent_count = 0
            used_callback = None if not progress_callback else (lambda s, t: progress_callback(sent_count + s, len(file)))
        ...
        async with helpers._FileStream(file, file_size=file_size) as stream:
            ...
            for part_index in range(part_count):
                ...
                if not isinstance(part, bytes):
                    raise TypeError(
                        "file descriptor returned {}, not bytes (you must " "open the file in bytes mode)".format(type(part))
                    )
    ...
    async def _file_to_media(
        ...
        if isinstance(file, (types.InputFile, types.InputFileBig)):
            ...
            file_handle = await self.upload_file(
                _resize_photo_if_needed(file, as_image), file_size=file_size, progress_callback=progress_callback
            )
