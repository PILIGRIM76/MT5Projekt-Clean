    ...
    class Event(EventCommon, SenderGetter):
        ...
        async def answer(self, message=None, cache_time=0, *, url=None, alert=False):
            ...
            return await self._client(
                functions.messages.SetBotCallbackAnswerRequest(
                    query_id=self.query.query_id, cache_time=cache_time, alert=alert, message=message, url=url
                )
            )
        ...
        async def edit(self, *args, **kwargs):
            ...
            if isinstance(self.query.msg_id, (types.InputBotInlineMessageID, types.InputBotInlineMessageID64)):
                ...
                return await self._client.edit_message(await self.get_input_chat(), self.query.msg_id, *args, **kwargs)
        ...
        async def delete(self, *args, **kwargs):
            ...
            return await self._client.delete_messages(await self.get_input_chat(), [self.query.msg_id], *args, **kwargs)
