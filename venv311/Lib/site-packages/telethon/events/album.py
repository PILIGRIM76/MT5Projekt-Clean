...
class Album(EventBuilder):
    ...
    class Event(EventCommon, SenderGetter):
        ...
        def __init__(self, messages):
            message = messages[0]
            super().__init__(chat_peer=message.peer_id, msg_id=message.id, broadcast=bool(message.post))
        ...
        async def delete(self, *args, **kwargs):
            ...
            """
            if self._client:
                return await self._client.delete_messages(await self.get_input_chat(), self.messages, *args, **kwargs)
        ...
        async def mark_read(self):
            ...
            """
            if self._client:
                await self._client.send_read_acknowledge(await self.get_input_chat(), max_id=self.messages[-1].id)
