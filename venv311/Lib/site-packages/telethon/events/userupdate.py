...
class UserUpdate(EventBuilder):
    ...
    def build(cls, update, others=None, self_id=None):
        if isinstance(update, types.UpdateUserStatus):
            ...
            return cls.Event(update.from_id, chat_peer=types.PeerChannel(update.channel_id), typing=update.action)
        elif isinstance(update, types.UpdateChatUserTyping):
            return cls.Event(update.from_id, chat_peer=types.PeerChat(update.chat_id), typing=update.action)
    ...
    class Event(EventCommon, SenderGetter):
        ...
        def _set_client(self, client):
            ...
            self._sender, self._input_sender = utils._get_entity_pair(self.sender_id, self._entities, client._mb_entity_cache)
        ...
        def recording(self):
            ...
            return isinstance(
                self.action,
                (types.SendMessageRecordAudioAction, types.SendMessageRecordRoundAction, types.SendMessageRecordVideoAction),
            )
        ...
        def audio(self):
            ...
            """
            return isinstance(self.action, (types.SendMessageRecordAudioAction, types.SendMessageUploadAudioAction))
        ...
        def round(self):
            ...
            """
            return isinstance(self.action, (types.SendMessageRecordRoundAction, types.SendMessageUploadRoundAction))
        ...
        def video(self):
            ...
            """
            return isinstance(self.action, (types.SendMessageRecordVideoAction, types.SendMessageUploadVideoAction))
