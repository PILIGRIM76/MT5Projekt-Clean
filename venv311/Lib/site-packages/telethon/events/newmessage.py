...
from .common import EventBuilder, EventCommon, _into_id_set, name_inner_event
    ...
    def __init__(
        ...
        *,
        ...
        if incoming and outgoing:
            ...
            raise ValueError("Don't create an event handler if you " "don't want neither incoming nor outgoing!")
