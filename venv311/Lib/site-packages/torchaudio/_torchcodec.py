...
def save_with_torchcodec(
    ...
    if format is not None:
        ...
        warnings.warn(
            "The 'format' parameter is not used by TorchCodec AudioEncoder. " "Format is determined by the file extension.",
            UserWarning,
            stacklevel=2,
        )
    ...
    if encoding is not None:
        ...
        warnings.warn("The 'encoding' parameter is not fully supported by TorchCodec AudioEncoder.", UserWarning, stacklevel=2)
