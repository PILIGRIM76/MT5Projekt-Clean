...
def _feature_window_function(
    ...
    if window_type == HANNING:
        ...
        return (
            blackman_coeff - 0.5 * torch.cos(a * window_function) + (0.5 - blackman_coeff) * torch.cos(2 * a * window_function)
...
def vtln_warp_mel_freq(
    ...
    """
    return mel_scale(
        vtln_warp_freq(vtln_low_cutoff, vtln_high_cutoff, low_freq, high_freq, vtln_warp_factor, inverse_mel_scale(mel_freq))
    )
