    ...
    def from_flag_details(
        ...
        return cls(
            ...
            payload=(
                ...
                if isinstance(details.metadata.payload, str) and details.metadata.payload
...
def to_payloads(response: FlagsResponse) -> Optional[dict[str, str]]:
    ...
    return {
        ...
        if isinstance(value, FeatureFlag) and value.enabled and value.metadata.payload is not None
    }
