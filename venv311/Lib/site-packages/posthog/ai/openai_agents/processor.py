...
class PostHogTracingProcessor(TracingProcessor):
    ...
    def _with_privacy_mode(self, value: Any) -> Any:
        ...
        if self._privacy_mode or (hasattr(self._client, "privacy_mode") and self._client.privacy_mode):
            return None
        return value
        ...
        try:
            ...
            if error_info:
                ...
                if "ModelBehaviorError" in error_type_raw or "ModelBehaviorError" in error_message:
                    ...
                    "OutputGuardrailTripwireTriggered" in error_type_raw or "OutputGuardrailTripwireTriggered" in error_message
                ):
    ...
    def _handle_response_span(
        ...
        if response:
            ...
            if output_items:
                properties["$ai_output_choices"] = self._with_privacy_mode(_ensure_serializable(output_items))
