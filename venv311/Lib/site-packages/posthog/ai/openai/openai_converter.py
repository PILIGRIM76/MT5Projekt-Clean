            ...
            if hasattr(choice, "message") and hasattr(choice.message, "annotations"):
                ...
                if annotations:
                    for annotation in annotations:
                        ...
                        annotation_type = (
                            annotation.get("type") if isinstance(annotation, dict) else getattr(annotation, "type", None)
                        )
...
def extract_openai_usage_from_chunk(chunk: Any, provider_type: str = "chat") -> TokenUsage:
    """
    ...
    if provider_type == "chat":
        ...
        if hasattr(chunk.usage, "prompt_tokens_details") and hasattr(chunk.usage.prompt_tokens_details, "cached_tokens"):
            usage["cache_read_input_tokens"] = chunk.usage.prompt_tokens_details.cached_tokens
        ...
        if hasattr(chunk, "type") and chunk.type == "response.completed":
            if hasattr(chunk, "response") and hasattr(chunk.response, "usage") and chunk.response.usage:
                ...
                if hasattr(response_usage, "input_tokens_details") and hasattr(
                    ...
                    usage["cache_read_input_tokens"] = response_usage.input_tokens_details.cached_tokens

                # Handle reasoning tokens
                if hasattr(response_usage, "output_tokens_details") and hasattr(
                    response_usage.output_tokens_details, "reasoning_tokens"
                ):
                    usage["reasoning_tokens"] = response_usage.output_tokens_details.reasoning_tokens
...
def extract_openai_content_from_chunk(chunk: Any, provider_type: str = "chat") -> Optional[str]:
    """
...
def format_openai_streaming_input(kwargs: Dict[str, Any], api_type: str = "chat") -> Any:
    """
