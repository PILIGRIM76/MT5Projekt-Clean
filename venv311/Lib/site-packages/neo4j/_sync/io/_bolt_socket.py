...
class BoltSocket(BoltSocketBase):
    ...
    def _parse_handshake_response_v2(
        ...
        self._handshake_send(ctx, bytes((0, 0, chosen_version.minor, chosen_version.major)))
    ...
    def connect(
        ...
        *,
        ...
        resolved_addresses = NetworkUtil.resolve_address(Address(address), resolver=custom_resolver)
