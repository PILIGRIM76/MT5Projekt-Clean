    ...
    def _acquire(
        ...
        while True:
            ...
            if connection:
                ...
                try:
                    self._re_auth_connection(connection, auth, force_auth, unprepared)
                except ConfigurationError:
                    if auth:
...
class BoltPool(IOPool):
    ...
    def acquire(
        ...
        return self._acquire(self.address, auth, deadline, liveness_check_timeout, unprepared)
    ...
    def update_routing_table(
        ...
        *,
        ...
        with self.refresh_lock:
            ...
            if not prefer_initial_routing_address and self._update_routing_table_from(
                self.address,
                database=database,
                imp_user=imp_user,
                bookmarks=bookmarks,
    ...
    def acquire(
        ...
        while True:
            try:
                ...
                # connections.
                address = self._select_address(access_mode=access_mode, database=target_database)
