...
from ._api import NotificationCategory as _NotificationCategory
from ._api import NotificationDisabledCategory as _NotificationDisabledCategory
from ._api import (
...
from ._warnings import PreviewWarning as _PreviewWarning
...
from ._work import SummaryNotification as _SummaryNotification
from ._work import (
    unit_of_work,
)
...
from .api import Auth  # TODO: Validate naming for Auth compared to other drivers.
from .api import (
    DEFAULT_DATABASE,
    READ_ACCESS,
    SYSTEM_DATABASE,
...
def __getattr__(name) -> _t.Any:
    ...
    if name == "SummaryNotification":
        _deprecation_warn(
            "SummaryNotification and related APIs are deprecated. " "Use GqlStatusObjects and related APIs instead.",
            stack_level=2,
        )
        return _SummaryNotification
    if name == "NotificationCategory":
        _deprecation_warn(
            "NotificationCategory is deprecated. " "Use NotificationClassification instead.",
            stack_level=2,
        )
        return _NotificationCategory
    if name == "NotificationDisabledCategory":
        _deprecation_warn(
            "NotificationDisabledCategory is deprecated. " "Use NotificationDisabledClassification instead.",
            stack_level=2,
        )
