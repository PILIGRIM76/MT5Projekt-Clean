...
class AsyncGraphDatabase:
    ...
    if t.TYPE_CHECKING:
        ...
        def driver(
            ...
            *,
            ...
            resolver: (
                t.Callable[[Address], t.Iterable[Address]] | t.Callable[[Address], t.Awaitable[t.Iterable[Address]]]
            ) = ...,
            encrypted: bool = ...,
            trusted_certificates: TrustStore = ...,
            client_certificate: ClientCertificate | AsyncClientCertificateProvider | None = ...,
        ...
        def driver(
            ...
            **config,
            ...
            if isinstance(client_certificate, ClientCertificate):
                ...
                config["client_certificate"] = _AsyncStaticClientCertificateProvider(client_certificate)
    ...
    def _neo4j_driver(cls, target, routing_context=None, **config):
        ...
        try:
            return AsyncNeo4jDriver._open(target, routing_context=routing_context, **config)
        except (BoltHandshakeError, BoltSecurityError) as error:
            from ..exceptions import ServiceUnavailable
...
class AsyncDriver:
    ...
    async def execute_query(
        ...
        database_: str | None = None,
        impersonated_user_: str | None = None,
        bookmark_manager_: AsyncBookmarkManager | BookmarkManager | t.Literal[_DefaultEnum.default] | None = _default,
        auth_: _TAuth = None,
