...
class AsyncSession(AsyncWorkspace):
    ...
    async def _get_server_info(self):
        ...
        await self._connect(READ_ACCESS, liveness_check_timeout=0, unprepared=True)
    ...
    async def _run_transaction(
        ...
        access_mode: str,
        api: TelemetryAPI,
        transaction_function: t.Callable[t.Concatenate[AsyncManagedTransaction, _P], t.Awaitable[_R]],
