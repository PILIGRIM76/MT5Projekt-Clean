...
class Point(tuple[float, ...]):
    ...
    def __eq__(self, other: object) -> bool:
        try:
            return type(self) is type(other) and tuple(self) == tuple(_t.cast(Point, other))
...
def _point_type(name: str, fields: tuple[str, str, str], srid_map: dict[int, int]) -> type[Point]:
...
if _t.TYPE_CHECKING:
    ...
    CartesianPoint = _point_type("CartesianPoint", ("x", "y", "z"), {2: 7203, 3: 9157})
...
if _t.TYPE_CHECKING:
    ...
    WGS84Point = _point_type("WGS84Point", ("longitude", "latitude", "height"), {2: 4326, 3: 4979})
