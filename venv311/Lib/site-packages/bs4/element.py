...
class PageElement(object):
    ...
    def find_parents(
        ...
        **kwargs: _StrainableAttribute,
        ...
        # nothing but Tags.
        return cast(ResultSet[Tag], self._find_all(name, attrs, None, limit, iterator, _stacklevel=_stacklevel + 1, **kwargs))
    ...
    def __call__(
        ...
        **kwargs: _StrainableAttribute,
        ...
        if string is None:
            ...
            tags: ResultSet[Tag] = self.find_all(name, attrs, recursive, None, limit, _stacklevel, **kwargs)
            return tags

        # Otherwise, we're searching for strings.
        strings: ResultSet[NavigableString] = self.find_all(None, None, recursive, string, limit, _stacklevel, **kwargs)
        return strings
    ...
    def find_all(
        ...
        **kwargs: _StrainableAttribute,
        ...
        if string is not None and (name is not None or attrs is not None or kwargs):
            ...
            # feature.
            return cast(
                ResultSet[Tag], self._find_all(name, attrs, string, limit, generator, _stacklevel=_stacklevel, **kwargs)
            )

        if string is None:
            # If string is None, we're searching for tags.
            return cast(ResultSet[Tag], self._find_all(name, attrs, None, limit, generator, _stacklevel=_stacklevel, **kwargs))

        # Otherwise, we're searching for strings.
        return cast(
            ResultSet[NavigableString], self._find_all(None, None, string, limit, generator, _stacklevel=_stacklevel, **kwargs)
        )
