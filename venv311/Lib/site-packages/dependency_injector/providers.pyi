...
class Callable(Provider[T_Any]):
    ...
    def set_provides(self, provides: Optional[Union[_Callable[..., T_Any], str]]) -> _Self: ...
    @property
...
class Factory(Provider[T]):
    ...
    def set_provides(self, provides: Optional[Union[_Callable[..., T], str]]) -> _Self: ...
    @property
    def args(self) -> Tuple[Injection]: ...
    def add_args(self, *args: Injection) -> _Self: ...
    def set_args(self, *args: Injection) -> _Self: ...
...
class Dict(Provider[_Dict]):
    def __init__(self, dict_: Optional[Mapping[Any, Injection]] = None, **kwargs: Injection): ...
    @property
    def kwargs(self) -> _Dict[Any, Injection]: ...
    def add_kwargs(self, dict_: Optional[Mapping[Any, Injection]] = None, **kwargs: Injection) -> _Self: ...
    def set_kwargs(self, dict_: Optional[Mapping[Any, Injection]] = None, **kwargs: Injection) -> _Self: ...
    def clear_kwargs(self) -> _Self: ...
