...
MARKDOWN_ESCAPES = str.maketrans({char: f"\\{char}" for char in string.punctuation if char not in ".,/-"})
...
class SummaryReporter:
    ...
    def report_markdown(
        ...
        for values in lines_values:
            ...
            self.write_items(
                (
                    formats[item].format(escape_markdown(str(value)), name_len=max_name, n=max_n - 1)
