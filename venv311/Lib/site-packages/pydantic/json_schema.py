    ...
    def decimal_schema(self, schema: core_schema.DecimalSchema) -> JsonSchemaValue:
        ...
        def get_decimal_pattern(schema: core_schema.DecimalSchema) -> str:
            ...
            # Case 2: Only max_digits is set
                ...
                pattern += rf"(?:" rf"\d{{0,{max_digits}}}" rf"|" rf"(?=[\d.]{{1,{max_digits + 1}}}0*$)" rf"\d*\.\d*0*$" rf")"
...
def model_json_schema(
    ...
    schema_generator_instance = schema_generator(by_alias=by_alias, ref_template=ref_template, union_format=union_format)
