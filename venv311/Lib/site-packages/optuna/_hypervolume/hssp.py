...
def _solve_hssp_on_unique_loss_vals(
    ...
    for k in range(subset_size):
        ...
        contribs = _lazy_contribs_update(contribs, rank_i_loss_vals, selected_vecs[: k + 2], reference_point, hv)
...
def _solve_hssp(
    ...
    rank_i_unique_loss_vals, indices_of_unique_loss_vals = np.unique(rank_i_loss_vals, return_index=True, axis=0)
