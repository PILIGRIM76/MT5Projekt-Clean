...
def _get_upper_bound_set(sorted_pareto_sols: np.ndarray, ref_point: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
    """
...
def _get_box_bounds(upper_bound_set: np.ndarray, def_points: np.ndarray, ref_point: np.ndarray) -> np.ndarray:
    # Eq. (2) of Lacour17.
...
def _get_non_dominated_box_bounds(
    ...
    box_upper_bounds, box_lower_bounds = -_get_box_bounds(neg_lower_bound_set, neg_def_points, point_at_infinity)
...
def get_non_dominated_box_bounds(
    ...
    sorted_pareto_sols = unique_lexsorted_loss_vals[_is_pareto_front(unique_lexsorted_loss_vals, assume_unique_lexsorted=True)]
