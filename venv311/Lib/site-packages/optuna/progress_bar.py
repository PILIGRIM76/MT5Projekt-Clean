    ...
    def update(self, elapsed_seconds: float, study: Study) -> None:
        ...
        if self._is_valid:
            if not study._is_multi_objective():
                ...
                try:
                    msg = f"Best trial: {study.best_trial.number}. " f"Best value: {study.best_value:.6g}"
            ...
            if self._n_trials is not None:
                ...
                if self._timeout is not None:
                    self._progress_bar.set_postfix_str(f"{elapsed_seconds:.02f}/{self._timeout} seconds")
