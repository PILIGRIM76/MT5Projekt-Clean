    ...
    def get_trial_id_from_study_id_trial_number(self, study_id: int, trial_number: int) -> int:
        with self._lock:
            ...
            if len(trials) <= trial_number:
                raise KeyError(f"No trial with trial number {trial_number} exists " f"in study with study_id {study_id}.")
    ...
    def get_all_trials(
        ...
        with self._lock:
            ...
            if states == (TrialState.WAITING,):
                ...
                for trial in self._studies[study_id].trials[self._prev_waiting_trial_number[study_id] :]:
