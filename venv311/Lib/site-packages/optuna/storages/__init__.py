...
from optuna.storages._grpc import GrpcStorageProxy, run_grpc_proxy_server
...
from optuna.storages.journal._file import DeprecatedJournalFileSymlinkLock as JournalFileSymlinkLock
...
def get_storage(storage: None | str | BaseStorage) -> BaseStorage:
    ...
    if isinstance(storage, str):
        if storage.startswith("redis"):
            raise ValueError("RedisStorage is removed at Optuna v3.1.0. Please use JournalRedisBackend instead.")
