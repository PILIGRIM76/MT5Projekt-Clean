...
from sqlalchemy import Column, Enum, Float, ForeignKey, Integer, UniqueConstraint, orm
...
def upgrade():
    ...
    try:
        ...
        objects = [
            TrialIntermediateValueModel(trial_id=r.trial_id, intermediate_value=r.value, step=r.step)
