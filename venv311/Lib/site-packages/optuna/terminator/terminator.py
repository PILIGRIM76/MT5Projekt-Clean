...
from optuna.terminator.erroreval import BaseErrorEvaluator, CrossValidationErrorEvaluator, StaticErrorEvaluator
...
class Terminator(BaseTerminator):
    ...
    def should_terminate(self, study: Study) -> bool:
        ...
        error = self._error_evaluator.evaluate(trials=study.trials, study_direction=study.direction)
