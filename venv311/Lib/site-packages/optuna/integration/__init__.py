...
if TYPE_CHECKING:
    from optuna.integration.allennlp import AllenNLPExecutor, AllenNLPPruningCallback
    ...
    from optuna.integration.fastaiv2 import FastAIPruningCallback, FastAIV2PruningCallback
    from optuna.integration.keras import KerasPruningCallback
    from optuna.integration.lightgbm import LightGBMPruningCallback, LightGBMTuner, LightGBMTunerCV
