...
import numpy as np
from optuna.samplers.nsgaii._constraints_evaluation import _evaluate_penalty, _validate_constraints
...
def _rank_population(
    ...
    *,
    ...
    objective_values *= np.array([-1.0 if d == StudyDirection.MAXIMIZE else 1.0 for d in directions])
