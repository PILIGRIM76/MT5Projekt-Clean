...
class NSGAIISampler(BaseGASampler):
    ...
    def __init__(
        ...
        *,
        ...
        elite_population_selection_strategy: Callable[[Study, list[FrozenTrial]], list[FrozenTrial]] | None = None,
        child_generation_strategy: (
            Callable[[Study, dict[str, BaseDistribution], list[FrozenTrial]], dict[str, Any]] | None
        ) = None,
        after_trial_strategy: Callable[[Study, FrozenTrial, TrialState, Sequence[float] | None], None] | None = None,
    ) -> None:
        ...
        self._elite_population_selection_strategy = (
            elite_population_selection_strategy
            or NSGAIIElitePopulationSelectionStrategy(population_size=population_size, constraints_func=constraints_func)
        )
        self._child_generation_strategy = child_generation_strategy or NSGAIIChildGenerationStrategy(
    ...
    def select_parent(self, study: Study, generation: int) -> list[FrozenTrial]:
        return self._elite_population_selection_strategy(
            study,
            self.get_population(study, generation - 1) + self.get_parent_population(study, generation - 1),
        )
