...
class BaseGASampler(BaseSampler, abc.ABC):
    ...
    def get_trial_generation(self, study: optuna.Study, trial: FrozenTrial) -> int:
        ...
        study._storage.set_trial_system_attr(trial._trial_id, self._get_generation_key(), generation)
        return generation
    ...
    def get_population(self, study: optuna.Study, generation: int) -> list[FrozenTrial]:
        ...
        return [
            trial
            for trial in study._get_trials(deepcopy=False, states=[TrialState.COMPLETE], use_cache=True)
    ...
    def get_parent_population(self, study: optuna.Study, generation: int) -> list[FrozenTrial]:
        ...
        cached_parent_population_ids = study_system_attrs.get(self._get_parent_cache_key_prefix() + str(generation), None)
