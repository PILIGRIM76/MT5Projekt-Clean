...
from optuna.visualization._parallel_coordinate import _get_parallel_coordinate_info, _ParallelCoordinateInfo
from optuna.visualization.matplotlib._matplotlib_imports import _imports

if _imports.is_successful():
    from optuna.visualization.matplotlib._matplotlib_imports import Axes, LineCollection, plt
