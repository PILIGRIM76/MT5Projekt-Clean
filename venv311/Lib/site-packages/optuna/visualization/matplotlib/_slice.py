...
from optuna.visualization._slice import _get_slice_plot_info, _PlotValues, _SlicePlotInfo, _SliceSubplotInfo
...
if _imports.is_successful():
    from optuna.visualization.matplotlib._matplotlib_imports import Axes, Colormap, PathCollection, matplotlib, plt
