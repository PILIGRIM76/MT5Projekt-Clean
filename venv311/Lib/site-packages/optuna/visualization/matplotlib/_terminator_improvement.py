...
from optuna.visualization._terminator_improvement import _get_improvement_info, _get_y_range
from optuna.visualization.matplotlib._matplotlib_imports import _imports

if TYPE_CHECKING:
    from optuna.study.study import Study
    from optuna.terminator import BaseErrorEvaluator, BaseImprovementEvaluator
    from optuna.visualization._terminator_improvement import _ImprovementInfo


if _imports.is_successful():
    from optuna.visualization.matplotlib._matplotlib_imports import Axes, plt
