...
from optuna.terminator import BaseErrorEvaluator, BaseImprovementEvaluator, CrossValidationErrorEvaluator, RegretBoundEvaluator
from optuna.terminator.erroreval import StaticErrorEvaluator
from optuna.terminator.improvement.evaluator import DEFAULT_MIN_N_TRIALS, BestValueStagnationEvaluator
...
def _get_improvement_info(
    ...
    for trial in tqdm.tqdm(study.trials):
        ...
        improvement = improvement_evaluator.evaluate(trials=completed_trials, study_direction=study.direction)
        improvements.append(improvement)

        if get_error:
            error = error_evaluator.evaluate(trials=completed_trials, study_direction=study.direction)
            errors.append(error)
