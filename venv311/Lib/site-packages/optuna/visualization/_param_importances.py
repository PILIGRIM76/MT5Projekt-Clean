...
from optuna.visualization._utils import _check_plot_args, _filter_nonfinite
...
def _get_importances_info(
    ...
    importances = optuna.importance.get_param_importances(study, evaluator=evaluator, params=params, target=target)
...
def _get_hover_template(importances_info: _ImportancesInfo, study: Study) -> list[str]:
    return [
        ...
        for param_name, importance in zip(importances_info.param_names, importances_info.importance_values)
    ]
