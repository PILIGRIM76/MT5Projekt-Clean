...
from optuna.distributions import CategoricalChoiceType, CategoricalDistribution
from optuna.logging import get_logger
from optuna.samplers._base import _CONSTRAINTS_KEY
from optuna.study import Study
from optuna.trial import FrozenTrial, TrialState
from optuna.visualization._plotly_imports import _imports
from optuna.visualization._utils import _check_plot_args, _filter_nonfinite, _is_log_scale

if _imports.is_successful():
    from optuna.visualization._plotly_imports import Scatter, go, make_subplots
...
def _get_slice_plot(info: _SlicePlotInfo) -> "go.Figure":
    ...
    if len(info.subplots) == 0:
        ...
        if not info.subplots[0].is_numerical:
            figure.update_xaxes(type="category", categoryorder="array", categoryarray=info.subplots[0].x_labels)
