...
# global helpers
#
def counted_array(expr: ParserElement, int_expr: typing.Optional[ParserElement] = None, **kwargs) -> ParserElement:
...
def original_text_for(expr: ParserElement, as_string: bool = True, **kwargs) -> ParserElement:
...
def locatedExpr(expr: ParserElement) -> ParserElement:
    ...
    return Group(locator("locn_start") + expr("value") + locator.copy().leave_whitespace()("locn_end"))
...
def nested_expr(
    ...
    **kwargs,
    ...
    ret = Forward()
    if ignoreExpr is not None:
        ret <<= Group(_suppression(opener) + ZeroOrMore(ignoreExpr | ret | content) + _suppression(closer))
    else:
