...
class ParseBaseException(Exception):
    ...
    def __str__(self) -> str:
        ...
        try:
            ...
            return f"{type(self).__name__}: {self.msg}" f" ({type(ex).__name__}: {ex} while formatting message)"

    def __repr__(self):
        return str(self)

    def mark_input_line(self, marker_string: typing.Optional[str] = None, **kwargs) -> str:
        """
