...
class QAbstractOAuth(PySide6.QtCore.QObject):
    ...
    def deleteResource(
        self, url: PySide6.QtCore.QUrl | str, /, parameters: typing.Dict[str, typing.Any] = ...
    ...
    def prepareRequest(
        ...
        /,
        body: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...,
    ) -> None: ...
    def put(
        self, url: PySide6.QtCore.QUrl | str, /, parameters: typing.Dict[str, typing.Any] = ...
    ) -> PySide6.QtNetwork.QNetworkReply: ...
...
class QAbstractOAuth2(PySide6.QtNetworkAuth.QAbstractOAuth):
    ...
    def __init__(
        ...
        *,
        scope: str | None = ...,
        grantedScopeTokens: typing.Optional[typing.Set[PySide6.QtCore.QByteArray]] = ...,
        requestedScopeTokens: typing.Optional[typing.Set[PySide6.QtCore.QByteArray]] = ...,
        userAgent: str | None = ...,
        clientIdentifierSharedKey: str | None = ...,
        state: str | None = ...,
        expiration: PySide6.QtCore.QDateTime | None = ...,
        refreshToken: str | None = ...,
        refreshLeadTime: int | None = ...,
        autoRefresh: bool | None = ...,
        nonceMode: PySide6.QtNetworkAuth.QAbstractOAuth2.NonceMode | None = ...,
        nonce: str | None = ...,
        idToken: str | None = ...,
        tokenUrl: PySide6.QtCore.QUrl | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    @typing.overload
    def post(
        self, url: PySide6.QtCore.QUrl | str, multiPart: PySide6.QtNetwork.QHttpMultiPart, /
    ) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def post(
        self, url: PySide6.QtCore.QUrl | str, /, parameters: typing.Dict[str, typing.Any] = ...
    ...
    @typing.overload
    def post(
        self, url: PySide6.QtCore.QUrl | str, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> PySide6.QtNetwork.QNetworkReply: ...
    def prepareRequest(
        self,
        request: PySide6.QtNetwork.QNetworkRequest,
...
class QOAuth1(PySide6.QtNetworkAuth.QAbstractOAuth):
    ...
    def setup(
        self,
        request: PySide6.QtNetwork.QNetworkRequest,
        signingParameters: typing.Dict[str, typing.Any],
        operation: PySide6.QtNetwork.QNetworkAccessManager.Operation,
        /,
    ) -> None: ...
    @typing.overload
    def setup(
        ...
        request: PySide6.QtNetwork.QNetworkRequest,
        signingParameters: typing.Dict[str, typing.Any],
        operationVerb: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
    ) -> None: ...
...
class QOAuth2AuthorizationCodeFlow(PySide6.QtNetworkAuth.QAbstractOAuth2):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        accessTokenUrl: PySide6.QtCore.QUrl | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    @typing.overload
    def __init__(
        self, /, parent: PySide6.QtCore.QObject | None = ..., *, accessTokenUrl: PySide6.QtCore.QUrl | None = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def setPkceMethod(
        self, method: PySide6.QtNetworkAuth.QOAuth2AuthorizationCodeFlow.PkceMethod, /, length: int = ...
    ) -> None: ...
...
class QOAuth2DeviceAuthorizationFlow(PySide6.QtNetworkAuth.QAbstractOAuth2):
    ...
    def __init__(
        ...
        *,
        userCode: str | None = ...,
        verificationUrl: PySide6.QtCore.QUrl | None = ...,
        completeVerificationUrl: PySide6.QtCore.QUrl | None = ...,
        polling: bool | None = ...,
        userCodeExpirationAt: PySide6.QtCore.QDateTime | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
