...
class QAreaSeries(PySide6.QtCharts.QAbstractSeries):
    ...
    def __init__(
        ...
        *,
        ...
        pointLabelsFormat: str | None = ...,
        pointLabelsVisible: bool | None = ...,
        pointLabelsFont: PySide6.QtGui.QFont | None = ...,
        pointLabelsColor: PySide6.QtGui.QColor | None = ...,
        pointLabelsClipping: bool | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        upperSeries: PySide6.QtCharts.QLineSeries | None = ...,
        lowerSeries: PySide6.QtCharts.QLineSeries | None = ...,
        color: PySide6.QtGui.QColor | None = ...,
        borderColor: PySide6.QtGui.QColor | None = ...,
        pointLabelsFormat: str | None = ...,
...
class QBarSet(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        labelBrush: PySide6.QtGui.QBrush | None = ...,
...
class QCandlestickModelMapper(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        series: PySide6.QtCharts.QCandlestickSeries | None = ...,
    ) -> None: ...
    def close(self, /) -> int: ...
...
class QCandlestickSeries(PySide6.QtCharts.QAbstractSeries):
    ...
    def __init__(
        ...
        *,
        count: int | None = ...,
        maximumColumnWidth: float | None = ...,
        minimumColumnWidth: float | None = ...,
        bodyWidth: float | None = ...,
        bodyOutlineVisible: bool | None = ...,
        capsWidth: float | None = ...,
        capsVisible: bool | None = ...,
        increasingColor: PySide6.QtGui.QColor | None = ...,
        decreasingColor: PySide6.QtGui.QColor | None = ...,
        brush: PySide6.QtGui.QBrush | None = ...,
        pen: PySide6.QtGui.QPen | None = ...,
    ) -> None: ...
    @typing.overload
...
class QCategoryAxis(PySide6.QtCharts.QValueAxis):
    ...
    def __init__(
        ...
        *,
        ...
        count: int | None = ...,
        categoriesLabels: collections.abc.Sequence[str] | None = ...,
        labelsPosition: PySide6.QtCharts.QCategoryAxis.AxisLabelsPosition | None = ...,
    ) -> None: ...
...
class QChart(PySide6.QtWidgets.QGraphicsWidget):
    ...
    def __init__(
        ...
        /,
        *,
        theme: PySide6.QtCharts.QChart.ChartTheme | None = ...,
        title: str | None = ...,
        backgroundVisible: bool | None = ...,
        dropShadowEnabled: bool | None = ...,
        backgroundRoundness: float | None = ...,
        animationOptions: PySide6.QtCharts.QChart.AnimationOption | None = ...,
        animationDuration: int | None = ...,
        animationEasingCurve: PySide6.QtCore.QEasingCurve | None = ...,
        margins: PySide6.QtCore.QMargins | None = ...,
        chartType: PySide6.QtCharts.QChart.ChartType | None = ...,
        plotAreaBackgroundVisible: bool | None = ...,
        localizeNumbers: bool | None = ...,
        locale: PySide6.QtCore.QLocale | None = ...,
        plotArea: PySide6.QtCore.QRectF | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def axes(
        self, /, orientation: PySide6.QtCore.Qt.Orientation = ..., series: PySide6.QtCharts.QAbstractSeries | None = ...
    ) -> typing.List[PySide6.QtCharts.QAbstractAxis]: ...
    ...
    def mapToPosition(
        self,
        value: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        /,
    ...
    def setAxisX(
        self, axis: PySide6.QtCharts.QAbstractAxis, /, series: PySide6.QtCharts.QAbstractSeries | None = ...
    ) -> None: ...
    def setAxisY(
        self, axis: PySide6.QtCharts.QAbstractAxis, /, series: PySide6.QtCharts.QAbstractSeries | None = ...
    ) -> None: ...
    ...
    def setPlotAreaBackgroundPen(
        self, pen: PySide6.QtGui.QPen | PySide6.QtCore.Qt.PenStyle | PySide6.QtGui.QColor, /
    ) -> None: ...
...
class QHBarModelMapper(PySide6.QtCharts.QBarModelMapper):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        series: PySide6.QtCharts.QAbstractBarSeries | None = ...,
        model: PySide6.QtCore.QAbstractItemModel | None = ...,
        firstBarSetRow: int | None = ...,
        lastBarSetRow: int | None = ...,
        firstColumn: int | None = ...,
...
class QHBoxPlotModelMapper(PySide6.QtCharts.QBoxPlotModelMapper):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        series: PySide6.QtCharts.QBoxPlotSeries | None = ...,
        model: PySide6.QtCore.QAbstractItemModel | None = ...,
        firstBoxSetRow: int | None = ...,
        lastBoxSetRow: int | None = ...,
        firstColumn: int | None = ...,
        columnCount: int | None = ...,
    ) -> None: ...
    def columnCount(self, /) -> int: ...
...
class QHCandlestickModelMapper(PySide6.QtCharts.QCandlestickModelMapper):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        timestampColumn: int | None = ...,
        openColumn: int | None = ...,
        highColumn: int | None = ...,
        lowColumn: int | None = ...,
        closeColumn: int | None = ...,
        firstSetRow: int | None = ...,
        lastSetRow: int | None = ...,
    ) -> None: ...
...
class QHPieModelMapper(PySide6.QtCharts.QPieModelMapper):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        series: PySide6.QtCharts.QPieSeries | None = ...,
        model: PySide6.QtCore.QAbstractItemModel | None = ...,
        valuesRow: int | None = ...,
        labelsRow: int | None = ...,
        firstColumn: int | None = ...,
...
class QHXYModelMapper(PySide6.QtCharts.QXYModelMapper):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        series: PySide6.QtCharts.QXYSeries | None = ...,
        model: PySide6.QtCore.QAbstractItemModel | None = ...,
        xRow: int | None = ...,
        yRow: int | None = ...,
        firstColumn: int | None = ...,
...
class QLegend(PySide6.QtWidgets.QGraphicsWidget):
    ...
    ) -> typing.List[PySide6.QtCharts.QLegendMarker]: ...
    def paint(
        self,
...
class QPieSlice(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        labelPosition: PySide6.QtCharts.QPieSlice.LabelPosition | None = ...,
        exploded: bool | None = ...,
        pen: PySide6.QtGui.QPen | None = ...,
        borderColor: PySide6.QtGui.QColor | None = ...,
...
class QPolarChart(PySide6.QtCharts.QChart):
    ...
    def addAxis(
        self, axis: PySide6.QtCharts.QAbstractAxis, polarOrientation: PySide6.QtCharts.QPolarChart.PolarOrientation, /
    ) -> None: ...
    @staticmethod
...
class QScatterSeries(PySide6.QtCharts.QXYSeries):
    ...
    def __init__(
        ...
        *,
        color: PySide6.QtGui.QColor | None = ...,
        borderColor: PySide6.QtGui.QColor | None = ...,
        markerShape: PySide6.QtCharts.QScatterSeries.MarkerShape | None = ...,
...
class QVBarModelMapper(PySide6.QtCharts.QBarModelMapper):
    ...
    def __init__(
        ...
        *,
        series: PySide6.QtCharts.QAbstractBarSeries | None = ...,
        model: PySide6.QtCore.QAbstractItemModel | None = ...,
        firstBarSetColumn: int | None = ...,
        lastBarSetColumn: int | None = ...,
        firstRow: int | None = ...,
        rowCount: int | None = ...,
    ) -> None: ...
...
class QVBoxPlotModelMapper(PySide6.QtCharts.QBoxPlotModelMapper):
    ...
    def __init__(
        ...
        *,
        series: PySide6.QtCharts.QBoxPlotSeries | None = ...,
        model: PySide6.QtCore.QAbstractItemModel | None = ...,
        firstBoxSetColumn: int | None = ...,
        lastBoxSetColumn: int | None = ...,
        firstRow: int | None = ...,
        rowCount: int | None = ...,
    ) -> None: ...
...
class QVCandlestickModelMapper(PySide6.QtCharts.QCandlestickModelMapper):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        timestampRow: int | None = ...,
        openRow: int | None = ...,
        highRow: int | None = ...,
        lowRow: int | None = ...,
        closeRow: int | None = ...,
        firstSetColumn: int | None = ...,
        lastSetColumn: int | None = ...,
    ) -> None: ...
...
class QVPieModelMapper(PySide6.QtCharts.QPieModelMapper):
    ...
    def __init__(
        ...
        *,
        series: PySide6.QtCharts.QPieSeries | None = ...,
        model: PySide6.QtCore.QAbstractItemModel | None = ...,
        valuesColumn: int | None = ...,
        labelsColumn: int | None = ...,
        firstRow: int | None = ...,
        rowCount: int | None = ...,
    ) -> None: ...
    def firstRow(self, /) -> int: ...
...
class QValueAxis(PySide6.QtCharts.QAbstractAxis):
    ...
    def __init__(
        ...
        *,
        ...
        tickType: PySide6.QtCharts.QValueAxis.TickType | None = ...,
    ) -> None: ...
...
class QXYSeries(PySide6.QtCharts.QAbstractSeries):
    ...
    def color(self, /) -> PySide6.QtGui.QColor: ...
    def colorBy(
        self, sourceData: collections.abc.Sequence[float], /, gradient: PySide6.QtGui.QLinearGradient = ...
    ) -> None: ...
    def count(self, /) -> int: ...
    ...
    def pointsConfiguration(
        self, /
    ) -> typing.Dict[int, typing.Dict[PySide6.QtCharts.QXYSeries.PointConfiguration, typing.Any]]: ...
    ...
    def setPointConfiguration(
        self, index: int, key: PySide6.QtCharts.QXYSeries.PointConfiguration, value: typing.Any, /
    ) -> None: ...
    @typing.overload
    def setPointConfiguration(
        self, index: int, configuration: typing.Dict[PySide6.QtCharts.QXYSeries.PointConfiguration, typing.Any], /
    ) -> None: ...
    def setPointLabelsClipping(self, /, enabled: bool = ...) -> None: ...
    def setPointLabelsColor(
        self,
    ...
    def setPointsConfiguration(
        self, pointsConfiguration: typing.Dict[int, typing.Dict[PySide6.QtCharts.QXYSeries.PointConfiguration, typing.Any]], /
    ) -> None: ...
    def setPointsVisible(self, /, visible: bool = ...) -> None: ...
    def setSelectedColor(
        self,
