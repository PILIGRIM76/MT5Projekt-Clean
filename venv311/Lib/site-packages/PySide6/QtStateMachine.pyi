...
class QAbstractTransition(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        targetState: PySide6.QtStateMachine.QAbstractState | None = ...,
        targetStates: collections.abc.Sequence[PySide6.QtStateMachine.QAbstractState] | None = ...,
        transitionType: PySide6.QtStateMachine.QAbstractTransition.TransitionType | None = ...,
    ) -> None: ...
...
class QEventTransition(PySide6.QtStateMachine.QAbstractTransition):
    ...
    def __init__(
        ...
        sourceState: PySide6.QtStateMachine.QState | None = ...,
        *,
        eventSource: PySide6.QtCore.QObject | None = ...,
        eventType: PySide6.QtCore.QEvent.Type | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QHistoryState(PySide6.QtStateMachine.QAbstractState):
    ...
    def __init__(
        ...
        *,
        defaultState: PySide6.QtStateMachine.QAbstractState | None = ...,
        defaultTransition: PySide6.QtStateMachine.QAbstractTransition | None = ...,
        historyType: PySide6.QtStateMachine.QHistoryState.HistoryType | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QKeyEventTransition(PySide6.QtStateMachine.QEventTransition):
    ...
    def __init__(
        ...
        sourceState: PySide6.QtStateMachine.QState | None = ...,
        *,
        modifierMask: PySide6.QtCore.Qt.KeyboardModifier | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QMouseEventTransition(PySide6.QtStateMachine.QEventTransition):
    ...
    def __init__(
        ...
        sourceState: PySide6.QtStateMachine.QState | None = ...,
        *,
        button: PySide6.QtCore.Qt.MouseButton | None = ...,
        modifierMask: PySide6.QtCore.Qt.KeyboardModifier | None = ...,
    ) -> None: ...
...
class QSignalTransition(PySide6.QtStateMachine.QAbstractTransition):
    ...
    def __init__(
        ...
        signal: bytes | bytearray | memoryview,
        /,
        sourceState: PySide6.QtStateMachine.QState | None = ...,
        *,
        senderObject: PySide6.QtCore.QObject | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        *,
        senderObject: PySide6.QtCore.QObject | None = ...,
        signal: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        signal: object,
        /,
        state: PySide6.QtStateMachine.QState | None = ...,
        *,
        senderObject: PySide6.QtCore.QObject | None = ...,
    ) -> None: ...
    def event(self, e: PySide6.QtCore.QEvent, /) -> bool: ...
...
class QState(PySide6.QtStateMachine.QAbstractState):
    ...
    def __init__(
        ...
        parent: PySide6.QtStateMachine.QState | None = ...,
        *,
        initialState: PySide6.QtStateMachine.QAbstractState | None = ...,
        errorState: PySide6.QtStateMachine.QAbstractState | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        *,
        initialState: PySide6.QtStateMachine.QAbstractState | None = ...,
        errorState: PySide6.QtStateMachine.QAbstractState | None = ...,
        childMode: PySide6.QtStateMachine.QState.ChildMode | None = ...,
    ) -> None: ...
    @typing.overload
    def addTransition(
    ...
    @typing.overload
    def addTransition(
        self, sender: PySide6.QtCore.QObject, signal: str, target: PySide6.QtStateMachine.QAbstractState, /
    ) -> PySide6.QtStateMachine.QSignalTransition: ...
    @typing.overload
    def addTransition(
        self, signal: object, arg__2: PySide6.QtStateMachine.QAbstractState, /
    ) -> PySide6.QtStateMachine.QSignalTransition: ...
...
class QStateMachine(PySide6.QtStateMachine.QState):
    ...
    class SignalEvent(PySide6.QtCore.QEvent):
        def __init__(
            self, sender: PySide6.QtCore.QObject, signalIndex: int, arguments: collections.abc.Sequence[typing.Any], /
        ) -> None: ...
    ...
    def __init__(
        ...
        *,
        ...
        globalRestorePolicy: PySide6.QtStateMachine.QState.RestorePolicy | None = ...,
        running: bool | None = ...,
        animated: bool | None = ...,
    ) -> None: ...
    @typing.overload
    ...
    def postEvent(
        self, event: PySide6.QtCore.QEvent, /, priority: PySide6.QtStateMachine.QStateMachine.EventPriority = ...
    ) -> None: ...
