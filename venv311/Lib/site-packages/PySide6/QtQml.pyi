...
class ListProperty(PySide6.QtCore.Property):
    def __init__(
        ...
        type: type,
        /,
        append: collections.abc.Callable[..., typing.Any] | None = ...,
        at: collections.abc.Callable[..., typing.Any] | None = ...,
        clear: collections.abc.Callable[..., typing.Any] | None = ...,
        count: collections.abc.Callable[..., typing.Any] | None = ...,
    ) -> None: ...
...
class QJSEngine(PySide6.QtCore.QObject):
    ...
    ) -> typing.Tuple[PySide6.QtQml.QJSValue, typing.List[str]]: ...
    ...
    def installExtensions(
        self,
        extensions: PySide6.QtQml.QJSEngine.Extension,
        /,
        object: (
...
class QJSManagedValue(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, value: PySide6.QtQml.QJSPrimitiveValue | str | bool | float | int, engine: PySide6.QtQml.QJSEngine, /
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def callAsConstructor(
        self, /, arguments: collections.abc.Sequence[PySide6.QtQml.QJSValue] = ...
    ) -> PySide6.QtQml.QJSValue: ...
    def callWithInstance(
        ...
        /,
        arguments: collections.abc.Sequence[PySide6.QtQml.QJSValue] = ...,
    ) -> PySide6.QtQml.QJSValue: ...
    @typing.overload
    ...
    def jsMetaInstantiate(
        self, /, values: collections.abc.Sequence[PySide6.QtQml.QJSValue] = ...
...
class QJSPrimitiveValue(Shiboken.Object):
    ...
    def __add__(
        self, rhs: PySide6.QtQml.QJSPrimitiveValue | str | bool | float | int, /
...
class QJSValue(Shiboken.Object):
    ...
    def callWithInstance(
        ...
        /,
        args: collections.abc.Sequence[PySide6.QtQml.QJSValue] = ...,
    ) -> PySide6.QtQml.QJSValue: ...
    def deleteProperty(self, name: str, /) -> bool: ...
    def equals(
        self,
...
class QQmlAbstractUrlInterceptor(Shiboken.Object):
    ...
    def __init__(self, /) -> None: ...
    def intercept(
        self, path: PySide6.QtCore.QUrl | str, type: PySide6.QtQml.QQmlAbstractUrlInterceptor.DataType, /
    ) -> PySide6.QtCore.QUrl: ...
...
class QQmlApplicationEngine(PySide6.QtQml.QQmlEngine):
    ...
    def loadData(
        self, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /, url: PySide6.QtCore.QUrl | str = ...
    ) -> None: ...
...
class QQmlComponent(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        progress: float | None = ...,
        status: PySide6.QtQml.QQmlComponent.Status | None = ...,
    ...
    def createObject(
        self, /, parent: PySide6.QtCore.QObject | None = ..., properties: typing.Dict[str, typing.Any] = ...
    ) -> PySide6.QtCore.QObject: ...
    def createWithInitialProperties(
        self, initialProperties: typing.Dict[str, typing.Any], /, context: PySide6.QtQml.QQmlContext | None = ...
    ) -> PySide6.QtCore.QObject: ...
    def createWithInitialProperties_withownership(
    ...
    def setData(
        self, arg__1: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, baseUrl: PySide6.QtCore.QUrl | str, /
    ) -> None: ...
...
class QQmlContext(PySide6.QtCore.QObject):
    ...
    def setContextProperties(
        self, properties: collections.abc.Sequence[PySide6.QtQml.QQmlContext.PropertyPair], /
    ) -> None: ...
    @typing.overload
...
class QQmlDebuggingEnabler(Shiboken.Object):
    ...
    def startTcpDebugServer(
        port: int, /, mode: PySide6.QtQml.QQmlDebuggingEnabler.StartMode = ..., hostName: str = ...
    ) -> bool: ...
...
class QQmlEngine(PySide6.QtQml.QJSEngine):
    ...
    def interceptUrl(
        self, url: PySide6.QtCore.QUrl | str, type: PySide6.QtQml.QQmlAbstractUrlInterceptor.DataType, /
    ) -> PySide6.QtCore.QUrl: ...
...
class QQmlListReference(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, o: PySide6.QtCore.QObject, property: bytes | bytearray | memoryview, engine: PySide6.QtQml.QQmlEngine, /
    ) -> None: ...
    @typing.overload
...
class QQmlProperty(Shiboken.Object):
    ...
    def __init__(
        ...
        arg__2: PySide6.QtQml.QQmlEngine,
        /,
        *,
        object: PySide6.QtCore.QObject | None = ...,
        name: str | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        arg__1: PySide6.QtCore.QObject,
        arg__2: PySide6.QtQml.QQmlContext,
        /,
        *,
        object: PySide6.QtCore.QObject | None = ...,
        name: str | None = ...,
    ...
    @typing.overload
    def __init__(
        self, arg__1: PySide6.QtCore.QObject, /, *, object: PySide6.QtCore.QObject | None = ..., name: str | None = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, arg__1: PySide6.QtQml.QQmlProperty, /, *, object: PySide6.QtCore.QObject | None = ..., name: str | None = ...
    ) -> None: ...
    @typing.overload
...
def qmlAttachedPropertiesObject(
    type_obj: type, arg__2: PySide6.QtCore.QObject, /, arg__3: bool = ...
) -> PySide6.QtCore.QObject: ...
...
def qmlRegisterSingletonInstance(
    ...
    version_major: int,
    version_minor: int,
    qml_name: bytes | bytearray | memoryview,
    callback: object,
    /,
) -> int: ...
@typing.overload
def qmlRegisterSingletonType(
    uri: str, version_major: int, version_minor: int, qml_name: bytes | bytearray | memoryview, callback: object, /
) -> int: ...
@typing.overload
def qmlRegisterSingletonType(
    type_obj: type, uri: str, version_major: int, version_minor: int, qml_name: bytes | bytearray | memoryview, /
) -> int: ...
@typing.overload
def qmlRegisterSingletonType(
    type_obj: type,
...
def qmlRegisterSingletonType(
    url: PySide6.QtCore.QUrl | str,
    uri: bytes | bytearray | memoryview,
    versionMajor: int,
    versionMinor: int,
    qmlName: bytes | bytearray | memoryview,
    /,
) -> int: ...
@typing.overload
def qmlRegisterType(
...
def qmlTypeId(
    uri: bytes | bytearray | memoryview, versionMajor: int, versionMinor: int, qmlName: bytes | bytearray | memoryview, /
) -> int: ...
