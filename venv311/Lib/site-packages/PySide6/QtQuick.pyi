...
class QQuickFramebufferObject(PySide6.QtQuick.QQuickItem):
    ...
    def __init__(
        self,
        /,
        parent: PySide6.QtQuick.QQuickItem | None = ...,
        *,
        textureFollowsItemSize: bool | None = ...,
    ...
    def updatePaintNode(
        self, arg__1: PySide6.QtQuick.QSGNode, arg__2: PySide6.QtQuick.QQuickItem.UpdatePaintNodeData, /
...
class QQuickGraphicsDevice(Shiboken.Object):
    ...
    @staticmethod
    def fromAdapter(
        adapterLuidLow: int, adapterLuidHigh: int, /, featureLevel: int | None = ...
...
class QQuickImageProvider(PySide6.QtQml.QQmlImageProviderBase):
    def __init__(
        self, type: PySide6.QtQml.QQmlImageProviderBase.ImageType, /, flags: PySide6.QtQml.QQmlImageProviderBase.Flag = ...
    ) -> None: ...
...
class QQuickItem(PySide6.QtCore.QObject, PySide6.QtQml.QQmlParserStatus):
    ...
    def __init__(
        ...
        *,
        ...
        visible: bool | None = ...,
        state: str | None = ...,
        childrenRect: PySide6.QtCore.QRectF | None = ...,
        baselineOffset: float | None = ...,
        clip: bool | None = ...,
        focus: bool | None = ...,
        activeFocus: bool | None = ...,
        activeFocusOnTab: bool | None = ...,
        focusPolicy: PySide6.QtCore.Qt.FocusPolicy | None = ...,
        rotation: float | None = ...,
        scale: float | None = ...,
        transformOrigin: PySide6.QtQuick.QQuickItem.TransformOrigin | None = ...,
        transformOriginPoint: PySide6.QtCore.QPointF | None = ...,
        smooth: bool | None = ...,
        antialiasing: bool | None = ...,
        implicitWidth: float | None = ...,
        implicitHeight: float | None = ...,
        containmentMask: PySide6.QtCore.QObject | None = ...,
    ) -> None: ...
    ...
    ) -> PySide6.QtQuick.QSharedPointer_QQuickItemGrabResult: ...
    @typing.overload
    def grabToImage(
        self,
        callback: (
    ...
    @typing.overload
    def mapFromItem(
        self, item: PySide6.QtQuick.QQuickItem, rect: PySide6.QtCore.QRectF | PySide6.QtCore.QRect, /
    ...
    @typing.overload
    def mapFromItem(
        self, item: PySide6.QtQuick.QQuickItem, x: float, y: float, width: float, height: float, /
    ) -> PySide6.QtCore.QRectF: ...
    def mapFromScene(
        self, point: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element, /
    ) -> PySide6.QtCore.QPointF: ...
...
class QQuickPaintedItem(PySide6.QtQuick.QQuickItem):
    ...
    def __init__(
        ...
        parent: PySide6.QtQuick.QQuickItem | None = ...,
        *,
        contentsSize: PySide6.QtCore.QSize | None = ...,
        fillColor: PySide6.QtGui.QColor | None = ...,
        contentsScale: float | None = ...,
        renderTarget: PySide6.QtQuick.QQuickPaintedItem.RenderTarget | None = ...,
        textureSize: PySide6.QtCore.QSize | None = ...,
    ) -> None: ...
    def antialiasing(self, /) -> bool: ...
    ...
    def setFillColor(
        self,
        arg__1: typing.Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, typing.Any, PySide6.QtCore.Qt.GlobalColor, int],
        /,
    ) -> None: ...
...
class QQuickRenderTarget(Shiboken.Object):
    ...
    @staticmethod
    def fromD3D11Texture(
        texture: int, format: int, pixelSize: PySide6.QtCore.QSize, /, sampleCount: int = ...
    ) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @typing.overload
    @staticmethod
    def fromD3D11Texture(
        ...
        sampleCount: int,
        flags: PySide6.QtQuick.QQuickRenderTarget.Flag,
        /,
    ) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @typing.overload
    @staticmethod
    def fromD3D12Texture(
        texture: int, resourceState: int, format: int, pixelSize: PySide6.QtCore.QSize, /, sampleCount: int = ...
    ) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @typing.overload
    @staticmethod
    def fromD3D12Texture(
    ...
    @staticmethod
    def fromOpenGLTexture(
        textureId: int, format: int, pixelSize: PySide6.QtCore.QSize, /, sampleCount: int = ...
    ) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @typing.overload
    @staticmethod
    def fromOpenGLTexture(
...
class QQuickRhiItem(PySide6.QtQuick.QQuickItem):
    ...
    def __init__(
        ...
        *,
        ...
        colorBufferFormat: PySide6.QtQuick.QQuickRhiItem.TextureFormat | None = ...,
        mirrorVertically: bool | None = ...,
        alphaBlending: bool | None = ...,
        fixedColorBufferWidth: int | None = ...,
        fixedColorBufferHeight: int | None = ...,
        effectiveColorBufferSize: PySide6.QtCore.QSize | None = ...,
    ) -> None: ...
...
class QQuickTextDocument(PySide6.QtCore.QObject):
    ...
    def __init__(
        self,
        parent: PySide6.QtQuick.QQuickItem,
        /,
        *,
        source: PySide6.QtCore.QUrl | None = ...,
        modified: bool | None = ...,
        status: PySide6.QtQuick.QQuickTextDocument.Status | None = ...,
...
class QQuickView(PySide6.QtQuick.QQuickWindow):
    ...
    def __init__(
        ...
        /,
        *,
        resizeMode: PySide6.QtQuick.QQuickView.ResizeMode | None = ...,
        status: PySide6.QtQuick.QQuickView.Status | None = ...,
        source: PySide6.QtCore.QUrl | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
    ...
    def setContent(
        self, url: PySide6.QtCore.QUrl | str, component: PySide6.QtQml.QQmlComponent, item: PySide6.QtCore.QObject, /
    ) -> None: ...
...
class QQuickWindow(PySide6.QtGui.QWindow):
    ...
    def __init__(
        ...
        *,
        ...
        contentItem: PySide6.QtQuick.QQuickItem | None = ...,
        activeFocusItem: PySide6.QtQuick.QQuickItem | None = ...,
    ...
    def createTextureFromImage(
        self, image: PySide6.QtGui.QImage, options: PySide6.QtQuick.QQuickWindow.CreateTextureOption, /
    ) -> PySide6.QtQuick.QSGTexture: ...
    def createTextureFromRhiTexture(
        self, texture: PySide6.QtGui.QRhiTexture, /, options: PySide6.QtQuick.QQuickWindow.CreateTextureOption = ...
    ) -> PySide6.QtQuick.QSGTexture: ...
    ...
    def scheduleRenderJob(
        self, job: PySide6.QtCore.QRunnable, schedule: PySide6.QtQuick.QQuickWindow.RenderStage, /
    ) -> None: ...
    def setColor(
        self,
...
class QSGGeometry(Shiboken.Object):
    class Attribute(Shiboken.Object):
        ...
        def createWithAttributeType(
            pos: int, tupleSize: int, primitiveType: int, attributeType: PySide6.QtQuick.QSGGeometry.AttributeType, /
        ) -> PySide6.QtQuick.QSGGeometry.Attribute: ...
    ...
    def updateColoredRectGeometry(
        g: PySide6.QtQuick.QSGGeometry, rect: PySide6.QtCore.QRectF | PySide6.QtCore.QRect, /
    ) -> None: ...
    @staticmethod
...
class QSGImageNode(PySide6.QtQuick.QSGGeometryNode):
    ...
    def rebuildGeometry(
        g: PySide6.QtQuick.QSGGeometry,
        texture: PySide6.QtQuick.QSGTexture,
        rect: PySide6.QtCore.QRectF | PySide6.QtCore.QRect,
        sourceRect: PySide6.QtCore.QRectF | PySide6.QtCore.QRect,
        texCoordMode: PySide6.QtQuick.QSGImageNode.TextureCoordinatesTransformFlag,
        /,
    ) -> None: ...
    ...
    def setTextureCoordinatesTransform(
        self, mode: PySide6.QtQuick.QSGImageNode.TextureCoordinatesTransformFlag, /
    ) -> None: ...
...
class QSGMaterialShader(Shiboken.Object):
    ...
    def updateGraphicsPipelineState(
        ...
        ps: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState,
...
class QSGNinePatchNode(PySide6.QtQuick.QSGGeometryNode):
    ...
    def rebuildGeometry(
        texture: PySide6.QtQuick.QSGTexture,
        geometry: PySide6.QtQuick.QSGGeometry,
        padding: PySide6.QtGui.QVector4D,
...
class QSGRendererInterface(Shiboken.Object):
    ...
    @typing.overload
    def getResource(
        self, window: PySide6.QtQuick.QQuickWindow, resource: PySide6.QtQuick.QSGRendererInterface.Resource, /
    ) -> int: ...
    @typing.overload
...
class QSGSimpleTextureNode(PySide6.QtQuick.QSGGeometryNode):
    ...
    def setTexture(self, texture: PySide6.QtQuick.QSGTexture, /) -> None: ...
    def setTextureCoordinatesTransform(
        self, mode: PySide6.QtQuick.QSGSimpleTextureNode.TextureCoordinatesTransformFlag, /
    ) -> None: ...
    def sourceRect(self, /) -> PySide6.QtCore.QRectF: ...
    def texture(self, /) -> PySide6.QtQuick.QSGTexture: ...
...
class QSGTextNode(PySide6.QtQuick.QSGTransformNode):
    ...
    def addTextLayout(
        self,
        position: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        layout: PySide6.QtGui.QTextLayout,
        /,
        selectionStart: int = ...,
        selectionCount: int = ...,
        lineStart: int | None = ...,
    ...
    def setSelectionTextColor(
        self,
        selectionTextColor: typing.Union[
            PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, typing.Any, PySide6.QtCore.Qt.GlobalColor, int
        ],
        /,
    ) -> None: ...
...
class QSGTexture(PySide6.QtCore.QObject):
    ...
    def __init__(self, /) -> None: ...
    def anisotropyLevel(self, /) -> PySide6.QtQuick.QSGTexture.AnisotropyLevel: ...
    def commitTextureOperations(
        self, rhi: PySide6.QtGui.QRhi, resourceUpdates: PySide6.QtGui.QRhiResourceUpdateBatch, /
    ) -> None: ...
    ...
    def removedFromAtlas(
        self, /, resourceUpdates: PySide6.QtGui.QRhiResourceUpdateBatch | None = ...
    ) -> PySide6.QtQuick.QSGTexture: ...
