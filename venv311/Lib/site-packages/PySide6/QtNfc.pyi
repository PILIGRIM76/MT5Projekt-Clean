...
class QNdefMessage(Shiboken.Object):
    ...
    def __iadd__(
        self, l: collections.abc.Sequence[PySide6.QtNfc.QNdefRecord], /
    ) -> typing.List[PySide6.QtNfc.QNdefRecord]: ...
    def __lshift__(
        self, l: collections.abc.Sequence[PySide6.QtNfc.QNdefRecord], /
    ) -> typing.List[PySide6.QtNfc.QNdefRecord]: ...
    @typing.overload
    ...
    @staticmethod
    def fromVector(
        vector: collections.abc.Sequence[PySide6.QtNfc.QNdefRecord], /
    ) -> typing.List[PySide6.QtNfc.QNdefRecord]: ...
...
class QNdefNfcSmartPosterRecord(PySide6.QtNfc.QNdefRecord):
    ...
    def icon(
        self, /, mimetype: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...
...
class QNdefRecord(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, other: PySide6.QtNfc.QNdefRecord, typeNameFormat: PySide6.QtNfc.QNdefRecord.TypeNameFormat, /
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QNearFieldTarget(PySide6.QtCore.QObject):
    ...
    def sendCommand(
        self, command: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ...
    def writeNdefMessages(
        self, messages: collections.abc.Sequence[PySide6.QtNfc.QNdefMessage], /
    ) -> PySide6.QtNfc.QNearFieldTarget.RequestId: ...
