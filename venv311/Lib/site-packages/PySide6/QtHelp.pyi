...
class QHelpEngineCore(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        autoSaveFilter: bool | None = ...,
        readOnly: bool | None = ...,
        currentFilter: str | None = ...,
    ) -> None: ...
    ...
    @typing.overload
    def files(
        self, namespaceName: str, filterAttributes: collections.abc.Sequence[str], /, extensionFilter: str = ...
    ) -> typing.List[PySide6.QtCore.QUrl]: ...
...
class QHelpSearchQuery(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, field: PySide6.QtHelp.QHelpSearchQuery.FieldName, wordList_: collections.abc.Sequence[str], /
    ) -> None: ...
    @typing.overload
