...
class Q3DBarsWidgetItem(PySide6.QtGraphsWidgets.Q3DGraphsWidgetItem):
    ...
    def __init__(
        ...
        *,
        ...
        primarySeries: PySide6.QtGraphs.QBar3DSeries | None = ...,
        selectedSeries: PySide6.QtGraphs.QBar3DSeries | None = ...,
...
class Q3DGraphsWidgetItem(PySide6.QtCore.QObject):
    ...
    def renderToImage(
        self, /, imageSize: PySide6.QtCore.QSize = ...
    ) -> typing.Tuple[PySide6.QtQuick.QQuickItemGrabResult]: ...
...
class Q3DScatterWidgetItem(PySide6.QtGraphsWidgets.Q3DGraphsWidgetItem):
    ...
    def __init__(
        ...
        *,
        ...
        selectedSeries: PySide6.QtGraphs.QScatter3DSeries | None = ...,
    ) -> None: ...
...
class Q3DSurfaceWidgetItem(PySide6.QtGraphsWidgets.Q3DGraphsWidgetItem):
    ...
    def __init__(
        ...
        *,
        ...
        axisY: PySide6.QtGraphs.QValue3DAxis | None = ...,
        axisZ: PySide6.QtGraphs.QValue3DAxis | None = ...,
        selectedSeries: PySide6.QtGraphs.QSurface3DSeries | None = ...,
    ...
    def renderSliceToImage(
        self, index: int, requestedIndex: int, sliceType: PySide6.QtGraphs.QtGraphs3D.SliceCaptureType, /
    ) -> None: ...
