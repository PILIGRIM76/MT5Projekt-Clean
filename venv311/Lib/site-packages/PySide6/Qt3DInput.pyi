...
class Qt3DInput(Shiboken.Object):
    ...
    class QActionInput(PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput):
        ...
        def __init__(
            ...
            *,
            sourceDevice: PySide6.Qt3DInput.Qt3DInput.QAbstractPhysicalDevice | None = ...,
            buttons: collections.abc.Sequence[int] | None = ...,
        ) -> None: ...
    ...
    class QAxisAccumulator(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            sourceAxis: PySide6.Qt3DInput.Qt3DInput.QAxis | None = ...,
            sourceAxisType: PySide6.Qt3DInput.Qt3DInput.QAxisAccumulator.SourceAxisType | None = ...,
            scale: float | None = ...,
            value: float | None = ...,
            velocity: float | None = ...,
        ) -> None: ...
        ...
        def setSourceAxisType(
            self, sourceAxisType: PySide6.Qt3DInput.Qt3DInput.QAxisAccumulator.SourceAxisType, /
        ) -> None: ...
    ...
    class QAxisSetting(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            deadZoneRadius: float | None = ...,
            axes: collections.abc.Sequence[int] | None = ...,
            smooth: bool | None = ...,
        ) -> None: ...
    ...
    class QInputSettings(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(
            self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, eventSource: PySide6.QtCore.QObject | None = ...
        ) -> None: ...
    ...
    class QKeyEvent(PySide6.QtCore.QObject):
        ...
        def __init__(
            self,
            ke: PySide6.QtGui.QKeyEvent,
            /,
            *,
            key: int | None = ...,
            text: str | None = ...,
            modifiers: int | None = ...,
            isAutoRepeat: bool | None = ...,
            count: int | None = ...,
            nativeScanCode: int | None = ...,
            accepted: bool | None = ...,
        ) -> None: ...
        @typing.overload
        def __init__(
    ...
    class QKeyboardDevice(PySide6.Qt3DInput.Qt3DInput.QAbstractPhysicalDevice):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            activeInput: PySide6.Qt3DInput.Qt3DInput.QKeyboardHandler | None = ...,
        ) -> None: ...
    ...
    class QKeyboardHandler(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            sourceDevice: PySide6.Qt3DInput.Qt3DInput.QKeyboardDevice | None = ...,
            focus: bool | None = ...,
        ) -> None: ...
        def focus(self, /) -> bool: ...
    ...
    class QMouseDevice(PySide6.Qt3DInput.Qt3DInput.QAbstractPhysicalDevice):
        ...
        def __init__(
            ...
            *,
            ...
            updateAxesContinuously: bool | None = ...,
        ) -> None: ...
        def axisCount(self, /) -> int: ...
        def axisIdentifier(self, name: str, /) -> int: ...
        def axisNames(self, /) -> typing.List[str]: ...
    ...
    class QMouseEvent(PySide6.QtCore.QObject):
        ...
        def __init__(
            self,
            e: PySide6.QtGui.QMouseEvent,
            /,
            *,
            x: int | None = ...,
            y: int | None = ...,
            wasHeld: bool | None = ...,
            button: PySide6.Qt3DInput.Qt3DInput.QMouseEvent.Buttons | None = ...,
            buttons: int | None = ...,
            modifiers: PySide6.Qt3DInput.Qt3DInput.QMouseEvent.Modifiers | None = ...,
            accepted: bool | None = ...,
        ) -> None: ...
    ...
    class QMouseHandler(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            sourceDevice: PySide6.Qt3DInput.Qt3DInput.QMouseDevice | None = ...,
    ...
    class QWheelEvent(PySide6.QtCore.QObject):
        ...
        def __init__(
            ...
            *,
            ...
            buttons: int | None = ...,
            modifiers: PySide6.Qt3DInput.Qt3DInput.QWheelEvent.Modifiers | None = ...,
            accepted: bool | None = ...,
        ) -> None: ...
