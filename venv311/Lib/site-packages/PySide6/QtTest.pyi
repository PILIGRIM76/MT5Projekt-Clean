...
class QTest(Shiboken.Object):
    ...
    class QTouchEventSequence(Shiboken.Object):
        ...
        @typing.overload
        def move(
            self, touchId: int, pt: PySide6.QtCore.QPoint, /, widget: PySide6.QtWidgets.QWidget | None = ...
        ) -> PySide6.QtTest.QTest.QTouchEventSequence: ...
        @typing.overload
        def move(
            self, touchId: int, pt: PySide6.QtCore.QPoint, /, window: PySide6.QtGui.QWindow | None = ...
        ) -> PySide6.QtTest.QTest.QTouchEventSequence: ...
        @typing.overload
        def press(
            self, touchId: int, pt: PySide6.QtCore.QPoint, /, widget: PySide6.QtWidgets.QWidget | None = ...
    ...
    def compare_string_helper(
        t1: bytes | bytearray | memoryview,
        t2: bytes | bytearray | memoryview,
        actual: bytes | bytearray | memoryview,
        expected: bytes | bytearray | memoryview,
        file: bytes | bytearray | memoryview,
        line: int,
    ...
    def createTouchDevice(
        devType: PySide6.QtGui.QInputDevice.DeviceType = ..., caps: PySide6.QtGui.QInputDevice.Capability = ...
    ...
    @staticmethod
    def formatString(
        prefix: bytes | bytearray | memoryview, suffix: bytes | bytearray | memoryview, numArguments: int, /
    ...
    def keyClick(
        ...
        /,
        modifier: PySide6.QtCore.Qt.KeyboardModifier = ...,
        delay: int = ...,
    ) -> None: ...
    @typing.overload
    @staticmethod
    def keyClick(
        widget: PySide6.QtWidgets.QWidget, key: int, /, modifier: PySide6.QtCore.Qt.KeyboardModifier = ..., delay: int = ...
    ) -> None: ...
    @typing.overload
    @staticmethod
    def keyClick(
    ...
    @staticmethod
    def keyClick(
        window: PySide6.QtGui.QWindow, key: int, /, modifier: PySide6.QtCore.Qt.KeyboardModifier = ..., delay: int = ...
    ) -> None: ...
    @staticmethod
    def keyClicks(
        widget: PySide6.QtWidgets.QWidget,
    ...
    def mouseClick(
        ...
        /,
        stateKey: PySide6.QtCore.Qt.KeyboardModifier = ...,
    ...
    def qCaught(
        expected: bytes | bytearray | memoryview,
        what: bytes | bytearray | memoryview,
        file: bytes | bytearray | memoryview,
        line: int,
        /,
    ) -> None: ...
    ...
    @staticmethod
    def qExpectFail(
        dataIndex: bytes | bytearray | memoryview,
        comment: bytes | bytearray | memoryview,
    ...
    def qFindTestData(
        basepath: str,
        /,
        file: bytes | bytearray | memoryview | None = ...,
        line: int | None = ...,
        builddir: bytes | bytearray | memoryview | None = ...,
        sourcedir: bytes | bytearray | memoryview | None = ...,
    ) -> str: ...
    @typing.overload
    @staticmethod
    def qFindTestData(
        basepath: bytes | bytearray | memoryview,
        /,
        file: bytes | bytearray | memoryview | None = ...,
        line: int | None = ...,
        builddir: bytes | bytearray | memoryview | None = ...,
    ...
    def qWaitForWindowActive(
        widget: PySide6.QtWidgets.QWidget,
        timeout: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int,
        /,
    ) -> bool: ...
    @typing.overload
    @staticmethod
    ...
    def setMainSourcePath(
        file: bytes | bytearray | memoryview, /, builddir: bytes | bytearray | memoryview | None = ...
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def touchEvent(
        widget: PySide6.QtWidgets.QWidget, device: PySide6.QtGui.QPointingDevice, /, autoCommit: bool = ...
    ) -> PySide6.QtTest.QTest.QTouchEventSequence: ...
    @typing.overload
    @staticmethod
    def touchEvent(
        window: PySide6.QtGui.QWindow, device: PySide6.QtGui.QPointingDevice, /, autoCommit: bool = ...
    ) -> PySide6.QtTest.QTest.QTouchEventSequence: ...
    @staticmethod
    def wheelEvent(
        window: PySide6.QtGui.QWindow,
        pos: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint,
