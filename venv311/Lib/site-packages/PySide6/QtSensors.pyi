...
class QAccelerometer(PySide6.QtSensors.QSensor):
    ...
    def __init__(
        ...
        *,
        accelerationMode: PySide6.QtSensors.QAccelerometer.AccelerationMode | None = ...,
    ) -> None: ...
...
class QAccelerometerReading(PySide6.QtSensors.QSensorReading):
    def __init__(
        self, parent: PySide6.QtCore.QObject, /, *, x: float | None = ..., y: float | None = ..., z: float | None = ...
    ) -> None: ...
...
class QAmbientLightReading(PySide6.QtSensors.QSensorReading):
    ...
    def __init__(
        self, parent: PySide6.QtCore.QObject, /, *, lightLevel: PySide6.QtSensors.QAmbientLightReading.LightLevel | None = ...
    ) -> None: ...
    def copyValuesFrom(self, other: PySide6.QtSensors.QSensorReading, /) -> None: ...
...
class QCompassReading(PySide6.QtSensors.QSensorReading):
    def __init__(
        self, parent: PySide6.QtCore.QObject, /, *, azimuth: float | None = ..., calibrationLevel: float | None = ...
    ) -> None: ...
...
class QHumidityReading(PySide6.QtSensors.QSensorReading):
    def __init__(
        self, parent: PySide6.QtCore.QObject, /, *, relativeHumidity: float | None = ..., absoluteHumidity: float | None = ...
    ) -> None: ...
...
class QLidReading(PySide6.QtSensors.QSensorReading):
    ...
    def __init__(
        self, parent: PySide6.QtCore.QObject, /, *, backLidClosed: bool | None = ..., frontLidClosed: bool | None = ...
    ) -> None: ...
...
class QOrientationReading(PySide6.QtSensors.QSensorReading):
    ...
    def __init__(
        self, parent: PySide6.QtCore.QObject, /, *, orientation: PySide6.QtSensors.QOrientationReading.Orientation | None = ...
    ) -> None: ...
    def copyValuesFrom(self, other: PySide6.QtSensors.QSensorReading, /) -> None: ...
...
class QPressureReading(PySide6.QtSensors.QSensorReading):
    def __init__(
        self, parent: PySide6.QtCore.QObject, /, *, pressure: float | None = ..., temperature: float | None = ...
    ) -> None: ...
    def copyValuesFrom(self, other: PySide6.QtSensors.QSensorReading, /) -> None: ...
...
class QSensor(PySide6.QtCore.QObject):
    ...
    def __init__(
        self,
        type: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        identifier: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview | None = ...,
        connectedToBackend: bool | None = ...,
        availableDataRates: collections.abc.Sequence[typing.Tuple[int, int]] | None = ...,
        dataRate: int | None = ...,
        reading: PySide6.QtSensors.QSensorReading | None = ...,
        busy: bool | None = ...,
        active: bool | None = ...,
        outputRanges: collections.abc.Sequence[PySide6.QtSensors.qoutputrange] | None = ...,
        outputRange: int | None = ...,
        description: str | None = ...,
        error: int | None = ...,
        alwaysOn: bool | None = ...,
        skipDuplicates: bool | None = ...,
        axesOrientationMode: PySide6.QtSensors.QSensor.AxesOrientationMode | None = ...,
        currentOrientation: int | None = ...,
        userOrientation: int | None = ...,
        maxBufferSize: int | None = ...,
        efficientBufferSize: int | None = ...,
        bufferSize: int | None = ...,
    ) -> None: ...
...
class QSensorManager(Shiboken.Object):
    ...
    def isBackendRegistered(
        type: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        identifier: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
    ) -> bool: ...
    @staticmethod
    def registerBackend(
...
class QTapReading(PySide6.QtSensors.QSensorReading):
    ...
    def __init__(
        ...
        /,
        *,
        tapDirection: PySide6.QtSensors.QTapReading.TapDirection | None = ...,
        doubleTap: bool | None = ...,
    ) -> None: ...
    def copyValuesFrom(self, other: PySide6.QtSensors.QSensorReading, /) -> None: ...
...
class QTapSensor(PySide6.QtSensors.QSensor):
    ...
    def __init__(
        self, /, parent: PySide6.QtCore.QObject | None = ..., *, returnDoubleTapEvents: bool | None = ...
    ) -> None: ...
...
class QTiltReading(PySide6.QtSensors.QSensorReading):
    def __init__(
        self, parent: PySide6.QtCore.QObject, /, *, yRotation: float | None = ..., xRotation: float | None = ...
    ) -> None: ...
    def copyValuesFrom(self, other: PySide6.QtSensors.QSensorReading, /) -> None: ...
