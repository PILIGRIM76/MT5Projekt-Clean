...
class Qt3DCore(Shiboken.Object):
    class QAbstractAspect(PySide6.QtCore.QObject):
        ...
        def registerBackendType(
            self, obj: PySide6.QtCore.QMetaObject, functor: PySide6.Qt3DCore.Qt3DCore.QBackendNodeMapperPtr, /
        ) -> None: ...
    ...
    class QAspectEngine(PySide6.QtCore.QObject):
        ...
        def lookupNodes(
            self, ids: collections.abc.Sequence[PySide6.Qt3DCore.Qt3DCore.QNodeId], /
        ) -> typing.List[PySide6.Qt3DCore.Qt3DCore.QNode]: ...
    ...
    class QAttribute(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            buffer: PySide6.Qt3DCore.Qt3DCore.QBuffer | None = ...,
            name: str | None = ...,
            byteStride: int | None = ...,
            byteOffset: int | None = ...,
            divisor: int | None = ...,
            attributeType: PySide6.Qt3DCore.Qt3DCore.QAttribute.AttributeType | None = ...,
            defaultPositionAttributeName: str | None = ...,
            defaultNormalAttributeName: str | None = ...,
            defaultColorAttributeName: str | None = ...,
            defaultTextureCoordinateAttributeName: str | None = ...,
            defaultTextureCoordinate1AttributeName: str | None = ...,
            defaultTextureCoordinate2AttributeName: str | None = ...,
            defaultTangentAttributeName: str | None = ...,
            defaultJointIndicesAttributeName: str | None = ...,
            defaultJointWeightsAttributeName: str | None = ...,
        ) -> None: ...
        @typing.overload
        def __init__(
            self,
        ...
        def __init__(
            ...
            *,
            buffer: PySide6.Qt3DCore.Qt3DCore.QBuffer | None = ...,
            name: str | None = ...,
            vertexBaseType: PySide6.Qt3DCore.Qt3DCore.QAttribute.VertexBaseType | None = ...,
            vertexSize: int | None = ...,
            count: int | None = ...,
            byteStride: int | None = ...,
            byteOffset: int | None = ...,
    ...
    class QBoundingVolume(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            view: PySide6.Qt3DCore.Qt3DCore.QGeometryView | None = ...,
            implicitMinPoint: PySide6.QtGui.QVector3D | None = ...,
            implicitMaxPoint: PySide6.QtGui.QVector3D | None = ...,
            implicitPointsValid: bool | None = ...,
            minPoint: PySide6.QtGui.QVector3D | None = ...,
            maxPoint: PySide6.QtGui.QVector3D | None = ...,
        ) -> None: ...
    ...
    class QBuffer(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            usage: PySide6.Qt3DCore.Qt3DCore.QBuffer.UsageType | None = ...,
            accessType: PySide6.Qt3DCore.Qt3DCore.QBuffer.AccessType | None = ...,
        ) -> None: ...
    ...
    class QComponent(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def __init__(
            self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, isShareable: bool | None = ...
        ) -> None: ...
    ...
    class QCoreSettings(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(
            self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, boundingVolumesEnabled: bool | None = ...
        ) -> None: ...
    ...
    class QGeometry(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            boundingVolumePositionAttribute: PySide6.Qt3DCore.Qt3DCore.QAttribute | None = ...,
            minExtent: PySide6.QtGui.QVector3D | None = ...,
            maxExtent: PySide6.QtGui.QVector3D | None = ...,
        ) -> None: ...
    ...
    class QGeometryView(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def __init__(
            ...
            *,
            ...
            primitiveType: PySide6.Qt3DCore.Qt3DCore.QGeometryView.PrimitiveType | None = ...,
        ) -> None: ...
    ...
    class QJoint(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            scale: PySide6.QtGui.QVector3D | None = ...,
            rotation: PySide6.QtGui.QQuaternion | None = ...,
            translation: PySide6.QtGui.QVector3D | None = ...,
            inverseBindMatrix: PySide6.QtGui.QMatrix4x4 | None = ...,
    ...
    class QSkeleton(PySide6.Qt3DCore.Qt3DCore.QAbstractSkeleton):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            rootJoint: PySide6.Qt3DCore.Qt3DCore.QJoint | None = ...,
        ) -> None: ...
    ...
    class QSkeletonLoader(PySide6.Qt3DCore.Qt3DCore.QAbstractSkeleton):
        ...
        def __init__(
            ...
            *,
            ...
            status: PySide6.Qt3DCore.Qt3DCore.QSkeletonLoader.Status | None = ...,
            createJointsEnabled: bool | None = ...,
            rootJoint: PySide6.Qt3DCore.Qt3DCore.QJoint | None = ...,
        ) -> None: ...
        @typing.overload
        def __init__(
    ...
    class QTransform(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            matrix: PySide6.QtGui.QMatrix4x4 | None = ...,
            scale: float | None = ...,
            scale3D: PySide6.QtGui.QVector3D | None = ...,
            rotation: PySide6.QtGui.QQuaternion | None = ...,
            translation: PySide6.QtGui.QVector3D | None = ...,
            rotationX: float | None = ...,
            rotationY: float | None = ...,
            rotationZ: float | None = ...,
            worldMatrix: PySide6.QtGui.QMatrix4x4 | None = ...,
        ) -> None: ...
        @staticmethod
        def fromAxes(
        ...
        def fromAxesAndAngles(
            axis1: PySide6.QtGui.QVector3D, angle1: float, axis2: PySide6.QtGui.QVector3D, angle2: float, /
        ) -> PySide6.QtGui.QQuaternion: ...
        @typing.overload
        @staticmethod
        def fromAxesAndAngles(
