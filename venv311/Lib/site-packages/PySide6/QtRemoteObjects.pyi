...
class QRemoteObjectAbstractPersistedStore(PySide6.QtCore.QObject):
    ...
    def restoreProperties(
        self, repName: str, repSig: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> typing.List[typing.Any]: ...
    def saveProperties(
        self,
        repName: str,
        repSig: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
...
class QRemoteObjectHost(PySide6.QtRemoteObjects.QRemoteObjectHostBase):
    ...
    @typing.overload
    def __init__(
        self, /, parent: PySide6.QtCore.QObject | None = ..., *, hostUrl: PySide6.QtCore.QUrl | None = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        /,
        *,
        hostUrl: PySide6.QtCore.QUrl | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QRemoteObjectNode(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        registryUrl: PySide6.QtCore.QUrl | None = ...,
        persistedStore: PySide6.QtRemoteObjects.QRemoteObjectAbstractPersistedStore | None = ...,
    ...
    def acquireModel(
        ...
        name: str,
        /,
        action: PySide6.QtRemoteObjects.QtRemoteObjects.InitialAction = ...,
        rolesHint: collections.abc.Sequence[int] = ...,
...
class QRemoteObjectPendingCallWatcher(PySide6.QtCore.QObject, PySide6.QtRemoteObjects.QRemoteObjectPendingCall):
    ...
    def __init__(
        self, call: PySide6.QtRemoteObjects.QRemoteObjectPendingCall, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    def isFinished(self, /) -> bool: ...
...
class QRemoteObjectRegistryHost(PySide6.QtRemoteObjects.QRemoteObjectHostBase):
    def __init__(
        self, /, registryAddress: PySide6.QtCore.QUrl | str = ..., parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
...
class QRemoteObjectReplica(PySide6.QtCore.QObject):
    ...
    def __init__(
        self,
        /,
        t: PySide6.QtRemoteObjects.QRemoteObjectReplica.ConstructorType = ...,
        *,
        node: PySide6.QtRemoteObjects.QRemoteObjectNode | None = ...,
        state: PySide6.QtRemoteObjects.QRemoteObjectReplica.State | None = ...,
    ) -> None: ...
    def initialize(self, /) -> None: ...
    ...
    def send(
        self, call: PySide6.QtCore.QMetaObject.Call, index: int, args: collections.abc.Sequence[typing.Any], /
    ) -> None: ...
    def sendWithReply(
        self, call: PySide6.QtCore.QMetaObject.Call, index: int, args: collections.abc.Sequence[typing.Any], /
...
class QRemoteObjectSourceLocationInfo(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, QRemoteObjectSourceLocationInfo: PySide6.QtRemoteObjects.QRemoteObjectSourceLocationInfo, /
    ) -> None: ...
    @typing.overload
...
class QtROClientFactory(Shiboken.Object):
    def create(
        self, url: PySide6.QtCore.QUrl | str, /, parent: PySide6.QtCore.QObject | None = ...
