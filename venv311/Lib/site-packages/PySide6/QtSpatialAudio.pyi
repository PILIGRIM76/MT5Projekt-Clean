...
class QAmbientSound(PySide6.QtCore.QObject):
    ...
    def __init__(
        self,
        engine: PySide6.QtSpatialAudio.QAudioEngine,
        /,
        *,
...
class QAudioEngine(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        /,
        *,
        outputMode: PySide6.QtSpatialAudio.QAudioEngine.OutputMode | None = ...,
        outputDevice: PySide6.QtMultimedia.QAudioDevice | None = ...,
        masterVolume: float | None = ...,
        paused: bool | None = ...,
        distanceScale: float | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QAudioRoom(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        dimensions: PySide6.QtGui.QVector3D | None = ...,
        rotation: PySide6.QtGui.QQuaternion | None = ...,
        reflectionGain: float | None = ...,
        reverbGain: float | None = ...,
        reverbTime: float | None = ...,
        reverbBrightness: float | None = ...,
    ) -> None: ...
    ...
    def setRotation(self, q: PySide6.QtGui.QQuaternion, /) -> None: ...
    def setWallMaterial(
        self, wall: PySide6.QtSpatialAudio.QAudioRoom.Wall, material: PySide6.QtSpatialAudio.QAudioRoom.Material, /
    ) -> None: ...
...
class QSpatialSound(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        rotation: PySide6.QtGui.QQuaternion | None = ...,
        volume: float | None = ...,
        distanceModel: PySide6.QtSpatialAudio.QSpatialSound.DistanceModel | None = ...,
        size: float | None = ...,
        distanceCutoff: float | None = ...,
        manualAttenuation: float | None = ...,
        occlusionIntensity: float | None = ...,
        directivity: float | None = ...,
        directivityOrder: float | None = ...,
        nearFieldGain: float | None = ...,
        loops: int | None = ...,
        autoPlay: bool | None = ...,
    ) -> None: ...
    def autoPlay(self, /) -> bool: ...
