...
class QUiLoader(PySide6.QtCore.QObject):
    ...
    def createLayout(
        self, className: str, /, parent: PySide6.QtCore.QObject | None = ..., name: str = ...
    ) -> PySide6.QtWidgets.QLayout: ...
    def createWidget(
        self, className: str, /, parent: PySide6.QtWidgets.QWidget | None = ..., name: str = ...
    ...
    @typing.overload
    def load(
        self, device: PySide6.QtCore.QIODevice, /, parentWidget: PySide6.QtWidgets.QWidget | None = ...
    ) -> PySide6.QtWidgets.QWidget: ...
    @typing.overload
    def load(
        self, arg__1: str | bytes | os.PathLike[str], /, parentWidget: PySide6.QtWidgets.QWidget | None = ...
    ) -> PySide6.QtWidgets.QWidget: ...
