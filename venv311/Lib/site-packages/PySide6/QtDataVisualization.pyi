...
class Q3DBars(PySide6.QtDataVisualization.QAbstract3DGraph):
    ...
    def __init__(
        self,
        /,
        format: PySide6.QtGui.QSurfaceFormat | PySide6.QtGui.QSurfaceFormat.FormatOption | None = ...,
        parent: PySide6.QtGui.QWindow | None = ...,
        *,
        multiSeriesUniform: bool | None = ...,
        barThickness: float | None = ...,
        barSpacing: PySide6.QtCore.QSizeF | None = ...,
        barSpacingRelative: bool | None = ...,
        barSeriesMargin: PySide6.QtCore.QSizeF | None = ...,
        rowAxis: PySide6.QtDataVisualization.QCategory3DAxis | None = ...,
        columnAxis: PySide6.QtDataVisualization.QCategory3DAxis | None = ...,
        valueAxis: PySide6.QtDataVisualization.QValue3DAxis | None = ...,
        primarySeries: PySide6.QtDataVisualization.QBar3DSeries | None = ...,
        selectedSeries: PySide6.QtDataVisualization.QBar3DSeries | None = ...,
        floorLevel: float | None = ...,
    ) -> None: ...
...
class Q3DCamera(PySide6.QtDataVisualization.Q3DObject):
    ...
    def __init__(
        ...
        *,
        ...
        zoomLevel: float | None = ...,
        cameraPreset: PySide6.QtDataVisualization.Q3DCamera.CameraPreset | None = ...,
        wrapXRotation: bool | None = ...,
        wrapYRotation: bool | None = ...,
        target: PySide6.QtGui.QVector3D | None = ...,
        minZoomLevel: float | None = ...,
        maxZoomLevel: float | None = ...,
    ) -> None: ...
...
class Q3DInputHandler(PySide6.QtDataVisualization.QAbstract3DInputHandler):
    ...
    def __init__(
        ...
        *,
        ...
        zoomEnabled: bool | None = ...,
        selectionEnabled: bool | None = ...,
        zoomAtTargetEnabled: bool | None = ...,
    ) -> None: ...
...
class Q3DObject(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        parentScene: PySide6.QtDataVisualization.Q3DScene | None = ...,
...
class Q3DScatter(PySide6.QtDataVisualization.QAbstract3DGraph):
    ...
    def __init__(
        ...
        parent: PySide6.QtGui.QWindow | None = ...,
        *,
        axisX: PySide6.QtDataVisualization.QValue3DAxis | None = ...,
        axisY: PySide6.QtDataVisualization.QValue3DAxis | None = ...,
        axisZ: PySide6.QtDataVisualization.QValue3DAxis | None = ...,
        selectedSeries: PySide6.QtDataVisualization.QScatter3DSeries | None = ...,
    ) -> None: ...
...
class Q3DScene(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        activeCamera: PySide6.QtDataVisualization.Q3DCamera | None = ...,
        activeLight: PySide6.QtDataVisualization.Q3DLight | None = ...,
...
class Q3DSurface(PySide6.QtDataVisualization.QAbstract3DGraph):
    ...
    def __init__(
        ...
        *,
        ...
        axisY: PySide6.QtDataVisualization.QValue3DAxis | None = ...,
        axisZ: PySide6.QtDataVisualization.QValue3DAxis | None = ...,
        selectedSeries: PySide6.QtDataVisualization.QSurface3DSeries | None = ...,
        flipHorizontalGrid: bool | None = ...,
    ) -> None: ...
    def addAxis(self, axis: PySide6.QtDataVisualization.QValue3DAxis, /) -> None: ...
...
class Q3DTheme(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        type: PySide6.QtDataVisualization.Q3DTheme.Theme | None = ...,
        baseColors: collections.abc.Sequence[PySide6.QtGui.QColor] | None = ...,
        backgroundColor: PySide6.QtGui.QColor | None = ...,
        windowColor: PySide6.QtGui.QColor | None = ...,
        labelTextColor: PySide6.QtGui.QColor | None = ...,
        labelBackgroundColor: PySide6.QtGui.QColor | None = ...,
        gridLineColor: PySide6.QtGui.QColor | None = ...,
        singleHighlightColor: PySide6.QtGui.QColor | None = ...,
        multiHighlightColor: PySide6.QtGui.QColor | None = ...,
        lightColor: PySide6.QtGui.QColor | None = ...,
        baseGradients: collections.abc.Sequence[PySide6.QtGui.QLinearGradient] | None = ...,
        singleHighlightGradient: PySide6.QtGui.QLinearGradient | None = ...,
        multiHighlightGradient: PySide6.QtGui.QLinearGradient | None = ...,
        lightStrength: float | None = ...,
        ambientLightStrength: float | None = ...,
        highlightLightStrength: float | None = ...,
        labelBorderEnabled: bool | None = ...,
        font: PySide6.QtGui.QFont | None = ...,
        backgroundEnabled: bool | None = ...,
        gridEnabled: bool | None = ...,
        labelBackgroundEnabled: bool | None = ...,
        colorStyle: PySide6.QtDataVisualization.Q3DTheme.ColorStyle | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QAbstract3DGraph(PySide6.QtGui.QWindow):
    ...
    def renderToImage(
        self, /, msaaSamples: int | None = ..., imageSize: PySide6.QtCore.QSize = ...
...
class QAbstract3DInputHandler(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        inputView: PySide6.QtDataVisualization.QAbstract3DInputHandler.InputView | None = ...,
        inputPosition: PySide6.QtCore.QPoint | None = ...,
        scene: PySide6.QtDataVisualization.Q3DScene | None = ...,
    ) -> None: ...
...
class QBar3DSeries(PySide6.QtDataVisualization.QAbstract3DSeries):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        dataProxy: PySide6.QtDataVisualization.QBarDataProxy | None = ...,
        selectedBar: PySide6.QtCore.QPoint | None = ...,
        meshAngle: float | None = ...,
        rowColors: collections.abc.Sequence[PySide6.QtGui.QColor] | None = ...,
    ) -> None: ...
...
class QBarDataProxy(PySide6.QtDataVisualization.QAbstractDataProxy):
    ...
    def __init__(
        ...
        *,
        ...
        series: PySide6.QtDataVisualization.QBar3DSeries | None = ...,
    ) -> None: ...
    @typing.overload
    ...
    def addRows(
        self,
        rows: typing.List[typing.List[PySide6.QtDataVisualization.QBarDataItem]],
    ...
    @typing.overload
    def insertRow(
        self, arg__1: int, arg__2: collections.abc.Sequence[PySide6.QtDataVisualization.QBarDataItem], /
    ) -> None: ...
    @typing.overload
    def insertRow(
        self, arg__1: int, arg__2: collections.abc.Sequence[PySide6.QtDataVisualization.QBarDataItem], arg__3: str, /
    ) -> None: ...
    @typing.overload
    def insertRows(
        self, rowIndex: int, rows: typing.List[typing.List[PySide6.QtDataVisualization.QBarDataItem]], /
    ) -> None: ...
    @typing.overload
    def insertRows(
        self,
    ...
    def resetArray(
        self,
        arg__1: typing.List[typing.List[PySide6.QtDataVisualization.QBarDataItem]],
        arg__2: collections.abc.Sequence[str],
        arg__3: collections.abc.Sequence[str],
        /,
    ) -> None: ...
...
class QItemModelBarDataProxy(PySide6.QtDataVisualization.QBarDataProxy):
    ...
    def __init__(
        ...
        *,
        ...
        multiMatchBehavior: PySide6.QtDataVisualization.QItemModelBarDataProxy.MultiMatchBehavior | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def setMultiMatchBehavior(
        self, behavior: PySide6.QtDataVisualization.QItemModelBarDataProxy.MultiMatchBehavior, /
    ) -> None: ...
...
class QItemModelSurfaceDataProxy(PySide6.QtDataVisualization.QSurfaceDataProxy):
    ...
    def __init__(
        ...
        *,
        ...
        yPosRoleReplace: str | None = ...,
        zPosRoleReplace: str | None = ...,
        multiMatchBehavior: PySide6.QtDataVisualization.QItemModelSurfaceDataProxy.MultiMatchBehavior | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def setItemModel(self, itemModel: PySide6.QtCore.QAbstractItemModel, /) -> None: ...
    def setMultiMatchBehavior(
        self, behavior: PySide6.QtDataVisualization.QItemModelSurfaceDataProxy.MultiMatchBehavior, /
    ) -> None: ...
    def setRowCategories(self, categories: collections.abc.Sequence[str], /) -> None: ...
    def setRowRole(self, role: str, /) -> None: ...
    def setRowRolePattern(self, pattern: PySide6.QtCore.QRegularExpression | str, /) -> None: ...
...
class QScatter3DSeries(PySide6.QtDataVisualization.QAbstract3DSeries):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        dataProxy: PySide6.QtDataVisualization.QScatterDataProxy | None = ...,
        selectedItem: int | None = ...,
        itemSize: float | None = ...,
    ) -> None: ...
...
class QScatterDataProxy(PySide6.QtDataVisualization.QAbstractDataProxy):
    ...
    def __init__(
        ...
        *,
        itemCount: int | None = ...,
        series: PySide6.QtDataVisualization.QScatter3DSeries | None = ...,
    ) -> None: ...
    ...
    def insertItem(
        self, index: int, item: PySide6.QtDataVisualization.QScatterDataItem | PySide6.QtGui.QVector3D, /
    ) -> None: ...
    def insertItems(
        self, index: int, items: collections.abc.Sequence[PySide6.QtDataVisualization.QScatterDataItem], /
    ) -> None: ...
...
class QSurface3DSeries(PySide6.QtDataVisualization.QAbstract3DSeries):
    ...
    def __init__(
        ...
        *,
        ...
        flatShadingEnabled: bool | None = ...,
        flatShadingSupported: bool | None = ...,
        drawMode: PySide6.QtDataVisualization.QSurface3DSeries.DrawFlag | None = ...,
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        dataProxy: PySide6.QtDataVisualization.QSurfaceDataProxy | None = ...,
        selectedPoint: PySide6.QtCore.QPoint | None = ...,
        flatShadingEnabled: bool | None = ...,
        flatShadingSupported: bool | None = ...,
        drawMode: PySide6.QtDataVisualization.QSurface3DSeries.DrawFlag | None = ...,
...
class QSurfaceDataProxy(PySide6.QtDataVisualization.QAbstractDataProxy):
    ...
    def __init__(
        ...
        *,
        ...
        series: PySide6.QtDataVisualization.QSurface3DSeries | None = ...,
    ) -> None: ...
    ...
    def insertRow(
        self, arg__1: int, arg__2: collections.abc.Sequence[PySide6.QtDataVisualization.QSurfaceDataItem], /
    ) -> None: ...
    def insertRows(
        self, rowIndex: int, rows: typing.List[typing.List[PySide6.QtDataVisualization.QSurfaceDataItem]], /
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setItem(
        self, position: PySide6.QtCore.QPoint, item: PySide6.QtDataVisualization.QSurfaceDataItem | PySide6.QtGui.QVector3D, /
    ) -> None: ...
    @typing.overload
    def setItem(
        self, rowIndex: int, columnIndex: int, item: PySide6.QtDataVisualization.QSurfaceDataItem | PySide6.QtGui.QVector3D, /
    ) -> None: ...
    def setRow(
        self, arg__1: int, arg__2: collections.abc.Sequence[PySide6.QtDataVisualization.QSurfaceDataItem], /
    ) -> None: ...
...
class QValue3DAxis(PySide6.QtDataVisualization.QAbstract3DAxis):
    ...
    def __init__(
        ...
        *,
        ...
        formatter: PySide6.QtDataVisualization.QValue3DAxisFormatter | None = ...,
        reversed: bool | None = ...,
    ) -> None: ...
