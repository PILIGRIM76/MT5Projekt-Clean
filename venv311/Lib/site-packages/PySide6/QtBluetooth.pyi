...
class QBluetoothDeviceDiscoveryAgent(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, deviceAdapter: PySide6.QtBluetooth.QBluetoothAddress, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    @typing.overload
...
class QBluetoothDeviceInfo(Shiboken.Object):
    ...
    def setManufacturerData(
        self, manufacturerId: int, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> bool: ...
...
class QBluetoothLocalDevice(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, address: PySide6.QtBluetooth.QBluetoothAddress, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    @typing.overload
    def __init__(self, /, parent: PySide6.QtCore.QObject | None = ...) -> None: ...
    def address(self, /) -> PySide6.QtBluetooth.QBluetoothAddress: ...
    ...
    def requestPairing(
        self, address: PySide6.QtBluetooth.QBluetoothAddress, pairing: PySide6.QtBluetooth.QBluetoothLocalDevice.Pairing, /
    ) -> None: ...
...
class QBluetoothServer(PySide6.QtCore.QObject):
    ...
    def __init__(
        self, serverType: PySide6.QtBluetooth.QBluetoothServiceInfo.Protocol, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    def close(self, /) -> None: ...
...
class QBluetoothServiceInfo(Shiboken.Object):
    ...
    def setAttribute(
        self,
        attributeId: int,
        value: PySide6.QtBluetooth.QBluetoothServiceInfo.Alternative | collections.abc.Sequence[typing.Any],
        /,
    ) -> None: ...
    @typing.overload
    def setAttribute(
        self,
        attributeId: int,
        value: PySide6.QtBluetooth.QBluetoothServiceInfo.Sequence | collections.abc.Sequence[typing.Any],
        /,
    ) -> None: ...
    @typing.overload
    def setAttribute(
...
class QBluetoothSocket(PySide6.QtCore.QIODevice):
    ...
    @typing.overload
    def __init__(
        self, socketType: PySide6.QtBluetooth.QBluetoothServiceInfo.Protocol, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    @typing.overload
    def __init__(self, /, parent: PySide6.QtCore.QObject | None = ...) -> None: ...
    def abort(self, /) -> None: ...
    ...
    @typing.overload
    def connectToService(
        self, service: PySide6.QtBluetooth.QBluetoothServiceInfo, /, openMode: PySide6.QtCore.QIODeviceBase.OpenModeFlag = ...
    ) -> None: ...
...
class QLowEnergyAdvertisingParameters(Shiboken.Object):
    class AddressInfo(Shiboken.Object):
        ...
        @typing.overload
        def __init__(
            self, addr: PySide6.QtBluetooth.QBluetoothAddress, t: PySide6.QtBluetooth.QLowEnergyController.RemoteAddressType, /
        ) -> None: ...
        def __copy__(self, /) -> typing.Self: ...
    ...
    def setWhiteList(
        self,
        whiteList: collections.abc.Sequence[PySide6.QtBluetooth.QLowEnergyAdvertisingParameters.AddressInfo],
...
class QLowEnergyCharacteristicData(Shiboken.Object):
    ...
    def setDescriptors(
        self, descriptors: collections.abc.Sequence[PySide6.QtBluetooth.QLowEnergyDescriptorData], /
    ) -> None: ...
...
class QLowEnergyController(PySide6.QtCore.QObject):
    ...
    def addService(
        self, service: PySide6.QtBluetooth.QLowEnergyServiceData, /, parent: PySide6.QtCore.QObject | None = ...
    ...
    @staticmethod
    def createCentral(
        remoteDevice: PySide6.QtBluetooth.QBluetoothDeviceInfo, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> PySide6.QtBluetooth.QLowEnergyController: ...
    @typing.overload
    @staticmethod
    def createPeripheral(
        localDevice: PySide6.QtBluetooth.QBluetoothAddress, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> PySide6.QtBluetooth.QLowEnergyController: ...
    @typing.overload
    @staticmethod
...
class QLowEnergyDescriptorData(Shiboken.Object):
    ...
    def setReadPermissions(
        self, readable: bool, /, constraints: PySide6.QtBluetooth.QBluetooth.AttAccessConstraint = ...
    ) -> None: ...
    def setUuid(
        self,
        uuid: (
    ...
    def setWritePermissions(
        self, writable: bool, /, constraints: PySide6.QtBluetooth.QBluetooth.AttAccessConstraint = ...
    ) -> None: ...
...
class QLowEnergyService(PySide6.QtCore.QObject):
    ...
    def writeCharacteristic(
        ...
        newValue: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
...
class QLowEnergyServiceData(Shiboken.Object):
    ...
    def setCharacteristics(
        self, characteristics: collections.abc.Sequence[PySide6.QtBluetooth.QLowEnergyCharacteristicData], /
    ) -> None: ...
