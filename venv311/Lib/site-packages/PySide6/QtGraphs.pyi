...
class Q3DScene(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        viewport: PySide6.QtCore.QRect | None = ...,
        primarySubViewport: PySide6.QtCore.QRect | None = ...,
        secondarySubViewport: PySide6.QtCore.QRect | None = ...,
        selectionQueryPosition: PySide6.QtCore.QPoint | None = ...,
        secondarySubviewOnTop: bool | None = ...,
        slicingActive: bool | None = ...,
        devicePixelRatio: float | None = ...,
        graphPositionQuery: PySide6.QtCore.QPoint | None = ...,
        invalidSelectionPoint: PySide6.QtCore.QPoint | None = ...,
    ) -> None: ...
...
class QAreaSeries(PySide6.QtGraphs.QAbstractSeries):
    ...
    def __init__(
        ...
        *,
        ...
        selectedColor: PySide6.QtGui.QColor | None = ...,
        borderColor: PySide6.QtGui.QColor | None = ...,
        selectedBorderColor: PySide6.QtGui.QColor | None = ...,
        borderWidth: float | None = ...,
        selected: bool | None = ...,
        upperSeries: PySide6.QtGraphs.QXYSeries | None = ...,
        lowerSeries: PySide6.QtGraphs.QXYSeries | None = ...,
    ) -> None: ...
    ...
    def setSelectedBorderColor(
        self,
        newSelectedBorderColor: typing.Union[
            PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, typing.Any, PySide6.QtCore.Qt.GlobalColor, int
        ],
        /,
    ) -> None: ...
...
class QBar3DSeries(PySide6.QtGraphs.QAbstract3DSeries):
    ...
    def __init__(
        self,
        dataProxy: PySide6.QtGraphs.QBarDataProxy,
        /,
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        selectedBar: PySide6.QtCore.QPoint | None = ...,
        meshAngle: float | None = ...,
        rowColors: collections.abc.Sequence[PySide6.QtGui.QColor] | None = ...,
        rowLabels: collections.abc.Sequence[str] | None = ...,
        columnLabels: collections.abc.Sequence[str] | None = ...,
        customRowLabels: collections.abc.Sequence[str] | None = ...,
        customColumnLabels: collections.abc.Sequence[str] | None = ...,
        dataArray: collections.abc.Sequence[collections.abc.Sequence[PySide6.QtGraphs.QBarDataItem]] | None = ...,
        valueColoringEnabled: bool | None = ...,
        rowAxis: PySide6.QtGraphs.QCategory3DAxis | None = ...,
        valueAxis: PySide6.QtGraphs.QValue3DAxis | None = ...,
        columnAxis: PySide6.QtGraphs.QCategory3DAxis | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        dataProxy: PySide6.QtGraphs.QBarDataProxy | None = ...,
        selectedBar: PySide6.QtCore.QPoint | None = ...,
        meshAngle: float | None = ...,
        rowColors: collections.abc.Sequence[PySide6.QtGui.QColor] | None = ...,
        rowLabels: collections.abc.Sequence[str] | None = ...,
    ...
    def setDataArray(
        self, newDataArray: collections.abc.Sequence[collections.abc.Sequence[PySide6.QtGraphs.QBarDataItem]], /
    ) -> None: ...
...
class QBarCategoryAxis(PySide6.QtGraphs.QAbstractAxis):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        categories: collections.abc.Sequence[str] | None = ...,
        min: str | None = ...,
        max: str | None = ...,
        count: int | None = ...,
        labelPosition: PySide6.QtGraphs.QBarCategoryAxis.LabelPosition | None = ...,
    ) -> None: ...
    @typing.overload
...
class QBarDataProxy(PySide6.QtGraphs.QAbstractDataProxy):
    ...
    def __init__(
        ...
        *,
        rowCount: int | None = ...,
        colCount: int | None = ...,
        series: PySide6.QtGraphs.QBar3DSeries | None = ...,
    ) -> None: ...
    @typing.overload
    ...
    def addRows(
        self,
        rows: collections.abc.Sequence[collections.abc.Sequence[PySide6.QtGraphs.QBarDataItem]],
    ...
    @typing.overload
    def insertRow(
        self, rowIndex: int, row: collections.abc.Sequence[PySide6.QtGraphs.QBarDataItem], label: str, /
    ) -> None: ...
    @typing.overload
    def insertRows(
        self, rowIndex: int, rows: collections.abc.Sequence[collections.abc.Sequence[PySide6.QtGraphs.QBarDataItem]], /
    ) -> None: ...
    @typing.overload
    def insertRows(
        self,
    ...
    def removeRows(
        self, rowIndex: int, removeCount: int, /, removeLabels: PySide6.QtGraphs.QBarDataProxy.RemoveLabels = ...
    ) -> None: ...
    @typing.overload
    def resetArray(self, /) -> None: ...
    @typing.overload
    def resetArray(
        self, newArray: collections.abc.Sequence[collections.abc.Sequence[PySide6.QtGraphs.QBarDataItem]], /
    ) -> None: ...
    @typing.overload
    def resetArray(
        self,
        newArray: collections.abc.Sequence[collections.abc.Sequence[PySide6.QtGraphs.QBarDataItem]],
        rowLabels: collections.abc.Sequence[str],
        columnLabels: collections.abc.Sequence[str],
        /,
    ) -> None: ...
...
class QBarModelMapper(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        series: PySide6.QtGraphs.QBarSeries | None = ...,
        model: PySide6.QtCore.QAbstractItemModel | None = ...,
        firstBarSetSection: int | None = ...,
        lastBarSetSection: int | None = ...,
        first: int | None = ...,
        count: int | None = ...,
...
class QBarSeries(PySide6.QtGraphs.QAbstractSeries):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        seriesColors: collections.abc.Sequence[PySide6.QtGui.QColor] | None = ...,
        borderColors: collections.abc.Sequence[PySide6.QtGui.QColor] | None = ...,
        barsType: PySide6.QtGraphs.QBarSeries.BarsType | None = ...,
        barWidth: float | None = ...,
        count: int | None = ...,
        labelsVisible: bool | None = ...,
        labelsFormat: str | None = ...,
        labelsPosition: PySide6.QtGraphs.QBarSeries.LabelsPosition | None = ...,
        labelsMargin: float | None = ...,
        labelsAngle: float | None = ...,
        labelsPrecision: int | None = ...,
        barDelegate: PySide6.QtQml.QQmlComponent | None = ...,
        barSets: collections.abc.Sequence[PySide6.QtGraphs.QBarSet] | None = ...,
    ) -> None: ...
    @typing.overload
...
class QBarSet(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        selectedColor: PySide6.QtGui.QColor | None = ...,
        borderColor: PySide6.QtGui.QColor | None = ...,
        labelColor: PySide6.QtGui.QColor | None = ...,
        values: collections.abc.Sequence[typing.Any] | None = ...,
        borderWidth: float | None = ...,
        count: int | None = ...,
        selectedBars: collections.abc.Sequence[int] | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QCategory3DAxis(PySide6.QtGraphs.QAbstract3DAxis):
    ...
    def __init__(
        self, /, parent: PySide6.QtCore.QObject | None = ..., *, labels: collections.abc.Sequence[str] | None = ...
    ) -> None: ...
    def labels(self, /) -> typing.List[str]: ...
    def setLabels(self, labels: collections.abc.Sequence[str], /) -> None: ...
...
class QCustom3DItem(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        texture: PySide6.QtGui.QImage,
        /,
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        textureFile: str | None = ...,
        positionAbsolute: bool | None = ...,
        visible: bool | None = ...,
        shadowCasting: bool | None = ...,
        scalingAbsolute: bool | None = ...,
        rotationAbsolute: bool | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        *,
        ...
        positionAbsolute: bool | None = ...,
        scaling: PySide6.QtGui.QVector3D | None = ...,
        rotation: PySide6.QtGui.QQuaternion | None = ...,
        visible: bool | None = ...,
        shadowCasting: bool | None = ...,
        scalingAbsolute: bool | None = ...,
        rotationAbsolute: bool | None = ...,
...
class QCustom3DLabel(PySide6.QtGraphs.QCustom3DItem):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        textColor: PySide6.QtGui.QColor | None = ...,
        backgroundColor: PySide6.QtGui.QColor | None = ...,
        borderVisible: bool | None = ...,
        backgroundVisible: bool | None = ...,
        facingCamera: bool | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QCustom3DVolume(PySide6.QtGraphs.QCustom3DItem):
    ...
    def __init__(
        ...
        textureHeight: int,
        textureDepth: int,
        textureData: collections.abc.Sequence[int],
        textureFormat: PySide6.QtGui.QImage.Format,
        colorTable: collections.abc.Sequence[int],
        /,
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        sliceIndexX: int | None = ...,
        sliceIndexY: int | None = ...,
        sliceIndexZ: int | None = ...,
        alphaMultiplier: float | None = ...,
        preserveOpacity: bool | None = ...,
        useHighDefShader: bool | None = ...,
        drawSlices: bool | None = ...,
        drawSliceFrames: bool | None = ...,
        sliceFrameColor: PySide6.QtGui.QColor | None = ...,
        sliceFrameWidths: PySide6.QtGui.QVector3D | None = ...,
        sliceFrameGaps: PySide6.QtGui.QVector3D | None = ...,
        sliceFrameThicknesses: PySide6.QtGui.QVector3D | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        *,
        ...
        textureDepth: int | None = ...,
        sliceIndexX: int | None = ...,
        sliceIndexY: int | None = ...,
        sliceIndexZ: int | None = ...,
        colorTable: collections.abc.Sequence[int] | None = ...,
        textureData: collections.abc.Sequence[int] | None = ...,
        alphaMultiplier: float | None = ...,
        preserveOpacity: bool | None = ...,
        useHighDefShader: bool | None = ...,
        drawSlices: bool | None = ...,
...
class QCustomSeries(PySide6.QtGraphs.QAbstractSeries):
    ...
    def __init__(
        self, /, parent: PySide6.QtCore.QObject | None = ..., *, delegate: PySide6.QtQml.QQmlComponent | None = ...
    ) -> None: ...
    @typing.overload
...
class QDateTimeAxis(PySide6.QtGraphs.QAbstractAxis):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        min: PySide6.QtCore.QDateTime | None = ...,
        max: PySide6.QtCore.QDateTime | None = ...,
        labelFormat: str | None = ...,
        subTickCount: int | None = ...,
        tickInterval: float | None = ...,
        timeZone: PySide6.QtCore.QTimeZone | None = ...,
        zoom: float | None = ...,
        pan: float | None = ...,
        visualMin: PySide6.QtCore.QDateTime | None = ...,
        visualMax: PySide6.QtCore.QDateTime | None = ...,
    ) -> None: ...
...
class QGraphsLine(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtGraphs.QGraphsLine,
        /,
        *,
        mainColor: PySide6.QtGui.QColor | None = ...,
        subColor: PySide6.QtGui.QColor | None = ...,
        mainWidth: float | None = ...,
        subWidth: float | None = ...,
        labelTextColor: PySide6.QtGui.QColor | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QGraphsTheme(PySide6.QtCore.QObject, PySide6.QtQml.QQmlParserStatus):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        colorScheme: PySide6.QtGraphs.QGraphsTheme.ColorScheme | None = ...,
        theme: PySide6.QtGraphs.QGraphsTheme.Theme | None = ...,
        colorStyle: PySide6.QtGraphs.QGraphsTheme.ColorStyle | None = ...,
        backgroundColor: PySide6.QtGui.QColor | None = ...,
        backgroundVisible: bool | None = ...,
        plotAreaBackgroundColor: PySide6.QtGui.QColor | None = ...,
        plotAreaBackgroundVisible: bool | None = ...,
        gridVisible: bool | None = ...,
        axisXLabelFont: PySide6.QtGui.QFont | None = ...,
        axisYLabelFont: PySide6.QtGui.QFont | None = ...,
        axisZLabelFont: PySide6.QtGui.QFont | None = ...,
        grid: PySide6.QtGraphs.QGraphsLine | None = ...,
        axisX: PySide6.QtGraphs.QGraphsLine | None = ...,
        axisY: PySide6.QtGraphs.QGraphsLine | None = ...,
        axisZ: PySide6.QtGraphs.QGraphsLine | None = ...,
        labelFont: PySide6.QtGui.QFont | None = ...,
        labelsVisible: bool | None = ...,
        labelBackgroundColor: PySide6.QtGui.QColor | None = ...,
        labelTextColor: PySide6.QtGui.QColor | None = ...,
        labelBackgroundVisible: bool | None = ...,
        labelBorderVisible: bool | None = ...,
        seriesColors: collections.abc.Sequence[PySide6.QtGui.QColor] | None = ...,
        borderColors: collections.abc.Sequence[PySide6.QtGui.QColor] | None = ...,
        borderWidth: float | None = ...,
        singleHighlightColor: PySide6.QtGui.QColor | None = ...,
        multiHighlightColor: PySide6.QtGui.QColor | None = ...,
    ) -> None: ...
    ...
    def setBackgroundColor(
        self,
        newBackgroundColor: typing.Union[
            PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, typing.Any, PySide6.QtCore.Qt.GlobalColor, int
        ],
        /,
    ) -> None: ...
    ...
    def setLabelBackgroundColor(
        self,
        newLabelBackgroundColor: typing.Union[
            PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, typing.Any, PySide6.QtCore.Qt.GlobalColor, int
        ],
        /,
    ) -> None: ...
    ...
    def setLabelTextColor(
        self,
        newLabelTextColor: typing.Union[
            PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, typing.Any, PySide6.QtCore.Qt.GlobalColor, int
        ],
        /,
    ) -> None: ...
    ...
    def setMultiHighlightColor(
        self,
        newMultiHighlightColor: typing.Union[
            PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, typing.Any, PySide6.QtCore.Qt.GlobalColor, int
        ],
        /,
    ) -> None: ...
    ...
    def setSingleHighlightColor(
        self,
        newSingleHighlightColor: typing.Union[
            PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, typing.Any, PySide6.QtCore.Qt.GlobalColor, int
        ],
        /,
    ) -> None: ...
    def setSingleHighlightGradient(self, gradient: PySide6.QtGui.QLinearGradient, /) -> None: ...
    def setTheme(
        self, newTheme: PySide6.QtGraphs.QGraphsTheme.Theme, /, force: PySide6.QtGraphs.QGraphsTheme.ForceTheme = ...
    ) -> None: ...
    def singleHighlightColor(self, /) -> PySide6.QtGui.QColor: ...
    def singleHighlightGradient(self, /) -> PySide6.QtGui.QLinearGradient: ...
...
class QHeightMapSurfaceDataProxy(PySide6.QtGraphs.QSurfaceDataProxy):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        heightMap: PySide6.QtGui.QImage | None = ...,
        heightMapFile: str | None = ...,
        minXValue: float | None = ...,
        maxXValue: float | None = ...,
        minZValue: float | None = ...,
        maxZValue: float | None = ...,
        minYValue: float | None = ...,
        maxYValue: float | None = ...,
        autoScaleY: bool | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QItemModelBarDataProxy(PySide6.QtGraphs.QBarDataProxy):
    ...
    def __init__(
        ...
        valueRole: str,
        rotationRole: str,
        rowCategories: collections.abc.Sequence[str],
        columnCategories: collections.abc.Sequence[str],
        /,
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        useModelCategories: bool | None = ...,
        autoRowCategories: bool | None = ...,
        autoColumnCategories: bool | None = ...,
        rowRolePattern: PySide6.QtCore.QRegularExpression | None = ...,
        columnRolePattern: PySide6.QtCore.QRegularExpression | None = ...,
        valueRolePattern: PySide6.QtCore.QRegularExpression | None = ...,
        rotationRolePattern: PySide6.QtCore.QRegularExpression | None = ...,
        rowRoleReplace: str | None = ...,
        columnRoleReplace: str | None = ...,
        valueRoleReplace: str | None = ...,
        rotationRoleReplace: str | None = ...,
        multiMatchBehavior: PySide6.QtGraphs.QItemModelBarDataProxy.MultiMatchBehavior | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        rowCategories: collections.abc.Sequence[str] | None = ...,
        columnCategories: collections.abc.Sequence[str] | None = ...,
        useModelCategories: bool | None = ...,
        autoRowCategories: bool | None = ...,
        autoColumnCategories: bool | None = ...,
        rowRolePattern: PySide6.QtCore.QRegularExpression | None = ...,
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        itemModel: PySide6.QtCore.QAbstractItemModel | None = ...,
        rowRole: str | None = ...,
        columnRole: str | None = ...,
        valueRole: str | None = ...,
        rotationRole: str | None = ...,
...
class QItemModelScatterDataProxy(PySide6.QtGraphs.QScatterDataProxy):
    ...
    def __init__(
        ...
        *,
        scaleRole: str | None = ...,
        xPosRolePattern: PySide6.QtCore.QRegularExpression | None = ...,
        yPosRolePattern: PySide6.QtCore.QRegularExpression | None = ...,
        zPosRolePattern: PySide6.QtCore.QRegularExpression | None = ...,
        rotationRolePattern: PySide6.QtCore.QRegularExpression | None = ...,
        scaleRolePattern: PySide6.QtCore.QRegularExpression | None = ...,
        xPosRoleReplace: str | None = ...,
        yPosRoleReplace: str | None = ...,
        zPosRoleReplace: str | None = ...,
        rotationRoleReplace: str | None = ...,
        scaleRoleReplace: str | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QItemModelSurfaceDataProxy(PySide6.QtGraphs.QSurfaceDataProxy):
    ...
    def __init__(
        ...
        *,
        ...
        yPosRoleReplace: str | None = ...,
        zPosRoleReplace: str | None = ...,
        multiMatchBehavior: PySide6.QtGraphs.QItemModelSurfaceDataProxy.MultiMatchBehavior | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QLineSeries(PySide6.QtGraphs.QXYSeries):
    ...
    def __init__(
        ...
        *,
        width: float | None = ...,
        capStyle: PySide6.QtCore.Qt.PenCapStyle | None = ...,
        joinStyle: PySide6.QtCore.Qt.PenJoinStyle | None = ...,
        lineStyle: PySide6.QtGraphs.QLineSeries.LineStyle | None = ...,
        strokeStyle: PySide6.QtGraphs.QLineSeries.StrokeStyle | None = ...,
        dashOffset: float | None = ...,
        dashPattern: collections.abc.Sequence[float] | None = ...,
    ) -> None: ...
...
class QLogValue3DAxisFormatter(PySide6.QtGraphs.QValue3DAxisFormatter):
    ...
    def __init__(
        ...
        *,
        base: float | None = ...,
        autoSubGrid: bool | None = ...,
        edgeLabelsVisible: bool | None = ...,
    ) -> None: ...
...
class QPieModelMapper(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        series: PySide6.QtGraphs.QPieSeries | None = ...,
        model: PySide6.QtCore.QAbstractItemModel | None = ...,
        valuesSection: int | None = ...,
        labelsSection: int | None = ...,
        first: int | None = ...,
        count: int | None = ...,
        orientation: PySide6.QtCore.Qt.Orientation | None = ...,
    ) -> None: ...
...
class QPieSeries(PySide6.QtGraphs.QAbstractSeries):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        horizontalPosition: float | None = ...,
        verticalPosition: float | None = ...,
        pieSize: float | None = ...,
        ...
        sum: float | None = ...,
        holeSize: float | None = ...,
        angleSpanVisibleLimit: float | None = ...,
        angleSpanLabelVisibility: PySide6.QtGraphs.QPieSeries.LabelVisibility | None = ...,
    ) -> None: ...
...
class QPieSlice(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        labelVisible: bool | None = ...,
        labelPosition: PySide6.QtGraphs.QPieSlice.LabelPosition | None = ...,
        labelColor: PySide6.QtGui.QColor | None = ...,
        labelFont: PySide6.QtGui.QFont | None = ...,
        labelArmLengthFactor: float | None = ...,
        color: PySide6.QtGui.QColor | None = ...,
        borderColor: PySide6.QtGui.QColor | None = ...,
        borderWidth: float | None = ...,
        exploded: bool | None = ...,
        explodeDistanceFactor: float | None = ...,
        percentage: float | None = ...,
        startAngle: float | None = ...,
        angleSpan: float | None = ...,
        subSlicesCount: int | None = ...,
        subSlicesSum: float | None = ...,
        subSlicesRatio: float | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QScatter3DSeries(PySide6.QtGraphs.QAbstract3DSeries):
    ...
    def __init__(
        self,
        dataProxy: PySide6.QtGraphs.QScatterDataProxy,
        /,
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        selectedItem: int | None = ...,
        itemSize: float | None = ...,
        dataArray: collections.abc.Sequence[PySide6.QtGraphs.QScatterDataItem] | None = ...,
        scaleArray: collections.abc.Sequence[PySide6.QtGui.QVector3D] | None = ...,
        axisX: PySide6.QtGraphs.QValue3DAxis | None = ...,
        axisY: PySide6.QtGraphs.QValue3DAxis | None = ...,
        axisZ: PySide6.QtGraphs.QValue3DAxis | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        dataProxy: PySide6.QtGraphs.QScatterDataProxy | None = ...,
        selectedItem: int | None = ...,
        itemSize: float | None = ...,
        dataArray: collections.abc.Sequence[PySide6.QtGraphs.QScatterDataItem] | None = ...,
        scaleArray: collections.abc.Sequence[PySide6.QtGui.QVector3D] | None = ...,
...
class QScatterDataProxy(PySide6.QtGraphs.QAbstractDataProxy):
    ...
    def __init__(
        ...
        *,
        itemCount: int | None = ...,
        series: PySide6.QtGraphs.QScatter3DSeries | None = ...,
    ) -> None: ...
...
class QSpline3DSeries(PySide6.QtGraphs.QScatter3DSeries):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        splineVisible: bool | None = ...,
        splineTension: float | None = ...,
        splineKnotting: float | None = ...,
        splineLooping: bool | None = ...,
        splineColor: PySide6.QtGui.QColor | None = ...,
        splineResolution: int | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QSurface3DSeries(PySide6.QtGraphs.QAbstract3DSeries):
    ...
    def __init__(
        self,
        dataProxy: PySide6.QtGraphs.QSurfaceDataProxy,
        /,
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        selectedPoint: PySide6.QtCore.QPoint | None = ...,
        flatShadingSupported: bool | None = ...,
        drawMode: PySide6.QtGraphs.QSurface3DSeries.DrawFlag | None = ...,
        shading: PySide6.QtGraphs.QSurface3DSeries.Shading | None = ...,
        texture: PySide6.QtGui.QImage | None = ...,
        textureFile: str | None = ...,
        wireframeColor: PySide6.QtGui.QColor | None = ...,
        dataArray: collections.abc.Sequence[collections.abc.Sequence[PySide6.QtGraphs.QSurfaceDataItem]] | None = ...,
        rowsSanitized: bool | None = ...,
        axisX: PySide6.QtGraphs.QValue3DAxis | None = ...,
        axisY: PySide6.QtGraphs.QValue3DAxis | None = ...,
        axisZ: PySide6.QtGraphs.QValue3DAxis | None = ...,
    ) -> None: ...
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        dataProxy: PySide6.QtGraphs.QSurfaceDataProxy | None = ...,
        selectedPoint: PySide6.QtCore.QPoint | None = ...,
        flatShadingSupported: bool | None = ...,
        drawMode: PySide6.QtGraphs.QSurface3DSeries.DrawFlag | None = ...,
        shading: PySide6.QtGraphs.QSurface3DSeries.Shading | None = ...,
    ...
    def setAxisZ(self, axis: PySide6.QtGraphs.QValue3DAxis, /) -> None: ...
    def setDataArray(
        self, newDataArray: collections.abc.Sequence[collections.abc.Sequence[PySide6.QtGraphs.QSurfaceDataItem]], /
    ) -> None: ...
...
class QSurfaceDataProxy(PySide6.QtGraphs.QAbstractDataProxy):
    ...
    def __init__(
        ...
        *,
        ...
        series: PySide6.QtGraphs.QSurface3DSeries | None = ...,
    ) -> None: ...
    def addRow(self, row: collections.abc.Sequence[PySide6.QtGraphs.QSurfaceDataItem], /) -> int: ...
    def addRows(
        self, rows: collections.abc.Sequence[collections.abc.Sequence[PySide6.QtGraphs.QSurfaceDataItem]], /
    ) -> int: ...
    def columnCount(self, /) -> int: ...
    def insertRow(self, rowIndex: int, row: collections.abc.Sequence[PySide6.QtGraphs.QSurfaceDataItem], /) -> None: ...
    def insertRows(
        self, rowIndex: int, rows: collections.abc.Sequence[collections.abc.Sequence[PySide6.QtGraphs.QSurfaceDataItem]], /
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def resetArray(
        self, newArray: collections.abc.Sequence[collections.abc.Sequence[PySide6.QtGraphs.QSurfaceDataItem]], /
    ) -> None: ...
    def resetArrayNp(
        self, x: float, deltaX: float, z: float, deltaZ: float, data: collections.abc.Sequence[typing.Any], /
    ) -> None: ...
    def rowCount(self, /) -> int: ...
...
class QValue3DAxis(PySide6.QtGraphs.QAbstract3DAxis):
    ...
    def __init__(
        ...
        *,
        ...
        subSegmentCount: int | None = ...,
        labelFormat: str | None = ...,
        formatter: PySide6.QtGraphs.QValue3DAxisFormatter | None = ...,
        reversed: bool | None = ...,
    ) -> None: ...
...
class QValueAxis(PySide6.QtGraphs.QAbstractAxis):
    ...
    def __init__(
        ...
        *,
        ...
        max: float | None = ...,
        labelFormat: str | None = ...,
        labelDecimals: int | None = ...,
        subTickCount: int | None = ...,
        tickAnchor: float | None = ...,
        tickInterval: float | None = ...,
        zoom: float | None = ...,
        pan: float | None = ...,
        visualMin: float | None = ...,
        visualMax: float | None = ...,
    ) -> None: ...
...
class QXYModelMapper(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        series: PySide6.QtGraphs.QXYSeries | None = ...,
        model: PySide6.QtCore.QAbstractItemModel | None = ...,
        xSection: int | None = ...,
        ySection: int | None = ...,
        first: int | None = ...,
...
class QXYSeries(PySide6.QtGraphs.QAbstractSeries):
    ...
    def insert(
        self, index: int, point: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element, /
    ) -> None: ...
    ...
    def replace(
        self,
        oldPoint: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        newPoint: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        /,
    ) -> None: ...
    @typing.overload
    def replace(
        self, index: int, newPoint: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element, /
    ) -> None: ...
    @typing.overload
