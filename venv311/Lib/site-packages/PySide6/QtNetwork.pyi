...
class QAbstractSocket(PySide6.QtCore.QIODevice):
    ...
    def __init__(
        self, socketType: PySide6.QtNetwork.QAbstractSocket.SocketType, parent: PySide6.QtCore.QObject, /
    ) -> None: ...
    def abort(self, /) -> None: ...
    @typing.overload
    def bind(
        self,
        address: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress,
        /,
        port: int | None = ...,
        mode: PySide6.QtNetwork.QAbstractSocket.BindFlag = ...,
    ) -> bool: ...
    @typing.overload
    ...
    def setLocalAddress(
        self, address: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, /
    ) -> None: ...
    ...
    def setProxy(
        self, networkProxy: PySide6.QtNetwork.QNetworkProxy | PySide6.QtNetwork.QNetworkProxy.ProxyType, /
    ) -> None: ...
...
class QDnsLookup(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        name: str,
        protocol: PySide6.QtNetwork.QDnsLookup.Protocol,
        nameserver: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress,
        /,
        port: int | None = ...,
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        error: PySide6.QtNetwork.QDnsLookup.Error | None = ...,
        authenticData: bool | None = ...,
        errorString: str | None = ...,
        nameserverPort: int | None = ...,
        nameserverProtocol: PySide6.QtNetwork.QDnsLookup.Protocol | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def __init__(
        ...
        *,
        ...
        authenticData: bool | None = ...,
        errorString: str | None = ...,
        nameserver: PySide6.QtNetwork.QHostAddress | None = ...,
        nameserverPort: int | None = ...,
        nameserverProtocol: PySide6.QtNetwork.QDnsLookup.Protocol | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        ...
        *,
        ...
        errorString: str | None = ...,
        name: str | None = ...,
        type: PySide6.QtNetwork.QDnsLookup.Type | None = ...,
        nameserver: PySide6.QtNetwork.QHostAddress | None = ...,
        nameserverPort: int | None = ...,
        nameserverProtocol: PySide6.QtNetwork.QDnsLookup.Protocol | None = ...,
    ) -> None: ...
    ...
    @typing.overload
    def setNameserver(
        self, nameserver: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, /
    ) -> None: ...
    @typing.overload
    def setNameserver(
        self, nameserver: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, port: int, /
    ) -> None: ...
...
class QDtls(PySide6.QtCore.QObject):
    ...
    def decryptDatagram(
        self, socket: PySide6.QtNetwork.QUdpSocket, dgram: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
...
class QDtlsClientVerifier(PySide6.QtCore.QObject):
    class GeneratorParameters(Shiboken.Object):
        ...
        def __init__(
            self,
            a: PySide6.QtCore.QCryptographicHash.Algorithm,
            s: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
            /,
        ) -> None: ...
        @typing.overload
    ...
    def verifyClient(
        ...
        dgram: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        address: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress,
        port: int,
        /,
    ) -> bool: ...
...
class QFormDataPartBuilder(Shiboken.Object):
    def __init__(self, /) -> None: ...
    def setBody(
        self, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /, fileName: str = ..., mimeType: str = ...
    ) -> PySide6.QtNetwork.QFormDataPartBuilder: ...
    def setBodyDevice(
        self, body: PySide6.QtCore.QIODevice, /, fileName: str = ..., mimeType: str = ...
    ) -> PySide6.QtNetwork.QFormDataPartBuilder: ...
...
class QHostAddress(Shiboken.Object):
    ...
    def isEqual(
        ...
        address: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress,
        /,
        mode: PySide6.QtNetwork.QHostAddress.ConversionModeFlag = ...,
    ) -> bool: ...
    def isGlobal(self, /) -> bool: ...
    @typing.overload
    def isInSubnet(
        self, subnet: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, netmask: int, /
    ) -> bool: ...
    @typing.overload
...
class QHstsPolicy(Shiboken.Object):
    ...
    def __init__(
        ...
        flags: PySide6.QtNetwork.QHstsPolicy.PolicyFlag,
        host: str,
        /,
...
class QHttpHeaders(Shiboken.Object):
    ...
    @staticmethod
    def fromListOfPairs(
        headers: collections.abc.Sequence[typing.Tuple[PySide6.QtCore.QByteArray, PySide6.QtCore.QByteArray]], /
    ) -> PySide6.QtNetwork.QHttpHeaders: ...
    @staticmethod
    def fromMultiHash(
        headers: typing.Dict[PySide6.QtCore.QByteArray, PySide6.QtCore.QByteArray], /
    ) -> PySide6.QtNetwork.QHttpHeaders: ...
    @staticmethod
    def fromMultiMap(
        headers: typing.Dict[PySide6.QtCore.QByteArray, PySide6.QtCore.QByteArray], /
    ...
    def setDateTimeValue(
        self, name: PySide6.QtNetwork.QHttpHeaders.WellKnownHeader, dateTime: PySide6.QtCore.QDateTime, /
    ) -> None: ...
    @typing.overload
    ...
    def value(
        self,
        name: PySide6.QtNetwork.QHttpHeaders.WellKnownHeader,
        /,
        defaultValue: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...,
    ) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    def value(
        self, name: str, /, defaultValue: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...
    ) -> PySide6.QtCore.QByteArray: ...
...
class QHttpMultiPart(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, contentType: PySide6.QtNetwork.QHttpMultiPart.ContentType, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    @typing.overload
    def __init__(self, /, parent: PySide6.QtCore.QObject | None = ...) -> None: ...
...
class QHttpPart(Shiboken.Object):
    ...
    def setRawHeader(
        self,
        headerName: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        headerValue: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
    ) -> None: ...
...
class QLocalServer(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        socketOptions: PySide6.QtNetwork.QLocalServer.SocketOption | None = ...,
    ) -> None: ...
...
class QNetworkAccessManager(PySide6.QtCore.QObject):
    ...
    def addStrictTransportSecurityHosts(
        self, knownHosts: collections.abc.Sequence[PySide6.QtNetwork.QHstsPolicy], /
    ) -> None: ...
    ...
    def connectToHostEncrypted(
        self, hostName: str, /, port: int = ..., sslConfiguration: PySide6.QtNetwork.QSslConfiguration = ...
    ) -> None: ...
    @typing.overload
    def connectToHostEncrypted(
        self, hostName: str, port: int, sslConfiguration: PySide6.QtNetwork.QSslConfiguration, peerName: str, /
    ) -> None: ...
    ...
    @typing.overload
    def get(
        self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> PySide6.QtNetwork.QNetworkReply: ...
    ...
    @typing.overload
    def post(
        self, request: PySide6.QtNetwork.QNetworkRequest, multiPart: PySide6.QtNetwork.QHttpMultiPart, /
    ) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def post(
        self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ...
    def sendCustomRequest(
        self,
        request: PySide6.QtNetwork.QNetworkRequest,
        verb: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
...
class QNetworkAddressEntry(Shiboken.Object):
    ...
    def setAddressLifetime(
        self,
        preferred: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int,
        validity: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int,
        /,
    ) -> None: ...
    def setBroadcast(
        self, newBroadcast: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, /
    ) -> None: ...
    ...
    def setNetmask(
        self, newNetmask: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, /
    ) -> None: ...
...
class QNetworkCacheMetaData(Shiboken.Object):
    ...
    def setRawHeaders(
        self, headers: collections.abc.Sequence[typing.Tuple[PySide6.QtCore.QByteArray, PySide6.QtCore.QByteArray]], /
    ) -> None: ...
...
class QNetworkCookie(Shiboken.Object):
    ...
    def __init__(
        self,
        /,
        name: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...,
        value: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...,
    ) -> None: ...
    def __copy__(self, /) -> typing.Self: ...
    ...
    @staticmethod
    def parseCookies(
        cookieString: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
...
class QNetworkCookieJar(PySide6.QtCore.QObject):
    ...
    def setCookiesFromUrl(
        self, cookieList: collections.abc.Sequence[PySide6.QtNetwork.QNetworkCookie], url: PySide6.QtCore.QUrl | str, /
    ) -> bool: ...
...
class QNetworkDatagram(Shiboken.Object):
    ...
    def __init__(
        ...
        data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
        destinationAddress: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress = ...,
        port: int | None = ...,
    ) -> None: ...
    def __copy__(self, /) -> typing.Self: ...
    def clear(self, /) -> None: ...
    ...
    def isValid(self, /) -> bool: ...
    def makeReply(
        self, payload: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ...
    def setDestination(
        self, address: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, port: int, /
    ) -> None: ...
...
class QNetworkProxy(Shiboken.Object):
    ...
    def port(self, /) -> int: ...
    def rawHeader(
        self, headerName: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> PySide6.QtCore.QByteArray: ...
...
class QNetworkProxyFactory(Shiboken.Object):
    ...
    ) -> typing.List[PySide6.QtNetwork.QNetworkProxy]: ...
    def queryProxy(
        self, /, query: PySide6.QtNetwork.QNetworkProxyQuery | PySide6.QtCore.QUrl | int = ...
    ) -> typing.List[PySide6.QtNetwork.QNetworkProxy]: ...
    @staticmethod
...
class QNetworkProxyQuery(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, requestUrl: PySide6.QtCore.QUrl | str, /, queryType: PySide6.QtNetwork.QNetworkProxyQuery.QueryType = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, bindPort: int, /, protocolTag: str = ..., queryType: PySide6.QtNetwork.QNetworkProxyQuery.QueryType = ...
    ) -> None: ...
    def __copy__(self, /) -> typing.Self: ...
...
class QNetworkRequest(Shiboken.Object):
    ...
    def attribute(
        self, code: PySide6.QtNetwork.QNetworkRequest.Attribute, /, defaultValue: typing.Any = ...
    ) -> typing.Any: ...
...
class QPasswordDigestor(Shiboken.Object):
    ...
    def deriveKeyPbkdf1(
        ...
        password: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        salt: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        iterations: int,
        dkLen: int,
        /,
    ) -> PySide6.QtCore.QByteArray: ...
...
class QRestAccessManager(PySide6.QtCore.QObject):
    def __init__(
        self, manager: PySide6.QtNetwork.QNetworkAccessManager, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    @typing.overload
    def deleteResource(self, request: PySide6.QtNetwork.QNetworkRequest, /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def deleteResource(
        ...
        slot: collections.abc.Callable[..., typing.Any],
        /,
    ) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def get(self, request: PySide6.QtNetwork.QNetworkRequest, /) -> PySide6.QtNetwork.QNetworkReply: ...
    ...
    def get(
        self,
        request: PySide6.QtNetwork.QNetworkRequest,
        data: PySide6.QtCore.QJsonDocument,
        context: PySide6.QtCore.QObject,
        slot: collections.abc.Callable[..., typing.Any],
        /,
    ) -> PySide6.QtNetwork.QNetworkReply: ...
    ...
    @typing.overload
    def patch(
        self, request: PySide6.QtNetwork.QNetworkRequest, data: typing.Dict[str, typing.Any], /
    ) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def patch(
        self,
    ...
    @typing.overload
    def post(
        self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtNetwork.QHttpMultiPart, /
    ) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def post(
        self,
        request: PySide6.QtNetwork.QNetworkRequest,
        data: PySide6.QtNetwork.QHttpMultiPart,
        context: PySide6.QtCore.QObject,
        slot: collections.abc.Callable[..., typing.Any],
        /,
    ) -> PySide6.QtNetwork.QNetworkReply: ...
    ...
    def sendCustomRequest(
        self,
        request: PySide6.QtNetwork.QNetworkRequest,
        method: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        data: PySide6.QtCore.QIODevice,
        /,
    ) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
...
class QSslCertificate(Shiboken.Object):
    ...
    def fromData(
        ...
        /,
        format: PySide6.QtNetwork.QSsl.EncodingFormat = ...,
    ) -> typing.List[PySide6.QtNetwork.QSslCertificate]: ...
    @staticmethod
    def fromDevice(
        device: PySide6.QtCore.QIODevice, /, format: PySide6.QtNetwork.QSsl.EncodingFormat = ...
    ) -> typing.List[PySide6.QtNetwork.QSslCertificate]: ...
    @staticmethod
    def fromFile(
        filePath: str, /, format: PySide6.QtNetwork.QSsl.EncodingFormat = ...
    ) -> typing.List[PySide6.QtNetwork.QSslCertificate]: ...
    @staticmethod
    def fromPath(
        path: str,
    ...
    def importPkcs12(
        ...
        /,
        caCertificates: collections.abc.Sequence[PySide6.QtNetwork.QSslCertificate] | None = ...,
        passPhrase: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...,
    ) -> bool: ...
    ...
    def subjectAlternativeNames(
        self, /
    ) -> typing.OrderedDict[PySide6.QtNetwork.QSsl.AlternativeNameEntryType, typing.List[str]]: ...
    ...
    @staticmethod
    def verify(
        certificateChain: collections.abc.Sequence[PySide6.QtNetwork.QSslCertificate], /, hostName: str = ...
    ) -> typing.List[PySide6.QtNetwork.QSslError]: ...
...
class QSslConfiguration(Shiboken.Object):
    ...
    def setBackendConfiguration(
        self, /, backendConfiguration: typing.Dict[PySide6.QtCore.QByteArray, typing.Any] = ...
    ) -> None: ...
    def setBackendConfigurationOption(
        self, name: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, value: typing.Any, /
    ) -> None: ...
...
class QSslDiffieHellmanParameters(Shiboken.Object):
    ...
    @staticmethod
    def fromEncoded(
        encoded: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
        format: PySide6.QtNetwork.QSsl.EncodingFormat = ...,
    ) -> PySide6.QtNetwork.QSslDiffieHellmanParameters: ...
    def isEmpty(self, /) -> bool: ...
...
class QSslKey(Shiboken.Object):
    ...
    def toDer(
        self, /, passPhrase: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...
    ) -> PySide6.QtCore.QByteArray: ...
    def toPem(
        self, /, passPhrase: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...
    ) -> PySide6.QtCore.QByteArray: ...
...
class QUdpSocket(PySide6.QtNetwork.QAbstractSocket):
    ...
    def joinMulticastGroup(
        self, groupAddress: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, /
    ) -> bool: ...
    @typing.overload
    def joinMulticastGroup(
        self,
        groupAddress: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress,
    ...
    def writeDatagram(
        self,
        datagram: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        host: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress,
        port: int,
        /,
    ) -> int: ...
