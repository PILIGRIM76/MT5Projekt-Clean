...
class QCanvasGridPattern(PySide6.QtCanvasPainter.QCanvasBrush):
    ...
    def __init__(
        ...
        rect: PySide6.QtCore.QRectF | PySide6.QtCore.QRect,
        /,
        lineColor: typing.Union[
            PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, typing.Any, PySide6.QtCore.Qt.GlobalColor, int
        ] = ...,
        backgroundColor: typing.Union[
            PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, typing.Any, PySide6.QtCore.Qt.GlobalColor, int
        ] = ...,
        lineWidth: float = ...,
        feather: float = ...,
...
class QCanvasImagePattern(PySide6.QtCanvasPainter.QCanvasBrush):
    ...
    def __init__(
        self,
        image: PySide6.QtCanvasPainter.QCanvasImage,
        rect: PySide6.QtCore.QRectF | PySide6.QtCore.QRect,
        /,
        angle: float = ...,
        tintColor: typing.Union[
            PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, typing.Any, PySide6.QtCore.Qt.GlobalColor, int
        ] = ...,
    ) -> None: ...
    @typing.overload
...
class QCanvasLinearGradient(PySide6.QtCanvasPainter.QCanvasGradient):
    ...
    def __init__(
        ...
        end: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        /,
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setEndPosition(
        self, end: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element, /
    ) -> None: ...
    @typing.overload
...
class QCanvasPainter(Shiboken.Object):
    ...
    @typing.overload
    def addImage(
        self, image: PySide6.QtGui.QImage, /, flags: PySide6.QtCanvasPainter.QCanvasPainter.ImageFlag = ...
    ) -> PySide6.QtCanvasPainter.QCanvasImage: ...
    @typing.overload
    def addImage(
        self, texture: PySide6.QtGui.QRhiTexture, /, flags: PySide6.QtCanvasPainter.QCanvasPainter.ImageFlag = ...
    ) -> PySide6.QtCanvasPainter.QCanvasImage: ...
    @typing.overload
    def addImage(
        self,
        canvas: PySide6.QtCanvasPainter.QCanvasOffscreenCanvas,
        /,
        flags: PySide6.QtCanvasPainter.QCanvasPainter.ImageFlag = ...,
    ) -> PySide6.QtCanvasPainter.QCanvasImage: ...
    @typing.overload
    def addPath(self, path: PySide6.QtGui.QPainterPath, /) -> None: ...
    @typing.overload
    def addPath(
        self, path: PySide6.QtCanvasPainter.QCanvasPath | int, /, transform: PySide6.QtGui.QTransform = ...
    ) -> None: ...
    @typing.overload
    def addPath(
        self,
        path: PySide6.QtCanvasPainter.QCanvasPath | int,
        start: int,
        count: int,
        /,
    ...
    def arc(
        self,
        centerPoint: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        radius: float,
        a0: float,
        a1: float,
        /,
        direction: PySide6.QtCanvasPainter.QCanvasPainter.PathWinding = ...,
        connection: PySide6.QtCanvasPainter.QCanvasPainter.PathConnection = ...,
    ) -> None: ...
    @typing.overload
    def arc(
        self,
    ...
    def arcTo(
        self,
        controlPoint1: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        controlPoint2: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        radius: float,
        /,
    ) -> None: ...
    @typing.overload
    ...
    def bezierCurveTo(
        ...
        controlPoint1: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        controlPoint2: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        endPoint: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        /,
    ) -> None: ...
    @typing.overload
    ...
    def createCanvas(
        ...
        /,
        sampleCount: int = ...,
        flags: PySide6.QtCanvasPainter.QCanvasOffscreenCanvas.Flag = ...,
    ...
    @typing.overload
    def drawImage(
        self, image: PySide6.QtCanvasPainter.QCanvasImage, destinationRect: PySide6.QtCore.QRectF | PySide6.QtCore.QRect, /
    ) -> None: ...
    @typing.overload
    def drawImage(
        self,
        ...
        destinationRect: PySide6.QtCore.QRectF | PySide6.QtCore.QRect,
        /,
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawImage(
        self, image: PySide6.QtCanvasPainter.QCanvasImage, x: float, y: float, width: float, height: float, /
    ) -> None: ...
    @typing.overload
    ...
    def quadraticCurveTo(
        self,
        controlPoint: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        endPoint: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        /,
    ) -> None: ...
    @typing.overload
...
class QCanvasPainterItem(PySide6.QtQuick.QQuickRhiItem):
    ...
    def __init__(
        ...
        *,
        ...
        debug: typing.Optional[typing.Dict[str, typing.Any]] = ...,
    ) -> None: ...
...
class QCanvasPath(Shiboken.Object):
    ...
    def setPathWinding(self, winding: PySide6.QtCanvasPainter.QCanvasPainter.PathWinding, /) -> None: ...
    def sliced(
        self, start: int, count: int, /, transform: PySide6.QtGui.QTransform = ...
...
class QCanvasRhiPaintDriver(Shiboken.Object):
    ...
    def beginPaint(
        self,
        cb: PySide6.QtGui.QRhiCommandBuffer,
        rt: PySide6.QtGui.QRhiRenderTarget,
        matrix: PySide6.QtGui.QMatrix4x4 | PySide6.QtGui.QTransform,
        /,
        flags: PySide6.QtCanvasPainter.QCanvasRhiPaintDriver.BeginPaintFlag = ...,
    ) -> None: ...
    @typing.overload
    def beginPaint(
        self,
        ...
        logicalSize: PySide6.QtCore.QSize = ...,
        dpr: float = ...,
        flags: PySide6.QtCanvasPainter.QCanvasRhiPaintDriver.BeginPaintFlag = ...,
    ) -> None: ...
    @typing.overload
