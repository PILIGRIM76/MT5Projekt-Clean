...
class QTextToSpeech(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        state: PySide6.QtTextToSpeech.QTextToSpeech.State | None = ...,
        volume: float | None = ...,
        rate: float | None = ...,
        pitch: float | None = ...,
        locale: PySide6.QtCore.QLocale | None = ...,
        voice: PySide6.QtTextToSpeech.QVoice | None = ...,
        engineCapabilities: PySide6.QtTextToSpeech.QTextToSpeech.Capability | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    ) -> typing.List[PySide6.QtTextToSpeech.QVoice]: ...
    @staticmethod
...
class QTextToSpeechEngine(PySide6.QtCore.QObject):
    ...
    def createVoice(
        ...
        gender: PySide6.QtTextToSpeech.QVoice.Gender,
        age: PySide6.QtTextToSpeech.QVoice.Age,
        data: typing.Any,
        /,
...
class QVoice(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtTextToSpeech.QVoice,
        /,
        *,
        name: str | None = ...,
        gender: PySide6.QtTextToSpeech.QVoice.Gender | None = ...,
        age: PySide6.QtTextToSpeech.QVoice.Age | None = ...,
        locale: PySide6.QtCore.QLocale | None = ...,
        language: PySide6.QtCore.QLocale.Language | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
