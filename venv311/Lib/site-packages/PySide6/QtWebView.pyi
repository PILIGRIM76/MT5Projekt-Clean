...
class QWebView(PySide6.QtGui.QWindow):
    ...
    def __init__(
        ...
        /,
        *,
        httpUserAgentString: str | None = ...,
        url: PySide6.QtCore.QUrl | None = ...,
        loading: bool | None = ...,
        loadProgress: int | None = ...,
        title: str | None = ...,
        settings: PySide6.QtWebView.QWebViewSettings | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QWebViewLoadingInfo(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtWebView.QWebViewLoadingInfo,
        /,
        *,
        url: PySide6.QtCore.QUrl | None = ...,
        status: PySide6.QtWebView.QWebViewLoadingInfo.LoadStatus | None = ...,
