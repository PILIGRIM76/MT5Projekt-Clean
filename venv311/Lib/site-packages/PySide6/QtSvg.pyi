...
class QSvgGenerator(PySide6.QtGui.QPaintDevice):
    ...
    def __init__(
        self,
        version: PySide6.QtSvg.QSvgGenerator.SvgVersion,
        /,
        *,
        size: PySide6.QtCore.QSize | None = ...,
        viewBox: PySide6.QtCore.QRectF | None = ...,
        title: str | None = ...,
        description: str | None = ...,
        fileName: str | None = ...,
        outputDevice: PySide6.QtCore.QIODevice | None = ...,
        resolution: int | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
...
class QSvgRenderer(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        aspectRatioMode: PySide6.QtCore.Qt.AspectRatioMode | None = ...,
        options: PySide6.QtSvg.QtSvg.Option | None = ...,
        animationEnabled: bool | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def __init__(
        self,
        contents: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        viewBox: PySide6.QtCore.QRectF | None = ...,
    ...
    @typing.overload
    def render(
        self, p: PySide6.QtGui.QPainter, elementId: str, /, bounds: PySide6.QtCore.QRectF | PySide6.QtCore.QRect = ...
    ) -> None: ...
    @typing.overload
