...
class QGeoAreaMonitorSource(PySide6.QtCore.QObject):
    ...
    ) -> typing.List[PySide6.QtPositioning.QGeoAreaMonitorInfo]: ...
    @staticmethod
    ...
    def requestUpdate(
        self, monitor: PySide6.QtPositioning.QGeoAreaMonitorInfo | str, signal: bytes | bytearray | memoryview, /
    ) -> bool: ...
...
class QGeoCircle(PySide6.QtPositioning.QGeoShape):
    ...
    def __init__(
        self,
        other: PySide6.QtPositioning.QGeoCircle,
        /,
        *,
        center: PySide6.QtPositioning.QGeoCoordinate | None = ...,
        radius: float | None = ...,
    ) -> None: ...
    @typing.overload
    ...
    def __init__(
        self,
        other: PySide6.QtPositioning.QGeoShape,
        /,
        *,
        center: PySide6.QtPositioning.QGeoCoordinate | None = ...,
        radius: float | None = ...,
    ...
    @typing.overload
    def __init__(
        self, /, *, center: PySide6.QtPositioning.QGeoCoordinate | None = ..., radius: float | None = ...
    ) -> None: ...
    def __copy__(self, /) -> typing.Self: ...
...
class QGeoCoordinate(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtPositioning.QGeoCoordinate,
        /,
        *,
        latitude: float | None = ...,
    ...
    @typing.overload
    def __init__(
        self, latitude: float, longitude: float, /, *, altitude: float | None = ..., isValid: bool | None = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QGeoPath(PySide6.QtPositioning.QGeoShape):
    ...
    def __init__(
        self,
        other: PySide6.QtPositioning.QGeoPath,
        /,
        *,
        path: collections.abc.Sequence[typing.Any] | None = ...,
        width: float | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
    ...
    @typing.overload
    def __init__(
        self, path: collections.abc.Sequence[PySide6.QtPositioning.QGeoCoordinate], /, width: float = ...
    ) -> None: ...
    @typing.overload
...
class QGeoPolygon(PySide6.QtPositioning.QGeoShape):
    ...
    def __init__(
        self,
        other: PySide6.QtPositioning.QGeoPolygon,
        /,
        *,
        perimeter: collections.abc.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def __init__(
        self,
        path: collections.abc.Sequence[PySide6.QtPositioning.QGeoCoordinate],
        /,
        *,
        perimeter: collections.abc.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self, /, *, perimeter: collections.abc.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None = ...
    ) -> None: ...
    def __copy__(self, /) -> typing.Self: ...
    def __lshift__(self, stream: PySide6.QtCore.QDataStream, /) -> PySide6.QtCore.QDataStream: ...
    def __rshift__(self, stream: PySide6.QtCore.QDataStream, /) -> PySide6.QtCore.QDataStream: ...
...
class QGeoPositionInfoSource(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        minimumUpdateInterval: int | None = ...,
        sourceName: str | None = ...,
        preferredPositioningMethods: PySide6.QtPositioning.QGeoPositionInfoSource.PositioningMethod | None = ...,
    ) -> None: ...
    @staticmethod
    def availableSources() -> typing.List[str]: ...
    def backendProperty(self, name: str, /) -> typing.Any: ...
    ...
    def createDefaultSource(
        parameters: typing.Dict[str, typing.Any], parent: PySide6.QtCore.QObject, /
    ...
    @staticmethod
    def createSource(
        sourceName: str, parameters: typing.Dict[str, typing.Any], parent: PySide6.QtCore.QObject, /
    ) -> PySide6.QtPositioning.QGeoPositionInfoSource: ...
    ...
    def setPreferredPositioningMethods(
        self, methods: PySide6.QtPositioning.QGeoPositionInfoSource.PositioningMethod, /
    ) -> None: ...
...
class QGeoPositionInfoSourceFactory(Shiboken.Object):
    def __init__(self, /) -> None: ...
    def areaMonitor(
        self, parent: PySide6.QtCore.QObject, parameters: typing.Dict[str, typing.Any], /
...
class QGeoRectangle(PySide6.QtPositioning.QGeoShape):
    ...
    def __init__(
        self,
        other: PySide6.QtPositioning.QGeoRectangle,
        /,
        *,
        bottomLeft: PySide6.QtPositioning.QGeoCoordinate | None = ...,
        bottomRight: PySide6.QtPositioning.QGeoCoordinate | None = ...,
        topLeft: PySide6.QtPositioning.QGeoCoordinate | None = ...,
        topRight: PySide6.QtPositioning.QGeoCoordinate | None = ...,
        center: PySide6.QtPositioning.QGeoCoordinate | None = ...,
        height: float | None = ...,
        width: float | None = ...,
    ) -> None: ...
    ...
    def __init__(
        self,
        coordinates: collections.abc.Sequence[PySide6.QtPositioning.QGeoCoordinate],
        /,
        *,
        bottomLeft: PySide6.QtPositioning.QGeoCoordinate | None = ...,
        bottomRight: PySide6.QtPositioning.QGeoCoordinate | None = ...,
...
class QGeoSatelliteInfo(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtPositioning.QGeoSatelliteInfo,
        /,
        *,
        satelliteSystem: PySide6.QtPositioning.QGeoSatelliteInfo.SatelliteSystem | None = ...,
        satelliteIdentifier: int | None = ...,
...
class QGeoSatelliteInfoSource(PySide6.QtCore.QObject):
    ...
    def __init__(
        self, parent: PySide6.QtCore.QObject, /, *, updateInterval: int | None = ..., minimumUpdateInterval: int | None = ...
    ) -> None: ...
    @staticmethod
    def availableSources() -> typing.List[str]: ...
    def backendProperty(self, name: str, /) -> typing.Any: ...
...
class QGeoShape(Shiboken.Object):
    ...
    def __init__(
        ...
        /,
        *,
        type: PySide6.QtPositioning.QGeoShape.ShapeType | None = ...,
        isValid: bool | None = ...,
        isEmpty: bool | None = ...,
        center: PySide6.QtPositioning.QGeoCoordinate | None = ...,
    ) -> None: ...
...
class QNmeaPositionInfoSource(PySide6.QtPositioning.QGeoPositionInfoSource):
    ...
    def parsePosInfoFromNmeaData(
        self, data: bytes | bytearray | memoryview, size: int, posInfo: PySide6.QtPositioning.QGeoPositionInfo, /
    ) -> typing.Tuple[bool, bool]: ...
    @typing.overload
    def parsePosInfoFromNmeaData(
        self,
        data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        posInfo: PySide6.QtPositioning.QGeoPositionInfo,
        /,
    ) -> typing.Tuple[bool, bool]: ...
    def requestUpdate(self, /, timeout: int | None = ...) -> None: ...
...
class QNmeaSatelliteInfoSource(PySide6.QtPositioning.QGeoSatelliteInfoSource):
    ...
    def __init__(
        self, mode: PySide6.QtPositioning.QNmeaSatelliteInfoSource.UpdateMode, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    def backendProperty(self, name: str, /) -> typing.Any: ...
    def device(self, /) -> PySide6.QtCore.QIODevice: ...
    def error(self, /) -> PySide6.QtPositioning.QGeoSatelliteInfoSource.Error: ...
    ...
    def parseSatelliteInfoFromNmea(
        ...
        size: int,
        infos: collections.abc.Sequence[PySide6.QtPositioning.QGeoSatelliteInfo],
        system: PySide6.QtPositioning.QGeoSatelliteInfo.SatelliteSystem,
        /,
    ) -> PySide6.QtPositioning.QNmeaSatelliteInfoSource.SatelliteInfoParseStatus: ...
    @typing.overload
    def parseSatelliteInfoFromNmea(
        self,
        data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
    ...
    def parseSatellitesInUseFromNmea(
        self, data: bytes | bytearray | memoryview, size: int, pnrsInUse: collections.abc.Sequence[int], /
    ) -> PySide6.QtPositioning.QGeoSatelliteInfo.SatelliteSystem: ...
    @typing.overload
    def parseSatellitesInUseFromNmea(
        self, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, pnrsInUse: collections.abc.Sequence[int], /
    ) -> PySide6.QtPositioning.QGeoSatelliteInfo.SatelliteSystem: ...
    def requestUpdate(self, /, timeout: int | None = ...) -> None: ...
    def setBackendProperty(self, name: str, value: typing.Any, /) -> bool: ...
    def setDevice(self, source: PySide6.QtCore.QIODevice, /) -> None: ...
