...
class QGeoCodeReply(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, error: PySide6.QtLocation.QGeoCodeReply.Error, errorString: str, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    @typing.overload
...
class QGeoCodingManager(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def geocode(
        self, address: PySide6.QtPositioning.QGeoAddress, /, bounds: PySide6.QtPositioning.QGeoShape = ...
    ) -> PySide6.QtLocation.QGeoCodeReply: ...
    @typing.overload
    def geocode(
        self, searchString: str, /, limit: int = ..., offset: int | None = ..., bounds: PySide6.QtPositioning.QGeoShape = ...
    ) -> PySide6.QtLocation.QGeoCodeReply: ...
    def locale(self, /) -> PySide6.QtCore.QLocale: ...
    def managerName(self, /) -> str: ...
    def managerVersion(self, /) -> int: ...
    def reverseGeocode(
        self, coordinate: PySide6.QtPositioning.QGeoCoordinate, /, bounds: PySide6.QtPositioning.QGeoShape = ...
    ) -> PySide6.QtLocation.QGeoCodeReply: ...
...
class QGeoCodingManagerEngine(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def geocode(
        self, address: str, limit: int, offset: int, bounds: PySide6.QtPositioning.QGeoShape, /
    ) -> PySide6.QtLocation.QGeoCodeReply: ...
    def locale(self, /) -> PySide6.QtCore.QLocale: ...
    def managerName(self, /) -> str: ...
    def managerVersion(self, /) -> int: ...
...
class QGeoManeuver(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtLocation.QGeoManeuver,
        /,
        *,
        valid: bool | None = ...,
        position: PySide6.QtPositioning.QGeoCoordinate | None = ...,
        instructionText: str | None = ...,
        direction: PySide6.QtLocation.QGeoManeuver.InstructionDirection | None = ...,
        timeToNextInstruction: int | None = ...,
        distanceToNextInstruction: float | None = ...,
        waypoint: PySide6.QtPositioning.QGeoCoordinate | None = ...,
        extendedAttributes: typing.Optional[typing.Dict[str, typing.Any]] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QGeoRoute(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtLocation.QGeoRoute,
        /,
        *,
        routeId: str | None = ...,
        bounds: PySide6.QtPositioning.QGeoRectangle | None = ...,
        travelTime: int | None = ...,
        distance: float | None = ...,
        path: collections.abc.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None = ...,
        routeLegs: collections.abc.Sequence[PySide6.QtLocation.QGeoRoute] | None = ...,
        extendedAttributes: typing.Optional[typing.Dict[str, typing.Any]] = ...,
        legIndex: int | None = ...,
        overallRoute: PySide6.QtLocation.QGeoRoute | None = ...,
        segmentsCount: int | None = ...,
        segments: collections.abc.Sequence[PySide6.QtLocation.QGeoRouteSegment] | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def setBounds(
        ...
        bounds: (
            ...
            | collections.abc.Sequence[PySide6.QtPositioning.QGeoCoordinate]
        ),
        /,
    ) -> None: ...
...
class QGeoRouteReply(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, error: PySide6.QtLocation.QGeoRouteReply.Error, errorString: str, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, request: PySide6.QtLocation.QGeoRouteRequest, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    def abort(self, /) -> None: ...
...
class QGeoRouteRequest(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, origin: PySide6.QtPositioning.QGeoCoordinate, destination: PySide6.QtPositioning.QGeoCoordinate, /
    ) -> None: ...
    @typing.overload
    ...
    def featureWeight(
        self, featureType: PySide6.QtLocation.QGeoRouteRequest.FeatureType, /
    ) -> PySide6.QtLocation.QGeoRouteRequest.FeatureWeight: ...
    ...
    def setFeatureWeight(
        self,
        featureType: PySide6.QtLocation.QGeoRouteRequest.FeatureType,
        featureWeight: PySide6.QtLocation.QGeoRouteRequest.FeatureWeight,
        /,
    ) -> None: ...
...
class QGeoRouteSegment(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtLocation.QGeoRouteSegment,
        /,
        *,
        travelTime: int | None = ...,
        distance: float | None = ...,
        path: collections.abc.Sequence[PySide6.QtPositioning.QGeoCoordinate] | None = ...,
        maneuver: PySide6.QtLocation.QGeoManeuver | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QGeoRoutingManager(PySide6.QtCore.QObject):
    ...
    def updateRoute(
        self, route: PySide6.QtLocation.QGeoRoute, position: PySide6.QtPositioning.QGeoCoordinate, /
...
class QGeoRoutingManagerEngine(PySide6.QtCore.QObject):
    ...
    def setSupportedRouteOptimizations(
        self, optimizations: PySide6.QtLocation.QGeoRouteRequest.RouteOptimization, /
    ) -> None: ...
...
class QGeoServiceProviderFactory(Shiboken.Object):
    ...
    def createGeocodingManagerEngine(
        self, parameters: typing.Dict[str, typing.Any], error: PySide6.QtLocation.QGeoServiceProvider.Error, /
    ) -> typing.Tuple[PySide6.QtLocation.QGeoCodingManagerEngine, str]: ...
    def createPlaceManagerEngine(
        self, parameters: typing.Dict[str, typing.Any], error: PySide6.QtLocation.QGeoServiceProvider.Error, /
    ) -> typing.Tuple[PySide6.QtLocation.QPlaceManagerEngine, str]: ...
    def createRoutingManagerEngine(
        self, parameters: typing.Dict[str, typing.Any], error: PySide6.QtLocation.QGeoServiceProvider.Error, /
    ) -> typing.Tuple[PySide6.QtLocation.QGeoRoutingManagerEngine, str]: ...
...
class QPlace(Shiboken.Object):
    ...
    def content(
        self, type: PySide6.QtLocation.QPlaceContent.Type, /
    ) -> typing.Dict[int, PySide6.QtLocation.QPlaceContent]: ...
    ...
    def insertContent(
        self, type: PySide6.QtLocation.QPlaceContent.Type, content: typing.Dict[int, PySide6.QtLocation.QPlaceContent], /
    ) -> None: ...
    ...
    def setContactDetails(
        self, contactType: str, details: collections.abc.Sequence[PySide6.QtLocation.QPlaceContactDetail], /
    ) -> None: ...
    def setContent(
        self, type: PySide6.QtLocation.QPlaceContent.Type, content: typing.Dict[int, PySide6.QtLocation.QPlaceContent], /
    ) -> None: ...
...
class QPlaceAttribute(Shiboken.Object):
    @typing.overload
    def __init__(
        self, other: PySide6.QtLocation.QPlaceAttribute, /, *, label: str | None = ..., text: str | None = ...
    ) -> None: ...
    @typing.overload
...
class QPlaceContactDetail(Shiboken.Object):
    @typing.overload
    def __init__(
        self, other: PySide6.QtLocation.QPlaceContactDetail, /, *, label: str | None = ..., value: str | None = ...
    ) -> None: ...
    @typing.overload
...
class QPlaceIcon(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtLocation.QPlaceIcon,
        /,
        *,
        parameters: typing.Optional[typing.Dict[str, typing.Any]] = ...,
        manager: PySide6.QtLocation.QPlaceManager | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QPlaceIdReply(PySide6.QtLocation.QPlaceReply):
    ...
    def __init__(
        self, operationType: PySide6.QtLocation.QPlaceIdReply.OperationType, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    def id(self, /) -> str: ...
...
class QPlaceManager(PySide6.QtCore.QObject):
    ...
    def getPlaceContent(
        self, request: PySide6.QtLocation.QPlaceContentRequest, /
    ...
    def saveCategory(
        self, category: PySide6.QtLocation.QPlaceCategory, /, parentId: str = ...
    ...
    def searchSuggestions(
        self, request: PySide6.QtLocation.QPlaceSearchRequest, /
...
class QPlaceRatings(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtLocation.QPlaceRatings,
        /,
        *,
        average: float | None = ...,
        maximum: float | None = ...,
...
class QPlaceSupplier(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtLocation.QPlaceSupplier,
        /,
        *,
        name: str | None = ...,
        supplierId: str | None = ...,
        url: PySide6.QtCore.QUrl | None = ...,
        icon: PySide6.QtLocation.QPlaceIcon | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QPlaceUser(Shiboken.Object):
    @typing.overload
    def __init__(
        self, other: PySide6.QtLocation.QPlaceUser, /, *, userId: str | None = ..., name: str | None = ...
    ) -> None: ...
    @typing.overload
