...
class QScxmlDataModel(PySide6.QtCore.QObject):
    ...
    def __init__(
        self, /, parent: PySide6.QtCore.QObject | None = ..., *, stateMachine: PySide6.QtScxml.QScxmlStateMachine | None = ...
    ) -> None: ...
    @staticmethod
...
class QScxmlDynamicScxmlServiceFactory(PySide6.QtScxml.QScxmlInvokableServiceFactory):
    def __init__(
        ...
        names: collections.abc.Sequence[int],
        parameters: collections.abc.Sequence[PySide6.QtScxml.QScxmlExecutableContent.ParameterInfo],
        /,
...
class QScxmlError(Shiboken.Object):
    ...
    def __init__(
        self,
        arg__1: PySide6.QtScxml.QScxmlError,
        /,
        *,
        valid: bool | None = ...,
        fileName: str | None = ...,
...
class QScxmlEvent(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtScxml.QScxmlEvent,
        /,
        *,
        name: str | None = ...,
        eventType: PySide6.QtScxml.QScxmlEvent.EventType | None = ...,
        scxmlType: str | None = ...,
        sendId: str | None = ...,
        origin: str | None = ...,
        originType: str | None = ...,
...
class QScxmlStateMachine(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        dataModel: PySide6.QtScxml.QScxmlDataModel | None = ...,
        initialValues: typing.Optional[typing.Dict[str, typing.Any]] = ...,
        invokedServices: collections.abc.Sequence[PySide6.QtScxml.QScxmlInvokableService] | None = ...,
        sessionId: str | None = ...,
        name: str | None = ...,
        invoked: bool | None = ...,
        parseErrors: collections.abc.Sequence[PySide6.QtScxml.QScxmlError] | None = ...,
        loader: PySide6.QtScxml.QScxmlCompiler.Loader | None = ...,
        tableData: PySide6.QtScxml.QScxmlTableData | None = ...,
    ) -> None: ...
    ...
    def connectToEvent(
        ...
        method: bytes | bytearray | memoryview,
        /,
...
class QScxmlStaticScxmlServiceFactory(PySide6.QtScxml.QScxmlInvokableServiceFactory):
    def __init__(
        ...
        metaObject: PySide6.QtCore.QMetaObject,
        invokeInfo: PySide6.QtScxml.QScxmlExecutableContent.InvokeInfo,
        nameList: collections.abc.Sequence[int],
        parameters: collections.abc.Sequence[PySide6.QtScxml.QScxmlExecutableContent.ParameterInfo],
        /,
        parent: PySide6.QtCore.QObject | None = ...,
    ) -> None: ...
