...
class QQuick3DGeometry(PySide6.QtQuick3D.QQuick3DObject):
    ...
    def addSubset(
        ...
        offset: int,
        count: int,
        boundsMin: PySide6.QtGui.QVector3D,
        boundsMax: PySide6.QtGui.QVector3D,
        /,
        name: str = ...,
    ) -> None: ...
    @typing.overload
...
class QQuick3DInstancing(PySide6.QtQuick3D.QQuick3DObject):
    ...
    def __init__(
        self,
        /,
        parent: PySide6.QtQuick3D.QQuick3DObject | None = ...,
        *,
        instanceCountOverride: int | None = ...,
        hasTransparency: bool | None = ...,
        depthSortingEnabled: bool | None = ...,
        shadowBoundsMinimum: PySide6.QtGui.QVector3D | None = ...,
        shadowBoundsMaximum: PySide6.QtGui.QVector3D | None = ...,
    ) -> None: ...
    @staticmethod
