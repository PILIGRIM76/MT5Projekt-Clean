...
class QDomDocument(PySide6.QtXml.QDomNode):
    ...
    @typing.overload
    def setContent(
        self, device: PySide6.QtCore.QIODevice, /, options: PySide6.QtXml.QDomDocument.ParseOption = ...
    ) -> PySide6.QtXml.QDomDocument.ParseResult: ...
    @typing.overload
    def setContent(self, dev: PySide6.QtCore.QIODevice, namespaceProcessing: bool, /) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
    def setContent(
        self, reader: PySide6.QtCore.QXmlStreamReader, /, options: PySide6.QtXml.QDomDocument.ParseOption = ...
    ) -> PySide6.QtXml.QDomDocument.ParseResult: ...
    @typing.overload
    def setContent(
    ...
    @typing.overload
    def setContent(
        self, data: str, /, options: PySide6.QtXml.QDomDocument.ParseOption = ...
    ) -> PySide6.QtXml.QDomDocument.ParseResult: ...
    @typing.overload
    def setContent(self, text: str, namespaceProcessing: bool, /) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
    def setContent(
        self, text: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
    def setContent(
        self,
        ...
        /,
        options: PySide6.QtXml.QDomDocument.ParseOption = ...,
    ) -> PySide6.QtXml.QDomDocument.ParseResult: ...
    @typing.overload
    def setContent(
        self, text: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, namespaceProcessing: bool, /
    ) -> typing.Tuple[bool, str, int, int]: ...
...
class QDomNode(Shiboken.Object):
    ...
    def save(
        self, arg__1: PySide6.QtCore.QTextStream, arg__2: int, /, arg__3: PySide6.QtXml.QDomNode.EncodingPolicy = ...
    ) -> None: ...
