    ...
    def _step(self, exception_or_future: BaseException | futures.QAsyncioFuture | None = None) -> None:
        ...
        try:
            ...
            if asyncio.futures.isfuture(result):
                ...
                # called again.
                result.add_done_callback(self._step, context=self._context)  # type: ignore[arg-type]
                ...
                self._loop.call_exception_handler(
                    {
                        ...
                        "task": self,
                        "future": (exception_or_future if asyncio.futures.isfuture(exception_or_future) else None),
                        "traceback": self._tb,
                    }
                )
