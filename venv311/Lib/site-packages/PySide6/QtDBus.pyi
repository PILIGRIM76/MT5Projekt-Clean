...
class QDBusAbstractInterface(PySide6.QtDBus.QDBusAbstractInterfaceBase):
    def __init__(
        ...
        service: str,
        path: str,
        interface: bytes | bytearray | memoryview,
        connection: PySide6.QtDBus.QDBusConnection,
        parent: PySide6.QtCore.QObject,
        /,
    ) -> None: ...
    def asyncCall(self, method: str, /) -> PySide6.QtDBus.QDBusPendingCall: ...
    def asyncCallWithArgumentList(
        self, method: str, args: collections.abc.Sequence[typing.Any], /
    ) -> PySide6.QtDBus.QDBusPendingCall: ...
    @typing.overload
    def call(self, mode: PySide6.QtDBus.QDBus.CallMode, method: str, /) -> PySide6.QtDBus.QDBusMessage: ...
    @typing.overload
    def call(
        self, arg__1: PySide6.QtDBus.QDBus.CallMode, arg__2: str, arg__3: typing.Any, /
    ) -> PySide6.QtDBus.QDBusMessage: ...
    @typing.overload
    def call(
        self, arg__1: PySide6.QtDBus.QDBus.CallMode, arg__2: str, arg__3: typing.Any, arg__4: typing.Any, /
    ) -> PySide6.QtDBus.QDBusMessage: ...
    @typing.overload
    def call(
        self, arg__1: PySide6.QtDBus.QDBus.CallMode, arg__2: str, arg__3: typing.Any, arg__4: typing.Any, arg__5: typing.Any, /
    ) -> PySide6.QtDBus.QDBusMessage: ...
    @typing.overload
    def call(
        self,
        arg__1: PySide6.QtDBus.QDBus.CallMode,
        arg__2: str,
        arg__3: typing.Any,
        arg__4: typing.Any,
        arg__5: typing.Any,
    ...
    @typing.overload
    def call(
        self, arg__1: str, arg__2: typing.Any, arg__3: typing.Any, arg__4: typing.Any, /
    ) -> PySide6.QtDBus.QDBusMessage: ...
    @typing.overload
    def call(
        self, arg__1: str, arg__2: typing.Any, arg__3: typing.Any, arg__4: typing.Any, arg__5: typing.Any, /
    ) -> PySide6.QtDBus.QDBusMessage: ...
    def callWithArgumentList(
        self, mode: PySide6.QtDBus.QDBus.CallMode, method: str, args: collections.abc.Sequence[typing.Any], /
    ) -> PySide6.QtDBus.QDBusMessage: ...
    @typing.overload
    ...
    def callWithCallback(
        ...
        receiver: PySide6.QtCore.QObject,
        member: bytes | bytearray | memoryview,
        errorSlot: bytes | bytearray | memoryview,
        /,
    ) -> bool: ...
...
class QDBusArgument(Shiboken.Object):
    ...
    @typing.overload
    def __lshift__(
        self, arg: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ...
    def beginMap(
        self,
        keyMetaType: PySide6.QtCore.QMetaType | PySide6.QtCore.QMetaType.Type,
        valueMetaType: PySide6.QtCore.QMetaType | PySide6.QtCore.QMetaType.Type,
        /,
    ) -> None: ...
    @typing.overload
...
class QDBusConnection(Shiboken.Object):
    ...
    def call(
        self, message: PySide6.QtDBus.QDBusMessage, /, mode: PySide6.QtDBus.QDBus.CallMode = ..., timeout: int = ...
    ) -> PySide6.QtDBus.QDBusMessage: ...
    @typing.overload
    def callWithCallback(
        self,
        message: PySide6.QtDBus.QDBusMessage,
        receiver: PySide6.QtCore.QObject,
        returnMethod: bytes | bytearray | memoryview,
        errorMethod: bytes | bytearray | memoryview,
        /,
        timeout: int = ...,
    ) -> bool: ...
    @typing.overload
    def callWithCallback(
        ...
        message: PySide6.QtDBus.QDBusMessage,
        receiver: PySide6.QtCore.QObject,
        slot: bytes | bytearray | memoryview,
        /,
        timeout: int = ...,
    ) -> bool: ...
    @typing.overload
    ...
    def connect(
        ...
        interface: str,
        name: str,
        argumentMatch: collections.abc.Sequence[str],
        signature: str,
        receiver: PySide6.QtCore.QObject,
        slot: bytes | bytearray | memoryview,
        /,
    ...
    @typing.overload
    def registerObject(
        self, path: str, object: PySide6.QtCore.QObject, /, options: PySide6.QtDBus.QDBusConnection.RegisterOption = ...
    ) -> bool: ...
    @typing.overload
    def registerObject(
        self,
        ...
        /,
        options: PySide6.QtDBus.QDBusConnection.RegisterOption = ...,
    ) -> bool: ...
    def registerService(self, serviceName: str, /) -> bool: ...
    def registerVirtualObject(
        self,
        path: str,
        object: PySide6.QtDBus.QDBusVirtualObject,
        /,
        options: PySide6.QtDBus.QDBusConnection.VirtualObjectRegisterOption = ...,
    ) -> bool: ...
...
class QDBusConnectionInterface(PySide6.QtDBus.QDBusAbstractInterface):
    ...
    def registerService(
        self,
        arg__1: str,
        arg__2: PySide6.QtDBus.QDBusConnectionInterface.ServiceQueueOptions,
        arg__3: PySide6.QtDBus.QDBusConnectionInterface.ServiceReplacementOptions,
        /,
    ) -> PySide6.QtDBus.QDBusReply: ...
...
class QDBusMessage(Shiboken.Object):
    ...
    def createErrorReply(
        self, err: PySide6.QtDBus.QDBusError | PySide6.QtDBus.QDBusMessage, /
    ) -> PySide6.QtDBus.QDBusMessage: ...
    @staticmethod
...
class QDBusServiceWatcher(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        connection: PySide6.QtDBus.QDBusConnection,
        /,
        watchMode: PySide6.QtDBus.QDBusServiceWatcher.WatchModeFlag = ...,
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        watchedServices: collections.abc.Sequence[str] | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        *,
        watchedServices: collections.abc.Sequence[str] | None = ...,
        watchMode: PySide6.QtDBus.QDBusServiceWatcher.WatchModeFlag | None = ...,
    ) -> None: ...
