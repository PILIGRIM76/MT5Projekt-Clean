...
class Qt3DAnimation(Shiboken.Object):
    ...
    class QAbstractClipAnimator(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(
            ...
            *,
            running: bool | None = ...,
            loops: int | None = ...,
            channelMapper: PySide6.Qt3DAnimation.Qt3DAnimation.QChannelMapper | None = ...,
            clock: PySide6.Qt3DAnimation.Qt3DAnimation.QClock | None = ...,
            normalizedTime: float | None = ...,
        ) -> None: ...
    ...
    class QAdditiveClipBlend(PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractClipBlendNode):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            baseClip: PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractClipBlendNode | None = ...,
            additiveClip: PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractClipBlendNode | None = ...,
            additiveFactor: float | None = ...,
        ) -> None: ...
    ...
    class QAnimationClip(PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractAnimationClip):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            clipData: PySide6.Qt3DAnimation.Qt3DAnimation.QAnimationClipData | None = ...,
        ) -> None: ...
    ...
    class QAnimationClipLoader(PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractAnimationClip):
        ...
        def __init__(
            ...
            *,
            ...
            status: PySide6.Qt3DAnimation.Qt3DAnimation.QAnimationClipLoader.Status | None = ...,
        ) -> None: ...
        @typing.overload
        def __init__(
            self,
    ...
    class QAnimationController(PySide6.QtCore.QObject):
        ...
        def __init__(
            ...
            *,
            activeAnimationGroup: int | None = ...,
            position: float | None = ...,
            positionScale: float | None = ...,
            positionOffset: float | None = ...,
        ...
        def setAnimationGroups(
            self, animationGroups: collections.abc.Sequence[PySide6.Qt3DAnimation.Qt3DAnimation.QAnimationGroup], /
        ) -> None: ...
    ...
    class QAnimationGroup(PySide6.QtCore.QObject):
        ...
        def setAnimations(
            self, animations: collections.abc.Sequence[PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractAnimation], /
        ) -> None: ...
        def setName(self, name: str, /) -> None: ...
        def setPosition(self, position: float, /) -> None: ...
    ...
    class QBlendedClipAnimator(PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractClipAnimator):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            blendTree: PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractClipBlendNode | None = ...,
        ) -> None: ...
    ...
    class QCallbackMapping(PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractChannelMapping):
        ...
        def __init__(
            self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, channelName: str | None = ...
        ) -> None: ...
        ...
        def setCallback(
            self,
            type: int,
            callback: PySide6.Qt3DAnimation.Qt3DAnimation.QAnimationCallback,
            /,
            flags: PySide6.Qt3DAnimation.Qt3DAnimation.QAnimationCallback.Flag = ...,
        ) -> None: ...
    ...
    class QChannel(Shiboken.Object):
        ...
        def insertChannelComponent(
            self, index: int, component: PySide6.Qt3DAnimation.Qt3DAnimation.QChannelComponent, /
        ) -> None: ...
    ...
    class QChannelMapping(PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractChannelMapping):
        ...
        def __init__(
            ...
            *,
            ...
            target: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            property: str | None = ...,
        ) -> None: ...
        def channelName(self, /) -> str: ...
    ...
    class QClipAnimator(PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractClipAnimator):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            clip: PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractAnimationClip | None = ...,
        ) -> None: ...
    ...
    class QClock(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def __init__(
            self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, playbackRate: float | None = ...
        ) -> None: ...
    ...
    class QKeyFrame(Shiboken.Object):
        ...
        @typing.overload
        def __init__(
            self, coords: PySide6.QtGui.QVector2D, lh: PySide6.QtGui.QVector2D, rh: PySide6.QtGui.QVector2D, /
        ) -> None: ...
    ...
    class QKeyframeAnimation(PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractAnimation):
        ...
        def __init__(
            ...
            parent: PySide6.QtCore.QObject | None = ...,
            *,
            framePositions: collections.abc.Sequence[float] | None = ...,
            target: PySide6.Qt3DCore.Qt3DCore.QTransform | None = ...,
            easing: PySide6.QtCore.QEasingCurve | None = ...,
            targetName: str | None = ...,
            startMode: PySide6.Qt3DAnimation.Qt3DAnimation.QKeyframeAnimation.RepeatMode | None = ...,
            endMode: PySide6.Qt3DAnimation.Qt3DAnimation.QKeyframeAnimation.RepeatMode | None = ...,
        ) -> None: ...
    ...
    class QLerpClipBlend(PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractClipBlendNode):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            startClip: PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractClipBlendNode | None = ...,
            endClip: PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractClipBlendNode | None = ...,
            blendFactor: float | None = ...,
        ) -> None: ...
    ...
    class QMorphTarget(PySide6.QtCore.QObject):
        ...
        def __init__(
            self, /, parent: PySide6.QtCore.QObject | None = ..., *, attributeNames: collections.abc.Sequence[str] | None = ...
        ) -> None: ...
        ...
        @staticmethod
        def fromGeometry(
            geometry: PySide6.Qt3DCore.Qt3DCore.QGeometry, attributes: collections.abc.Sequence[str], /
    ...
    class QMorphingAnimation(PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractAnimation):
        ...
        def __init__(
            ...
            parent: PySide6.QtCore.QObject | None = ...,
            *,
            targetPositions: collections.abc.Sequence[float] | None = ...,
            interpolator: float | None = ...,
            target: PySide6.Qt3DRender.Qt3DRender.QGeometryRenderer | None = ...,
            targetName: str | None = ...,
            method: PySide6.Qt3DAnimation.Qt3DAnimation.QMorphingAnimation.Method | None = ...,
            easing: PySide6.QtCore.QEasingCurve | None = ...,
        ) -> None: ...
        ...
        def setMorphTargets(
            self, targets: collections.abc.Sequence[PySide6.Qt3DAnimation.Qt3DAnimation.QMorphTarget], /
        ) -> None: ...
    ...
    class QSkeletonMapping(PySide6.Qt3DAnimation.Qt3DAnimation.QAbstractChannelMapping):
        ...
        def __init__(
            ...
            parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ...,
            *,
            skeleton: PySide6.Qt3DCore.Qt3DCore.QAbstractSkeleton | None = ...,
        ) -> None: ...
