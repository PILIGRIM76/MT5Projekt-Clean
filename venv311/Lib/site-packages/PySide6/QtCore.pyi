...
class Property:
    ...
    def __init__(
        ...
        type: type,
        /,
        fget: collections.abc.Callable[[typing.Any], typing.Any] | None = ...,
        fset: collections.abc.Callable[[typing.Any, typing.Any], None] | None = ...,
        freset: collections.abc.Callable[[typing.Any, typing.Any], None] | None = ...,
        doc: str | None = ...,
        notify: PySide6.QtCore.Signal | None = ...,
        designable: bool = ...,
        scriptable: bool = ...,
        stored: bool = ...,
        user: bool = ...,
...
class PyClassProperty(property):
    ...
    def __init__(
        ...
        fget: collections.abc.Callable[[typing.Any], typing.Any] | None = ...,
        fset: collections.abc.Callable[[typing.Any, typing.Any], None] | None = ...,
        fdel: collections.abc.Callable[[typing.Any], None] | None = ...,
        doc: str | None = ...,
    ) -> None: ...
...
class QAbstractAnimation(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        state: PySide6.QtCore.QAbstractAnimation.State | None = ...,
        loopCount: int | None = ...,
        currentTime: int | None = ...,
        currentLoop: int | None = ...,
        direction: PySide6.QtCore.QAbstractAnimation.Direction | None = ...,
        duration: int | None = ...,
    ) -> None: ...
    ...
    def updateState(
        self, newState: PySide6.QtCore.QAbstractAnimation.State, oldState: PySide6.QtCore.QAbstractAnimation.State, /
    ) -> None: ...
...
class QAbstractEventDispatcher(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def registerTimer(
        self, interval: int, timerType: PySide6.QtCore.Qt.TimerType, object: PySide6.QtCore.QObject, /
    ) -> int: ...
    @typing.overload
    def registerTimer(
        self, timerId: int, interval: int, timerType: PySide6.QtCore.Qt.TimerType, object: PySide6.QtCore.QObject, /
    ) -> None: ...
    def registeredTimers(
        self, object: PySide6.QtCore.QObject, /
    ) -> typing.List[PySide6.QtCore.QAbstractEventDispatcher.TimerInfo]: ...
...
class QAbstractItemModel(PySide6.QtCore.QObject):
    ...
    def beginMoveColumns(
        ...
        sourceFirst: int,
        sourceLast: int,
        destinationParent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex,
    ...
    def changePersistentIndexList(
        self,
        from_: collections.abc.Sequence[PySide6.QtCore.QModelIndex],
        to: collections.abc.Sequence[PySide6.QtCore.QModelIndex],
        /,
    ) -> None: ...
    def checkIndex(
        self,
        ...
        /,
        options: PySide6.QtCore.QAbstractItemModel.CheckIndexOption = ...,
    ) -> bool: ...
    ...
    def encodeData(
        self, indexes: collections.abc.Sequence[PySide6.QtCore.QModelIndex], stream: PySide6.QtCore.QDataStream, /
    ) -> None: ...
    ...
    def match(
        ...
        /,
        hits: int = ...,
        flags: PySide6.QtCore.Qt.MatchFlag = ...,
    ) -> typing.List[PySide6.QtCore.QModelIndex]: ...
...
class QAbstractProxyModel(PySide6.QtCore.QAbstractItemModel):
    ...
    def __init__(
        self, /, parent: PySide6.QtCore.QObject | None = ..., *, sourceModel: PySide6.QtCore.QAbstractItemModel | None = ...
    ) -> None: ...
    def buddy(
        self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /
    ) -> PySide6.QtCore.QModelIndex: ...
    ...
    def data(
        self, proxyIndex: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /, role: int = ...
    ) -> typing.Any: ...
    def dropMimeData(
        self,
        data: PySide6.QtCore.QMimeData,
    ...
    def mapFromSource(
        self, sourceIndex: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /
    ) -> PySide6.QtCore.QModelIndex: ...
    ...
    def mapToSource(
        self, proxyIndex: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /
    ) -> PySide6.QtCore.QModelIndex: ...
    def mimeData(self, indexes: collections.abc.Sequence[PySide6.QtCore.QModelIndex], /) -> PySide6.QtCore.QMimeData: ...
    def mimeTypes(self, /) -> typing.List[str]: ...
    def revert(self, /) -> None: ...
...
class QBasicReadWriteLock(Shiboken.Object):
    def __init__(self, /) -> None: ...
    def contendedTryLockForRead(
        self, timeout: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int, dd: int, /
    ) -> bool: ...
    def contendedTryLockForWrite(
        self, timeout: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int, dd: int, /
    ) -> bool: ...
    ...
    @typing.overload
    def tryLockForRead(
        self, timeout: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int, /
    ) -> bool: ...
    def tryLockForReadInternal(
        self, timeout: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int, tsanFlags: int, /
    ) -> bool: ...
    @typing.overload
...
class QBuffer(PySide6.QtCore.QIODevice):
    ...
    @typing.overload
    def __init__(
        self, buf: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    def atEnd(self, /) -> bool: ...
...
class QByteArray(Shiboken.Object):
    ...
    def clear(self, /) -> None: ...
    def compare(
        self, a: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /, cs: PySide6.QtCore.Qt.CaseSensitivity = ...
    ) -> int: ...
    @typing.overload
    ...
    @typing.overload
    def erase(
        self, first: bytes | bytearray | memoryview, last: bytes | bytearray | memoryview, /
    ) -> bytes | bytearray | memoryview: ...
    def fill(self, c: int, /, size: int = ...) -> PySide6.QtCore.QByteArray: ...
    def first(self, n: int, /) -> PySide6.QtCore.QByteArray: ...
    @staticmethod
    def fromBase64(
        base64: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
        options: PySide6.QtCore.QByteArray.Base64Option = ...,
    ...
    def fromPercentEncoding(
        pctEncoded: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /, percent: int = ...
    ) -> PySide6.QtCore.QByteArray: ...
    @staticmethod
    ...
    @typing.overload
    def insert(
        self, i: int, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    ...
    @typing.overload
    def replace(
        self, before: bytes | bytearray | memoryview, bsize: int, after: bytes | bytearray | memoryview, asize: int, /
    ) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    def replace(
        self,
        before: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        after: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
    ) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    def replace(
        self, before: int, after: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    ...
    @typing.overload
    def replace(
        self, index: int, len: int, s: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> PySide6.QtCore.QByteArray: ...
    ...
    def toPercentEncoding(
        self,
        /,
        exclude: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...,
        include: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...,
        percent: int = ...,
    ) -> PySide6.QtCore.QByteArray: ...
...
class QCalendar(Shiboken.Object):
    ...
    def matchCenturyToWeekday(
        self, parts: PySide6.QtCore.QCalendar.YearMonthDay | int, dow: int, /
...
class QCborValue(Shiboken.Object):
    ...
    @staticmethod
    def fromCbor(
        data: bytearray, len: int, /, error: PySide6.QtCore.QCborParserError | None = ...
    ) -> PySide6.QtCore.QCborValue: ...
    @typing.overload
    @staticmethod
    def fromCbor(
        data: bytes | bytearray | memoryview, len: int, /, error: PySide6.QtCore.QCborParserError | None = ...
    ) -> PySide6.QtCore.QCborValue: ...
    @typing.overload
    @staticmethod
    def fromCbor(
        ba: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /, error: PySide6.QtCore.QCborParserError | None = ...
    ) -> PySide6.QtCore.QCborValue: ...
    @staticmethod
    def fromJsonValue(
        v: typing.Union[
            ...
            typing.Dict[str, PySide6.QtCore.QJsonValue],
            bytes,
            bytearray,
            memoryview,
            float,
    ...
    def toByteArray(
        self, /, defaultValue: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...
    ) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    def toCbor(self, /, opt: PySide6.QtCore.QCborValue.EncodingOption = ...) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    def toCbor(
        self, writer: PySide6.QtCore.QCborStreamWriter, /, opt: PySide6.QtCore.QCborValue.EncodingOption = ...
    ) -> None: ...
...
class QCollator(Shiboken.Object):
    ...
    @typing.overload
    def compare(
        self, s1: bytes | bytearray | memoryview, len1: int, s2: bytes | bytearray | memoryview, len2: int, /
    ) -> int: ...
    @staticmethod
...
class QCommandLineOption(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, names: collections.abc.Sequence[str], description: str, /, valueName: str = ..., defaultValue: str = ...
    ) -> None: ...
...
class QCommandLineParser(Shiboken.Object):
    ...
    def setOptionsAfterPositionalArgumentsMode(
        self, mode: PySide6.QtCore.QCommandLineParser.OptionsAfterPositionalArgumentsMode, /
    ) -> None: ...
    ...
    def showMessageAndExit(
        type: PySide6.QtCore.QCommandLineParser.MessageType, message: str, /, exitCode: int | None = ...
    ) -> None: ...
...
class QCoreApplication(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        organizationDomain: str | None = ...,
        quitLockEnabled: bool | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    @staticmethod
    def processEvents(
        flags: PySide6.QtCore.QEventLoop.ProcessEventsFlag,
        deadline: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int,
        /,
    ) -> None: ...
    @staticmethod
    def quit() -> None: ...
    ...
    def requestPermission(
        self,
        permission: PySide6.QtCore.QBluetoothPermission,
        context: PySide6.QtCore.QObject,
        functor: collections.abc.Callable[..., typing.Any],
        /,
    ) -> None: ...
    @typing.overload
    def requestPermission(
        self,
        permission: PySide6.QtCore.QCalendarPermission,
        context: PySide6.QtCore.QObject,
        functor: collections.abc.Callable[..., typing.Any],
        /,
    ) -> None: ...
    ...
    def requestPermission(
        self,
        permission: PySide6.QtCore.QCameraPermission,
        context: PySide6.QtCore.QObject,
        functor: collections.abc.Callable[..., typing.Any],
        /,
    ) -> None: ...
    ...
    def requestPermission(
        self,
        permission: PySide6.QtCore.QContactsPermission,
        context: PySide6.QtCore.QObject,
        functor: collections.abc.Callable[..., typing.Any],
        /,
    ) -> None: ...
    ...
    def requestPermission(
        self,
        permission: PySide6.QtCore.QLocationPermission,
        context: PySide6.QtCore.QObject,
        functor: collections.abc.Callable[..., typing.Any],
        /,
    ) -> None: ...
    ...
    def requestPermission(
        self,
        permission: PySide6.QtCore.QMicrophonePermission,
        context: PySide6.QtCore.QObject,
        functor: collections.abc.Callable[..., typing.Any],
        /,
    ) -> None: ...
...
class QDataStream(PySide6.QtCore.QIODeviceBase):
    ...
    def __init__(
        self,
        arg__1: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        flags: PySide6.QtCore.QIODeviceBase.OpenModeFlag,
        /,
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def __lshift__(
        self, arg__2: PySide6.QtCore.QEasingCurve | PySide6.QtCore.QEasingCurve.Type, /
    ...
    @typing.overload
    def __lshift__(
        self, tz: PySide6.QtCore.QTimeZone | PySide6.QtCore.QTimeZone.Initialization, /
    ) -> PySide6.QtCore.QDataStream: ...
    @typing.overload
    def __lshift__(
        self, combination: PySide6.QtCore.QKeyCombination | PySide6.QtCore.Qt.KeyboardModifier | PySide6.QtCore.Qt.Key, /
    ) -> PySide6.QtCore.QDataStream: ...
    @typing.overload
    ...
    @typing.overload
    def __lshift__(
        self, arg__2: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> PySide6.QtCore.QDataStream: ...
    @typing.overload
...
class QDate(Shiboken.Object):
    ...
    @typing.overload
    def endOfDay(
        self, zone: PySide6.QtCore.QTimeZone | PySide6.QtCore.QTimeZone.Initialization, /
...
class QDateTime(Shiboken.Object):
    ...
    def __init__(
        ...
        time: PySide6.QtCore.QTime,
        /,
        resolve: PySide6.QtCore.QDateTime.TransitionResolution = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        date: PySide6.QtCore.QDate,
        time: PySide6.QtCore.QTime,
        timeZone: PySide6.QtCore.QTimeZone | PySide6.QtCore.QTimeZone.Initialization,
        /,
        resolve: PySide6.QtCore.QDateTime.TransitionResolution = ...,
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def __init__(
        self, year: int, month: int, day: int, h: int, m: int, s: int, ms: int, spec: PySide6.QtCore.Qt.TimeSpec, /
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        ms: int,
        /,
        spec: PySide6.QtCore.QTimeZone | PySide6.QtCore.QTimeZone.Initialization = ...,
    ) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def currentDateTime(
        zone: PySide6.QtCore.QTimeZone | PySide6.QtCore.QTimeZone.Initialization, /
    ) -> PySide6.QtCore.QDateTime: ...
    @staticmethod
    ...
    def fromMSecsSinceEpoch(
        msecs: int, spec: PySide6.QtCore.Qt.TimeSpec, /, offsetFromUtc: int | None = ...
    ) -> PySide6.QtCore.QDateTime: ...
    @typing.overload
    @staticmethod
    def fromMSecsSinceEpoch(
        msecs: int, timeZone: PySide6.QtCore.QTimeZone | PySide6.QtCore.QTimeZone.Initialization, /
    ) -> PySide6.QtCore.QDateTime: ...
    @typing.overload
    @staticmethod
    ...
    def fromSecsSinceEpoch(
        secs: int, spec: PySide6.QtCore.Qt.TimeSpec, /, offsetFromUtc: int | None = ...
    ) -> PySide6.QtCore.QDateTime: ...
    @typing.overload
    @staticmethod
    def fromSecsSinceEpoch(
        secs: int, timeZone: PySide6.QtCore.QTimeZone | PySide6.QtCore.QTimeZone.Initialization, /
    ) -> PySide6.QtCore.QDateTime: ...
    @typing.overload
    @staticmethod
    ...
    def setTimeZone(
        self,
        toZone: PySide6.QtCore.QTimeZone | PySide6.QtCore.QTimeZone.Initialization,
        /,
        resolve: PySide6.QtCore.QDateTime.TransitionResolution = ...,
    ) -> None: ...
    ...
    def toTimeZone(
        self, toZone: PySide6.QtCore.QTimeZone | PySide6.QtCore.QTimeZone.Initialization, /
    ) -> PySide6.QtCore.QDateTime: ...
...
class QDeadlineTimer(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, arg__1: PySide6.QtCore.QDeadlineTimer.ForeverConstant, /, type_: PySide6.QtCore.Qt.TimerType = ...
    ) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def addNSecs(
        dt: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int, nsecs: int, /
    ...
    def setPreciseRemainingTime(
        self, secs: int, /, nsecs: int | None = ..., type: PySide6.QtCore.Qt.TimerType = ...
    ) -> None: ...
...
class QDir(Shiboken.Object):
    ...
    def __init__(
        ...
        nameFilter: str,
        /,
        sort: PySide6.QtCore.QDir.SortFlag = ...,
        filter: PySide6.QtCore.QDir.Filter = ...,
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def entryInfoList(
        self, /, filters: PySide6.QtCore.QDir.Filter = ..., sort: PySide6.QtCore.QDir.SortFlag = ...
    ) -> typing.List[PySide6.QtCore.QFileInfo]: ...
    @typing.overload
    def entryInfoList(
        self,
        nameFilters: collections.abc.Sequence[str],
        /,
        filters: PySide6.QtCore.QDir.Filter = ...,
        sort: PySide6.QtCore.QDir.SortFlag = ...,
    ) -> typing.List[PySide6.QtCore.QFileInfo]: ...
    @typing.overload
    def entryList(
...
class QDirIterator(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, path: str, filter: PySide6.QtCore.QDir.Filter, /, flags: PySide6.QtCore.QDirIterator.IteratorFlag = ...
    ) -> None: ...
    @typing.overload
    ...
    def __init__(
        ...
        /,
        filters: PySide6.QtCore.QDir.Filter = ...,
        flags: PySide6.QtCore.QDirIterator.IteratorFlag = ...,
    ) -> None: ...
...
class QDirListing(Shiboken.Object):
    class DirEntry(Shiboken.Object):
        ...
        def fileTime(
            self,
            type: PySide6.QtCore.QFileDevice.FileTime,
    ...
    @typing.overload
    def __init__(
        self, path: str, nameFilters: collections.abc.Sequence[str], /, flags: PySide6.QtCore.QDirListing.IteratorFlag = ...
    ) -> None: ...
...
class QEasingCurve(Shiboken.Object):
    ...
    def addTCBSegment(
        self, nextPoint: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint, t: float, c: float, b: float, /
    ) -> None: ...
...
class QFile(PySide6.QtCore.QFileDevice):
    ...
    @typing.overload
    def open(
        self, flags: PySide6.QtCore.QIODeviceBase.OpenModeFlag, permissions: PySide6.QtCore.QFileDevice.Permission, /
    ) -> bool: ...
    @typing.overload
    def open(
        self,
        fd: int,
        ioFlags: PySide6.QtCore.QIODeviceBase.OpenModeFlag,
        /,
        handleFlags: PySide6.QtCore.QFileDevice.FileHandleFlag = ...,
    ) -> bool: ...
    @typing.overload  # type: ignore[misc, overload-cannot-match]
...
class QFileInfo(Shiboken.Object):
    ...
    def fileTime(
        self,
        time: PySide6.QtCore.QFileDevice.FileTime,
        tz: PySide6.QtCore.QTimeZone | PySide6.QtCore.QTimeZone.Initialization,
        /,
    ) -> PySide6.QtCore.QDateTime: ...
    def group(self, /) -> str: ...
...
class QIODevice(PySide6.QtCore.QObject, PySide6.QtCore.QIODeviceBase):
    ...
    def readLineData(self, maxlen: int, /) -> object: ...
    def readLineInto(
        self, result: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /, maxlen: int | None = ...
    ) -> bool: ...
    def reset(self, /) -> bool: ...
    def rollbackTransaction(self, /) -> None: ...
...
class QItemSelection(Shiboken.Object):
    ...
    def __lshift__(
        self, l: collections.abc.Sequence[PySide6.QtCore.QItemSelectionRange], /
    ) -> typing.List[PySide6.QtCore.QItemSelectionRange]: ...
    ...
    @staticmethod
    def fromList(
        list: collections.abc.Sequence[PySide6.QtCore.QItemSelectionRange], /
    ) -> typing.List[PySide6.QtCore.QItemSelectionRange]: ...
    @staticmethod
    def fromVector(
        vector: collections.abc.Sequence[PySide6.QtCore.QItemSelectionRange], /
    ) -> typing.List[PySide6.QtCore.QItemSelectionRange]: ...
    ...
    def max_size(self, /) -> int: ...
    def merge(
        self, other: PySide6.QtCore.QItemSelection, command: PySide6.QtCore.QItemSelectionModel.SelectionFlag, /
    ) -> None: ...
...
class QItemSelectionModel(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        /,
        *,
        hasSelection: bool | None = ...,
        currentIndex: PySide6.QtCore.QModelIndex | None = ...,
        selection: PySide6.QtCore.QItemSelection | None = ...,
        selectedIndexes: collections.abc.Sequence[PySide6.QtCore.QModelIndex] | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        /,
        model: PySide6.QtCore.QAbstractItemModel | None = ...,
        *,
        hasSelection: bool | None = ...,
        currentIndex: PySide6.QtCore.QModelIndex | None = ...,
        selection: PySide6.QtCore.QItemSelection | None = ...,
    ...
    def emitSelectionChanged(
        self, newSelection: PySide6.QtCore.QItemSelection, oldSelection: PySide6.QtCore.QItemSelection, /
    ) -> None: ...
    ...
    @typing.overload
    def select(
        self, selection: PySide6.QtCore.QItemSelection, command: PySide6.QtCore.QItemSelectionModel.SelectionFlag, /
    ) -> None: ...
    @typing.overload
    def select(
        self,
...
class QItemSelectionRange(Shiboken.Object):
    ...
    @typing.overload
    def contains(
        self, row: int, column: int, parentIndex: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /
    ) -> bool: ...
    def height(self, /) -> int: ...
    def indexes(self, /) -> typing.List[PySide6.QtCore.QModelIndex]: ...
...
class QJsonDocument(Shiboken.Object):
    ...
    @staticmethod
    def fromJson(
        json: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /, error: PySide6.QtCore.QJsonParseError | None = ...
...
class QJsonValue(Shiboken.Object):
    ...
    @typing.overload
    def toObject(
        self, defaultValue: typing.Dict[str, PySide6.QtCore.QJsonValue], /
    ) -> typing.Dict[str, PySide6.QtCore.QJsonValue]: ...
    @typing.overload
    def toString(self, /) -> str: ...
    @typing.overload
...
class QKeyCombination(Shiboken.Object):
    ...
    def __copy__(self, /) -> typing.Self: ...
    def __eq__(
        self, rhs: PySide6.QtCore.QKeyCombination | PySide6.QtCore.Qt.KeyboardModifier | PySide6.QtCore.Qt.Key, /
    ) -> bool: ...
    def __hash__(self, /) -> int: ...
    def __ne__(
        self, rhs: PySide6.QtCore.QKeyCombination | PySide6.QtCore.Qt.KeyboardModifier | PySide6.QtCore.Qt.Key, /
...
class QLibrary(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        loadHints: PySide6.QtCore.QLibrary.LoadHint | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QLineF(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, pt1: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint, pt2: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint, /
    ) -> None: ...
    @typing.overload
    ...
    ) -> typing.Tuple[PySide6.QtCore.QLineF.IntersectionType, PySide6.QtCore.QPointF]: ...
    def isNull(self, /) -> bool: ...
    ...
    def setPoints(
        self, p1: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint, p2: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint, /
    ) -> None: ...
...
class QLocale(Shiboken.Object):
    ...
    @staticmethod
    def codeToLanguage(
        languageCode: str, /, codeTypes: PySide6.QtCore.QLocale.LanguageCodeType = ...
    ...
    def formattedDataSize(
        self, bytes: int, /, precision: int = ..., format: PySide6.QtCore.QLocale.DataSizeFormat = ...
    ) -> str: ...
    def groupSeparator(self, /) -> str: ...
    def language(self, /) -> PySide6.QtCore.QLocale.Language: ...
    @staticmethod
    def languageToCode(
        language: PySide6.QtCore.QLocale.Language, /, codeTypes: PySide6.QtCore.QLocale.LanguageCodeType = ...
    ) -> str: ...
    @staticmethod
    ...
    def matchingLocales(
        ...
        territory: PySide6.QtCore.QLocale.Country,
        /,
    ) -> typing.List[PySide6.QtCore.QLocale]: ...
    ...
    @typing.overload
    def toDate(
        self, string: str, format: PySide6.QtCore.QLocale.FormatType, cal: PySide6.QtCore.QCalendar, /, baseYear: int = ...
    ) -> PySide6.QtCore.QDate: ...
    @typing.overload
    def toDate(
        self, string: str, /, format: PySide6.QtCore.QLocale.FormatType = ..., baseYear: int = ...
    ) -> PySide6.QtCore.QDate: ...
    @typing.overload
    def toDate(
        self, string: str, format: str, cal: PySide6.QtCore.QCalendar, /, baseYear: int = ...
    ) -> PySide6.QtCore.QDate: ...
    @typing.overload
    ...
    @typing.overload
    def toString(
        self, date: PySide6.QtCore.QDate, format: PySide6.QtCore.QLocale.FormatType, cal: PySide6.QtCore.QCalendar, /
    ) -> str: ...
    @typing.overload
    ...
    @typing.overload
    def toString(
        self, dateTime: PySide6.QtCore.QDateTime, format: PySide6.QtCore.QLocale.FormatType, cal: PySide6.QtCore.QCalendar, /
    ) -> str: ...
    @typing.overload
...
class QMessageAuthenticationCode(Shiboken.Object):
    def __init__(
        ...
        method: PySide6.QtCore.QCryptographicHash.Algorithm,
        /,
        key: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview = ...,
    ) -> None: ...
    @typing.overload
    def addData(self, device: PySide6.QtCore.QIODevice, /) -> bool: ...
    @typing.overload
    ...
    @staticmethod
    def hash(
        message: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        key: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        method: PySide6.QtCore.QCryptographicHash.Algorithm,
        /,
    ) -> PySide6.QtCore.QByteArray: ...
...
class QMessageLogContext(Shiboken.Object):
    ...
    def __init__(
        self,
        fileName: bytes | bytearray | memoryview,
        lineNumber: int,
        functionName: bytes | bytearray | memoryview,
        categoryName: bytes | bytearray | memoryview,
        /,
    ) -> None: ...
...
class QMessageLogger(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, file: bytes | bytearray | memoryview, line: int, function: bytes | bytearray | memoryview, /
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        line: int,
        function: bytes | bytearray | memoryview,
        category: bytes | bytearray | memoryview,
        /,
    ) -> None: ...
    @typing.overload
...
class QMetaMethod(Shiboken.Object):
    ...
    def invoke(
        ...
        /,
        val0: PySide6.QtCore.QGenericArgumentHolder = ...,
        val1: PySide6.QtCore.QGenericArgumentHolder = ...,
        val2: PySide6.QtCore.QGenericArgumentHolder = ...,
        val3: PySide6.QtCore.QGenericArgumentHolder = ...,
        val4: PySide6.QtCore.QGenericArgumentHolder = ...,
        val5: PySide6.QtCore.QGenericArgumentHolder = ...,
        val6: PySide6.QtCore.QGenericArgumentHolder = ...,
        val7: PySide6.QtCore.QGenericArgumentHolder = ...,
        val8: PySide6.QtCore.QGenericArgumentHolder = ...,
        val9: PySide6.QtCore.QGenericArgumentHolder = ...,
    ) -> object: ...
    @typing.overload
    def invoke(
        self,
        object: PySide6.QtCore.QObject,
        type: PySide6.QtCore.Qt.ConnectionType,
        ret: PySide6.QtCore.QGenericReturnArgumentHolder,
        /,
        val0: PySide6.QtCore.QGenericArgumentHolder = ...,
        val1: PySide6.QtCore.QGenericArgumentHolder = ...,
        val2: PySide6.QtCore.QGenericArgumentHolder = ...,
...
class QMetaObject(Shiboken.Object):
    ...
    @staticmethod
    def disconnect(
        sender: PySide6.QtCore.QObject, signal_index: int, receiver: PySide6.QtCore.QObject, method_index: int, /
    ) -> bool: ...
    @staticmethod
    def disconnectOne(
        sender: PySide6.QtCore.QObject, signal_index: int, receiver: PySide6.QtCore.QObject, method_index: int, /
...
class QMetaType(Shiboken.Object):
    ...
    @staticmethod
    def canConvert(
        fromType: PySide6.QtCore.QMetaType | PySide6.QtCore.QMetaType.Type,
        toType: PySide6.QtCore.QMetaType | PySide6.QtCore.QMetaType.Type,
        /,
    ) -> bool: ...
    @staticmethod
    def canView(
    ...
    def name(self, /) -> bytes | bytearray | memoryview: ...
    @staticmethod
    def registerNormalizedTypedef(
        normalizedTypeName: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        type: PySide6.QtCore.QMetaType | PySide6.QtCore.QMetaType.Type,
        /,
    ) -> None: ...
    ...
    def unregisterConverterFunction(
        from_: PySide6.QtCore.QMetaType | PySide6.QtCore.QMetaType.Type,
        to: PySide6.QtCore.QMetaType | PySide6.QtCore.QMetaType.Type,
        /,
    ) -> None: ...
    @staticmethod
...
class QMimeData(PySide6.QtCore.QObject):
    ...
    def retrieveData(
        self, mimetype: str, preferredType: PySide6.QtCore.QMetaType | PySide6.QtCore.QMetaType.Type, /
    ) -> typing.Any: ...
...
class QMimeDatabase(Shiboken.Object):
    ...
    @typing.overload
    def mimeTypeForData(
        self, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> PySide6.QtCore.QMimeType: ...
    @typing.overload
    def mimeTypeForFile(
        self, fileInfo: PySide6.QtCore.QFileInfo, /, mode: PySide6.QtCore.QMimeDatabase.MatchMode = ...
    ) -> PySide6.QtCore.QMimeType: ...
    @typing.overload
    def mimeTypeForFile(
    ...
    def mimeTypeForFileNameAndData(
        self, fileName: str, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> PySide6.QtCore.QMimeType: ...
...
class QMimeType(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtCore.QMimeType,
        /,
        *,
        valid: bool | None = ...,
        isDefault: bool | None = ...,
        name: str | None = ...,
        comment: str | None = ...,
        genericIconName: str | None = ...,
        iconName: str | None = ...,
        globPatterns: collections.abc.Sequence[str] | None = ...,
        parentMimeTypes: collections.abc.Sequence[str] | None = ...,
        allAncestors: collections.abc.Sequence[str] | None = ...,
        aliases: collections.abc.Sequence[str] | None = ...,
        suffixes: collections.abc.Sequence[str] | None = ...,
        preferredSuffix: str | None = ...,
...
class QObject(Shiboken.Object):
    ...
    def findChild(
        self, type: typing.Type[PlaceholderType], /, name: str = ..., options: PySide6.QtCore.Qt.FindChildOption = ...
    ) -> typing.Optional[PlaceholderType]: ...
    @typing.overload
    def findChildren(
        self, type: typing.Type[PlaceholderType], /, name: str = ..., options: PySide6.QtCore.Qt.FindChildOption = ...
    ) -> typing.List[PlaceholderType]: ...
    @typing.overload
    def findChildren(
        self,
        type: typing.Type[PlaceholderType],
...
class QOperatingSystemVersion(PySide6.QtCore.QOperatingSystemVersionBase):
    ...
    @typing.overload
    def __init__(
        self, osType: PySide6.QtCore.QOperatingSystemVersion.OSType, vmajor: int, /, vminor: int = ..., vmicro: int = ...
    ) -> None: ...
    def __copy__(self, /) -> typing.Self: ...
    def __repr__(self, /) -> str: ...
    @staticmethod
...
class QPointF(Shiboken.Object):
    ...
    @staticmethod
    def dotProduct(
        p1: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint, p2: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint, /
    ) -> float: ...
    def isNull(self, /) -> bool: ...
...
class QProcess(PySide6.QtCore.QIODevice):
    ...
    def setProcessEnvironment(
        self, environment: PySide6.QtCore.QProcessEnvironment | PySide6.QtCore.QProcessEnvironment.Initialization, /
    ) -> None: ...
    ...
    def start(
        ...
        mode: PySide6.QtCore.QIODeviceBase.OpenModeFlag = ...,
    ) -> None: ...
...
class QProcessEnvironment(Shiboken.Object):
    ...
    def __copy__(self, /) -> typing.Self: ...
    def __eq__(
        self, rhs: PySide6.QtCore.QProcessEnvironment | PySide6.QtCore.QProcessEnvironment.Initialization, /
    ) -> bool: ...
    def __ne__(
        self, rhs: PySide6.QtCore.QProcessEnvironment | PySide6.QtCore.QProcessEnvironment.Initialization, /
    ) -> bool: ...
    ...
    def swap(
        self, other: PySide6.QtCore.QProcessEnvironment | PySide6.QtCore.QProcessEnvironment.Initialization, /
    ) -> None: ...
    @staticmethod
...
class QPropertyAnimation(PySide6.QtCore.QVariantAnimation):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        targetObject: PySide6.QtCore.QObject | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        propertyName: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview | None = ...,
        targetObject: PySide6.QtCore.QObject | None = ...,
    ) -> None: ...
    def event(self, event: PySide6.QtCore.QEvent, /) -> bool: ...
    def propertyName(self, /) -> PySide6.QtCore.QByteArray: ...
...
class QRangeModel(PySide6.QtCore.QAbstractItemModel):
    ...
    def __init__(
        self,
        data: collections.abc.Sequence[typing.Any],
        /,
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        roleNames: typing.Optional[typing.Dict[int, PySide6.QtCore.QByteArray]] = ...,
        autoConnectPolicy: PySide6.QtCore.QRangeModel.AutoConnectPolicy | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def moveColumns(
        ...
        sourceColumn: int,
        count: int,
        destParent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex,
        destColumn: int,
        /,
    ) -> bool: ...
    def moveRows(
    ...
    def setData(
        self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, data: typing.Any, /, role: int = ...
    ) -> bool: ...
    def setHeaderData(
        self, section: int, orientation: PySide6.QtCore.Qt.Orientation, data: typing.Any, /, role: int = ...
    ) -> bool: ...
    def setItemData(
        self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, data: typing.Dict[int, typing.Any], /
    ) -> bool: ...
    def setRoleNames(self, names: typing.Dict[int, PySide6.QtCore.QByteArray], /) -> None: ...
    def sibling(
        self, row: int, column: int, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /
    ) -> PySide6.QtCore.QModelIndex: ...
    def sort(self, column: int, /, order: PySide6.QtCore.Qt.SortOrder = ...) -> None: ...
    def span(self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> PySide6.QtCore.QSize: ...
    def supportedDragActions(self, /) -> PySide6.QtCore.Qt.DropAction: ...
...
class QRectF(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, topleft: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint, size: PySide6.QtCore.QSizeF | PySide6.QtCore.QSize, /
    ) -> None: ...
    @typing.overload
...
class QRecursiveMutex(Shiboken.Object):
    ...
    @typing.overload
    def tryLock(
        self, /, timer: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int = ...
    ) -> bool: ...
    def try_lock(self, /) -> bool: ...
    def unlock(self, /) -> None: ...
...
class QRegularExpression(Shiboken.Object):
    ...
    def fromWildcard(
        ...
        options: PySide6.QtCore.QRegularExpression.WildcardConversionOption = ...,
    ) -> PySide6.QtCore.QRegularExpression: ...
    def globalMatch(
        self,
        subject: str,
        ...
        matchOptions: PySide6.QtCore.QRegularExpression.MatchOption = ...,
    ...
    def wildcardToRegularExpression(
        str: str, /, options: PySide6.QtCore.QRegularExpression.WildcardConversionOption = ...
    ) -> str: ...
...
class QSemaphore(Shiboken.Object):
    ...
    @typing.overload
    def tryAcquire(
        self, n: int, timeout: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int, /
    ) -> bool: ...
...
class QSequentialAnimationGroup(PySide6.QtCore.QAnimationGroup):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        currentAnimation: PySide6.QtCore.QAbstractAnimation | None = ...,
    ) -> None: ...
...
class QSettings(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, fileName: str, format: PySide6.QtCore.QSettings.Format, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    @typing.overload
...
class QSizeF(Shiboken.Object):
    ...
    @typing.overload
    def scaled(
        self, s: PySide6.QtCore.QSizeF | PySide6.QtCore.QSize, mode: PySide6.QtCore.Qt.AspectRatioMode, /
...
class QSocketNotifier(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, arg__1: PySide6.QtCore.QSocketNotifier.Type, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, socket: int, arg__2: PySide6.QtCore.QSocketNotifier.Type, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, arg__1: object, arg__2: PySide6.QtCore.QSocketNotifier.Type, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    def event(self, arg__1: PySide6.QtCore.QEvent, /) -> bool: ...
...
class QSortFilterProxyModel(PySide6.QtCore.QAbstractProxyModel):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        filterRegularExpression: PySide6.QtCore.QRegularExpression | None = ...,
        filterKeyColumn: int | None = ...,
        dynamicSortFilter: bool | None = ...,
        filterCaseSensitivity: PySide6.QtCore.Qt.CaseSensitivity | None = ...,
        sortCaseSensitivity: PySide6.QtCore.Qt.CaseSensitivity | None = ...,
        isSortLocaleAware: bool | None = ...,
        sortRole: int | None = ...,
        filterRole: int | None = ...,
        recursiveFilteringEnabled: bool | None = ...,
        autoAcceptChildRows: bool | None = ...,
    ) -> None: ...
    ...
    def filterAcceptsColumn(
        self, source_column: int, source_parent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /
    ) -> bool: ...
    def filterAcceptsRow(
        self, source_row: int, source_parent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /
    ) -> bool: ...
...
class QStandardPaths(Shiboken.Object):
    ...
    def locate(
        ...
        fileName: str,
        /,
        options: PySide6.QtCore.QStandardPaths.LocateOption = ...,
    ) -> str: ...
    @staticmethod
    def locateAll(
        type: PySide6.QtCore.QStandardPaths.StandardLocation,
...
class QStringConverter(PySide6.QtCore.QStringConverterBase):
    ...
    @typing.overload
    def __init__(
        self, encoding: PySide6.QtCore.QStringConverter.Encoding, f: PySide6.QtCore.QStringConverterBase.Flag, /
    ) -> None: ...
    @typing.overload
...
class QStringDecoder(PySide6.QtCore.QStringConverter):
    ...
    @typing.overload
    def __init__(
        self, encoding: PySide6.QtCore.QStringConverter.Encoding, /, flags: PySide6.QtCore.QStringConverterBase.Flag = ...
    ) -> None: ...
    @typing.overload
    def __init__(self, name: str, /, f: PySide6.QtCore.QStringConverterBase.Flag = ...) -> None: ...
    def appendToBuffer(
        self, out: bytes | bytearray | memoryview, ba: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> bytes | bytearray | memoryview: ...
    @staticmethod
    def decoderForHtml(
        data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
...
class QSystemSemaphore(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, key: str, /, initialValue: int | None = ..., mode: PySide6.QtCore.QSystemSemaphore.AccessMode = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        key: PySide6.QtCore.QNativeIpcKey | str,
        /,
        initialValue: int | None = ...,
        arg__3: PySide6.QtCore.QSystemSemaphore.AccessMode = ...,
    ) -> None: ...
    ...
    def setNativeKey(
        ...
        type: PySide6.QtCore.QNativeIpcKey.Type = ...,
    ) -> None: ...
    @typing.overload
    def setNativeKey(
        self,
...
class QTextStream(PySide6.QtCore.QIODeviceBase):
    ...
    def __init__(
        self,
        array: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
        openMode: PySide6.QtCore.QIODeviceBase.OpenModeFlag = ...,
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def __lshift__(
        self, array: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
...
class QThread(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def wait(
        self, /, deadline: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int = ...
    ) -> bool: ...
    @staticmethod
...
class QThreadPool(PySide6.QtCore.QObject):
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        expiryTimeout: int | None = ...,
        maxThreadCount: int | None = ...,
        activeThreadCount: int | None = ...,
        stackSize: int | None = ...,
        threadPriority: PySide6.QtCore.QThread.Priority | None = ...,
    ) -> None: ...
...
class QTimeLine(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        currentTime: int | None = ...,
        direction: PySide6.QtCore.QTimeLine.Direction | None = ...,
        loopCount: int | None = ...,
        easingCurve: PySide6.QtCore.QEasingCurve | None = ...,
    ) -> None: ...
...
class QTimeZone(Shiboken.Object):
    ...
    def __init__(
        self,
        zoneId: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        offsetSeconds: int,
        name: str,
        abbreviation: str,
        /,
    ...
    def ianaIdToWindowsId(
        ianaId: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> PySide6.QtCore.QByteArray: ...
    ...
    def timeSpec(self, /) -> PySide6.QtCore.Qt.TimeSpec: ...
    def transitions(
        self, fromDateTime: PySide6.QtCore.QDateTime, toDateTime: PySide6.QtCore.QDateTime, /
    ) -> typing.List[PySide6.QtCore.QTimeZone.OffsetData]: ...
    @staticmethod
    def utc() -> PySide6.QtCore.QTimeZone: ...
    @typing.overload
    @staticmethod
    def windowsIdToDefaultIanaId(
        windowsId: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    @staticmethod
    def windowsIdToDefaultIanaId(
        windowsId: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, territory: PySide6.QtCore.QLocale.Country, /
    ) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    @staticmethod
...
class QTimer(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        singleShot: bool | None = ...,
        interval: int | None = ...,
        remainingTime: int | None = ...,
        timerType: PySide6.QtCore.Qt.TimerType | None = ...,
        active: bool | None = ...,
    ) -> None: ...
    def id(self, /) -> PySide6.QtCore.Qt.TimerId: ...
    ...
    @staticmethod
    def singleShot(
        msec: int, context: PySide6.QtCore.QObject, functor: collections.abc.Callable[..., typing.Any], /
    ) -> None: ...
    @typing.overload
    @staticmethod
...
class QUrl(Shiboken.Object):
    ...
    @staticmethod
    def fromAce(
        domain: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
        options: PySide6.QtCore.QUrl.AceProcessingOption = ...,
    ) -> str: ...
    @staticmethod
    def fromEncoded(
        input: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /, mode: PySide6.QtCore.QUrl.ParsingMode = ...
    ) -> PySide6.QtCore.QUrl: ...
    @staticmethod
    ...
    @staticmethod
    def fromStringList(
        uris: collections.abc.Sequence[str], /, mode: PySide6.QtCore.QUrl.ParsingMode = ...
    ) -> typing.List[PySide6.QtCore.QUrl]: ...
    @staticmethod
    def fromUserInput(
        userInput: str, /, workingDirectory: str = ..., options: PySide6.QtCore.QUrl.UserInputResolutionOption = ...
    ) -> PySide6.QtCore.QUrl: ...
    ...
    @staticmethod
    def toStringList(
        uris: collections.abc.Sequence[PySide6.QtCore.QUrl], /, options: PySide6.QtCore.QUrl.ComponentFormattingOption = ...
    ) -> typing.List[str]: ...
...
class QUuid(Shiboken.Object):
    ...
    @staticmethod
    def createUuidV3(
        ns: PySide6.QtCore.QUuid, baseData: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
...
class QVariantAnimation(PySide6.QtCore.QAbstractAnimation):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        startValue: typing.Optional[typing.Any] = ...,
        endValue: typing.Optional[typing.Any] = ...,
        currentValue: typing.Optional[typing.Any] = ...,
        duration: int | None = ...,
        easingCurve: PySide6.QtCore.QEasingCurve | None = ...,
    ) -> None: ...
...
class QXmlStreamAttributes(Shiboken.Object):
    ...
    def __add__(
        self, l: collections.abc.Sequence[PySide6.QtCore.QXmlStreamAttribute], /
    ) -> typing.List[PySide6.QtCore.QXmlStreamAttribute]: ...
    def __copy__(self, /) -> typing.Self: ...
    ...
    @staticmethod
    def fromVector(
        vector: collections.abc.Sequence[PySide6.QtCore.QXmlStreamAttribute], /
    ) -> typing.List[PySide6.QtCore.QXmlStreamAttribute]: ...
...
class QXmlStreamReader(Shiboken.Object):
    ...
    def addExtraNamespaceDeclarations(
        self, extraNamespaceDeclaractions: collections.abc.Sequence[PySide6.QtCore.QXmlStreamNamespaceDeclaration], /
    ) -> None: ...
    def atEnd(self, /) -> bool: ...
...
class Signal:
    def __init__(
        self, /, *types: type, name: str | None = ..., arguments: typing.Optional[typing.List[str]] = ...
    ) -> None: ...
    @typing.overload
    def __get__(
        self, instance: PySide6.QtCore.QObject, owner: typing.Optional[typing.Any], /
...
class SignalInstance:
    def __repr__(self, /) -> str: ...
    def connect(
        self, slot: object, /, type: PySide6.QtCore.Qt.ConnectionType = ...
...
@typing.overload
def qCompress(
    data: bytes | bytearray | memoryview, nbytes: int, /, compressionLevel: int = ...
) -> PySide6.QtCore.QByteArray: ...
@typing.overload
def qCompress(
    data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /, compressionLevel: int = ...
) -> PySide6.QtCore.QByteArray: ...
...
def qRegisterResourceData(
    arg__1: int,
    arg__2: bytes | bytearray | memoryview,
    arg__3: bytes | bytearray | memoryview,
    arg__4: bytes | bytearray | memoryview,
    /,
) -> bool: ...
