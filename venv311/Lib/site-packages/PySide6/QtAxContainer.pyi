...
class QAxBase(Shiboken.Object):
    ...
    @typing.overload
    def dynamicCall(
        self, name: bytes | bytearray | memoryview, vars: collections.abc.Sequence[typing.Any], /
    ) -> typing.Any: ...
    @typing.overload
    def dynamicCall(
        self,
...
class QAxWidget(PySide6.QtAxContainer.QAxBaseWidget, PySide6.QtAxContainer.QAxBase):
    @typing.overload
    def __init__(
        self, c: str, /, parent: PySide6.QtWidgets.QWidget | None = ..., f: PySide6.QtCore.Qt.WindowType = ...
    ) -> None: ...
    @typing.overload
    ...
    def createHostWindow(
        self, arg__1: bool, arg__2: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
    ) -> bool: ...
    def doVerb(self, verb: str, /) -> bool: ...
