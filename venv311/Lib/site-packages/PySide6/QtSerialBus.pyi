...
class QCanBusDevice(PySide6.QtCore.QObject):
    ...
    @staticmethod
    def createDeviceInfo(
        plugin: str, name: str, isVirtual: bool, isFlexibleDataRateCapable: bool, /
    ) -> PySide6.QtSerialBus.QCanBusDeviceInfo: ...
    ...
    def enqueueOutgoingFrame(
        self, newFrame: PySide6.QtSerialBus.QCanBusFrame | PySide6.QtSerialBus.QCanBusFrame.FrameType, /
    ) -> None: ...
    ...
    def interpretErrorFrame(
        self, errorFrame: PySide6.QtSerialBus.QCanBusFrame | PySide6.QtSerialBus.QCanBusFrame.FrameType, /
    ) -> str: ...
    def open(self, /) -> bool: ...
    ...
    def setConfigurationParameter(
        self, key: PySide6.QtSerialBus.QCanBusDevice.ConfigurationKey, value: typing.Any, /
    ) -> None: ...
...
class QCanDbcFileParser(Shiboken.Object):
    ...
    def messageValueDescriptions(
        self, /
    ) -> typing.Dict[PySide6.QtSerialBus.QtCanBus.UniqueId, typing.Dict[str, typing.Dict[int, str]]]: ...
    @typing.overload
...
class QCanFrameProcessor(Shiboken.Object):
    ...
    def __init__(self, /) -> None: ...
    def addMessageDescriptions(
        self, descriptions: collections.abc.Sequence[PySide6.QtSerialBus.QCanMessageDescription], /
    ) -> None: ...
    ...
    def messageDescriptions(self, /) -> typing.List[PySide6.QtSerialBus.QCanMessageDescription]: ...
    def parseFrame(
        self, frame: PySide6.QtSerialBus.QCanBusFrame | PySide6.QtSerialBus.QCanBusFrame.FrameType, /
    ) -> PySide6.QtSerialBus.QCanFrameProcessor.ParseResult: ...
    def prepareFrame(
        self, uniqueId: PySide6.QtSerialBus.QtCanBus.UniqueId, signalValues: typing.Dict[str, typing.Any], /
    ) -> PySide6.QtSerialBus.QCanBusFrame: ...
    def setMessageDescriptions(
        self, descriptions: collections.abc.Sequence[PySide6.QtSerialBus.QCanMessageDescription], /
    ) -> None: ...
...
class QCanMessageDescription(Shiboken.Object):
    ...
    def setSignalDescriptions(
        self, descriptions: collections.abc.Sequence[PySide6.QtSerialBus.QCanSignalDescription], /
    ) -> None: ...
...
class QCanSignalDescription(Shiboken.Object):
    ...
    def __repr__(self, /) -> str: ...
    @typing.overload
    def addMultiplexSignal(
        self, name: str, ranges: collections.abc.Sequence[PySide6.QtSerialBus.QCanSignalDescription.MultiplexValueRange], /
    ) -> None: ...
    @typing.overload
    ...
    def multiplexSignals(
        self, /
    ) -> typing.Dict[str, typing.List[PySide6.QtSerialBus.QCanSignalDescription.MultiplexValueRange]]: ...
    ...
    def setMultiplexSignals(
        self,
        multiplexorSignals: typing.Dict[
            str, collections.abc.Sequence[PySide6.QtSerialBus.QCanSignalDescription.MultiplexValueRange]
        ],
        /,
    ) -> None: ...
...
class QModbusClient(PySide6.QtSerialBus.QModbusDevice):
    ...
    def processPrivateResponse(
        self, response: PySide6.QtSerialBus.QModbusResponse, data: PySide6.QtSerialBus.QModbusDataUnit, /
    ) -> bool: ...
    def processResponse(
        self, response: PySide6.QtSerialBus.QModbusResponse, data: PySide6.QtSerialBus.QModbusDataUnit, /
    ) -> bool: ...
    def sendRawRequest(
        self, request: PySide6.QtSerialBus.QModbusRequest, serverAddress: int, /
    ) -> PySide6.QtSerialBus.QModbusReply: ...
    def sendReadRequest(
        self, read: PySide6.QtSerialBus.QModbusDataUnit, serverAddress: int, /
    ) -> PySide6.QtSerialBus.QModbusReply: ...
    def sendReadWriteRequest(
        self, read: PySide6.QtSerialBus.QModbusDataUnit, write: PySide6.QtSerialBus.QModbusDataUnit, serverAddress: int, /
    ) -> PySide6.QtSerialBus.QModbusReply: ...
    def sendWriteRequest(
        self, write: PySide6.QtSerialBus.QModbusDataUnit, serverAddress: int, /
    ) -> PySide6.QtSerialBus.QModbusReply: ...
...
class QModbusDataUnit(Shiboken.Object):
    ...
    def __init__(
        self,
        type: PySide6.QtSerialBus.QModbusDataUnit.RegisterType,
        newStartAddress: int,
        newValues: collections.abc.Sequence[int],
        /,
    ) -> None: ...
    @typing.overload
    def __init__(
        self, type: PySide6.QtSerialBus.QModbusDataUnit.RegisterType, newStartAddress: int, newValueCount: int, /
    ) -> None: ...
    def __copy__(self, /) -> typing.Self: ...
    def isValid(self, /) -> bool: ...
...
class QModbusDevice(PySide6.QtCore.QObject):
    ...
    def setConnectionParameter(
        self, parameter: PySide6.QtSerialBus.QModbusDevice.ConnectionParameter, value: typing.Any, /
    ) -> None: ...
...
class QModbusDeviceIdentification(Shiboken.Object):
    ...
    @staticmethod
    def fromByteArray(
        ba: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
...
class QModbusExceptionResponse(PySide6.QtSerialBus.QModbusResponse):
    ...
    @typing.overload
    def __init__(
        self, fc: PySide6.QtSerialBus.QModbusPdu.FunctionCode, ec: PySide6.QtSerialBus.QModbusPdu.ExceptionCode, /
    ) -> None: ...
    @typing.overload
...
class QModbusPdu(Shiboken.Object):
    ...
    def __init__(
        self,
        code: PySide6.QtSerialBus.QModbusPdu.FunctionCode,
        newData: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        /,
    ) -> None: ...
    @typing.overload
...
class QModbusReply(PySide6.QtCore.QObject):
    ...
    def __init__(
        self,
        type: PySide6.QtSerialBus.QModbusReply.ReplyType,
        serverAddress: int,
        /,
...
class QModbusServer(PySide6.QtSerialBus.QModbusDevice):
    ...
    def setMap(
        self, map: typing.Dict[PySide6.QtSerialBus.QModbusDataUnit.RegisterType, PySide6.QtSerialBus.QModbusDataUnit], /
    ) -> bool: ...
