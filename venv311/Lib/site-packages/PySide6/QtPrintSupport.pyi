...
class QAbstractPrintDialog(PySide6.QtWidgets.QDialog):
    ...
    def __init__(
        self, printer: PySide6.QtPrintSupport.QPrinter, /, parent: PySide6.QtWidgets.QWidget | None = ...
    ) -> None: ...
...
class QPrintDialog(PySide6.QtPrintSupport.QAbstractPrintDialog):
    ...
    def __init__(
        ...
        *,
        options: PySide6.QtPrintSupport.QAbstractPrintDialog.PrintDialogOption | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QPrinter(PySide6.QtGui.QPagedPaintDevice):
    ...
    @typing.overload
    def __init__(
        self, printer: PySide6.QtPrintSupport.QPrinterInfo, /, mode: PySide6.QtPrintSupport.QPrinter.PrinterMode = ...
    ) -> None: ...
    def abort(self, /) -> bool: ...
    ...
    def setEngines(
        self, printEngine: PySide6.QtPrintSupport.QPrintEngine, paintEngine: PySide6.QtGui.QPaintEngine, /
    ) -> None: ...
    ...
    def setPageSize(
        self, size: PySide6.QtGui.QPageSize | PySide6.QtGui.QPageSize.PageSizeId | PySide6.QtCore.QSize, /
    ) -> bool: ...
