...
class QAudio(Shiboken.Object):
    ...
    @staticmethod
    def convertVolume(
        volume: float, from_: PySide6.QtMultimedia.QAudio.VolumeScale, to: PySide6.QtMultimedia.QAudio.VolumeScale, /
    ) -> float: ...
...
class QAudioDecoder(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        isDecoding: bool | None = ...,
        error: str | None = ...,
        bufferAvailable: bool | None = ...,
    ) -> None: ...
...
class QAudioDevice(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtMultimedia.QAudioDevice,
        /,
        *,
        id: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview | None = ...,
        description: str | None = ...,
        isDefault: bool | None = ...,
        mode: PySide6.QtMultimedia.QAudioDevice.Mode | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QAudioInput(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        device: PySide6.QtMultimedia.QAudioDevice | None = ...,
        volume: float | None = ...,
        muted: bool | None = ...,
    ) -> None: ...
    @typing.overload
...
class QAudioSink(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, /, format: PySide6.QtMultimedia.QAudioFormat = ..., parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
...
class QCamera(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        active: bool | None = ...,
        cameraDevice: PySide6.QtMultimedia.QCameraDevice | None = ...,
        error: PySide6.QtMultimedia.QCamera.Error | None = ...,
        errorString: str | None = ...,
        cameraFormat: PySide6.QtMultimedia.QCameraFormat | None = ...,
        focusMode: PySide6.QtMultimedia.QCamera.FocusMode | None = ...,
        focusPoint: PySide6.QtCore.QPointF | None = ...,
        customFocusPoint: PySide6.QtCore.QPointF | None = ...,
        focusDistance: float | None = ...,
        minimumZoomFactor: float | None = ...,
        maximumZoomFactor: float | None = ...,
        zoomFactor: float | None = ...,
        exposureTime: float | None = ...,
        manualExposureTime: float | None = ...,
        isoSensitivity: int | None = ...,
        manualIsoSensitivity: int | None = ...,
        exposureCompensation: float | None = ...,
        exposureMode: PySide6.QtMultimedia.QCamera.ExposureMode | None = ...,
        flashReady: bool | None = ...,
        flashMode: PySide6.QtMultimedia.QCamera.FlashMode | None = ...,
        torchMode: PySide6.QtMultimedia.QCamera.TorchMode | None = ...,
        whiteBalanceMode: PySide6.QtMultimedia.QCamera.WhiteBalanceMode | None = ...,
        colorTemperature: int | None = ...,
        supportedFeatures: PySide6.QtMultimedia.QCamera.Feature | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QCameraDevice(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtMultimedia.QCameraDevice,
        /,
        *,
        id: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview | None = ...,
        description: str | None = ...,
        isDefault: bool | None = ...,
        position: PySide6.QtMultimedia.QCameraDevice.Position | None = ...,
        videoFormats: collections.abc.Sequence[PySide6.QtMultimedia.QCameraFormat] | None = ...,
        correctionAngle: PySide6.QtMultimedia.QtVideo.Rotation | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QCameraFormat(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtMultimedia.QCameraFormat,
        /,
        *,
        resolution: PySide6.QtCore.QSize | None = ...,
        pixelFormat: PySide6.QtMultimedia.QVideoFrameFormat.PixelFormat | None = ...,
        minFrameRate: float | None = ...,
...
class QCapturableWindow(Shiboken.Object):
    @typing.overload
    def __init__(
        self, window: PySide6.QtGui.QWindow, /, *, description: str | None = ..., isValid: bool | None = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, other: PySide6.QtMultimedia.QCapturableWindow, /, *, description: str | None = ..., isValid: bool | None = ...
    ) -> None: ...
    @typing.overload
...
class QImageCapture(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        readyForCapture: bool | None = ...,
        metaData: PySide6.QtMultimedia.QMediaMetaData | None = ...,
        error: PySide6.QtMultimedia.QImageCapture.Error | None = ...,
        errorString: str | None = ...,
        fileFormat: PySide6.QtMultimedia.QImageCapture.FileFormat | None = ...,
        quality: PySide6.QtMultimedia.QImageCapture.Quality | None = ...,
        supportedFormats: collections.abc.Sequence[PySide6.QtMultimedia.QImageCapture.FileFormat] | None = ...,
    ) -> None: ...
...
class QMediaCaptureSession(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        audioInput: PySide6.QtMultimedia.QAudioInput | None = ...,
        audioBufferInput: PySide6.QtMultimedia.QAudioBufferInput | None = ...,
        audioOutput: PySide6.QtMultimedia.QAudioOutput | None = ...,
        camera: PySide6.QtMultimedia.QCamera | None = ...,
        screenCapture: PySide6.QtMultimedia.QScreenCapture | None = ...,
        windowCapture: PySide6.QtMultimedia.QWindowCapture | None = ...,
        videoFrameInput: PySide6.QtMultimedia.QVideoFrameInput | None = ...,
        imageCapture: PySide6.QtMultimedia.QImageCapture | None = ...,
        recorder: PySide6.QtMultimedia.QMediaRecorder | None = ...,
        videoOutput: PySide6.QtCore.QObject | None = ...,
    ) -> None: ...
...
class QMediaDevices(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        audioInputs: collections.abc.Sequence[PySide6.QtMultimedia.QAudioDevice] | None = ...,
        audioOutputs: collections.abc.Sequence[PySide6.QtMultimedia.QAudioDevice] | None = ...,
        videoInputs: collections.abc.Sequence[PySide6.QtMultimedia.QCameraDevice] | None = ...,
        defaultAudioInput: PySide6.QtMultimedia.QAudioDevice | None = ...,
        defaultAudioOutput: PySide6.QtMultimedia.QAudioDevice | None = ...,
        defaultVideoInput: PySide6.QtMultimedia.QCameraDevice | None = ...,
    ) -> None: ...
    @staticmethod
...
class QMediaFormat(Shiboken.Object):
    ...
    def __init__(
        self,
        /,
        format: PySide6.QtMultimedia.QMediaFormat.FileFormat = ...,
        *,
        fileFormat: PySide6.QtMultimedia.QMediaFormat.FileFormat | None = ...,
        audioCodec: PySide6.QtMultimedia.QMediaFormat.AudioCodec | None = ...,
        videoCodec: PySide6.QtMultimedia.QMediaFormat.VideoCodec | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        other: PySide6.QtMultimedia.QMediaFormat,
        /,
        *,
        fileFormat: PySide6.QtMultimedia.QMediaFormat.FileFormat | None = ...,
        audioCodec: PySide6.QtMultimedia.QMediaFormat.AudioCodec | None = ...,
    ...
    ) -> typing.List[PySide6.QtMultimedia.QMediaFormat.AudioCodec]: ...
    def supportedFileFormats(
        self, m: PySide6.QtMultimedia.QMediaFormat.ConversionMode, /
    ) -> typing.List[PySide6.QtMultimedia.QMediaFormat.FileFormat]: ...
    def supportedVideoCodecs(
        self, m: PySide6.QtMultimedia.QMediaFormat.ConversionMode, /
    ) -> typing.List[PySide6.QtMultimedia.QMediaFormat.VideoCodec]: ...
...
class QMediaPlayer(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        loops: int | None = ...,
        playbackState: PySide6.QtMultimedia.QMediaPlayer.PlaybackState | None = ...,
        mediaStatus: PySide6.QtMultimedia.QMediaPlayer.MediaStatus | None = ...,
        metaData: PySide6.QtMultimedia.QMediaMetaData | None = ...,
        error: PySide6.QtMultimedia.QMediaPlayer.Error | None = ...,
        errorString: str | None = ...,
        videoOutput: PySide6.QtCore.QObject | None = ...,
        audioOutput: PySide6.QtMultimedia.QAudioOutput | None = ...,
        audioBufferOutput: PySide6.QtMultimedia.QAudioBufferOutput | None = ...,
        audioTracks: collections.abc.Sequence[PySide6.QtMultimedia.QMediaMetaData] | None = ...,
        videoTracks: collections.abc.Sequence[PySide6.QtMultimedia.QMediaMetaData] | None = ...,
        subtitleTracks: collections.abc.Sequence[PySide6.QtMultimedia.QMediaMetaData] | None = ...,
        activeAudioTrack: int | None = ...,
        activeVideoTrack: int | None = ...,
        activeSubtitleTrack: int | None = ...,
        pitchCompensationAvailability: PySide6.QtMultimedia.QMediaPlayer.PitchCompensationAvailability | None = ...,
        pitchCompensation: bool | None = ...,
        playbackOptions: PySide6.QtMultimedia.QPlaybackOptions | None = ...,
    ) -> None: ...
...
class QMediaRecorder(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        parent: PySide6.QtCore.QObject | None = ...,
        *,
        recorderState: PySide6.QtMultimedia.QMediaRecorder.RecorderState | None = ...,
        duration: int | None = ...,
        outputLocation: PySide6.QtCore.QUrl | None = ...,
        actualLocation: PySide6.QtCore.QUrl | None = ...,
        metaData: PySide6.QtMultimedia.QMediaMetaData | None = ...,
        error: PySide6.QtMultimedia.QMediaRecorder.Error | None = ...,
        errorString: str | None = ...,
        mediaFormat: PySide6.QtMultimedia.QMediaFormat | None = ...,
        quality: PySide6.QtMultimedia.QMediaRecorder.Quality | None = ...,
        encodingMode: PySide6.QtMultimedia.QMediaRecorder.EncodingMode | None = ...,
        videoResolution: PySide6.QtCore.QSize | None = ...,
        videoFrameRate: float | None = ...,
        videoBitRate: int | None = ...,
        audioBitRate: int | None = ...,
        audioChannelCount: int | None = ...,
    ...
    def setMediaFormat(
        self, format: PySide6.QtMultimedia.QMediaFormat | PySide6.QtMultimedia.QMediaFormat.FileFormat, /
    ) -> None: ...
    def setMetaData(self, metaData: PySide6.QtMultimedia.QMediaMetaData, /) -> None: ...
...
class QMediaTimeRange(Shiboken.Object):
    ...
    def __init__(self, start: int, end: int, /) -> None: ...
    def __add__(
        self, r2: PySide6.QtMultimedia.QMediaTimeRange | PySide6.QtMultimedia.QMediaTimeRange.Interval, /
    ...
    @typing.overload
    def __iadd__(
        self, arg__1: PySide6.QtMultimedia.QMediaTimeRange | PySide6.QtMultimedia.QMediaTimeRange.Interval, /
    ) -> PySide6.QtMultimedia.QMediaTimeRange: ...
    @typing.overload  # type: ignore[misc]
...
class QPlaybackOptions(Shiboken.Object):
    ...
    def __init__(
        self,
        arg__1: PySide6.QtMultimedia.QPlaybackOptions,
        /,
        *,
        networkTimeout: int | None = ...,
        playbackIntent: PySide6.QtMultimedia.QPlaybackOptions.PlaybackIntent | None = ...,
        probeSize: int | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
...
class QScreenCapture(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        error: PySide6.QtMultimedia.QScreenCapture.Error | None = ...,
        errorString: str | None = ...,
    ) -> None: ...
    def captureSession(self, /) -> PySide6.QtMultimedia.QMediaCaptureSession: ...
...
class QSoundEffect(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        source: PySide6.QtCore.QUrl | None = ...,
        loops: int | None = ...,
        loopsRemaining: int | None = ...,
        volume: float | None = ...,
        muted: bool | None = ...,
        playing: bool | None = ...,
        status: PySide6.QtMultimedia.QSoundEffect.Status | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        *,
        ...
        playing: bool | None = ...,
        status: PySide6.QtMultimedia.QSoundEffect.Status | None = ...,
        audioDevice: PySide6.QtMultimedia.QAudioDevice | None = ...,
    ) -> None: ...
...
class QVideoFrame(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, buffer: PySide6.QtMultimedia.QAbstractVideoBuffer, format: PySide6.QtMultimedia.QVideoFrameFormat, /
    ) -> None: ...
    @typing.overload
    ...
    def paint(
        ...
        options: PySide6.QtMultimedia.QVideoFrame.PaintOptions,
        /,
    ) -> None: ...
    def pixelFormat(self, /) -> PySide6.QtMultimedia.QVideoFrameFormat.PixelFormat: ...
...
class QVideoFrameFormat(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, size: PySide6.QtCore.QSize, pixelFormat: PySide6.QtMultimedia.QVideoFrameFormat.PixelFormat, /
    ) -> None: ...
    @typing.overload
    def __init__(self, format: PySide6.QtMultimedia.QVideoFrameFormat, /) -> None: ...
    def __copy__(self, /) -> typing.Self: ...
    ...
    def updateUniformData(
        self,
        dst: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
        frame: PySide6.QtMultimedia.QVideoFrame | PySide6.QtMultimedia.QVideoFrameFormat,
...
class QVideoFrameInput(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, format: PySide6.QtMultimedia.QVideoFrameFormat, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> None: ...
    @typing.overload
    def __init__(self, /, parent: PySide6.QtCore.QObject | None = ...) -> None: ...
    def captureSession(self, /) -> PySide6.QtMultimedia.QMediaCaptureSession: ...
...
class QVideoSink(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        videoSize: PySide6.QtCore.QSize | None = ...,
    ) -> None: ...
...
class QWindowCapture(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        active: bool | None = ...,
        window: PySide6.QtMultimedia.QCapturableWindow | None = ...,
        error: PySide6.QtMultimedia.QWindowCapture.Error | None = ...,
        errorString: str | None = ...,
    ) -> None: ...
    @staticmethod
...
class QtAudio(Shiboken.Object):
    ...
    @staticmethod
    def convertVolume(
        volume: float, from_: PySide6.QtMultimedia.QtAudio.VolumeScale, to: PySide6.QtMultimedia.QtAudio.VolumeScale, /
    ) -> float: ...
