...
class QWebEngineCertificateError(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtWebEngineCore.QWebEngineCertificateError,
        /,
        *,
        url: PySide6.QtCore.QUrl | None = ...,
        type: PySide6.QtWebEngineCore.QWebEngineCertificateError.Type | None = ...,
...
class QWebEngineClientCertificateStore(Shiboken.Object):
    def add(
        ...
        privateKey: PySide6.QtNetwork.QSslKey | int,
        /,
    ) -> None: ...
    def certificates(self, /) -> typing.List[PySide6.QtNetwork.QSslCertificate]: ...
    def clear(self, /) -> None: ...
...
class QWebEngineDesktopMediaRequest(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtWebEngineCore.QWebEngineDesktopMediaRequest,
        /,
        *,
        screensModel: PySide6.QtCore.QAbstractListModel | None = ...,
        windowsModel: PySide6.QtCore.QAbstractListModel | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QWebEngineExtensionInfo(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtWebEngineCore.QWebEngineExtensionInfo,
        /,
        *,
        name: str | None = ...,
        id: str | None = ...,
        ...
        path: str | None = ...,
        error: str | None = ...,
        actionPopupUrl: PySide6.QtCore.QUrl | None = ...,
        isEnabled: bool | None = ...,
        isLoaded: bool | None = ...,
...
class QWebEngineFileSystemAccessRequest(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtWebEngineCore.QWebEngineFileSystemAccessRequest,
        /,
        *,
        origin: PySide6.QtCore.QUrl | None = ...,
        filePath: PySide6.QtCore.QUrl | None = ...,
        handleType: PySide6.QtWebEngineCore.QWebEngineFileSystemAccessRequest.HandleType | None = ...,
        accessFlags: PySide6.QtWebEngineCore.QWebEngineFileSystemAccessRequest.AccessFlag | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QWebEngineFindTextResult(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtWebEngineCore.QWebEngineFindTextResult,
        /,
        *,
        numberOfMatches: int | None = ...,
        activeMatch: int | None = ...,
    ) -> None: ...
    @typing.overload
...
class QWebEngineFrame(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtWebEngineCore.QWebEngineFrame,
        /,
        *,
        isValid: bool | None = ...,
        name: str | None = ...,
        ...
        isMainFrame: bool | None = ...,
        children: collections.abc.Sequence[PySide6.QtWebEngineCore.QWebEngineFrame] | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    @typing.overload
    def runJavaScript(
        self, scriptSource: str, worldId: int, /, resultCallback: collections.abc.Callable[..., typing.Any] = ...
    ) -> None: ...
...
class QWebEngineFullScreenRequest(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtWebEngineCore.QWebEngineFullScreenRequest,
        /,
        *,
        toggleOn: bool | None = ...,
        origin: PySide6.QtCore.QUrl | None = ...,
...
class QWebEngineHttpRequest(Shiboken.Object):
    ...
    @typing.overload
    def __init__(
        self, /, url: PySide6.QtCore.QUrl | str = ..., method: PySide6.QtWebEngineCore.QWebEngineHttpRequest.Method = ...
    ) -> None: ...
    ...
    @staticmethod
    def postRequest(
        url: PySide6.QtCore.QUrl | str, postData: typing.Dict[str, str], /
...
class QWebEngineLoadingInfo(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtWebEngineCore.QWebEngineLoadingInfo,
        /,
        *,
        url: PySide6.QtCore.QUrl | None = ...,
        isErrorPage: bool | None = ...,
        status: PySide6.QtWebEngineCore.QWebEngineLoadingInfo.LoadStatus | None = ...,
        errorString: str | None = ...,
        errorDomain: PySide6.QtWebEngineCore.QWebEngineLoadingInfo.ErrorDomain | None = ...,
        errorCode: int | None = ...,
        responseHeaders: typing.Optional[typing.Dict[PySide6.QtCore.QByteArray, PySide6.QtCore.QByteArray]] = ...,
        isDownload: bool | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QWebEnginePage(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        requestedUrl: PySide6.QtCore.QUrl | None = ...,
        zoomFactor: float | None = ...,
        title: str | None = ...,
        url: PySide6.QtCore.QUrl | None = ...,
        iconUrl: PySide6.QtCore.QUrl | None = ...,
        icon: PySide6.QtGui.QIcon | None = ...,
        backgroundColor: PySide6.QtGui.QColor | None = ...,
        contentsSize: PySide6.QtCore.QSizeF | None = ...,
        scrollPosition: PySide6.QtCore.QPointF | None = ...,
        audioMuted: bool | None = ...,
        recentlyAudible: bool | None = ...,
        visible: bool | None = ...,
        lifecycleState: PySide6.QtWebEngineCore.QWebEnginePage.LifecycleState | None = ...,
        recommendedState: PySide6.QtWebEngineCore.QWebEnginePage.LifecycleState | None = ...,
        renderProcessPid: int | None = ...,
        loading: bool | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
    ...
    def acceptNavigationRequest(
        self, url: PySide6.QtCore.QUrl | str, type: PySide6.QtWebEngineCore.QWebEnginePage.NavigationType, isMainFrame: bool, /
    ) -> bool: ...
    ...
    def chooseFiles(
        ...
        oldFiles: collections.abc.Sequence[str],
        acceptedMimeTypes: collections.abc.Sequence[str],
        /,
    ) -> typing.List[str]: ...
    ...
    def findText(
        self,
        subString: str,
        options: PySide6.QtWebEngineCore.QWebEnginePage.FindFlag,
        resultCallback: collections.abc.Callable[..., typing.Any],
        /,
    ) -> None: ...
    ...
    def javaScriptPrompt(
        self, securityOrigin: PySide6.QtCore.QUrl | str, msg: str, defaultValue: str, /
    ...
    @typing.overload
    def printToPdf(
        self, filePath: str, /, layout: PySide6.QtGui.QPageLayout = ..., ranges: PySide6.QtGui.QPageRanges = ...
    ) -> None: ...
    @typing.overload
    def printToPdf(
        self,
        resultCallback: collections.abc.Callable[..., typing.Any],
        /,
        pageLayout: PySide6.QtGui.QPageLayout = ...,
    ...
    @typing.overload
    def runJavaScript(
        self, scriptSource: str, /, worldId: int | None = ..., resultCallback: collections.abc.Callable[..., typing.Any] = ...
    ) -> None: ...
    def save(
        self, filePath: str, /, format: PySide6.QtWebEngineCore.QWebEngineDownloadRequest.SavePageFormat = ...
    ) -> None: ...
...
class QWebEnginePermission(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtWebEngineCore.QWebEnginePermission,
        /,
        *,
        origin: PySide6.QtCore.QUrl | None = ...,
        permissionType: PySide6.QtWebEngineCore.QWebEnginePermission.PermissionType | None = ...,
        state: PySide6.QtWebEngineCore.QWebEnginePermission.State | None = ...,
        isValid: bool | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
...
class QWebEngineProfile(PySide6.QtCore.QObject):
    ...
    def installUrlSchemeHandler(
        self,
        scheme: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview,
    ...
    def listPermissionsForOrigin(
        self, securityOrigin: PySide6.QtCore.QUrl | str, /
    ) -> typing.List[PySide6.QtWebEngineCore.QWebEnginePermission]: ...
    def listPermissionsForPermissionType(
        self, permissionType: PySide6.QtWebEngineCore.QWebEnginePermission.PermissionType, /
    ) -> typing.List[PySide6.QtWebEngineCore.QWebEnginePermission]: ...
    ...
    def queryPermission(
        self,
        securityOrigin: PySide6.QtCore.QUrl | str,
        permissionType: PySide6.QtWebEngineCore.QWebEnginePermission.PermissionType,
        /,
    ...
    def setPersistentPermissionsPolicy(
        self, arg__1: PySide6.QtWebEngineCore.QWebEngineProfile.PersistentPermissionsPolicy, /
    ) -> None: ...
    ...
    def urlSchemeHandler(
        self, arg__1: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
...
class QWebEngineProfileBuilder(Shiboken.Object):
    ...
    def createProfile(
        self, storageName: str, /, parent: PySide6.QtCore.QObject | None = ...
    ) -> PySide6.QtWebEngineCore.QWebEngineProfile: ...
    def setAdditionalTrustedCertificates(
        self, additionalTrustedCertificates: collections.abc.Sequence[PySide6.QtNetwork.QSslCertificate], /
    ...
    def setHttpCacheType(
        self, httpCacheType: PySide6.QtWebEngineCore.QWebEngineProfile.HttpCacheType, /
    ) -> PySide6.QtWebEngineCore.QWebEngineProfileBuilder: ...
    def setPersistentCookiesPolicy(
        self, persistentCookiesPolicy: PySide6.QtWebEngineCore.QWebEngineProfile.PersistentCookiesPolicy, /
    ) -> PySide6.QtWebEngineCore.QWebEngineProfileBuilder: ...
    def setPersistentPermissionsPolicy(
        self, persistentPermissionPolicy: PySide6.QtWebEngineCore.QWebEngineProfile.PersistentPermissionsPolicy, /
    ) -> PySide6.QtWebEngineCore.QWebEngineProfileBuilder: ...
...
class QWebEngineRegisterProtocolHandlerRequest(Shiboken.Object):
    ...
    def __init__(
        self,
        QWebEngineRegisterProtocolHandlerRequest: PySide6.QtWebEngineCore.QWebEngineRegisterProtocolHandlerRequest,
        /,
        *,
        origin: PySide6.QtCore.QUrl | None = ...,
        scheme: str | None = ...,
...
class QWebEngineScript(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtWebEngineCore.QWebEngineScript,
        /,
        *,
        name: str | None = ...,
        sourceUrl: PySide6.QtCore.QUrl | None = ...,
        sourceCode: str | None = ...,
        injectionPoint: PySide6.QtWebEngineCore.QWebEngineScript.InjectionPoint | None = ...,
        worldId: int | None = ...,
        runsOnSubFrames: bool | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QWebEngineUrlRequestJob(PySide6.QtCore.QObject):
    ...
    def redirect(self, url: PySide6.QtCore.QUrl | str, /) -> None: ...
    def reply(
        self, contentType: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, device: PySide6.QtCore.QIODevice, /
    ) -> None: ...
    def requestBody(self, /) -> PySide6.QtCore.QIODevice: ...
    ...
    def setAdditionalResponseHeaders(
        self, additionalResponseHeaders: typing.Dict[PySide6.QtCore.QByteArray, PySide6.QtCore.QByteArray], /
    ) -> None: ...
