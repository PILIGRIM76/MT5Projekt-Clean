...
class QSqlDatabase(Shiboken.Object):
    ...
    def __init__(
        self,
        driver: PySide6.QtSql.QSqlDriver,
        /,
        *,
        numericalPrecisionPolicy: PySide6.QtSql.QSql.NumericalPrecisionPolicy | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        other: PySide6.QtSql.QSqlDatabase,
        /,
        *,
        numericalPrecisionPolicy: PySide6.QtSql.QSql.NumericalPrecisionPolicy | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self, type: str, /, *, numericalPrecisionPolicy: PySide6.QtSql.QSql.NumericalPrecisionPolicy | None = ...
    ) -> None: ...
    @typing.overload
...
class QSqlDriver(PySide6.QtCore.QObject):
    ...
    def numericalPrecisionPolicy(self, /) -> PySide6.QtSql.QSql.NumericalPrecisionPolicy: ...
    def open(
        self, db: str, /, user: str = ..., password: str = ..., host: str = ..., port: int = ..., connOpts: str = ...
    ) -> bool: ...
    def primaryIndex(self, tableName: str, /) -> PySide6.QtSql.QSqlIndex: ...
    def record(self, tableName: str, /) -> PySide6.QtSql.QSqlRecord: ...
...
class QSqlField(Shiboken.Object):
    ...
    def __init__(
        ...
        *,
        ...
        name: str | None = ...,
        tableName: str | None = ...,
        metaType: PySide6.QtCore.QMetaType | None = ...,
        requiredStatus: PySide6.QtSql.QSqlField.RequiredStatus | None = ...,
        readOnly: bool | None = ...,
        generated: bool | None = ...,
        autoValue: bool | None = ...,
        length: int | None = ...,
...
class QSqlQuery(Shiboken.Object):
    ...
    def __init__(
        ...
        /,
        *,
        forwardOnly: bool | None = ...,
        positionalBindingEnabled: bool | None = ...,
        numericalPrecisionPolicy: PySide6.QtSql.QSql.NumericalPrecisionPolicy | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        other: PySide6.QtSql.QSqlQuery,
        /,
        *,
        forwardOnly: bool | None = ...,
        positionalBindingEnabled: bool | None = ...,
...
class QSqlQueryModel(PySide6.QtCore.QAbstractTableModel):
    ...
    def data(
        self, item: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /, role: int = ...
    ) -> typing.Any: ...
    ...
    def indexInQuery(
        self, item: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /
...
class QSqlRelationalTableModel(PySide6.QtSql.QSqlTableModel):
    ...
    def setData(
        self, item: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, value: typing.Any, /, role: int = ...
    ) -> bool: ...
...
class QSqlTableModel(PySide6.QtSql.QSqlQueryModel):
    ...
    def data(
        self, idx: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /, role: int = ...
    ) -> typing.Any: ...
