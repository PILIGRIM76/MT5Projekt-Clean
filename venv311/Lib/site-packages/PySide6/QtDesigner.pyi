...
class QAbstractFormBuilder(Shiboken.Object):
    ...
    def load(
        self, dev: PySide6.QtCore.QIODevice, /, parentWidget: PySide6.QtWidgets.QWidget | None = ...
    ) -> PySide6.QtWidgets.QWidget: ...
    def reset(self, /) -> None: ...
...
class QDesignerFormWindowInterface(PySide6.QtWidgets.QWidget):
    ...
    def setResourceFileSaveMode(
        self, behaviour: PySide6.QtDesigner.QDesignerFormWindowInterface.ResourceFileSaveMode, /
    ) -> None: ...
...
class QDesignerFormWindowManagerInterface(PySide6.QtCore.QObject):
    ...
    def actionGroup(
        self, actionGroup: PySide6.QtDesigner.QDesignerFormWindowManagerInterface.ActionGroup, /
    ...
    def createFormWindow(
        self, /, parentWidget: PySide6.QtWidgets.QWidget | None = ..., flags: PySide6.QtCore.Qt.WindowType = ...
...
class QDesignerFormWindowToolInterface(PySide6.QtCore.QObject):
    ...
    def formWindow(self, /) -> PySide6.QtDesigner.QDesignerFormWindowInterface: ...
    def handleEvent(
        self, widget: PySide6.QtWidgets.QWidget, managedWidget: PySide6.QtWidgets.QWidget, event: PySide6.QtCore.QEvent, /
    ) -> bool: ...
...
class QDesignerWidgetBoxInterface(PySide6.QtWidgets.QWidget):
    class Category(Shiboken.Object):
        ...
        @typing.overload
        def __init__(
            self, /, aname: str = ..., atype: PySide6.QtDesigner.QDesignerWidgetBoxInterface.Category.Type = ...
        ) -> None: ...
    ...
    def dropWidgets(
        self,
        item_list: collections.abc.Sequence[PySide6.QtDesigner.QDesignerDnDItemInterface],
