...
IMPORT_WARNING_PYSIDE = (
    f"[DEPLOY] Found 'import PySide6' in file {0}"
...
PLUGINS_TO_REMOVE = ["accessiblebridge", "platforms/darwin", "networkaccess", "scenegraph", "wayland-inputdevice-integration"]
...
from .dependency_util import QtDependencyReader, find_permission_categories, find_pyside_modules
from .deploy_util import cleanup, config_option_exists, create_config_file, finalize
