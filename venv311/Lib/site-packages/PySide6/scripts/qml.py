...
from PySide6.QtCore import QCoreApplication, QLibraryInfo, Qt, QUrl, SignalInstance
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--list-conf", action="version", help="List the built-in configurations.", version=print_configurations()
    )
    parser.add_argument(
        "--apptype",
        "-a",
