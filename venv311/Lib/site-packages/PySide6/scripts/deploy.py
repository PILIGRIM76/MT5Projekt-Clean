...
def main(
    ...
    extra_modules_grouped: str = None,
    mode: str = None,
) -> str | None:
    """
    ...
    if config.qml_files:
        logging.info("[DEPLOY] Included QML files: " f"{[str(qml_file) for qml_file in config.qml_files]}")
    ...
    try:
        ...
        command_str = nuitka.create_executable(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-v", "--verbose", help="Run in verbose mode", action="store_const", dest="loglevel", const=logging.INFO
    )
    ...
    parser.add_argument("--mode", choices=["onefile", "standalone"], default="onefile", help=HELP_MODE)
