...
class QPdfDocument(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        pageCount: int | None = ...,
        password: str | None = ...,
        status: PySide6.QtPdf.QPdfDocument.Status | None = ...,
        pageModel: PySide6.QtCore.QAbstractListModel | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def render(
        self, page: int, imageSize: PySide6.QtCore.QSize, /, options: PySide6.QtPdf.QPdfDocumentRenderOptions = ...
...
class QPdfLink(Shiboken.Object):
    ...
    def __init__(
        self,
        other: PySide6.QtPdf.QPdfLink,
        /,
        *,
        valid: bool | None = ...,
        page: int | None = ...,
        location: PySide6.QtCore.QPointF | None = ...,
        zoom: float | None = ...,
        url: PySide6.QtCore.QUrl | None = ...,
        contextBefore: str | None = ...,
        contextAfter: str | None = ...,
        rectangles: collections.abc.Sequence[PySide6.QtCore.QRectF] | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QPdfPageNavigator(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        ...
        currentLocation: PySide6.QtCore.QPointF | None = ...,
        currentZoom: float | None = ...,
        backAvailable: bool | None = ...,
        forwardAvailable: bool | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def jump(
        self,
        page: int,
        location: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element,
        /,
        zoom: float | None = ...,
    ) -> None: ...
    def update(
...
class QPdfPageRenderer(PySide6.QtCore.QObject):
    ...
    def __init__(
        ...
        *,
        document: PySide6.QtPdf.QPdfDocument | None = ...,
        renderMode: PySide6.QtPdf.QPdfPageRenderer.RenderMode | None = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def requestPage(
        self, pageNumber: int, imageSize: PySide6.QtCore.QSize, /, options: PySide6.QtPdf.QPdfDocumentRenderOptions = ...
    ) -> int: ...
    def setDocument(self, document: PySide6.QtPdf.QPdfDocument, /) -> None: ...
...
class QPdfSearchModel(PySide6.QtCore.QAbstractListModel):
    ...
    @typing.overload
    def __init__(
        self, /, *, document: PySide6.QtPdf.QPdfDocument | None = ..., searchString: str | None = ..., count: int | None = ...
    ) -> None: ...
    def count(self, /) -> int: ...
    def data(self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, role: int, /) -> typing.Any: ...
    def document(self, /) -> PySide6.QtPdf.QPdfDocument: ...
...
class QPdfSelection(Shiboken.Object):
    def __init__(
        self,
        other: PySide6.QtPdf.QPdfSelection,
        /,
        *,
        valid: bool | None = ...,
        bounds: collections.abc.Sequence[PySide6.QtGui.QPolygonF] | None = ...,
        boundingRectangle: PySide6.QtCore.QRectF | None = ...,
        text: str | None = ...,
        startIndex: int | None = ...,
        endIndex: int | None = ...,
    ) -> None: ...
