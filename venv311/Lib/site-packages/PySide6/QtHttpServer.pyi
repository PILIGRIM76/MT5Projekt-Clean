...
class QHttpServer(PySide6.QtHttpServer.QAbstractHttpServer):
    def __init__(self, /, parent: PySide6.QtCore.QObject | None = ...) -> None: ...
    def addAfterRequestHandler(
        self, context: PySide6.QtCore.QObject, callback: collections.abc.Callable[..., typing.Any], /
    ) -> None: ...
    def clearMissingHandler(self, /) -> None: ...
    def handleRequest(
        self, request: PySide6.QtHttpServer.QHttpServerRequest, responder: PySide6.QtHttpServer.QHttpServerResponder, /
    ) -> bool: ...
    def missingHandler(
        self, request: PySide6.QtHttpServer.QHttpServerRequest, responder: PySide6.QtHttpServer.QHttpServerResponder, /
    ) -> None: ...
...
class QHttpServerResponder(Shiboken.Object):
    ...
    def write(
        ...
        headers: PySide6.QtNetwork.QHttpHeaders,
        /,
        status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...,
    ) -> None: ...
    @typing.overload
    def write(
        self,
    ...
    @typing.overload
    def write(
        self, headers: PySide6.QtNetwork.QHttpHeaders, /, status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...
    ) -> None: ...
    @typing.overload
    def write(
        self,
        document: PySide6.QtCore.QJsonDocument,
        headers: PySide6.QtNetwork.QHttpHeaders,
        /,
        status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...,
    ) -> None: ...
    @typing.overload
    def write(
        self, document: PySide6.QtCore.QJsonDocument, /, status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...
    ) -> None: ...
    @typing.overload
    ...
    def writeBeginChunked(
        self,
        headers: PySide6.QtNetwork.QHttpHeaders,
        trailerNames: collections.abc.Sequence[PySide6.QtNetwork.QHttpHeaders.WellKnownHeader],
        /,
        status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...,
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def writeEndChunked(
        self, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, trailers: PySide6.QtNetwork.QHttpHeaders, /
    ) -> None: ...

class QHttpServerResponse(Shiboken.Object):
    @typing.overload
    def __init__(
        self, data: PySide6.QtCore.QJsonArray, /, status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...
    ) -> None: ...
    @typing.overload
    ...
    def __init__(
        self,
        data: typing.Dict[str, PySide6.QtCore.QJsonValue],
        /,
        status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self, data: bytes | bytearray | memoryview, /, status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QHttpServerRouterRule(Shiboken.Object):
    ...
    def matches(
        self, request: PySide6.QtHttpServer.QHttpServerRequest, match: PySide6.QtCore.QRegularExpressionMatch, /
    ) -> bool: ...
...
class QHttpServerWebSocketUpgradeResponse(Shiboken.Object):
    ...
    @staticmethod
    def deny(
        status: int, message: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /
