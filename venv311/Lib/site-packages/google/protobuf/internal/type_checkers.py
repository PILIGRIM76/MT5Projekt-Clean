...
class BoolValueChecker(object):
    ...
    def CheckValue(self, proposed_value):
        if not hasattr(proposed_value, "__index__"):
            ...
            if type(proposed_value).__module__ == "numpy" and type(proposed_value).__name__ == "bool":
                return bool(proposed_value)
            message = "%.1024r has type %s, but expected one of: %s" % (proposed_value, type(proposed_value), (bool, int))
            raise TypeError(message)

        if type(proposed_value).__module__ == "numpy" and type(proposed_value).__name__ == "ndarray":
            message = "%.1024r has type %s, but expected one of: %s" % (proposed_value, type(proposed_value), (bool, int))
            raise TypeError(message)
