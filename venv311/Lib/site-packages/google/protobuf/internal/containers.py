...
class RepeatedScalarFieldContainer(BaseContainer[_T], MutableSequence[_T]):
    ...
    def __deepcopy__(
        ...
        clone = RepeatedScalarFieldContainer(copy.deepcopy(self._message_listener), self._type_checker, self._field)
    ...
    def __array__(self, dtype=None, copy=None):
        ...
        if dtype is None:
            ...
            if cpp_type == FieldDescriptor.CPPTYPE_INT32:
                ...
                raise SystemError("Code should never reach here: message type detected in" " RepeatedScalarFieldContainer")
