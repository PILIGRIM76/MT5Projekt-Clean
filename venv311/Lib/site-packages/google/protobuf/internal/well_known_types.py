...
class Timestamp(object):
    ...
    def FromDatetime(self, dt):
        ...
        if type(dt).__name__ != "datetime" and not isinstance(dt, datetime.datetime):
            raise TypeError("Fail to convert to Timestamp. Expected a datetime object " "got {0}".format(type(dt).__name__))
        try:
...
class Duration(object):
    ...
    def FromTimedelta(self, td):
        ...
        if type(td).__name__ != "timedelta" and not isinstance(td, datetime.timedelta):
            raise TypeError("Fail to convert to Duration. Expected a timedelta object " "got {0}".format(type(td).__name__))
        try:
            self._NormalizeDuration(
