...
from google.protobuf.internal import api_implementation, containers, decoder, encoder, enum_type_wrapper, extension_dict
    ...
    if field.is_repeated:
        ...
        if field.cpp_type == _FieldDescriptor.CPPTYPE_MESSAGE:
            ...
            def MakeRepeatedScalarDefault(message):
                return containers.RepeatedScalarFieldContainer(message._listener_for_children, type_checker, field)
    ...
    def init(self, **kwargs):
        ...
        def init_wkt_or_merge(field, msg, value):
            if isinstance(value, message_mod.Message):
                msg.MergeFrom(value)
            elif isinstance(value, dict) and field.message_type.full_name == _StructFullTypeName:
                msg.Clear()
        ...
        for field_name, field_value in kwargs.items():
            ...
            if field.is_repeated:
                ...
                if field.cpp_type == _FieldDescriptor.CPPTYPE_MESSAGE:  # Composite
                    if _IsMapField(field):
                        ...
                        for val in field_value:
                            if isinstance(val, dict) and (field.message_type.full_name != _StructFullTypeName):
                                field_copy.add(**val)
                            else:
                ...
                field_copy = field._default_constructor(self)
                if isinstance(field_value, dict) and (field.message_type.full_name != _StructFullTypeName):
