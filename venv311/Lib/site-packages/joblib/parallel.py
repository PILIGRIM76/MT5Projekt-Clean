    ...
    def _check_backend(self, backend, inner_max_num_threads, **backend_params):
        ...
        if isinstance(backend, str):
            ...
            if len(backend_params) > 0:
                raise ValueError("Constructor parameters backend_params are only " "supported when backend is a string.")
...
class Parallel(Logger):
    ...
    * Ability to use shared memory efficiently with worker
    ...
    def _initialize_backend(self):
        ...
        try:
            n_jobs = self._backend.configure(n_jobs=self.n_jobs, parallel=self, **self._backend_kwargs)
    ...
    def _retrieve(self):
        ...
        while self._wait_retrieval():
            ...
            if self.return_ordered:
                ...
                if (nb_jobs == 0) or (self._jobs[0].get_status(timeout=self.timeout) == TASK_PENDING):
                    time.sleep(0.01)
                    continue
