...
class Range(typing.Generic[_RV]):
    ...
    def _issubset_lower(self, other: Self) -> bool:
        ...
        return self._lower > other._lower or (self._lower == other._lower and (other._lower_inc or not self._lower_inc))
    ...
    def _issubset_upper(self, other: Self) -> bool:
        ...
        return self._upper < other._upper or (self._upper == other._upper and (other._upper_inc or not self._upper_inc))
