...
class BitString:
    ...
    @classmethod
    def frombytes(cls, bytes_: builtins.bytes | None = None, bitlength: int | None = None) -> Self:
    ...
    @classmethod
    def from_int(cls, x: int, length: int, bitorder: _BitOrderType = "big", *, signed: bool = False) -> Self:
...
class Point(typing.Tuple[float, float]):
    ...
    def __new__(
        cls,
        x: typing.SupportsFloat | typing.SupportsIndex | str | builtins.bytes | builtins.bytearray,
        y: typing.SupportsFloat | typing.SupportsIndex | str | builtins.bytes | builtins.bytearray,
    ) -> Self:
