    ...
    def __new__(mcls, name, bases, dct):
        ...
        if code is not None:
            ...
            if existing is not None:
                raise TypeError(
                    "{} has duplicate SQLSTATE code, which is" "already defined by {}".format(name, existing.__name__)
                )
...
class PostgresMessage(metaclass=PostgresMessageMeta):
    ...
    def _make_constructor(cls, fields, query=None):
        ...
        if is_icse:
            ...
            message = "cached statement plan is invalid due to a database " "schema or configuration change"
