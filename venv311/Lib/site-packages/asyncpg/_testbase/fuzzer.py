    ...
    async def listen(self):
        while True:
            try:
                ...
                await self._wait(self.loop.sock_connect(backend_sock, (self.backend_host, self.backend_port)))
            except StopServer:
                break
...
class Connection:
    ...
    async def handle(self):
        ...
        try:
            await asyncio.wait([self.proxy_to_backend_task, self.proxy_from_backend_task], return_when=asyncio.FIRST_COMPLETED)
