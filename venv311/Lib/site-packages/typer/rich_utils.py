...
COLOR_SYSTEM: Optional[Literal["auto", "standard", "256", "truecolor", "windows"]] = "auto"  # Set to None to disable colors
...
def _make_rich_text(*, text: str, style: str = "", markup_mode: MarkupModeStrict) -> Union[Markdown, Text]:
