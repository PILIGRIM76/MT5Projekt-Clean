...
def TextExcel(xl):
    ...
    assert xl.Range("A1:B1").Value == (("Hi 0", 2),), "flat-horizontal cell range failed"
...
def TestAll():
    ...
    try:
        ...
        mod = gencache.EnsureModule("{00020813-0000-0000-C000-000000000046}", 0, 1, 2, bForDemand=True)
