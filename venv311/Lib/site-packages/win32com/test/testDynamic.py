...
class VeryPermissive:
    ...
    def write(self, *args):
        if len(args) == 0:
            raise COMException(scode=winerror.DISP_E_BADPARAMCOUNT)  # Probably call as PROPGET.
...
def Test():
    ...
    try:
        ...
        assert v == list(client.TestSequence), f"Dynamic sequences not working! {v!r}/{client.testSequence!r}"
