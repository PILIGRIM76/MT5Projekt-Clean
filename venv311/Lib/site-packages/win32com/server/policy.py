...
class BasicWrapPolicy:
    ...
    def _CreateInstance_(self, clsid, reqIID):
        ...
        try:
            ...
            raise ValueError(f"The object is not correctly registered - {regSpec % clsid} key can not be read")
...
class DesignatedWrapPolicy(MappedWrapPolicy):
    ...
    def _invokeex_(self, dispid, lcid, wFlags, args, kwArgs, serviceProvider):
        ...
        if wFlags & (DISPATCH_PROPERTYPUT | DISPATCH_PROPERTYPUTREF):  ### correct?
            ...
            if isinstance(fn, types.MethodType) and isinstance(getattr(self._obj_, name, None), types.MethodType):
                fn(*args)
            else:
