        ...
        for name in sorted(self.mapVars):
            ...
            if vdesc[4] == pythoncom.VAR_CONST:
                ...
                try:
                    ...
                    use = use.replace('"', "'")
                    use = f'"{use}" # This VARIANT type cannot be converted automatically'
                print(
...
class DispatchItem(build.DispatchItem, WritableItem):
    ...
    def WriteCallbackClassBody(self, generator):
        ...
        for entry in chain(self.propMapGet.values(), self.propMapPut.values(), self.mapFuncs.values()):
            fdesc = entry.desc
...
class Generator:
    ...
    def generate_child(self, child, dir):
        ...
        try:
            ...
            assert found, f"Can't find the '{child}' interface in the CoClasses, or the interfaces"
