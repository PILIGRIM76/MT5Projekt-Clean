...
class Bessel(CtrlNode):
    ...
    uiTemplate = [
        ...
        ("cutoff", "spin", {"value": 1000.0, "step": 1, "dec": True, "bounds": [0.0, None], "suffix": "Hz", "siPrefix": True}),
...
class Butterworth(CtrlNode):
    ...
    uiTemplate = [
        ("band", "combo", {"values": ["lowpass", "highpass"], "index": 0}),
        ("wPass", "spin", {"value": 1000.0, "step": 1, "dec": True, "bounds": [0.0, None], "suffix": "Hz", "siPrefix": True}),
        ("wStop", "spin", {"value": 2000.0, "step": 1, "dec": True, "bounds": [0.0, None], "suffix": "Hz", "siPrefix": True}),
...
class ButterworthNotch(CtrlNode):
    ...
    uiTemplate = [
        (
            "low_wPass",
            "spin",
            {"value": 1000.0, "step": 1, "dec": True, "bounds": [0.0, None], "suffix": "Hz", "siPrefix": True},
        ),
        (
            "low_wStop",
            "spin",
            {"value": 2000.0, "step": 1, "dec": True, "bounds": [0.0, None], "suffix": "Hz", "siPrefix": True},
        ),
        ...
        (
            "high_wPass",
            "spin",
            {"value": 3000.0, "step": 1, "dec": True, "bounds": [0.0, None], "suffix": "Hz", "siPrefix": True},
        ),
        (
            "high_wStop",
            "spin",
            {"value": 4000.0, "step": 1, "dec": True, "bounds": [0.0, None], "suffix": "Hz", "siPrefix": True},
        ),
        (
            "high_gPass",
            "spin",
