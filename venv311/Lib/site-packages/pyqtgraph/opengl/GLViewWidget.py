...
class GLViewMixin:
    ...
    def setCameraParams(self, **kwds):
        ...
        self.setCameraPosition(
            pos=kwds.get("center"),
            distance=kwds.get("distance"),
            elevation=kwds.get("elevation"),
            azimuth=kwds.get("azimuth"),
    ...
    def pan(self, dx, dy, dz, relative="global"):
        ...
        *relative*      String that determines the direction of dx,dy,dz.
        ...
        if relative == "global":
            ...
            xDist = dist * 2.0 * tan(0.5 * radians(self.opts["fov"]))  ## approx. width of view at distance of center point
