...
from .. import functions_qimage, getConfigOption, getCupy
...
class RawImageWidget(QtWidgets.QWidget):
    ...
    def paintEvent(self, ev):
        ...
        if self.image is None:
            ...
            qimage = None
            if not self.opts[1] and {"levels", "lut"}.issuperset(  # no positional arguments
                self.opts[2]
            ):  # no kwargs besides levels and lut
