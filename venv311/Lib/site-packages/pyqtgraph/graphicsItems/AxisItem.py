...
class AxisItem(GraphicsWidget):
    ...
    def tickSpacing(self, minVal, maxVal, size):
        ...
        ref_size = 300.0  # axes longer than this display more than the minimum number of major ticks
        ...
        p10unit = 10.0 ** (  # approximate a power of ten base factor just smaller than the given number
        ...
        if 100.0 * p10unit <= majorMaxSpacing:  # Cheaper to check this than to use a more complicated approximation.
            majorScaleFactor = 10
            p10unit *= 10.0
        else:
