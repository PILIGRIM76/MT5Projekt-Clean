...
class HistogramLUTItem(GraphicsWidget):
    ...
    def __init__(self, image=None, fillHistogram=True, levelMode="mono", gradientPosition="right", orientation="vertical"):
        ...
        self.regions = [
            ...
            LinearRegionItem(
                [0, 1], regionOrientation, swapMode="block", pen="r", brush=fn.mkBrush((255, 50, 50, 50)), span=(0.0, 1 / 3.0)
            ),
            LinearRegionItem(
                [0, 1],
                regionOrientation,
            ...
            LinearRegionItem(
                [0, 1], regionOrientation, swapMode="block", pen="b", brush=fn.mkBrush((50, 50, 255, 80)), span=(2 / 3.0, 1.0)
            ),
            LinearRegionItem(
                [0, 1],
                regionOrientation,
