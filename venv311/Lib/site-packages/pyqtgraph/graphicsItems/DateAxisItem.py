...
YEAR_MONTH_ZOOM_LEVEL = ZoomLevel(
    [TickSpec(YEAR_SPACING, makeYStepper(1), "%Y", autoSkip=[1, 5, 10, 25]), TickSpec(MONTH_SPACING, makeMStepper(1), "%b")],
    "YYYY",
)
MONTH_DAY_ZOOM_LEVEL = ZoomLevel(
    [TickSpec(MONTH_SPACING, makeMStepper(1), "%b"), TickSpec(DAY_SPACING, makeSStepper(DAY_SPACING), "%d", autoSkip=[1, 5])],
    "MMM",
)
...
HMS_ZOOM_LEVEL = ZoomLevel(
    [TickSpec(SECOND_SPACING, makeSStepper(SECOND_SPACING), "%H:%M:%S", autoSkip=[1, 5, 15, 30])], "99:99:99"
)
