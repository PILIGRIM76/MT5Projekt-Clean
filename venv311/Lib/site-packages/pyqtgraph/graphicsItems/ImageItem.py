...
from .. import functions_qimage, getConfigOption
...
class ImageItem(GraphicsObject):
    ...
    **Bases:** :class:`GraphicsObject <pyqtgraph.GraphicsObject>`
    ...
    def render(self):
        ...
        if lut is not None and lut.dtype != self._xp.uint8:
            ...
            qimage = functions_qimage.try_make_qimage(
                image, levels=levels, lut=lut, transparentLocations=self._imageNanLocations
            )
    ...
    def getHistogram(self, bins="auto", step="auto", perChannel=False, targetImageSize=200, targetHistogramSize=500, **kwds):
        ...
        if step == "auto":
            step = (
                max(1, int(self._xp.ceil(self.image.shape[0] / targetImageSize))),
