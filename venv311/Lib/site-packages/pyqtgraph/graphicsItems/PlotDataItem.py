...
class PlotDataItem(GraphicsObject):
    ...
    **Signals:**
    ...
    def __init__(self, *args, **kargs):
        ...
        **Notes on performance:**
        ...
        self._datasetDisplay = (
            None  # will hold a PlotDataset for data downsampled and limited for display, accessed by getData()
        )
    ...
    def setDynamicRangeLimit(self, limit=1e06, hysteresis=3.0):
        """
    ...
    def _getDisplayDataset(self):
        ...
        if (
            ...
            and not (self.property("yViewRangeWasChanged") and self.opts["dynamicRangeLimit"] is not None)
        ):
...
def isSequence(obj):
    return (
        hasattr(obj, "__iter__") or isinstance(obj, np.ndarray) or (hasattr(obj, "implements") and obj.implements("MetaArray"))
    )
