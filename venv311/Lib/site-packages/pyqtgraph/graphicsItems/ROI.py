...
class Handle(UIGraphicsItem):
    ...
    def __init__(
        self, radius, typ=None, pen=(200, 200, 220), hoverPen=(255, 255, 0), parent=None, deletable=False, antialias=True
    ):
        self.rois = []
        self.radius = radius
        self.typ = typ
    ...
    **Arguments**
    ...
    def addSegment(self, h1, h2, index=None):
        seg = _PolyLineSegment(
            handles=(h1, h2), pen=self.pen, hoverPen=self.hoverPen, parent=self, movable=False, antialias=self._antialias
        )
        if index is None:
