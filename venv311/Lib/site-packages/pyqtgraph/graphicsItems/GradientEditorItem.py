...
class TickMenu(QtWidgets.QMenu):
    ...
    def __init__(self, tick, sliderItem):
        ...
        self.removeAct = self.addAction(
            translate("GradientEditorItem", "Remove Tick"), lambda: self.sliderItem().removeTick(tick)
        )
        ...
        colorAct = self.addAction(
            translate("Context Menu", "Set Color"), lambda: self.sliderItem().raiseColorDialog(self.tick())
        )
