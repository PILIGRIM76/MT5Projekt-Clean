...
x_data = np.arange(101) + 1_000.0
y_data = np.random.normal(scale=40.0, size=101)
...
for axis_key, hide_overlap in (("top", False), ("bottom", False), ("left", True), ("right", True)):
...
for axis_key, tolerance in (("top", 15), ("bottom", 200), ("left", 100), ("right", 15)):
...
for p in (p1, p2, p3, p4):
    ...
    if p != p1:
        ...
        p.setYLink(p1)
    ax.setTickFont(font)
p1.setXRange(1_000.0, 1_100.0, padding=0.0)
p1.setYRange(-60.0, 60.0, padding=0.0)
