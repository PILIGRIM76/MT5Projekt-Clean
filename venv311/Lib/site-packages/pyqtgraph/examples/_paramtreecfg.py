...
cfg = {
    "list": {"limits": {"type": "checklist", "limits": ["a", "b", "c"]}},
    "file": {
        "acceptMode": {"type": "list", "limits": list(enum(dlg.AcceptMode, dlg).enumMap)},
        "fileMode": {"type": "list", "limits": list(enum(dlg.FileMode, dlg).enumMap)},
        "viewMode": {"type": "list", "limits": list(enum(dlg.ViewMode, dlg).enumMap)},
        "dialogLabel": {"type": "list", "limits": list(enum(dlg.DialogLabel, dlg).enumMap)},
        "relativeTo": {"type": "str", "value": None},
        "directory": {"type": "str", "value": None},
        "windowTitle": {"type": "str", "value": None},
        "nameFilter": {"type": "str", "value": None},
    },
    "float": {
        "Float Information": {
            "type": "str",
    ...
    "checklist": {
        ...
        "delay": {"type": "float", "value": 1.0, "limits": [0, None]},
    },
    "pen": {
        "Pen Information": {
            "type": "str",
