...
parser.add_argument(
    "--dtype", default="uint8", choices=["uint8", "uint16", "float"], help="Image dtype (uint8, uint16, or float)"
)
parser.add_argument("--frames", default=3, type=int, help="Number of image frames to generate (default=3)")
parser.add_argument(
    "--image-mode", default="mono", choices=["mono", "rgb"], help="Image data mode (mono or rgb)", dest="image_mode"
)
parser.add_argument(
    "--levels",
    default=None,
