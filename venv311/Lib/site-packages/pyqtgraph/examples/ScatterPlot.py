...
random_str = lambda: (
    "".join([chr(np.random.randint(ord("A"), ord("z"))) for i in range(np.random.randint(1, 5))]),
...
s2.addPoints(spots)
spots = [
    {"pos": pos[:, i], "data": 1, "brush": pg.intColor(i, n), "symbol": label[1], "size": label[2] * (5 + i / 10.0)}
