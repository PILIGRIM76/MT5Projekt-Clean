...
params = [
    ...
    },
    {
        ...
        "type": "group",
        "children": [
            {"name": "List contextMenu", "type": "float", "value": 0, "context": ["menu1", "menu2"]},
            {
...
layout.addWidget(
    QtWidgets.QLabel("These are two views of the same data. They should always display the same values."), 0, 0, 1, 2
)
