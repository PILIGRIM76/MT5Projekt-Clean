...
def attrs(
    ...
    *never* go away, though).
    ...
    def wrap(cls):
        ...
        eq = not is_exc and _determine_whether_to_implement(cls, eq_, auto_detect, ("__eq__", "__ne__"))
        ...
        if is_exc:
            ...
            hashability = Hashability.HASHABLE_CACHED if cache_hash else Hashability.HASHABLE
        elif hash is False:
            hashability = Hashability.LEAVE_ALONE
        elif hash is None:
        ...
        props = ClassProps(
            ...
            added_init=_determine_whether_to_implement(cls, init, auto_detect, ("__init__",)),
            added_repr=_determine_whether_to_implement(cls, repr, auto_detect, ("__repr__",)),
            added_eq=eq,
        ...
        if not props.is_hashable and cache_hash:
            msg = (
                "Invalid value for cache_hash.  To use hash caching, hashing must be either explicitly or implicitly enabled."
            )
            raise TypeError(msg)
...
class ClassProps:
    ...
    def is_hashable(self):
        return (
            self.hashability is ClassProps.Hashability.HASHABLE or self.hashability is ClassProps.Hashability.HASHABLE_CACHED
        )
