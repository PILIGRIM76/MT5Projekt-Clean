...
from .vecs_io import bvecs_iter, bvecs_iter_chunked, bvecs_mmap, fvecs_mmap, fvecs_read, ivecs_read
...
class Dataset:
    ...
    def __str__(self):
        return f"dataset in dimension {self.d}, with metric {self.metric}, " f"size: Q {self.nq} B {self.nb} T {self.nt}"
...
class SyntheticDataset(Dataset):
    ...
    def get_groundtruth(self, k=100):
        return knn(self.xq, self.xb, k, faiss.METRIC_L2 if self.metric == "L2" else faiss.METRIC_INNER_PRODUCT)[1]
