...
def range_PR(lims_ref, Iref, lims_new, Inew, mode="overall"):
    ...
    return counts_to_PR(lims_ref[1:] - lims_ref[:-1], lims_new[1:] - lims_new[:-1], ninter, mode=mode)
...
def range_PR_multiple_thresholds(lims_ref, Iref, lims_new, Dnew, Inew, thresholds, mode="overall", do_sort="ref,new"):
