...
def _check_dtype_uint8(codes):
    if codes.dtype != "uint8":
        raise TypeError("Input argument %s must be ndarray of dtype " " uint8, but found %s" % ("codes", codes.dtype))
...
def handle_Index(the_class):
    ...
    def replacement_search_and_reconstruct(self, x, k, *, params=None, D=None, I=None, R=None):
        ...
        self.search_and_reconstruct_c(n, swig_ptr(x), k, swig_ptr(D), swig_ptr(I), swig_ptr(R), params)
        return D, I, R

    def replacement_search_and_return_codes(self, x, k, *, include_listnos=False, params=None, D=None, I=None, codes=None):
        """Find the k nearest neighbors of the set of vectors x in the index,
        ...
        self.search_and_return_codes_c(n, swig_ptr(x), k, swig_ptr(D), swig_ptr(I), swig_ptr(codes), include_listnos, params)
        return D, I, codes
    ...
    def replacement_search_preassigned(self, x, k, Iq, Dq, *, params=None, D=None, I=None):
        ...
        self.search_preassigned_c(n, swig_ptr(x), k, swig_ptr(Iq), swig_ptr(Dq), swig_ptr(D), swig_ptr(I), False)
        return D, I
    ...
    replace_method(the_class, "search_and_return_codes", replacement_search_and_return_codes, ignore_missing=True)

    # these ones are IVF-specific
    replace_method(the_class, "search_preassigned", replacement_search_preassigned, ignore_missing=True)
    replace_method(the_class, "range_search_preassigned", replacement_range_search_preassigned, ignore_missing=True)
    ...
    original_setattr = the_class.__setattr__ if hasattr(the_class, "__setattr__") else object.__setattr__
...
def handle_Embedding(the_class):
    ...
    def from_torch(self, emb):
        ...
        faiss.copy_array_to_vector(np.ascontiguousarray(emb.weight.data).ravel(), self.weight)
...
def handle_QINCo(the_class):
    ...
    def from_torch(self, qinco):
        ...
        assert (qinco.d, qinco.K, qinco.L, qinco.M, qinco.h) == (self.d, self.K, self.L, self.M, self.h)
