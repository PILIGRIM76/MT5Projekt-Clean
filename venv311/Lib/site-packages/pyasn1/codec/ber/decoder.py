    ...
    def __call__(
        ...
        **options,
        ...
        if _nestingLevel > MAX_NESTING_DEPTH:
            raise error.PyAsn1Error("ASN.1 structure nesting depth exceeds limit (%d)" % MAX_NESTING_DEPTH)
            ...
            if state is stDecodeLength:
                ...
                if firstOctet < 128:
                    ...
                    if size > MAX_LENGTH_OCTETS:
                        raise error.PyAsn1Error("BER length field size %d exceeds limit (%d)" % (size, MAX_LENGTH_OCTETS))
