...
def consecutive_groups(iterable: Iterable[_T], ordering: None | Callable[[_T], int] = ...) -> Iterator[Iterator[_T]]: ...
@overload
def difference(
    iterable: Iterable[_T],
...
def windowed_complete(iterable: Iterable[_T], n: int) -> Iterator[tuple[tuple[_T, ...], tuple[_T, ...], tuple[_T, ...]]]: ...
def all_unique(iterable: Iterable[_T], key: Callable[[_T], _U] | None = ...) -> bool: ...
def nth_product(index: int, *iterables: Iterable[_T], repeat: int = ...) -> tuple[_T, ...]: ...
...
def product_index(element: Iterable[_T], *iterables: Iterable[_T], repeat: int = ...) -> int: ...
...
def gray_product(*iterables: Iterable[_T], repeat: int = ...) -> Iterator[tuple[_T, ...]]: ...
def partial_product(*iterables: Iterable[_T], repeat: int = ...) -> Iterator[tuple[_T, ...]]: ...
...
def powerset_of_sets(iterable: Iterable[_T], *, baseset: type = ...) -> Iterator[set[_T]] | Iterator[frozenset[_T]]: ...
def join_mappings(
...
def concurrent_tee(iterable: Iterable[_T], n: int = ...) -> tuple[Iterator[_T]]: ...
def synchronized(
