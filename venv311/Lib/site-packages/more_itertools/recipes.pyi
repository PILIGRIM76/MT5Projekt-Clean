...
def repeatfunc(function: Callable[..., _U], times: int | None = ..., *args: Any) -> Iterator[_U]: ...
...
def random_product(*iterables: Iterable[_T], repeat: int = ...) -> tuple[_T, ...]: ...
...
def running_mean(iterable: Iterable[_NumberT], *, maxlen: int | None = ...) -> Iterator[_NumberT]: ...
def running_median(iterable: Iterable[_NumberT], *, maxlen: int | None = ...) -> Iterator[_NumberT]: ...
def running_min(iterable: Iterable[_NumberT], *, maxlen: int | None = ...) -> Iterator[_NumberT]: ...
def running_max(iterable: Iterable[_NumberT], *, maxlen: int | None = ...) -> Iterator[_NumberT]: ...
...
def running_statistics(iterable: Iterable[_NumberT], *, maxlen: int | None = ...) -> Iterator[Stats]: ...
