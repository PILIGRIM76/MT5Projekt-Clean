...
class StorageRegistry(ABCMeta):
    def __new__(mcs, name: str, bases: tuple[type, ...], dct: dict[str, str | list[str]]) -> StorageRegistry:
...
class StorageURIOptions:
    ...
    def empty(self) -> bool:
        ...
        instance
        """
        return bool(self.username is None and self.password is None and not (self.locations or self.path or self.query))
