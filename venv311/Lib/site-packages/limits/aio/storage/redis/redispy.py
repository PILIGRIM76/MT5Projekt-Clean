...
class RedispyBridge(RedisBridge):
    ...
    def use_cluster(self, **options: str | float | bool) -> None:
        ...
        for host, port in self.options_from_uri.locations:
            cluster_hosts.append(self.dependency.asyncio.cluster.ClusterNode(host=host, port=int(port)))
    ...
    async def acquire_sliding_window_entry(
        ...
        acquired = await self.lua_acquire_sliding_window([previous_key, current_key], [limit, expiry, amount])
        return bool(acquired)
