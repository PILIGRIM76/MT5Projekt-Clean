    ...
    def __getitem__(self, key: str) -> Dependency:
        ...
        if dependency.module is MissingModule:
            ...
            if dependency.version_required:
                message += (
                    f" A minimum version of {dependency.version_required} is required." if dependency.version_required else ""
                )
            message += " See https://limits.readthedocs.io/en/stable/storage.html#supported-versions" " for more details."
