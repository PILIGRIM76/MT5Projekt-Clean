...
class Bar:
    ...
    def colour(self, value):
        ...
        try:
            ...
            warn(
                f"Unknown colour ({value}); valid choices:" f" [hex (#00ff00), {', '.join(self.COLOURS)}]",
                TqdmWarning,
                stacklevel=2,
            )
            self._colour = None
...
class tqdm(Comparable):
    ...
    def format_meter(
        ...
        **extra_kwargs,
        ...
        try:
            eta_dt = (
                datetime.now() + timedelta(seconds=remaining) if rate and total else datetime.fromtimestamp(0, timezone.utc)
            )
