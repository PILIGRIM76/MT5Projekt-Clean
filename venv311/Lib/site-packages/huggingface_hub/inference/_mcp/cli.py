        ...
        if len(inputs) > 0:
            ...
            for input_item in inputs:
                ...
                if not input_usages:
                    print(
                        ANSI.yellow(
                            f"Input '{input_id}' defined in config but not used by any server or as an API key." " Skipping."
                        )
                    )
                    continue
                ...
                if not final_value:
                    ...
                    if final_value:
                        ...
                        print(ANSI.yellow(f"No value found for '{env_variable_key}' in environment variables. Continuing."))
