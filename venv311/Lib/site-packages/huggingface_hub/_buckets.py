...
class _BucketAddFile:
    ...
    def __post_init__(self) -> None:
        ...
        self.mtime = int(os.path.getmtime(self.source) * 1000 if not isinstance(self.source, bytes) else time.time() * 1000)
...
class BucketFolder:
    ...
    def __init__(self, **kwargs):
        ...
        self.uploaded_at = (
            (uploaded_at if isinstance(uploaded_at, datetime) else parse_datetime(uploaded_at)) if uploaded_at else None
        )
