...
class ARCHModelFixedResult(_SummaryRepr):
    ...
    def forecast(
        ...
        *,
        ...
        if params is None:
            params = self._params
        elif params.size != np.array(self._params).size or params.ndim != self._params.ndim:
    ...
    def arch_lm_test(self, lags: int | None = None, standardized: bool = False) -> WaldTestStatistic:
        """
...
class ARCHModelResult(ARCHModelFixedResult):
    ...
    def summary(self) -> Summary:
        ...
        conf_int_str = ["[" + format_float_fixed(c[0], 7, 3) + "," + format_float_fixed(c[1], 7, 3) + "]" for c in conf_int]
...
def _format_forecasts(values: Float64Array, index: list[Label] | pd.Index, start_index: int) -> pd.DataFrame:
