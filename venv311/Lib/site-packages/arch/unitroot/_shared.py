...
def _check_cointegrating_regression(
    ...
    if y.shape[0] != x.shape[0]:
        raise ValueError(
            f"The number of observations in y and x differ. y has " f"{y.shape[0]} observtations, and x has {x.shape[0]}."
        )
...
def _cross_section(y: ArrayLike1D | ArrayLike2D, x: ArrayLike2D, trend: UnitRootTrend) -> RegressionResults:
