            ...
            for k, v in config[section].items():
                ...
                if strip_v.startswith("[") and strip_v.endswith("]"):
                    try:
                        ...
                        raise ConfigFileParserException(
                            "Error evaluating list: " + str(e) + ". Put quotes around your text if it's meant to be a string."
                        ) from e
                else:
            ...
            if source == _COMMAND_LINE_SOURCE_KEY:
                ...
                for action in self._actions:
                    ...
                    if (
                        ...
                        and already_on_command_line(existing_command_line_args, action.option_strings, self.prefix_chars)
                    ):
...
def add_argument(self, *args, **kwargs):
    ...
    is_config_file_arg = kwargs.pop("is_config_file_arg", None) or kwargs.pop("is_config_file", None)  # for backward compat.
