...
class TeacherForcing(Model):
    ...
    def get_teacher_forced_logits(self, X, Y):
        ...
        if (
            hasattr(self.similarity_model.config, "is_encoder_decoder") and not self.similarity_model.config.is_encoder_decoder
        ...
        if self.similarity_model.config.is_encoder_decoder:
            ...
            if (
                ...
                hasattr(self.similarity_model.config, "bos_token_id") and self.similarity_model.config.bos_token_id is not None
            ):
                ...
                raise ValueError("No decoder_start_token_id or bos_token_id defined in config for encoder-decoder generation")
