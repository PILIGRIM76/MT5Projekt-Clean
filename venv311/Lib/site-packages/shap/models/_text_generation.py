...
class TextGeneration(Model):
    ...
    def model_generate(self, X):
        ...
        """
        if (hasattr(self.inner_model.config, "is_encoder_decoder") and not self.inner_model.config.is_encoder_decoder) and (
            hasattr(self.inner_model.config, "is_decoder") and not self.inner_model.config.is_decoder
        ):
            pass
