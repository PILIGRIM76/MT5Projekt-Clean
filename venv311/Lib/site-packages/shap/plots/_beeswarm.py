...
def beeswarm(
    ...
    if len(sv_shape) == 1:
        ...
        emsg = "The beeswarm plot does not support plotting explanations with instances that have more than one dimension!"
        raise ValueError(emsg)
...
def summary_legacy(
    ...
    if plot_type == "dot":
        ...
        for i, ind in enumerate(class_inds):
            ...
            plt.barh(y_pos, global_shap_values[feature_inds], 0.7, left=left_pos, align="center", color=color(i), label=label)
    ...
    # draw the color bar
    if color_bar and features is not None and plot_type != "bar" and (plot_type != "layered_violin" or color in plt.colormaps):
        import matplotlib.cm as cm
