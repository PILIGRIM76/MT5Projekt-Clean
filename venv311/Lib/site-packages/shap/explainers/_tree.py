...
def _safe_check_tree_instance_experimental(tree_instance: Any) -> None:
    ...
    if safe_instance:
        ...
        warnings.warn(f"Unable to check experimental integration status for {tree_instance} object", ExperimentalWarning)
...
class TreeExplainer(Explainer):
    ...
    def shap_values(
        ...
        X, y, X_missing, flat_output, tree_limit, check_additivity = self._validate_inputs(X, y, tree_limit, check_additivity)
