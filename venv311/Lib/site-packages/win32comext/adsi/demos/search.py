...
def main():
    ...
    parser.add_option("-q", "--quiet", action="store_true", help="suppress output messages")
    ...
    parser.add_option("", "--attributes", help="comma sep'd list of attribute names to print")
