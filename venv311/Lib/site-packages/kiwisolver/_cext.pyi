...
class Constraint:
    def __init__(
        ...
        strength: float | Literal["weak"] | Literal["medium"] | Literal["strong"] | Literal["required"] = "required",
        /,
    ) -> None: ...
    ...
    def __or__(
        self,
        other: float | Literal["weak"] | Literal["medium"] | Literal["strong"] | Literal["required"],
    ) -> Constraint: ...
    def __ror__(
        self,
        other: float | Literal["weak"] | Literal["medium"] | Literal["strong"] | Literal["required"],
...
class Solver:
    ...
    def addEditVariable(
        self,
        variable: Variable,
        strength: float | Literal["weak"] | Literal["medium"] | Literal["strong"] | Literal["required"],
        /,
    ) -> None:
