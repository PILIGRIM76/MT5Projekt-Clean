...
if sys.version_info >= (3, 10):
    ...
    class LazyObjectProxy(AutoObjectProxy[T]):
        def __init__(self, callback: Callable[[], T] | None, *, interface: Any = ...) -> None: ...

    @overload
    def lazy_import(name: str) -> LazyObjectProxy[ModuleType]: ...
    @overload
    def lazy_import(name: str, attribute: str, *, interface: Any = ...) -> LazyObjectProxy[Any]: ...
    ...
    GenericCallableWrapperFunction = Callable[[WrappedFunction[P, R], Any, tuple[Any, ...], dict[str, Any]], R]

    ClassMethodWrapperFunction = Callable[[type[Any], WrappedFunction[P, R], Any, tuple[Any, ...], dict[str, Any]], R]

    InstanceMethodWrapperFunction = Callable[[Any, WrappedFunction[P, R], Any, tuple[Any, ...], dict[str, Any]], R]

    WrapperFunction = (
        GenericCallableWrapperFunction[P, R] | ClassMethodWrapperFunction[P, R] | InstanceMethodWrapperFunction[P, R]
    )
    ...
    class AdapterFactory(Protocol):
        def __call__(self, wrapped: Callable[..., Any]) -> str | FullArgSpec | Callable[..., Any]: ...
    ...
    class PartialFunctionDecorator:
        @overload
        def __call__(self, wrapper: GenericCallableWrapperFunction[P, R], /) -> FunctionDecorator: ...
        @overload
        def __call__(self, wrapper: ClassMethodWrapperFunction[P, R], /) -> FunctionDecorator: ...
        @overload
        def __call__(self, wrapper: InstanceMethodWrapperFunction[P, R], /) -> FunctionDecorator: ...
    ...
    @overload
    def decorator(wrapper: GenericCallableWrapperFunction[P, R], /) -> FunctionDecorator: ...
    @overload
    ...
    def transient_function_wrapper(target: ModuleType | type[Any] | Any | str, name: str) -> TransientDecorator: ...
    ...
    WrapperFactory = Callable[[Callable[..., Any], tuple[Any, ...], dict[str, Any]], type[ObjectProxy[Any]]]
    ...
    def register_post_import_hook(hook: Callable[[ModuleType], Any] | str, name: str) -> None: ...
