...
class Coder:
    ...
    def create(
        ...
        **kwargs,
        ...
        valid_formats = [str(c.edit_format) for c in coders.__all__ if hasattr(c, "edit_format") and c.edit_format is not None]
    ...
    def get_announcements(self):
        ...
        if self.edit_format == "architect":
            output = f"Editor model: {main_model.editor_model.name} with" f" {main_model.editor_edit_format} edit format"
            lines.append(output)
    ...
    def choose_fence(self):
        ...
        if good:
            ...
            self.io.tool_warning("Unable to find a fencing strategy! Falling back to:" f" {self.fence[0]}...{self.fence[1]}")
    ...
    def calculate_and_show_tokens_and_cost(self, messages, completion=None):
        ...
        if not cost:
            cost = self.compute_costs_from_tokens(prompt_tokens, completion_tokens, cache_write_tokens, cache_hit_tokens)
        ...
        cost_report = f"Cost: ${format_cost(self.message_cost)} message," f" ${format_cost(self.total_cost)} session."
