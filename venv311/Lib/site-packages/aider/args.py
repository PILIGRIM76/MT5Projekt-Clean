...
def get_parser(default_config_files, git_root):
    ...
    edit_format_choices = sorted(
        {c.edit_format for c in _aider_coders.__all__ if hasattr(c, "edit_format") and c.edit_format is not None}
    )
    group = parser.add_argument_group("Main model")
    group.add_argument("files", metavar="FILE", nargs="*", help="files to edit with an LLM (optional)").complete = shtab.FILE
    group.add_argument(
        "--model",
        metavar="MODEL",
        default=None,
    ...
    group.add_argument(
        ...
        metavar="WEAK_MODEL",
        default=None,
        help=("Specify the model to use for commit messages and chat history summarization (default" " depends on --model)"),
    )
    group.add_argument(
        "--editor-model",
    ...
    group.add_argument(
        ...
        help=("Specify a file containing the message to send the LLM, process reply, then exit" " (disables chat mode)"),
    ).complete = shtab.FILE
    group.add_argument(
        "--gui",
        "--browser",
