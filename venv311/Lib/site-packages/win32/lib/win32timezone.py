...
class TimeZoneInfo(datetime.tzinfo):
    ...
    def _LoadDynamicInfoFromKey(self, key) -> None:
        ...
        infos = [(int(year), TimeZoneDefinition(values)) for year, values in info.items()]
...
class _RegKeyDict(Dict[str, str]):
    ...
    @classmethod
    def open(cls, key: winreg._KeyType, sub_key: str, reserved: int = 0, access: int = 131097) -> _RegKeyDict:
    ...
    @staticmethod
    def _enumerate_reg(key: _T, func: Callable[[_T, int], _VT]) -> Generator[_VT, None, None]:
