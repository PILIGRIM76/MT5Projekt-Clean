...
class Submodule(IndexObject, TraversableIterableObj):
    ...
    @classmethod
    def _config_parser(cls, repo: "Repo", parent_commit: Union["Commit", None], read_only: bool) -> SubmoduleConfigParser:
        """
        :return:
        ...
        try:
            ...
            try:
                ...
                progress.update(
                    ...
                    0,
                    1,
                    prefix + "Cloning url '%s' to '%s' in submodule %r" % (self.url, checkout_module_abspath, self.name),
                )
                if not dry_run:
            ...
            if mrepo is not None and mrepo.head.commit.binsha != binsha:
                ...
                progress.update(
                    ...
                    0,
                    1,
                    prefix + "Updating working tree at %s for submodule %r to revision %s" % (self.path, self.name, hexsha),
                )
