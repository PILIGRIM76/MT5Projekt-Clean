...
from .multivariate_ols import MultivariateTestResults, _hypotheses_doc, _multivariate_ols_fit, _multivariate_ols_test
...
class MANOVA(Model):
    ...
    def fit(self):
        raise NotImplementedError("fit is not needed to use MANOVA. Call" "mv_test directly on a MANOVA instance.")
