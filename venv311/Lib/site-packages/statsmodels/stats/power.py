...
class Power:
    ...
    def __init__(self, **kwds):
        ...
        self.start_ttp = dict(
            effect_size=0.01, nobs=10.0, alpha=0.15, power=0.6, nobs1=10.0, ratio=1, df_num=10, df_denom=3  # for FTestPower
        )
...
class TTestIndPower(Power):
    ...
    def solve_power(self, effect_size=None, nobs1=None, alpha=None, power=None, ratio=1.0, alternative="two-sided"):
        ...
        return super().solve_power(
            effect_size=effect_size, nobs1=nobs1, alpha=alpha, power=power, ratio=ratio, alternative=alternative
        )
...
class FTestPower(Power):
    ...
    def solve_power(self, effect_size=None, df_num=None, df_denom=None, alpha=None, power=None, ncc=1, **kwargs):
        ...
        return super().solve_power(
            effect_size=effect_size, df_num=df_num, df_denom=df_denom, alpha=alpha, power=power, ncc=ncc
        )
