...
eff_prop1 = Holder(y_rd=y_rd, v_rd=v_rd, y_rr=y_rr, v_rr=v_rr, y_or=y_or, v_or=v_or, y_as=y_as, v_as=v_as)
...
results_or_dl_hk.event_e = np.array([18, 22, 21, 14, 42, 80, 13, 37, 23, 19, 106, 170, 34, 18, 13, 12, 42])
results_or_dl_hk.n_e = np.array([19, 34, 72, 22, 70, 183, 26, 61, 36, 45, 246, 386, 59, 45, 14, 26, 74])
results_or_dl_hk.event_c = np.array([12, 12, 15, 5, 13, 33, 18, 30, 12, 14, 76, 46, 17, 3, 14, 10, 40])
results_or_dl_hk.n_c = np.array([22, 35, 68, 20, 32, 94, 50, 55, 25, 35, 208, 141, 32, 15, 18, 19, 75])
