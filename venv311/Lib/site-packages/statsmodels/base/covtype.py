...
descriptions = {
    ...
    "HAC-Groupsum": "Driscoll and Kraay Standard Errors are robust to " "cluster correlation (HAC-Groupsum)",
    ...
    "OIM": "Covariance matrix calculated using the observed information " "matrix ({approx_type}) described in Harvey (1989).",
