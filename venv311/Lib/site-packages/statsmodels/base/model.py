...
class Model:
    ...
    will change as well.
    """.format(params_doc=_model_params_doc, extra_params_doc=_missing_param_doc + _extra_param_doc)
...
class GenericLikelihoodModel(LikelihoodModel):
    ...
    def __init__(
        self, endog, exog=None, loglike=None, score=None, hessian=None, missing="none", extra_params_names=None, **kwds
    ):
...
class GenericLikelihoodModelResults(LikelihoodModelResults, ResultMixin):
    ...
    def get_prediction(
        self, exog=None, which="mean", transform=True, row_labels=None, average=False, agg_weights=None, **kwargs
    ):
        """
