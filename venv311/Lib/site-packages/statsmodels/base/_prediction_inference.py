...
class PredictionResultsMonotonic(PredictionResultsBase):
    ...
    def __init__(
        self, predicted, var_pred, linpred=None, linpred_se=None, func=None, deriv=None, df=None, dist=None, row_labels=None
    ):
...
class PredictionResultsMean(PredictionResultsBase):
    ...
    def __init__(
        self, predicted_mean, var_pred_mean, var_resid=None, df=None, dist=None, row_labels=None, linpred=None, link=None
    ):
        # TODO: is var_resid used? drop from arguments?
...
def get_prediction_delta(
    self, exog=None, which="mean", average=False, agg_weights=None, transform=True, row_labels=None, pred_kwds=None
):
    """
...
def get_prediction(
    self, exog=None, transform=True, which="mean", row_labels=None, average=False, agg_weights=None, pred_kwds=None
):
    """
    Compute prediction results when endpoint transformation is valid.
