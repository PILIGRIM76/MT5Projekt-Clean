...
from statsmodels.stats.regularized_covariance import _calc_approx_inv_cov, _calc_nodewise_row, _calc_nodewise_weight
...
class DistributedModel:
    ...
    def fit(
        self, data_generator, fit_kwds=None, parallel_method="sequential", parallel_backend=None, init_kwds_generator=None
    ):
    ...
    def fit_joblib(self, data_generator, fit_kwds, parallel_backend, init_kwds_generator=None):
        ...
        if parallel_backend is None and init_kwds_generator is None:
            ...
            with parallel_backend:
                results_l = par(
                    f(self, pnum, endog, exog, fit_kwds, init_kwds) for pnum, ((endog, exog), init_kwds) in tup_gen
                )
