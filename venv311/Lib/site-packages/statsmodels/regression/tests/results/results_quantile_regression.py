...
epanechnikov_hsheather_q75.table = np.array(
    [[0.6440143, 0.0122001, 52.79, 0.000, 0.6199777, 0.6680508], [62.39648, 13.5509, 4.60, 0.000, 35.69854, 89.09443]]
)
...
biweight_bofinger.table = np.array(
    [[0.5601805, 0.0136491, 41.04, 0.000, 0.533289, 0.5870719], [81.48233, 15.1604, 5.37, 0.000, 51.61335, 111.3513]]
)
...
biweight_hsheather.table = np.array(
    [[0.5601805, 0.0128449, 43.61, 0.000, 0.5348735, 0.5854875], [81.48233, 14.26713, 5.71, 0.000, 53.37326, 109.5914]]
)
...
biweight_chamberlain.table = np.array(
    [[0.5601805, 0.0114969, 48.72, 0.000, 0.5375294, 0.5828315], [81.48233, 12.76983, 6.38, 0.000, 56.32325, 106.6414]]
)
...
epanechnikov_bofinger.table = np.array(
    [[0.5601805, 0.0209663, 26.72, 0.000, 0.5188727, 0.6014882], [81.48233, 23.28774, 3.50, 0.001, 35.60088, 127.3638]]
)
...
epanechnikov_hsheather.table = np.array(
    [[0.5601805, 0.0170484, 32.86, 0.000, 0.5265918, 0.5937692], [81.48233, 18.93605, 4.30, 0.000, 44.17457, 118.7901]]
)
...
epanechnikov_chamberlain.table = np.array(
    [[0.5601805, 0.0130407, 42.96, 0.000, 0.5344876, 0.5858733], [81.48233, 14.48467, 5.63, 0.000, 52.94468, 110.02]]
)
...
epan2_bofinger.table = np.array(
    [[0.5601805, 0.0143484, 39.04, 0.000, 0.5319113, 0.5884496], [81.48233, 15.93709, 5.11, 0.000, 50.08313, 112.8815]]
)
...
epan2_hsheather.table = np.array(
    [[0.5601805, 0.0131763, 42.51, 0.000, 0.5342206, 0.5861403], [81.48233, 14.63518, 5.57, 0.000, 52.64815, 110.3165]]
)
...
epan2_chamberlain.table = np.array(
    [[0.5601805, 0.0117925, 47.50, 0.000, 0.5369469, 0.583414], [81.48233, 13.0982, 6.22, 0.000, 55.67629, 107.2884]]
)
...
rectangle_bofinger.table = np.array(
    [[0.5601805, 0.0158331, 35.38, 0.000, 0.5289861, 0.5913748], [81.48233, 17.5862, 4.63, 0.000, 46.83404, 116.1306]]
)
...
rectangle_hsheather.table = np.array(
    [[0.5601805, 0.0137362, 40.78, 0.000, 0.5331174, 0.5872435], [81.48233, 15.25712, 5.34, 0.000, 51.42279, 111.5419]]
)
...
rectangle_chamberlain.table = np.array(
    [[0.5601805, 0.0118406, 47.31, 0.000, 0.5368522, 0.5835087], [81.48233, 13.1516, 6.20, 0.000, 55.57108, 107.3936]]
)
...
triangle_bofinger.table = np.array(
    [[0.5601805, 0.0138712, 40.38, 0.000, 0.5328515, 0.5875094], [81.48233, 15.40706, 5.29, 0.000, 51.12738, 111.8373]]
)
...
triangle_hsheather.table = np.array(
    [[0.5601805, 0.0128874, 43.47, 0.000, 0.5347898, 0.5855711], [81.48233, 14.31431, 5.69, 0.000, 53.2803, 109.6844]]
)
...
triangle_chamberlain.table = np.array(
    [[0.5601805, 0.0115725, 48.41, 0.000, 0.5373803, 0.5829806], [81.48233, 12.85389, 6.34, 0.000, 56.15764, 106.807]]
)
...
gaussian_bofinger.table = np.array(
    [[0.5601805, 0.0197311, 28.39, 0.000, 0.5213062, 0.5990547], [81.48233, 21.91582, 3.72, 0.000, 38.30383, 124.6608]]
)
...
gaussian_hsheather.table = np.array(
    [[0.5601805, 0.016532, 33.88, 0.000, 0.5276092, 0.5927518], [81.48233, 18.36248, 4.44, 0.000, 45.30462, 117.66]]
)
...
gaussian_chamberlain.table = np.array(
    [[0.5601805, 0.0128123, 43.72, 0.000, 0.5349378, 0.5854232], [81.48233, 14.23088, 5.73, 0.000, 53.44468, 109.52]]
)
...
cosine_bofinger.table = np.array(
    [[0.5601805, 0.0121011, 46.29, 0.000, 0.536339, 0.5840219], [81.48233, 13.44092, 6.06, 0.000, 55.00106, 107.9636]]
)
...
cosine_hsheather.table = np.array(
    [[0.5601805, 0.0116679, 48.01, 0.000, 0.5371924, 0.5831685], [81.48233, 12.9598, 6.29, 0.000, 55.94897, 107.0157]]
)
...
cosine_chamberlain.table = np.array(
    [[0.5601805, 0.0106479, 52.61, 0.000, 0.539202, 0.5811589], [81.48233, 11.82688, 6.89, 0.000, 58.18104, 104.7836]]
)
...
parzen_bofinger.table = np.array(
    [[0.5601805, 0.012909, 43.39, 0.000, 0.5347471, 0.5856138], [81.48233, 14.33838, 5.68, 0.000, 53.23289, 109.7318]]
)
...
parzen_hsheather.table = np.array(
    [[0.5601805, 0.0122688, 45.66, 0.000, 0.5360085, 0.5843524], [81.48233, 13.62723, 5.98, 0.000, 54.63401, 108.3307]]
)
...
parzen_chamberlain.table = np.array(
    [[0.5601805, 0.0110507, 50.69, 0.000, 0.5384084, 0.5819526], [81.48233, 12.2743, 6.64, 0.000, 57.29954, 105.6651]]
)
