    ...
    def filter(self, return_ssm=False, **kwargs):
        ...
        if not return_ssm:
            ...
            cov_kwds = {
                ...
                "custom_description": (
                    "Parameters and covariance matrix" " estimates are RLS estimates" " conditional on the entire sample."
                ),
            }
...
class RecursiveLSResults(MLEResults):
    ...
    def get_prediction(
        self, start=None, end=None, dynamic=False, information_set="predicted", signal_only=False, index=None, **kwargs
    ):
        ...
        if self.model._r_matrix is not None and (out_of_sample or dynamic):
            raise NotImplementedError(
                "Cannot yet perform out-of-sample or" " dynamic prediction in models with" " constraints."
            )
