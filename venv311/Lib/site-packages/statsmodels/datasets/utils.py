...
def get_rdataset(dataname, package="datasets", cache=False):
    ...
    data_base_url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/" "master/csv/" + package + "/"
    docs_base_url = "https://raw.githubusercontent.com/vincentarelbundock/Rdatasets/" "master/doc/" + package + "/rst/"
    ...
    return Dataset(data=data, __doc__=doc.read(), package=package, title=title, from_cache=from_cache)
