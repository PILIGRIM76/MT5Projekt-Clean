...
class Nested(CovStruct):
    ...
    def initialize(self, model):
        ...
        if self.model.weights is not None:
            warnings.warn(
                "weights not implemented for nested cov_struct, " "using unweighted covariance estimate", NotImplementedWarning
            )
...
class GlobalOddsRatio(CategoricalCovStruct):
    ...
    def initialize(self, model):
        ...
        if self.model.weights is not None:
            warnings.warn(
                "weights not implemented for GlobalOddsRatio " "cov_struct, using unweighted covariance estimate",
                NotImplementedWarning,
            )
...
class Equivalence(CovStruct):
    ...
    def initialize(self, model):
        ...
        if self.model.weights is not None:
            warnings.warn(
                "weights not implemented for equalence cov_struct, " "using unweighted covariance estimate",
                NotImplementedWarning,
            )
