...
params_table_rownames = ["income", "perpoverty", "perblack", "LN_VC100k96", "south", "degree", "_cons"]
...
resids_colnames = ["score_factor", "resid_response", "resid_anscombe", "resid_deviance", "resid_pearson", "resid_working"]
