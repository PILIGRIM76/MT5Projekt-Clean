...
class SimulationSmoother(KalmanSmoother):
    ...
    **kwargs
    ...
    def get_simulation_output(
        self, simulation_output=None, simulate_state=None, simulate_disturbance=None, simulate_all=None, **kwargs
    ):
        r"""
    ...
    def simulation_smoother(
        self, simulation_output=None, method="kfs", results_class=None, prefix=None, nobs=-1, random_state=None, **kwargs
    ):
        r"""
