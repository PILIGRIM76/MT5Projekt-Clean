...
local_level = {
    "models": [{"irregular": True, "level": True, "stochastic_level": True}, {"level": "local level"}, {"level": "llevel"}],
...
cycle_approx_diffuse.update(
    {"params": [37.57197224, 0.1, 2 * pi / 10, 1], "llf": -672.3102588, "kwargs": {"loglikelihood_burn": 0}}
)
...
seasonal_approx_diffuse.update({"params": [38.1704278, 0.1], "llf": -678.8138005, "kwargs": {"loglikelihood_burn": 0}})
...
freq_seasonal_approx_diffuse.update({"params": [38.95353592, 0.05], "llf": -688.9697249, "kwargs": {"loglikelihood_burn": 0}})
...
reg_approx_diffuse.update({"params": [2.215447924], "llf": -379.6233483, "kwargs": {"loglikelihood_burn": 0}})
