...
class StateSpaceMLEModel(tsbase.TimeSeriesModel):
    ...
    def fix_params(self, params):
        ...
        self._fixed_params = OrderedDict(
            [(name, self._fixed_params[name]) for name in self.param_names if name in self._fixed_params]
        )
        ...
        if method == "breakvar":
            ...
            for i in range(self.model.k_endog):
                ...
                if use_f:
                    ...
                    pval_lower = lambda test_statistics: f.cdf(test_statistics, numer_dof, denom_dof)  # noqa:E731
                    pval_upper = lambda test_statistics: f.sf(test_statistics, numer_dof, denom_dof)  # noqa:E731
                else:
                    from scipy.stats import chi2

                    pval_lower = lambda test_statistics: chi2.cdf(numer_dof * test_statistics, denom_dof)  # noqa:E731
                    pval_upper = lambda test_statistics: chi2.sf(numer_dof * test_statistics, denom_dof)  # noqa:E731
