...
class Y_arma11:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            #   [0.0017952, -0.0010996],
            #   [-0.0010996, 0.0043170]]
            self.cov_params = [[0.00179789246421, -0.00106195321540], [-0.00106195321540, 0.00370579282860]]
...
class Y_arma14:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            self.maroots = [1.0392 - 0.7070j, 1.0392 + 0.7070j, -1.2189 - 0.1310j, -1.2189 + 0.1310j]
            self.bse = [0.064888368113, 0.078031359430, 0.076246826219, 0.069267771804, 0.071567389557]
            self.cov_params = [
            ...
            self.maroots = [1.0280 - 0.6987j, 1.0280 + 0.6987j, -1.2108 - 0.1835j, -1.2108 + 0.1835j]
            # NOTE: bse, cov_params, tvalues taken from R; commented-out
            #   versions below are from [TODO: finish this sentence]
...
class Y_arma41:
    def __init__(self, method="mle"):
        if method == "mle":
            self.params = [0.859167822255, -0.445990454620, -0.094364739597, 0.633504596270, 0.039251240870]
...
class Y_arma50:
    def __init__(self, method="mle"):
        if method == "mle":
            self.params = [0.726892679311, -0.312619864536, 0.323740181610, 0.226499145083, -0.089562902305]
            self.aic = 691.422630427314
            self.bic = 712.551395934487
            self.arroots = [1.0772 + 0.0000j, 0.0087 - 1.2400j, 0.0087 + 1.2400j, -1.9764 + 0.0000j, 3.4107 + 0.0000j]
            ...
            self.bic = 697.8248
            self.arroots = [1.0755 + 0.0000j, 0.0075 - 1.2434j, 0.0075 + 1.2434j, -1.9686 + 0.0000j, 3.3994 + 0.0000j]
            self.maroots = None
...
class Y_arma14c:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            self.bse = [0.160891073193, 0.151756542096, 0.152996852330, 0.140231020145, 0.064663675882, 0.065045468010]
            self.cov_params = [
            ...
            self.bse = [0.1750455599911, 0.0942341854820, 0.0999988749541, 0.0929630759694, 0.0628352649371, 0.0645444272345]
            # self.cov_params = [
            ...
            self.tvalues = [27.08315344127, 7.24849772286, 1.97683352430, -8.21621311385, 2.18016541548, 4.72196341831]
...
class Y_arma41c:
    def __init__(self, method="mle"):
        if method == "mle":
            self.params = [1.062980233899, 0.768972932892, -0.264824839032, -0.279936544064, 0.756963578430, 0.231557444097]
            ...
            self.tvalues = [-1.02283347101, 11.85774561000, -2.93390571556, -3.30808959392, 13.56840602577, 2.24400708246]
...
class Y_arma22c:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            self.params = [4.507207454494, 0.793055048760, -0.363521072479, 0.033519062805, -0.702595834943]
...
class Y_arma50c:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            self.arroots = [-1.6535 + 0.0j, 0.0129 - 1.2018j, 0.0129 + 1.2018j, 1.1546 + 0.0j, 2.1052 + 0j]
            self.maroots = None
            ...
            self.params = [4.593494860193, 0.755427402630, -0.296867127441, 0.253556723526, 0.276987447724, -0.172647993470]
            # self.aic = 694.843378847617
            self.aic = 696.8434
            # self.bic = 715.850928110886
            self.bic = 721.3522
            self.arroots = [-1.6539 + 0.0000j, 0.0091 - 1.2069j, 0.0091 + 1.2069j, 1.1508 + 0.0000j, 2.0892 + 0.0000j]
            self.maroots = None
            # self.bse = [0.236922950898, 0.063573574389, 0.078206936773,
            #             0.078927252266, 0.078183651496, 0.063596048046]
            self.bse = [0.3359627893565, 0.0621593755265, 0.0764672280408, 0.0771715117870, 0.0764444608104, 0.0621813373935]
            # self.cov_params = [
