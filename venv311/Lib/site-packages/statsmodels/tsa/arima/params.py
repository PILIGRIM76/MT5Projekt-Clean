    ...
    def ar_poly(self, value):
        ...
        for i in range(1, self.spec.max_ar_order + 1):
            if i in self.spec.ar_lags:
                ...
                raise ValueError(
                    "AR polynomial includes non-zero values" " for lags that are excluded in the" " specification."
                )
    ...
    def ma_poly(self, value):
        ...
        for i in range(1, self.spec.max_ma_order + 1):
            if i in self.spec.ma_lags:
                ...
                raise ValueError(
                    "MA polynomial includes non-zero values" " for lags that are excluded in the" " specification."
                )
