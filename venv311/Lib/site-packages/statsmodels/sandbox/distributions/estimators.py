...
def fitquantilesgmm(distfn, x, start=None, pquant=None, frozen=None):
    ...
    parest = optimize.fmin(
        lambda params: np.sum(momentcondquant(distfn, params, mom2s, (pquant, xqs), shape=None) ** 2), start
    )
    return parest
...
if __name__ == "__main__":
    ...
    betaparest_gmmquantile = optimize.fmin(
        lambda params: np.sum(momentcondquant(stats.beta, params, mom2s, (pq, xqsb), shape=None) ** 2),
        [10, 10, 0.0, 1.0],
        maxiter=2000,
    )
    ...
    tparest_gmm3quantile = optimize.fmin(
        lambda params: np.sum(momentcondunbound(distfn, params, mom2s, (pq, xqs)) ** 2), [10, 1.0, 2.0]
    )
    ...
    tparest_gmmquantile = optimize.fmin(
        lambda params: np.sum(momentcondquant(distfn, params, mom2s, (pq, xqs), shape=None) ** 2), [10, 1.0, 2.0]
    )
