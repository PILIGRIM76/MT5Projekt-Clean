...
from . import kernels
from ._kernel_base import EstimatorSettings, GenericKDE, LeaveOneOut, _adjust_shape, gpke
...
class KDEMultivariateConditional(GenericKDE):
    ...
    def cdf(self, endog_predict=None, exog_predict=None):
        ...
        for i in range(N_data_predict):
            ...
            cdf_exog = gpke(
                self.bw[self.k_dep :], data=self.exog, data_predict=exog_predict[i, :], var_type=self.indep_type, tosum=False
            )
