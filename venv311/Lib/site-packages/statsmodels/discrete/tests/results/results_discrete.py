...
class Anes:
    ...
    def mnlogit_basezero():
        ...
        obj.margeff_dydx_overall = np.array(
            [
                [0.00868085993550, -0.09779854015456, 0.00272556969847, -0.01992376579372, -0.00603133322764],
                [0.00699386733148, -0.05022430802614, -0.00211003909752, -0.00536980000265, -0.00554366741814],
                [-0.00391040848820, -0.02824717135857, -0.00100551299310, 0.00664337806861, 0.00097987356999],
                [-0.00182580888015, -0.00573744730031, -0.00004249256428, -0.00546669558488, 0.00054101121854],
                [-0.00098558129923, 0.01985550937033, 0.00047972250012, 0.00172605778905, 0.00211291403209],
                [-0.00153469551647, 0.03755346502013, -0.00068531143399, 0.00472471794347, 0.00254733486106],
                [-0.00741820702809, 0.12459834487569, 0.00063806819375, 0.01766610701188, 0.00539385283759],
            ]
        ).T
        ...
        obj.margeff_dydx_mean = np.array(
            [
                [0.01149887431225, -0.13784207091973, 0.00273313385873, -0.02542974260540, -0.00855346837482],
                [0.01114846831102, -0.09864273512889, -0.00222435063712, -0.01214617126321, -0.00903581444579],
                [-0.00381702868421, -0.05132297961269, -0.00116763216994, 0.00624203027060, 0.00021912081810],
                [-0.00233455327258, -0.00928554037343, -0.00000206561214, -0.00775415690571, 0.00060004460394],
                [-0.00352579921274, 0.06412187169362, 0.00073938948643, 0.00747778063206, 0.00459965010365],
                [-0.00574308219449, 0.11126535089794, -0.00057337915464, 0.01467424346725, 0.00641760846097],
                [-0.00722687818452, 0.12170608820238, 0.00049490419675, 0.01693601418978, 0.00575285798725],
            ]
        ).T
        ...
        obj.margeff_dydx_dummy_overall = np.array(
            [
                ...
                [0.00058038428936, -0.00369080100124, 0.00035948233235, -0.00018863693013, 0.00079351293461, 0.12640653743480],
                [
                    0.00217597030999,
                    -0.01279456622853,
                    -0.00091882392767,
                ...
                [-0.00309932483642, 0.07911868907484, 0.00030378521102, 0.00805941631677, 0.00263129901425, 0.23790291475181],
            ]
        ).T
        obj.margeff_dydx_dummy_overall_se = np.array(
            [
                ...
                [0.0019756086, 0.0051031194, 0.0003862449, 0.0043621673, 0.0011796953, 0.0219999601],
                [0.0029714074, 0.0081732018, 0.0005715192, 0.0064742872, 0.0019130195, 0.0331694192],
                [0.0034443743, 0.0097296187, 0.0006774867, 0.0075996454, 0.0021993881, 0.038600835],
                [0.0032003518, 0.0098741227, 0.0006335772, 0.0070902078, 0.0021003227, 0.0255727127],
            ]
        ).T
        ...
        obj.margeff_eydx_dummy_overall_se = np.array(
            [
                [0.0272085605, 0.0777760394, 0.0052427952, 0.0584011446, 0.0148618012, 0.5796921383],
                [0.0262290023, 0.0724479385, 0.005174736, 0.0567743614, 0.0144447083, 0.3015738731],
                [0.0321415498, 0.0895589422, 0.0067480662, 0.0701460193, 0.0190451865, 0.3904138447],
                [0.0511305319, 0.1420904068, 0.0102342163, 0.1129912244, 0.0308618233, 0.3693799595],
                [0.0340186217, 0.0991711703, 0.0065812158, 0.0737441012, 0.0212966336, 0.2346982385],
                [0.0289250212, 0.0840662279, 0.0056743561, 0.0631772185, 0.0177278895, 0.2089516714],
                [0.0318251305, 0.1085637405, 0.0062400589, 0.0699123044, 0.0201045606, 0.3727166284],
            ]
        ).T
