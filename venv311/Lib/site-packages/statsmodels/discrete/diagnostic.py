...
class PoissonDiagnostic(CountDiagnostic):
    ...
    def _chisquare_binned(
        self, sort_var=None, bins=10, k_max=None, df=None, sort_method="quicksort", frac_upp=0.1, alpha_nc=0.05
    ):
        ...
        res = test_chisquare_binning(
            counts, expected, sort_var=sort_var, bins=bins, df=df, ordered=True, sort_method=sort_method, alpha_nc=alpha_nc
        )
        return res
