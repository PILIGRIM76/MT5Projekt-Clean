...
class PHReg(model.LikelihoodModel):
    ...
    def __init__(
        self, endog, exog, status=None, entry=None, strata=None, offset=None, ties="breslow", missing="drop", **kwargs
    ):
    ...
    def predict(
        self, params, exog=None, cov_params=None, endog=None, strata=None, offset=None, pred_type="lhr", pred_only=False
    ):
