...
def show_versions(show_dirs=True):
    ...
    try:
        ...
        print("numpy: {} ({})".format(safe_version(numpy, ["version", "version"]), dirname(numpy.__file__)))
    except ImportError:
        print("numpy: Not installed")
    ...
    try:
        ...
        print("scipy: {} ({})".format(safe_version(scipy, ["version", "version"]), dirname(scipy.__file__)))
    except ImportError:
        print("scipy: Not installed")
    ...
    try:
        ...
        print("pandas: {} ({})".format(safe_version(pandas, ["version", "version"], "__version__"), dirname(pandas.__file__)))
    except ImportError:
        print("pandas: Not installed")
