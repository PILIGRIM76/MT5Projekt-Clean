...
df_unordered["apply"] = df_unordered["apply"].cat.set_categories(["unlikely", "somewhat likely", "very likely"])
...
res_ord_logit.resid_prob_stats = [3.5137670974297e-06, -0.7706164931682951, 0.9434781714439548, 0.2550630116905416]
