...
if TYPE_CHECKING:
    ...
    _FileDescriptorOrPathT = TypeVar("_FileDescriptorOrPathT", bound=FileDescriptorOrPath)
    _P = ParamSpec("_P")
...
class on_interrupt(contextlib.ContextDecorator):
    ...
    def __init__(self, action: Literal["ignore", "suppress", "error"] = "error", /, code: int = 1):
        self.action = action
        self.code = code
