...
from ccxt.base.errors import ArgumentsRequired, AuthenticationError, BadRequest, ChecksumError, ExchangeError, NotSupported
...
class gate(ccxt.async_support.gate):
    ...
    async def watch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        :returns dict: a `ticker structure <https://docs.ccxt.com/?id=ticker-structure>`
        """
        return await self.subscribe_watch_tickers_and_bids_asks(
    ...
    async def subscribe_watch_tickers_and_bids_asks(
        self, symbols: Strings = None, callerMethodName: Str = None, params={}
    ) -> Tickers:
        await self.load_markets()
    ...
    async def un_subscribe_public_multiple(
        self, url, topic, symbols, messageHashes, subMessageHashes, payload, channel, params={}
    ):
        requestId = self.request_id()
        time = self.seconds()
        request: dict = {
