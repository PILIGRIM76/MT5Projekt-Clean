...
class luno(ccxt.async_support.luno):
    ...
    def parse_bids_asks(
        self, bidasks, priceKey: IndexType = "price", amountKey: IndexType = "volume", thirdKey: IndexType = 2
    ):
    ...
    def custom_parse_bid_ask(
        self, bidask, priceKey: IndexType = "price", amountKey: IndexType = "volume", thirdKey: IndexType = 2
    ):
