...
class cryptocom(Exchange, ImplicitAPI):
    ...
    def create_order_request(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        params = self.omit(
            params,
            ["postOnly", "clientOrderId", "timeInForce", "stopPrice", "triggerPrice", "stopLossPrice", "takeProfitPrice"],
        )
    ...
    def create_advanced_order_request(
        ...
        if isTrigger:
            ...
            request["type"] = uppercaseType
        if (side == "buy") and (
            (uppercaseType == "MARKET") or (uppercaseType == "STOP_LOSS") or (uppercaseType == "TAKE_PROFIT")
        ):
