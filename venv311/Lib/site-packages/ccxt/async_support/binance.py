...
class binance(Exchange, ImplicitAPI):
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        for i in range(0, len(fetchMarkets)):
            ...
            if marketType == "spot":
                ...
                raise ExchangeError(
                    self.id + ' fetchMarkets() self.options fetchMarkets "' + marketType + '" is not a supported market type'
                )
    ...
    def parse_market(self, market: dict) -> Market:
        ...
        if contract:
            if swap:
                ...
                symbol = (
                    symbol + ":" + settle + "-" + self.yymmdd(expiry) + "-" + strike + "-" + self.safe_string(optionParts, 3)
                )
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        if limit is not None:
            ...
            request["limit"] = (
                min(limit, maxLimitForContractHistorical) if isFutureOrSwap else limit
        ...
        if market["linear"] or isPortfolioMargin:
            if (price is None) and not ("priceMatch" in params):
                raise ArgumentsRequired(
                    self.id + " editOrder() requires a price argument for portfolio margin and linear orders"
                )
    ...
    def parse_order(self, order: dict, market: Market = None) -> Order:
        ...
        timestamp = self.safe_integer_n(
            order, ["time", "createTime", "workingTime", "transactTime", "updateTime"]
    ...
    def create_order_request(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        if (
            ...
            request["timeInForce"] = self.safe_string(
                self.options, "defaultTimeInForce"
            )  # 'GTC' = Good To Cancel(default), 'IOC' = Immediate Or Cancel
    ...
    async def fetch_order(self, id: str, symbol: Str = None, params={}):
        ...
        if clientOrderId is not None:
            ...
            request["orderId"] = id
        params = self.omit(
            params, ["type", "clientOrderId", "origClientOrderId", "stop", "trigger", "conditional", "clientAlgoId"]
        )
        response = None
        if market["option"]:
    ...
    def sign(self, path, api="public", method="GET", params={}, headers=None, body=None):
        ...
        if userDataStream:
            ...
            if (
                ...
                and (not self.safe_bool(self.options, "disableFuturesSandboxWarning"))
            ):
                raise NotSupported(
                    self.id
