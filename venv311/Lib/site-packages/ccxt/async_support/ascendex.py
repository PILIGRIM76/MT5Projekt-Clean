...
class ascendex(Exchange, ImplicitAPI):
    ...
    async def fetch_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        method = self.get_supported_mapping(
            type,
            {
                "spot": defaultMethod,
        ...
        if numAddresses > 1:
            ...
            if networkId is None:
                ...
                raise ArgumentsRequired(
                    self.id
                    + " fetchDepositAddress() returned more than one address, a chainName parameter is required, one of "
                    + chains
                )
    ...
    async def transfer(self, code: str, amount: float, fromAccount: str, toAccount: str, params={}) -> TransferEntry:
        ...
        if fromId != "cash" and toId != "cash":
            raise ExchangeError(
                self.id + " transfer() only supports direct balance transfer between spot and swap, spot and margin"
            )
        request: dict = {
            "account-group": accountGroup,
