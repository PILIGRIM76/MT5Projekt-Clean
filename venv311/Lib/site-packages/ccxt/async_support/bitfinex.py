...
class bitfinex(Exchange, ImplicitAPI):
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        spotMarketsInfo, futuresMarketsInfo, securitiesMarketsIds, marginIds = await self.publicGetConfConfig(
    ...
    def create_order_request(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        params = self.omit(
            params, ["triggerPrice", "stopPrice", "timeInForce", "postOnly", "reduceOnly", "trailingAmount", "clientOrderId"]
        )
    ...
    async def cancel_order(self, id: str, symbol: Str = None, params={}):
        ...
        if cid is not None:
            ...
            if cidDate is None:
                raise InvalidOrder(
                    self.id + " canceling an order by clientOrderId('cid') requires both 'cid' and 'cid_date'('YYYY-MM-DD')"
                )
            request = {
                "cid": cid,
                "cid_date": cidDate,
