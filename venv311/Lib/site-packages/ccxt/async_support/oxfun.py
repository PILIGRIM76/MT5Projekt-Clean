...
class oxfun(Exchange, ImplicitAPI):
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        """
        responseFromMarkets, responseFromTickers = await asyncio.gather(
            *[self.publicGetV3Markets(params), self.publicGetV3Tickers(params)]
        )
    ...
    async def fetch_ohlcv(
        ...
        if until is not None:
            ...
            request["endTime"] = self.sum(
                since, 7 * 24 * 60 * 60 * 1000
            )  # for the exchange not to raise an exception if since is younger than 7 days
    ...
    def parse_transactions(
        self, transactions, currency: Currency = None, since: Int = None, limit: Int = None, params={}
    ) -> List[Transaction]:
        result = []
