...
class mercado(Exchange, ImplicitAPI):
                ...
                if tag is None:
                    if not ("destination_tag" in params):
                        raise ArgumentsRequired(
                            self.id + " withdraw() requires a tag argument or destination_tag parameter to withdraw " + code
                        )
                else:
    ...
    async def fetch_ohlcv(
        self, symbol: str, timeframe: str = "15m", since: Int = None, limit: Int = None, params={}
    ) -> List[list]:
        """
