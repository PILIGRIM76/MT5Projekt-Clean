...
class exmo(Exchange, ImplicitAPI):
    ...
    def parse_fixed_float_value(self, input):
        ...
        if (result > 0) and isPercentage:
            raise ExchangeError(
                self.id + " parseFixedFloatValue() detected an unsupported non-zero percentage-based fee " + input
            )
        return result
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        params = self.omit(
            params, ["stopPrice", "stop_price", "triggerPrice", "timeInForce", "client_id", "clientOrderId", "cost"]
        )
