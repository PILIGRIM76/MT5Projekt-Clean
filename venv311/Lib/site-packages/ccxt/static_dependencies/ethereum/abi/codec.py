...
class ABIDecoder(BaseABICoder):
    ...
    def decode_single(self, typ: TypeStr, data: Decodable) -> Any:
        ...
        """
        warnings.warn(
            "abi.decode_single() is deprecated and will be removed in version 4.0.0 " "in favor of abi.decode()",
            category=DeprecationWarning,
        )
    ...
    def decode_abi(self, types: Iterable[TypeStr], data: Decodable) -> Tuple[Any, ...]:
        ...
        """
        warnings.warn(
            "abi.decode_abi() is deprecated and will be removed in version 4.0.0 in " "favor of abi.decode()",
            category=DeprecationWarning,
        )
