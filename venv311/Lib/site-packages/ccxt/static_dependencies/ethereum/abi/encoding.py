...
class TupleEncoder(BaseEncoder):
    ...
    def from_type_str(cls, abi_type, registry):
        encoders = tuple(registry.get_encoder(c.to_type_str()) for c in abi_type.components)
...
class NumberEncoder(Fixed32ByteSizeEncoder):
    ...
    def validate_value(self, value):
        ...
        illegal_value = self.illegal_value_fn is not None and self.illegal_value_fn(value)
        if illegal_value:
