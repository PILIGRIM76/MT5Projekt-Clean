...
if "argname" not in inspect.signature(typeguard.check_type).parameters:
    ...
    # typeguard < 3.0.0rc2
    def _check_type(value, expected_type, argname: str):
        return typeguard.check_type(value=value, expected_type=expected_type, argname=argname)  # type: ignore[call-overload]
    ...
    def _serialize(self, value: Any, attr: Optional[str], obj, **kwargs) -> Any:
        ...
        for typ, field in self.union_fields:
            try:
                ...
                errors.append(e)
        raise TypeError(f"Unable to serialize value with any of the fields in the union: {errors}")
    ...
    def _deserialize(self, value: Any, attr: Optional[str], data, **kwargs) -> Any:
        ...
        for typ, field in self.union_fields:
            try:
                ...
                _check_type(value=result, expected_type=typ, argname=attr or "anonymous")
                return result
