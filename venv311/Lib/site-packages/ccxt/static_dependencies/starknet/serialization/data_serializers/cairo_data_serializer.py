...
class CairoDataSerializer(ABC, Generic[SerializationType, DeserializationType]):
    ...
    @abstractmethod
    def deserialize_with_context(self, context: DeserializationContext) -> DeserializationType:
        """
        Transform calldata into python value.
    ...
    @abstractmethod
    def serialize_with_context(self, context: SerializationContext, value: SerializationType) -> Generator[int, None, None]:
        """
