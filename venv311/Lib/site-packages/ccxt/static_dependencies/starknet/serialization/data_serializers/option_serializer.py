...
class OptionSerializer(CairoDataSerializer[Optional[Any], Optional[Any]]):
    ...
    def deserialize_with_context(self, context: DeserializationContext) -> Optional[Any]:
    ...
    def serialize_with_context(self, context: SerializationContext, value: Optional[Any]) -> Generator[int, None, None]:
        if value is None:
            yield 1
        else:
            yield 0
