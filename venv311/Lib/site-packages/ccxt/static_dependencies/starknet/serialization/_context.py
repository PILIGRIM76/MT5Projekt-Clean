...
class Context(ABC):
    ...
    def ensure_valid_type(self, value: Any, valid: bool, expected_type: str):
        if not valid:
            raise InvalidTypeException(
                f"{self._error_prefix}: expected {expected_type}, " f"received '{value}' of type '{type(value)}'."
            )
    ...
    def _wrap_errors(self):
        try:
            ...
            action_name = f"deserialize '{self.current_entity}'" if self._namespace_stack else "deserialize"
