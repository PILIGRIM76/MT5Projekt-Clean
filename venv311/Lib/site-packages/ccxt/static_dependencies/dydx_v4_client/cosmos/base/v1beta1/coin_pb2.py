...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _COIN.fields_by_name["amount"]._serialized_options = (
    ...
    _DECCOIN.fields_by_name["amount"]._serialized_options = (
