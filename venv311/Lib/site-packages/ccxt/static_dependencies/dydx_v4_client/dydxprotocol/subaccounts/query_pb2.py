...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYCOLLATERALPOOLADDRESSRESPONSE.fields_by_name["collateral_pool_address"]._serialized_options = (
        b"\322\264-\024cosmos.AddressString"
    )
    _QUERY.methods_by_name["Subaccount"]._options = None
    _QUERY.methods_by_name["Subaccount"]._serialized_options = (
        b"\202\323\344\223\0027\0225/dydxprotocol/subaccounts/subaccount/{owner}/{number}"
    )
    _QUERY.methods_by_name["SubaccountAll"]._options = None
    _QUERY.methods_by_name["SubaccountAll"]._serialized_options = (
        b"\202\323\344\223\002&\022$/dydxprotocol/subaccounts/subaccount"
    )
    _QUERY.methods_by_name["GetWithdrawalAndTransfersBlockedInfo"]._options = None
    _QUERY.methods_by_name["GetWithdrawalAndTransfersBlockedInfo"]._serialized_options = (
    ...
    _QUERY.methods_by_name["CollateralPoolAddress"]._serialized_options = (
