...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MSGUPDATEEQUITYTIERLIMITCONFIGURATION.fields_by_name["authority"]._serialized_options = (
    ...
    _MSGUPDATEBLOCKRATELIMITCONFIGURATION.fields_by_name["authority"]._serialized_options = (
        b"\322\264-\024cosmos.AddressString"
    )
