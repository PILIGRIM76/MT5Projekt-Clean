...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _BLOCKRATELIMITCONFIGURATION.fields_by_name["max_short_term_orders_per_n_blocks"]._serialized_options = (
    ...
    _BLOCKRATELIMITCONFIGURATION.fields_by_name["max_short_term_order_cancellations_per_n_blocks"]._serialized_options = (
        b"\030\001\310\336\037\000"
    )
    _BLOCKRATELIMITCONFIGURATION.fields_by_name["max_short_term_orders_and_cancels_per_n_blocks"]._options = None
    _BLOCKRATELIMITCONFIGURATION.fields_by_name["max_short_term_orders_and_cancels_per_n_blocks"]._serialized_options = (
        b"\310\336\037\000"
    )
