        ...
        if marketType == "spot":
            ...
            if subType == "linear":
                ...
                if marginMode == "isolated":
                    ...
                    if trigger:
                        response = self.contractPrivatePostLinearSwapApiV1SwapCrossTriggerOpenorders(
                            self.extend(request, params)
                        )
                    elif stopLossTakeProfit:
                        response = self.contractPrivatePostLinearSwapApiV1SwapCrossTpslOpenorders(self.extend(request, params))
                    elif trailing:
                        response = self.contractPrivatePostLinearSwapApiV1SwapCrossTrackOpenorders(
                            self.extend(request, params)
                        )
                    else:
        ...
        if marketType == "spot":
            ...
            if market["linear"]:
                ...
                if marginMode == "isolated":
                    ...
                    if trigger:
                        response = self.contractPrivatePostLinearSwapApiV1SwapCrossTriggerCancelall(
                            self.extend(request, params)
                        )
                    elif stopLossTakeProfit:
