    ...
    def fetch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if marketType == "spot":
            ...
            if marginMode is not None:
                if marginMode != "isolated":
                    raise BadRequest(
                        self.id + " fetchOrders() does not support marginMode " + marginMode + " for spot-margin trading"
                    )
    ...
    def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if marketType == "spot":
            ...
            if marginMode is not None:
                if marginMode != "isolated":
                    raise BadRequest(
                        self.id + " fetchOpenOrders() does not support marginMode " + marginMode + " for spot-margin trading"
                    )
    ...
    def cancel_order(self, id: str, symbol: Str = None, params={}):
        ...
        if marketType == "spot":
            ...
            if marginMode is not None:
                if marginMode != "isolated":
                    raise BadRequest(
                        self.id + " cancelOrder() does not support marginMode " + marginMode + " for spot-margin trading"
                    )
    ...
    def cancel_all_orders(self, symbol: Str = None, params={}):
        ...
        if marketType == "spot":
            ...
            if marginMode is not None:
                if marginMode != "isolated":
                    raise BadRequest(
                        self.id + " cancelAllOrders() does not support marginMode " + marginMode + " for spot-margin trading"
                    )
