...
class coinex(Exchange, ImplicitAPI):
    ...
    def create_order_request(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        if swap:
            ...
            if triggerPrice is not None:
                request["trigger_price"] = self.price_to_precision(symbol, triggerPrice)
        params = self.omit(
            params, ["reduceOnly", "timeInForce", "postOnly", "stopPrice", "triggerPrice", "stopLossPrice", "takeProfitPrice"]
        )
    ...
    def edit_orders(self, orders: List[OrderRequest], params={}) -> List[Order]:
        ...
        for i in range(0, len(data)):
            ...
            if (code != "0") or (
                (message != "Success") and (message != "Succeeded") and (message.lower() != "ok") and not data
            ):
