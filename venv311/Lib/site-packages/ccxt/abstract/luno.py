...
class ImplicitAPI:
    ...
    private_get_accounts_id_pending = privateGetAccountsIdPending = Entry(
        "accounts/{id}/pending", "private", "GET", {"cost": 1}
    )
    private_get_accounts_id_transactions = privateGetAccountsIdTransactions = Entry(
    ...
    private_delete_beneficiaries_id = privateDeleteBeneficiariesId = Entry(
