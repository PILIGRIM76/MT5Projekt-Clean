...
class ImplicitAPI:
    ...
    private_get_accounts_account_currency = privateGetAccountsAccountCurrency = Entry(
    ...
    private_get_withdrawals_withdrawalid = privateGetWithdrawalsWithdrawalId = Entry(
