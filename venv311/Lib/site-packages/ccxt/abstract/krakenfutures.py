...
class ImplicitAPI:
    ...
    private_get_assignmentprogram_current = privateGetAssignmentprogramCurrent = Entry(
        "assignmentprogram/current", "private", "GET", {}
    )
    private_get_assignmentprogram_history = privateGetAssignmentprogramHistory = Entry(
        "assignmentprogram/history", "private", "GET", {}
    )
    ...
    private_post_assignmentprogram_add = privatePostAssignmentprogramAdd = Entry(
        "assignmentprogram/add", "private", "POST", {}
    )
    private_post_assignmentprogram_delete = privatePostAssignmentprogramDelete = Entry(
        "assignmentprogram/delete", "private", "POST", {}
    )
    ...
    charts_get_price_type_symbol_interval = chartsGetPriceTypeSymbolInterval = Entry(
        "{price_type}/{symbol}/{interval}", "charts", "GET", {}
    )
    ...
    history_get_market_symbol_executions = historyGetMarketSymbolExecutions = Entry(
        "market/{symbol}/executions", "history", "GET", {}
    )
