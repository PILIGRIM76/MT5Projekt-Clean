...
class ImplicitAPI:
    ...
    public_get_candles_timeframe_unit = publicGetCandlesTimeframeUnit = Entry(
    ...
    public_get_candles_minutes_unit = publicGetCandlesMinutesUnit = Entry(
    ...
    public_get_orderbook_instruments = publicGetOrderbookInstruments = Entry(
    ...
    private_get_withdraws_coin_addresses = privateGetWithdrawsCoinAddresses = Entry(
    ...
    private_get_deposits_chance_coin = privateGetDepositsChanceCoin = Entry(
        "deposits/chance/coin", "private", "GET", {"cost": 0.67}
    )
    private_get_deposit = privateGetDeposit = Entry("deposit", "private", "GET", {"cost": 0.67})
    private_get_deposits_coin_addresses = privateGetDepositsCoinAddresses = Entry(
        "deposits/coin_addresses", "private", "GET", {"cost": 0.67}
    )
    private_get_deposits_coin_address = privateGetDepositsCoinAddress = Entry(
    ...
    private_post_orders_cancel_and_new = privatePostOrdersCancelAndNew = Entry(
    ...
    private_post_deposits_generate_coin_address = privatePostDepositsGenerateCoinAddress = Entry(
        "deposits/generate_coin_address", "private", "POST", {"cost": 0.67}
    )
    private_post_travel_rule_deposit_uuid = privatePostTravelRuleDepositUuid = Entry(
        "travel_rule/deposit/uuid", "private", "POST", {"cost": 0.67}
    )
    private_post_travel_rule_deposit_txid = privatePostTravelRuleDepositTxid = Entry(
