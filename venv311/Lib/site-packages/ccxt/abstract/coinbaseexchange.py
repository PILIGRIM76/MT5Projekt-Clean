...
class ImplicitAPI:
    ...
    private_get_margin_profile_information = privateGetMarginProfileInformation = Entry(
        "margin/profile_information", "private", "GET", {}
    )
    private_get_margin_buying_power = privateGetMarginBuyingPower = Entry("margin/buying_power", "private", "GET", {})
    private_get_margin_withdrawal_power = privateGetMarginWithdrawalPower = Entry(
        "margin/withdrawal_power", "private", "GET", {}
    )
    private_get_margin_withdrawal_power_all = privateGetMarginWithdrawalPowerAll = Entry(
        "margin/withdrawal_power_all", "private", "GET", {}
    )
    private_get_margin_exit_plan = privateGetMarginExitPlan = Entry("margin/exit_plan", "private", "GET", {})
    private_get_margin_liquidation_history = privateGetMarginLiquidationHistory = Entry(
        "margin/liquidation_history", "private", "GET", {}
    )
    private_get_margin_position_refresh_amounts = privateGetMarginPositionRefreshAmounts = Entry(
        "margin/position_refresh_amounts", "private", "GET", {}
    )
    ...
    private_get_orders_client_client_oid = privateGetOrdersClientClientOid = Entry(
        "orders/client:{client_oid}", "private", "GET", {}
    )
    ...
    private_get_users_self_exchange_limits = privateGetUsersSelfExchangeLimits = Entry(
        "users/self/exchange-limits", "private", "GET", {}
    )
    private_get_users_self_hold_balances = privateGetUsersSelfHoldBalances = Entry(
        "users/self/hold-balances", "private", "GET", {}
    )
    private_get_users_self_trailing_volume = privateGetUsersSelfTrailingVolume = Entry(
        "users/self/trailing-volume", "private", "GET", {}
    )
    private_get_withdrawals_fee_estimate = privateGetWithdrawalsFeeEstimate = Entry(
        "withdrawals/fee-estimate", "private", "GET", {}
    )
    private_get_conversions_conversion_id = privateGetConversionsConversionId = Entry(
        "conversions/{conversion_id}", "private", "GET", {}
    )
    ...
    private_get_loans_lending_overview_xm = privateGetLoansLendingOverviewXm = Entry(
        "loans/lending-overview-xm", "private", "GET", {}
    )
    ...
    private_get_loans_repayment_preview = privateGetLoansRepaymentPreview = Entry(
        "loans/repayment-preview", "private", "GET", {}
    )
    private_get_loans_repayment_preview_xm = privateGetLoansRepaymentPreviewXm = Entry(
        "loans/repayment-preview-xm", "private", "GET", {}
    )
    private_get_loans_interest_loan_id = privateGetLoansInterestLoanId = Entry(
        "loans/interest/{loan_id}", "private", "GET", {}
    )
    private_get_loans_interest_history_loan_id = privateGetLoansInterestHistoryLoanId = Entry(
        "loans/interest/history/{loan_id}", "private", "GET", {}
    )
    ...
    private_post_deposits_coinbase_account = privatePostDepositsCoinbaseAccount = Entry(
        "deposits/coinbase-account", "private", "POST", {}
    )
    private_post_deposits_payment_method = privatePostDepositsPaymentMethod = Entry(
        "deposits/payment-method", "private", "POST", {}
    )
    private_post_coinbase_accounts_id_addresses = privatePostCoinbaseAccountsIdAddresses = Entry(
        "coinbase-accounts/{id}/addresses", "private", "POST", {}
    )
    ...
    private_post_profiles_margin_transfer = privatePostProfilesMarginTransfer = Entry(
        "profiles/margin-transfer", "private", "POST", {}
    )
    ...
    private_post_withdrawals_coinbase_account = privatePostWithdrawalsCoinbaseAccount = Entry(
        "withdrawals/coinbase-account", "private", "POST", {}
    )
    private_post_withdrawals_crypto = privatePostWithdrawalsCrypto = Entry("withdrawals/crypto", "private", "POST", {})
    private_post_withdrawals_payment_method = privatePostWithdrawalsPaymentMethod = Entry(
        "withdrawals/payment-method", "private", "POST", {}
    )
    ...
    private_delete_orders_client_client_oid = privateDeleteOrdersClientClientOid = Entry(
        "orders/client:{client_oid}", "private", "DELETE", {}
    )
