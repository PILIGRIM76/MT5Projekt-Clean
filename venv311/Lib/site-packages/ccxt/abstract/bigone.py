...
class ImplicitAPI:
    ...
    public_get_asset_pairs_asset_pair_name_depth = publicGetAssetPairsAssetPairNameDepth = Entry(
        "asset_pairs/{asset_pair_name}/depth", "public", "GET", {}
    )
    public_get_asset_pairs_asset_pair_name_trades = publicGetAssetPairsAssetPairNameTrades = Entry(
        "asset_pairs/{asset_pair_name}/trades", "public", "GET", {}
    )
    public_get_asset_pairs_asset_pair_name_ticker = publicGetAssetPairsAssetPairNameTicker = Entry(
        "asset_pairs/{asset_pair_name}/ticker", "public", "GET", {}
    )
    public_get_asset_pairs_asset_pair_name_candles = publicGetAssetPairsAssetPairNameCandles = Entry(
        "asset_pairs/{asset_pair_name}/candles", "public", "GET", {}
    )
    ...
    private_get_assets_asset_symbol_address = privateGetAssetsAssetSymbolAddress = Entry(
        "assets/{asset_symbol}/address", "private", "GET", {}
    )
    ...
    contractpublic_get_depth_symbol_snapshot = contractPublicGetDepthSymbolSnapshot = Entry(
        "depth@{symbol}/snapshot", "contractPublic", "GET", {}
    )
    contractpublic_get_instruments_difference = contractPublicGetInstrumentsDifference = Entry(
        "instruments/difference", "contractPublic", "GET", {}
    )
    contractpublic_get_instruments_prices = contractPublicGetInstrumentsPrices = Entry(
        "instruments/prices", "contractPublic", "GET", {}
    )
    ...
    contractprivate_get_orders_opening = contractPrivateGetOrdersOpening = Entry(
        "orders/opening", "contractPrivate", "GET", {}
    )
    contractprivate_get_orders_count = contractPrivateGetOrdersCount = Entry("orders/count", "contractPrivate", "GET", {})
    contractprivate_get_orders_opening_count = contractPrivateGetOrdersOpeningCount = Entry(
        "orders/opening/count", "contractPrivate", "GET", {}
    )
    ...
    contractprivate_put_positions_symbol_margin = contractPrivatePutPositionsSymbolMargin = Entry(
        "positions/{symbol}/margin", "contractPrivate", "PUT", {}
    )
    contractprivate_put_positions_symbol_risk_limit = contractPrivatePutPositionsSymbolRiskLimit = Entry(
        "positions/{symbol}/risk-limit", "contractPrivate", "PUT", {}
    )
    contractprivate_delete_orders_id = contractPrivateDeleteOrdersId = Entry("orders/{id}", "contractPrivate", "DELETE", {})
    contractprivate_delete_orders_batch = contractPrivateDeleteOrdersBatch = Entry(
        "orders/batch", "contractPrivate", "DELETE", {}
    )
