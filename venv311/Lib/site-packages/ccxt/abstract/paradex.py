...
class ImplicitAPI:
    ...
    private_get_account_subaccounts = privateGetAccountSubaccounts = Entry(
    ...
    private_get_orders_by_client_id_client_id = privateGetOrdersByClientIdClientId = Entry(
    ...
    private_get_points_data_market_program = privateGetPointsDataMarketProgram = Entry(
        "points_data/{market}/{program}", "private", "GET", {"cost": 1}
    )
    ...
    private_get_algo_orders_algo_id = privateGetAlgoOrdersAlgoId = Entry(
        "algo/orders/{algo_id}", "private", "GET", {"cost": 1}
    )
    private_get_vaults_account_summary = privateGetVaultsAccountSummary = Entry(
        "vaults/account-summary", "private", "GET", {"cost": 1}
    )
    private_post_account_margin_market = privatePostAccountMarginMarket = Entry(
        "account/margin/{market}", "private", "POST", {"cost": 1}
    )
    private_post_account_profile_max_slippage = privatePostAccountProfileMaxSlippage = Entry(
        "account/profile/max_slippage", "private", "POST", {"cost": 1}
    )
    private_post_account_profile_referral_code = privatePostAccountProfileReferralCode = Entry(
        "account/profile/referral_code", "private", "POST", {"cost": 1}
    )
    private_post_account_profile_username = privatePostAccountProfileUsername = Entry(
    ...
    private_delete_orders_by_client_id_client_id = privateDeleteOrdersByClientIdClientId = Entry(
    ...
    private_delete_algo_orders_algo_id = privateDeleteAlgoOrdersAlgoId = Entry(
