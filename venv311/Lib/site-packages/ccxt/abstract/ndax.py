...
class ImplicitAPI:
    ...
    public_get_subscribeblocktrades = publicGetSubscribeBlockTrades = Entry(
        "SubscribeBlockTrades", "public", "GET", {"cost": 1}
    )
    public_get_unsubscribeblocktrades = publicGetUnsubscribeBlockTrades = Entry(
    ...
    private_get_getuseraccountinfos = privateGetGetUserAccountInfos = Entry(
    ...
    private_get_getuseraffiliatecount = privateGetGetUserAffiliateCount = Entry(
        "GetUserAffiliateCount", "private", "GET", {"cost": 1}
    )
    private_get_getuseraffiliatetag = privateGetGetUserAffiliateTag = Entry(
    ...
    private_get_getallunredacteduserconfigsforuser = privateGetGetAllUnredactedUserConfigsForUser = Entry(
    ...
    private_get_getuserreporttickets = privateGetGetUserReportTickets = Entry(
        "GetUserReportTickets", "private", "GET", {"cost": 1}
    )
    private_get_getuserreportwriterresultrecords = privateGetGetUserReportWriterResultRecords = Entry(
    ...
    private_get_getaccountpositions = privateGetGetAccountPositions = Entry(
        "GetAccountPositions", "private", "GET", {"cost": 1}
    )
    private_get_getallaccountconfigs = privateGetGetAllAccountConfigs = Entry(
    ...
    private_get_getaccounttransactions = privateGetGetAccountTransactions = Entry(
        "GetAccountTransactions", "private", "GET", {"cost": 1}
    )
    private_get_getopentradereports = privateGetGetOpenTradeReports = Entry(
        "GetOpenTradeReports", "private", "GET", {"cost": 1}
    )
    private_get_getallopentradereports = privateGetGetAllOpenTradeReports = Entry(
    ...
    private_get_getalldepositrequestinfotemplates = privateGetGetAllDepositRequestInfoTemplates = Entry(
    ...
    private_get_getwithdrawtemplate = privateGetGetWithdrawTemplate = Entry(
        "GetWithdrawTemplate", "private", "GET", {"cost": 1}
    )
    private_get_getwithdrawtemplatetypes = privateGetGetWithdrawTemplateTypes = Entry(
    ...
    private_post_adduseraffiliatetag = privatePostAddUserAffiliateTag = Entry(
    ...
    private_post_subscribeaccountevents = privatePostSubscribeAccountEvents = Entry(
        "SubscribeAccountEvents", "private", "POST", {"cost": 1}
    )
    private_post_updateuseraffiliatetag = privatePostUpdateUserAffiliateTag = Entry(
    ...
    private_post_generatetransactionactivityreport = privatePostGenerateTransactionActivityReport = Entry(
    ...
    private_post_scheduletransactionactivityreport = privatePostScheduleTransactionActivityReport = Entry(
    ...
    private_post_cancelreplaceorder = privatePostCancelReplaceOrder = Entry(
    ...
    private_post_createdepositticket = privatePostCreateDepositTicket = Entry(
        "CreateDepositTicket", "private", "POST", {"cost": 1}
    )
    private_post_createwithdrawticket = privatePostCreateWithdrawTicket = Entry(
        "CreateWithdrawTicket", "private", "POST", {"cost": 1}
    )
    private_post_submitdepositticketcomment = privatePostSubmitDepositTicketComment = Entry(
    ...
    private_post_getorderhistorybyorderid = privatePostGetOrderHistoryByOrderId = Entry(
