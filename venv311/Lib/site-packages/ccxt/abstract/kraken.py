...
class ImplicitAPI:
    ...
    private_post_cancelallordersafter = privatePostCancelAllOrdersAfter = Entry(
        "CancelAllOrdersAfter", "private", "POST", {"cost": 3}
    )
    private_post_getwebsocketstoken = privatePostGetWebSocketsToken = Entry(
    ...
    private_post_earn_allocatestatus = privatePostEarnAllocateStatus = Entry(
        "Earn/AllocateStatus", "private", "POST", {"cost": 3}
    )
    private_post_earn_deallocatestatus = privatePostEarnDeallocateStatus = Entry(
