...
class ImplicitAPI:
    ...
    private_get_orders_client_order_id_client_oid = privateGetOrdersClientOrderIdClientOid = Entry(
        "orders/client_order_id/{client_oid}", "private", "GET", {}
    )
    private_get_products_product_id_orders_leverage = privateGetProductsProductIdOrdersLeverage = Entry(
        "products/{product_id}/orders/leverage", "private", "GET", {}
    )
    ...
    private_get_fills_history_download_csv = privateGetFillsHistoryDownloadCsv = Entry(
        "fills/history/download/csv", "private", "GET", {}
    )
    ...
    private_get_wallet_transactions_download = privateGetWalletTransactionsDownload = Entry(
        "wallet/transactions/download", "private", "GET", {}
    )
    private_get_wallets_sub_accounts_transfer_history = privateGetWalletsSubAccountsTransferHistory = Entry(
        "wallets/sub_accounts_transfer_history", "private", "GET", {}
    )
    private_get_users_trading_preferences = privateGetUsersTradingPreferences = Entry(
        "users/trading_preferences", "private", "GET", {}
    )
    ...
    private_post_products_product_id_orders_leverage = privatePostProductsProductIdOrdersLeverage = Entry(
        "products/{product_id}/orders/leverage", "private", "POST", {}
    )
    private_post_positions_change_margin = privatePostPositionsChangeMargin = Entry(
        "positions/change_margin", "private", "POST", {}
    )
    private_post_positions_close_all = privatePostPositionsCloseAll = Entry("positions/close_all", "private", "POST", {})
    private_post_wallets_sub_account_balance_transfer = privatePostWalletsSubAccountBalanceTransfer = Entry(
        "wallets/sub_account_balance_transfer", "private", "POST", {}
    )
