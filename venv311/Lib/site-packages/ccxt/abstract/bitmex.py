...
class ImplicitAPI:
    ...
    public_get_instrument_activeandindices = publicGetInstrumentActiveAndIndices = Entry(
        "instrument/activeAndIndices", "public", "GET", {"cost": 5}
    )
    public_get_instrument_activeintervals = publicGetInstrumentActiveIntervals = Entry(
        "instrument/activeIntervals", "public", "GET", {"cost": 5}
    )
    public_get_instrument_compositeindex = publicGetInstrumentCompositeIndex = Entry(
    ...
    public_get_instrument_usdvolume = publicGetInstrumentUsdVolume = Entry(
    ...
    public_get_schema_websockethelp = publicGetSchemaWebsocketHelp = Entry(
    ...
    private_get_execution_tradehistory = privateGetExecutionTradeHistory = Entry(
    ...
    private_get_user_affiliatestatus = privateGetUserAffiliateStatus = Entry(
        "user/affiliateStatus", "private", "GET", {"cost": 5}
    )
    private_get_user_checkreferralcode = privateGetUserCheckReferralCode = Entry(
    ...
    private_get_user_depositaddress = privateGetUserDepositAddress = Entry(
        "user/depositAddress", "private", "GET", {"cost": 5}
    )
    private_get_user_executionhistory = privateGetUserExecutionHistory = Entry(
        "user/executionHistory", "private", "GET", {"cost": 5}
    )
    private_get_user_getwallettransferaccounts = privateGetUserGetWalletTransferAccounts = Entry(
    ...
    private_get_user_quotefillratio = privateGetUserQuoteFillRatio = Entry(
        "user/quoteFillRatio", "private", "GET", {"cost": 5}
    )
    private_get_user_quotevalueratio = privateGetUserQuoteValueRatio = Entry(
    ...
    private_get_user_staking_instruments = privateGetUserStakingInstruments = Entry(
    ...
    private_get_user_unstakingrequests = privateGetUserUnstakingRequests = Entry(
    ...
    private_post_guild_sharestrades = privatePostGuildSharesTrades = Entry(
        "guild/sharesTrades", "private", "POST", {"cost": 5}
    )
    private_post_order = privatePostOrder = Entry("order", "private", "POST", {"cost": 1})
    private_post_order_cancelallafter = privatePostOrderCancelAllAfter = Entry(
        "order/cancelAllAfter", "private", "POST", {"cost": 5}
    )
    private_post_order_closeposition = privatePostOrderClosePosition = Entry(
    ...
    private_post_position_risklimit = privatePostPositionRiskLimit = Entry(
        "position/riskLimit", "private", "POST", {"cost": 5}
    )
    private_post_position_transfermargin = privatePostPositionTransferMargin = Entry(
        "position/transferMargin", "private", "POST", {"cost": 1}
    )
    private_post_user_addsubaccount = privatePostUserAddSubaccount = Entry(
        "user/addSubaccount", "private", "POST", {"cost": 5}
    )
    private_post_user_cancelwithdrawal = privatePostUserCancelWithdrawal = Entry(
        "user/cancelWithdrawal", "private", "POST", {"cost": 5}
    )
    private_post_user_communicationtoken = privatePostUserCommunicationToken = Entry(
    ...
    private_post_user_confirmwithdrawal = privatePostUserConfirmWithdrawal = Entry(
    ...
    private_post_user_requestwithdrawal = privatePostUserRequestWithdrawal = Entry(
        "user/requestWithdrawal", "private", "POST", {"cost": 5}
    )
    private_post_user_unstakingrequests = privatePostUserUnstakingRequests = Entry(
        "user/unstakingRequests", "private", "POST", {"cost": 5}
    )
    private_post_user_updatesubaccount = privatePostUserUpdateSubaccount = Entry(
        "user/updateSubaccount", "private", "POST", {"cost": 5}
    )
    private_post_user_wallettransfer = privatePostUserWalletTransfer = Entry(
    ...
    private_delete_user_unstakingrequests = privateDeleteUserUnstakingRequests = Entry(
