...
class ImplicitAPI:
    ...
    public_get_v3_data_all_ticker_info = publicGetV3DataAllTickerInfo = Entry(
    ...
    private_get_v3_order_by_client_order_id = privateGetV3OrderByClientOrderId = Entry(
    ...
    private_post_v3_delete_open_orders = privatePostV3DeleteOpenOrders = Entry(
        "v3/delete-open-orders", "private", "POST", {"cost": 1}
    )
    private_post_v3_delete_client_order_id = privatePostV3DeleteClientOrderId = Entry(
    ...
    private_post_v3_set_initial_margin_rate = privatePostV3SetInitialMarginRate = Entry(
    ...
    private_post_v3_contract_transfer_out = privatePostV3ContractTransferOut = Entry(
