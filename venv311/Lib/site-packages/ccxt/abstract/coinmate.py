...
class ImplicitAPI:
    ...
    private_post_bitcoincashwithdrawal = privatePostBitcoinCashWithdrawal = Entry(
        "bitcoinCashWithdrawal", "private", "POST", {}
    )
    private_post_bitcoincashdepositaddresses = privatePostBitcoinCashDepositAddresses = Entry(
        "bitcoinCashDepositAddresses", "private", "POST", {}
    )
    private_post_bitcoindepositaddresses = privatePostBitcoinDepositAddresses = Entry(
        "bitcoinDepositAddresses", "private", "POST", {}
    )
    private_post_bitcoinwithdrawal = privatePostBitcoinWithdrawal = Entry("bitcoinWithdrawal", "private", "POST", {})
    private_post_bitcoinwithdrawalfees = privatePostBitcoinWithdrawalFees = Entry(
        "bitcoinWithdrawalFees", "private", "POST", {}
    )
    ...
    private_post_ethereumdepositaddresses = privatePostEthereumDepositAddresses = Entry(
        "ethereumDepositAddresses", "private", "POST", {}
    )
    private_post_litecoinwithdrawal = privatePostLitecoinWithdrawal = Entry("litecoinWithdrawal", "private", "POST", {})
    private_post_litecoindepositaddresses = privatePostLitecoinDepositAddresses = Entry(
        "litecoinDepositAddresses", "private", "POST", {}
    )
    ...
    private_post_rippledepositaddresses = privatePostRippleDepositAddresses = Entry(
        "rippleDepositAddresses", "private", "POST", {}
    )
    ...
    private_post_unconfirmedbitcoindeposits = privatePostUnconfirmedBitcoinDeposits = Entry(
        "unconfirmedBitcoinDeposits", "private", "POST", {}
    )
    private_post_unconfirmedbitcoincashdeposits = privatePostUnconfirmedBitcoinCashDeposits = Entry(
        "unconfirmedBitcoinCashDeposits", "private", "POST", {}
    )
    private_post_unconfirmeddashdeposits = privatePostUnconfirmedDashDeposits = Entry(
        "unconfirmedDashDeposits", "private", "POST", {}
    )
    private_post_unconfirmedethereumdeposits = privatePostUnconfirmedEthereumDeposits = Entry(
        "unconfirmedEthereumDeposits", "private", "POST", {}
    )
    private_post_unconfirmedlitecoindeposits = privatePostUnconfirmedLitecoinDeposits = Entry(
        "unconfirmedLitecoinDeposits", "private", "POST", {}
    )
    private_post_unconfirmedrippledeposits = privatePostUnconfirmedRippleDeposits = Entry(
        "unconfirmedRippleDeposits", "private", "POST", {}
    )
    private_post_cancelallopenorders = privatePostCancelAllOpenOrders = Entry("cancelAllOpenOrders", "private", "POST", {})
    private_post_withdrawvirtualcurrency = privatePostWithdrawVirtualCurrency = Entry(
        "withdrawVirtualCurrency", "private", "POST", {}
    )
    private_post_virtualcurrencydepositaddresses = privatePostVirtualCurrencyDepositAddresses = Entry(
        "virtualCurrencyDepositAddresses", "private", "POST", {}
    )
    private_post_unconfirmedvirtualcurrencydeposits = privatePostUnconfirmedVirtualCurrencyDeposits = Entry(
        "unconfirmedVirtualCurrencyDeposits", "private", "POST", {}
    )
    ...
    private_post_unconfirmedadadeposits = privatePostUnconfirmedAdaDeposits = Entry(
        "unconfirmedAdaDeposits", "private", "POST", {}
    )
    ...
    private_post_unconfirmedsoldeposits = privatePostUnconfirmedSolDeposits = Entry(
        "unconfirmedSolDeposits", "private", "POST", {}
    )
