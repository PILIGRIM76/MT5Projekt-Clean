...
class ImplicitAPI:
    sapi_get_copytrading_futures_userstatus = sapiGetCopyTradingFuturesUserStatus = Entry(
        "copyTrading/futures/userStatus", "sapi", "GET", {"cost": 2}
    )
    sapi_get_copytrading_futures_leadsymbol = sapiGetCopyTradingFuturesLeadSymbol = Entry(
    ...
    sapi_get_asset_custody_transfer_history = sapiGetAssetCustodyTransferHistory = Entry(
    ...
    sapi_get_margin_delist_schedule = sapiGetMarginDelistSchedule = Entry(
        "margin/delist-schedule", "sapi", "GET", {"cost": 10}
    )
    sapi_get_margin_available_inventory = sapiGetMarginAvailableInventory = Entry(
        "margin/available-inventory", "sapi", "GET", {"cost": 0.3334}
    )
    sapi_get_margin_leveragebracket = sapiGetMarginLeverageBracket = Entry(
    ...
    sapi_get_loan_vip_request_interestrate = sapiGetLoanVipRequestInterestRate = Entry(
    ...
    sapi_get_loan_flexible_ongoing_orders = sapiGetLoanFlexibleOngoingOrders = Entry(
        "loan/flexible/ongoing/orders", "sapi", "GET", {"cost": 30}
    )
    sapi_get_loan_flexible_borrow_history = sapiGetLoanFlexibleBorrowHistory = Entry(
        "loan/flexible/borrow/history", "sapi", "GET", {"cost": 40}
    )
    sapi_get_loan_flexible_repay_history = sapiGetLoanFlexibleRepayHistory = Entry(
        "loan/flexible/repay/history", "sapi", "GET", {"cost": 40}
    )
    sapi_get_loan_flexible_ltv_adjustment_history = sapiGetLoanFlexibleLtvAdjustmentHistory = Entry(
    ...
    sapi_get_capital_deposit_address_list = sapiGetCapitalDepositAddressList = Entry(
    ...
    sapi_get_capital_withdraw_address_list = sapiGetCapitalWithdrawAddressList = Entry(
    ...
    sapi_get_convert_limit_queryopenorders = sapiGetConvertLimitQueryOpenOrders = Entry(
    ...
    sapi_get_sub_account_transaction_statistics = sapiGetSubAccountTransactionStatistics = Entry(
        "sub-account/transaction-statistics", "sapi", "GET", {"cost": 0.40002}
    )
    sapi_get_sub_account_subaccountapi_iprestriction = sapiGetSubAccountSubAccountApiIpRestriction = Entry(
    ...
    sapi_get_managed_subaccount_querytranslogfortradeparent = sapiGetManagedSubaccountQueryTransLogForTradeParent = Entry(
        "managed-subaccount/queryTransLogForTradeParent", "sapi", "GET", {"cost": 0.40002}
    )
    ...
    sapi_get_eth_staking_eth_history_stakinghistory = sapiGetEthStakingEthHistoryStakingHistory = Entry(
        "eth-staking/eth/history/stakingHistory", "sapi", "GET", {"cost": 15}
    )
    sapi_get_eth_staking_eth_history_redemptionhistory = sapiGetEthStakingEthHistoryRedemptionHistory = Entry(
        "eth-staking/eth/history/redemptionHistory", "sapi", "GET", {"cost": 15}
    )
    sapi_get_eth_staking_eth_history_rewardshistory = sapiGetEthStakingEthHistoryRewardsHistory = Entry(
    ...
    sapi_get_eth_staking_eth_history_ratehistory = sapiGetEthStakingEthHistoryRateHistory = Entry(
    ...
    sapi_get_eth_staking_wbeth_history_wraphistory = sapiGetEthStakingWbethHistoryWrapHistory = Entry(
        "eth-staking/wbeth/history/wrapHistory", "sapi", "GET", {"cost": 15}
    )
    sapi_get_eth_staking_wbeth_history_unwraphistory = sapiGetEthStakingWbethHistoryUnwrapHistory = Entry(
    ...
    sapi_get_sol_staking_sol_history_stakinghistory = sapiGetSolStakingSolHistoryStakingHistory = Entry(
        "sol-staking/sol/history/stakingHistory", "sapi", "GET", {"cost": 15}
    )
    sapi_get_sol_staking_sol_history_redemptionhistory = sapiGetSolStakingSolHistoryRedemptionHistory = Entry(
    ...
    sapi_get_sol_staking_sol_history_ratehistory = sapiGetSolStakingSolHistoryRateHistory = Entry(
    ...
    sapi_get_algo_spot_historicalorders = sapiGetAlgoSpotHistoricalOrders = Entry(
    ...
    sapi_get_portfolio_margin_asset_leverage = sapiGetPortfolioMarginAssetLeverage = Entry(
    ...
    sapi_get_portfolio_negative_balance_exchange_record = sapiGetPortfolioNegativeBalanceExchangeRecord = Entry(
        "portfolio/negative-balance-exchange-record", "sapi", "GET", {"cost": 2}
    )
    sapi_get_portfolio_pmloan_history = sapiGetPortfolioPmloanHistory = Entry(
        "portfolio/pmloan-history", "sapi", "GET", {"cost": 5}
    )
    sapi_get_portfolio_earn_asset_balance = sapiGetPortfolioEarnAssetBalance = Entry(
    ...
    sapi_get_lending_auto_invest_index_info = sapiGetLendingAutoInvestIndexInfo = Entry(
        "lending/auto-invest/index/info", "sapi", "GET", {"cost": 0.1}
    )
    sapi_get_lending_auto_invest_index_user_summary = sapiGetLendingAutoInvestIndexUserSummary = Entry(
        "lending/auto-invest/index/user-summary", "sapi", "GET", {"cost": 0.1}
    )
    sapi_get_lending_auto_invest_one_off_status = sapiGetLendingAutoInvestOneOffStatus = Entry(
        "lending/auto-invest/one-off/status", "sapi", "GET", {"cost": 0.1}
    )
    sapi_get_lending_auto_invest_redeem_history = sapiGetLendingAutoInvestRedeemHistory = Entry(
        "lending/auto-invest/redeem/history", "sapi", "GET", {"cost": 0.1}
    )
    sapi_get_lending_auto_invest_rebalance_history = sapiGetLendingAutoInvestRebalanceHistory = Entry(
    ...
    sapi_get_simple_earn_flexible_history_subscriptionrecord = sapiGetSimpleEarnFlexibleHistorySubscriptionRecord = Entry(
        "simple-earn/flexible/history/subscriptionRecord", "sapi", "GET", {"cost": 15}
    )
    ...
    sapi_get_accumulator_product_list = sapiGetAccumulatorProductList = Entry(
        "accumulator/product/list", "sapi", "GET", {"cost": 0.1}
    )
    sapi_get_accumulator_product_position_list = sapiGetAccumulatorProductPositionList = Entry(
        "accumulator/product/position/list", "sapi", "GET", {"cost": 0.1}
    )
    sapi_get_accumulator_product_sum_holding = sapiGetAccumulatorProductSumHolding = Entry(
        "accumulator/product/sum-holding", "sapi", "GET", {"cost": 0.1}
    )
    sapi_get_asset_assetdistributionhistory = sapiGetAssetAssetDistributionHistory = Entry(
        "asset/assetDistributionHistory", "sapi", "GET", {"cost": 1}
    )
    sapi_get_asset_query_trading_fee = sapiGetAssetQueryTradingFee = Entry(
        "asset/query/trading-fee", "sapi", "GET", {"cost": 1}
    )
    sapi_get_asset_query_trading_volume = sapiGetAssetQueryTradingVolume = Entry(
    ...
    sapi_get_fiatpayment_query_withdraw_history = sapiGetFiatpaymentQueryWithdrawHistory = Entry(
        "fiatpayment/query/withdraw/history", "sapi", "GET", {"cost": 1}
    )
    sapi_get_fiatpayment_query_deposit_history = sapiGetFiatpaymentQueryDepositHistory = Entry(
        "fiatpayment/query/deposit/history", "sapi", "GET", {"cost": 1}
    )
    sapi_get_capital_sub_account_deposit_address = sapiGetCapitalSubAccountDepositAddress = Entry(
        "capital/sub-account/deposit/address", "sapi", "GET", {"cost": 1}
    )
    sapi_get_capital_sub_account_deposit_history = sapiGetCapitalSubAccountDepositHistory = Entry(
    ...
    sapi_get_asset_query_dust_assets = sapiGetAssetQueryDustAssets = Entry(
        "asset/query/dust-assets", "sapi", "GET", {"cost": 1}
    )
    sapi_get_marketing_referral_reward_history = sapiGetMarketingReferralRewardHistory = Entry(
    ...
    sapi_get_staking_stakingbalance = sapiGetStakingStakingBalance = Entry(
    ...
    sapi_get_staking_stakingrewardshistory = sapiGetStakingStakingRewardsHistory = Entry(
    ...
    sapi_get_custodian_supportedassetlist = sapiGetCustodianSupportedAssetList = Entry(
        "custodian/supportedAssetList", "sapi", "GET", {"cost": 1}
    )
    sapi_get_custodian_wallettransferhistory = sapiGetCustodianWalletTransferHistory = Entry(
        "custodian/walletTransferHistory", "sapi", "GET", {"cost": 1}
    )
    sapi_get_custodian_custodiantransferhistory = sapiGetCustodianCustodianTransferHistory = Entry(
    ...
    sapi_get_custodian_orderhistory = sapiGetCustodianOrderHistory = Entry(
        "custodian/orderHistory", "sapi", "GET", {"cost": 1}
    )
    sapi_get_custodian_tradehistory = sapiGetCustodianTradeHistory = Entry(
        "custodian/tradeHistory", "sapi", "GET", {"cost": 1}
    )
    sapi_get_custodian_settlementsetting = sapiGetCustodianSettlementSetting = Entry(
        "custodian/settlementSetting", "sapi", "GET", {"cost": 1}
    )
    sapi_get_custodian_settlementhistory = sapiGetCustodianSettlementHistory = Entry(
    ...
    sapi_get_apipartner_checkeligibility = sapiGetApipartnerCheckEligibility = Entry(
        "apipartner/checkEligibility", "sapi", "GET", {"cost": 1}
    )
    sapi_get_apipartner_rebatehistory = sapiGetApipartnerRebateHistory = Entry(
    ...
    sapi_post_broker_subaccountapi_permission_universaltransfer = sapiPostBrokerSubAccountApiPermissionUniversalTransfer = (
        Entry("broker/subAccountApi/permission/universalTransfer", "sapi", "POST", {"cost": 1})
    )
    sapi_post_broker_subaccountapi_permission_vanillaoptions = sapiPostBrokerSubAccountApiPermissionVanillaOptions = Entry(
        "broker/subAccountApi/permission/vanillaOptions", "sapi", "POST", {"cost": 1}
    )
    ...
    sapi_post_algo_spot_newordertwap = sapiPostAlgoSpotNewOrderTwap = Entry(
    ...
    sapi_post_eth_staking_wbeth_wrap = sapiPostEthStakingWbethWrap = Entry(
    ...
    sapi_post_mining_hash_transfer_config = sapiPostMiningHashTransferConfig = Entry(
        "mining/hash-transfer/config", "sapi", "POST", {"cost": 0.5}
    )
    sapi_post_mining_hash_transfer_config_cancel = sapiPostMiningHashTransferConfigCancel = Entry(
    ...
    sapi_post_loan_flexible_adjust_ltv = sapiPostLoanFlexibleAdjustLtv = Entry(
    ...
    sapi_post_convert_limit_placeorder = sapiPostConvertLimitPlaceOrder = Entry(
        "convert/limit/placeOrder", "sapi", "POST", {"cost": 3.3335}
    )
    sapi_post_convert_limit_cancelorder = sapiPostConvertLimitCancelOrder = Entry(
    ...
    sapi_post_portfolio_earn_asset_transfer = sapiPostPortfolioEarnAssetTransfer = Entry(
    ...
    sapi_post_lending_auto_invest_one_off = sapiPostLendingAutoInvestOneOff = Entry(
        "lending/auto-invest/one-off", "sapi", "POST", {"cost": 0.1}
    )
    sapi_post_lending_auto_invest_redeem = sapiPostLendingAutoInvestRedeem = Entry(
    ...
    sapi_post_simple_earn_locked_setredeemoption = sapiPostSimpleEarnLockedSetRedeemOption = Entry(
        "simple-earn/locked/setRedeemOption", "sapi", "POST", {"cost": 5}
    )
    sapi_post_dci_product_subscribe = sapiPostDciProductSubscribe = Entry(
        "dci/product/subscribe", "sapi", "POST", {"cost": 0.1}
    )
    sapi_post_dci_product_auto_compound_edit = sapiPostDciProductAutoCompoundEdit = Entry(
        "dci/product/auto_compound/edit", "sapi", "POST", {"cost": 0.1}
    )
    sapi_post_accumulator_product_subscribe = sapiPostAccumulatorProductSubscribe = Entry(
    ...
    sapi_post_fiatpayment_withdraw_apply = sapiPostFiatpaymentWithdrawApply = Entry(
    ...
    sapi_post_custodian_wallettransfer = sapiPostCustodianWalletTransfer = Entry(
        "custodian/walletTransfer", "sapi", "POST", {"cost": 1}
    )
    sapi_post_custodian_custodiantransfer = sapiPostCustodianCustodianTransfer = Entry(
        "custodian/custodianTransfer", "sapi", "POST", {"cost": 1}
    )
    sapi_post_custodian_undotransfer = sapiPostCustodianUndoTransfer = Entry(
    ...
    sapi_delete_sub_account_subaccountapi_iprestriction_iplist = sapiDeleteSubAccountSubAccountApiIpRestrictionIpList = Entry(
        "sub-account/subAccountApi/ipRestriction/ipList", "sapi", "DELETE", {"cost": 20.001}
    )
    sapi_delete_custodian_cancelorder = sapiDeleteCustodianCancelOrder = Entry(
        "custodian/cancelOrder", "sapi", "DELETE", {"cost": 1}
    )
    sapi_delete_custodian_cancelordersbysymbol = sapiDeleteCustodianCancelOrdersBySymbol = Entry(
        "custodian/cancelOrdersBySymbol", "sapi", "DELETE", {"cost": 1}
    )
    sapi_delete_custodian_cancelocoorder = sapiDeleteCustodianCancelOcoOrder = Entry(
    ...
    sapiv2_get_sub_account_futures_accountsummary = sapiV2GetSubAccountFuturesAccountSummary = Entry(
    ...
    sapiv2_get_loan_flexible_ongoing_orders = sapiV2GetLoanFlexibleOngoingOrders = Entry(
        "loan/flexible/ongoing/orders", "sapiV2", "GET", {"cost": 30}
    )
    sapiv2_get_loan_flexible_borrow_history = sapiV2GetLoanFlexibleBorrowHistory = Entry(
        "loan/flexible/borrow/history", "sapiV2", "GET", {"cost": 40}
    )
    sapiv2_get_loan_flexible_repay_history = sapiV2GetLoanFlexibleRepayHistory = Entry(
        "loan/flexible/repay/history", "sapiV2", "GET", {"cost": 40}
    )
    sapiv2_get_loan_flexible_ltv_adjustment_history = sapiV2GetLoanFlexibleLtvAdjustmentHistory = Entry(
        "loan/flexible/ltv/adjustment/history", "sapiV2", "GET", {"cost": 40}
    )
    sapiv2_get_loan_flexible_loanable_data = sapiV2GetLoanFlexibleLoanableData = Entry(
        "loan/flexible/loanable/data", "sapiV2", "GET", {"cost": 40}
    )
    sapiv2_get_loan_flexible_collateral_data = sapiV2GetLoanFlexibleCollateralData = Entry(
    ...
    sapiv2_post_eth_staking_eth_stake = sapiV2PostEthStakingEthStake = Entry(
        "eth-staking/eth/stake", "sapiV2", "POST", {"cost": 15}
    )
    sapiv2_post_sub_account_subaccountapi_iprestriction = sapiV2PostSubAccountSubAccountApiIpRestriction = Entry(
        "sub-account/subAccountApi/ipRestriction", "sapiV2", "POST", {"cost": 20.001}
    )
    sapiv2_post_loan_flexible_borrow = sapiV2PostLoanFlexibleBorrow = Entry(
        "loan/flexible/borrow", "sapiV2", "POST", {"cost": 40.002}
    )
    sapiv2_post_loan_flexible_repay = sapiV2PostLoanFlexibleRepay = Entry(
        "loan/flexible/repay", "sapiV2", "POST", {"cost": 40.002}
    )
    sapiv2_post_loan_flexible_adjust_ltv = sapiV2PostLoanFlexibleAdjustLtv = Entry(
    ...
    sapiv3_get_sub_account_transfer_history = sapiV3GetSubAccountTransferHistory = Entry(
    ...
    sapiv3_post_sub_account_transfer = sapiV3PostSubAccountTransfer = Entry(
    ...
    dapipublic_get_premiumindexklines = dapiPublicGetPremiumIndexKlines = Entry(
    ...
    dapiprivate_get_pmexchangeinfo = dapiPrivateGetPmExchangeInfo = Entry(
    ...
    fapipublic_get_premiumindexklines = fapiPublicGetPremiumIndexKlines = Entry(
    ...
    fapipublic_get_convert_exchangeinfo = fapiPublicGetConvertExchangeInfo = Entry(
        "convert/exchangeInfo", "fapiPublic", "GET", {"cost": 4}
    )
    fapipublic_get_insurancebalance = fapiPublicGetInsuranceBalance = Entry(
    ...
    fapiprivate_get_openorders = fapiPrivateGetOpenOrders = Entry(
    ...
    fapiprivate_get_ratelimit_order = fapiPrivateGetRateLimitOrder = Entry(
    ...
    fapiprivate_get_convert_orderstatus = fapiPrivateGetConvertOrderStatus = Entry(
    ...
    fapiprivate_get_openalgoorders = fapiPrivateGetOpenAlgoOrders = Entry(
    ...
    fapiprivate_post_convert_getquote = fapiPrivatePostConvertGetQuote = Entry(
        "convert/getQuote", "fapiPrivate", "POST", {"cost": 200}
    )
    fapiprivate_post_convert_acceptquote = fapiPrivatePostConvertAcceptQuote = Entry(
    ...
    fapiprivate_delete_algoopenorders = fapiPrivateDeleteAlgoOpenOrders = Entry(
    ...
    eapiprivate_get_block_order_orders = eapiPrivateGetBlockOrderOrders = Entry(
        "block/order/orders", "eapiPrivate", "GET", {"cost": 5}
    )
    eapiprivate_get_block_order_execute = eapiPrivateGetBlockOrderExecute = Entry(
        "block/order/execute", "eapiPrivate", "GET", {"cost": 5}
    )
    eapiprivate_get_block_user_trades = eapiPrivateGetBlockUserTrades = Entry(
    ...
    eapiprivate_post_block_order_create = eapiPrivatePostBlockOrderCreate = Entry(
        "block/order/create", "eapiPrivate", "POST", {"cost": 5}
    )
    eapiprivate_post_block_order_execute = eapiPrivatePostBlockOrderExecute = Entry(
    ...
    eapiprivate_put_block_order_create = eapiPrivatePutBlockOrderCreate = Entry(
    ...
    eapiprivate_delete_block_order_create = eapiPrivateDeleteBlockOrderCreate = Entry(
    ...
    papi_get_um_conditional_openorder = papiGetUmConditionalOpenOrder = Entry(
        "um/conditional/openOrder", "papi", "GET", {"cost": 1}
    )
    papi_get_um_conditional_openorders = papiGetUmConditionalOpenOrders = Entry(
        "um/conditional/openOrders", "papi", "GET", {"cost": 1, "noSymbol": 40}
    )
    papi_get_um_conditional_orderhistory = papiGetUmConditionalOrderHistory = Entry(
        "um/conditional/orderHistory", "papi", "GET", {"cost": 1}
    )
    papi_get_um_conditional_allorders = papiGetUmConditionalAllOrders = Entry(
        "um/conditional/allOrders", "papi", "GET", {"cost": 1, "noSymbol": 40}
    )
    papi_get_cm_conditional_openorder = papiGetCmConditionalOpenOrder = Entry(
        "cm/conditional/openOrder", "papi", "GET", {"cost": 1}
    )
    papi_get_cm_conditional_openorders = papiGetCmConditionalOpenOrders = Entry(
        "cm/conditional/openOrders", "papi", "GET", {"cost": 1, "noSymbol": 40}
    )
    papi_get_cm_conditional_orderhistory = papiGetCmConditionalOrderHistory = Entry(
        "cm/conditional/orderHistory", "papi", "GET", {"cost": 1}
    )
    papi_get_cm_conditional_allorders = papiGetCmConditionalAllOrders = Entry(
    ...
    papi_get_um_apitradingstatus = papiGetUmApiTradingStatus = Entry(
    ...
    papi_delete_um_conditional_order = papiDeleteUmConditionalOrder = Entry(
    ...
    papi_delete_um_conditional_allopenorders = papiDeleteUmConditionalAllOpenOrders = Entry(
        "um/conditional/allOpenOrders", "papi", "DELETE", {"cost": 1}
    )
    papi_delete_cm_order = papiDeleteCmOrder = Entry("cm/order", "papi", "DELETE", {"cost": 1})
    papi_delete_cm_conditional_order = papiDeleteCmConditionalOrder = Entry(
    ...
    papi_delete_cm_conditional_allopenorders = papiDeleteCmConditionalAllOpenOrders = Entry(
