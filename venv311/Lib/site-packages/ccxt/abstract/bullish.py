...
class ImplicitAPI:
    ...
    public_get_v1_history_markets_symbol = publicGetV1HistoryMarketsSymbol = Entry(
    ...
    public_get_v1_markets_symbol_trades = publicGetV1MarketsSymbolTrades = Entry(
        "v1/markets/{symbol}/trades", "public", "GET", {"cost": 1}
    )
    public_get_v1_markets_symbol_tick = publicGetV1MarketsSymbolTick = Entry(
        "v1/markets/{symbol}/tick", "public", "GET", {"cost": 1}
    )
    public_get_v1_markets_symbol_candle = publicGetV1MarketsSymbolCandle = Entry(
    ...
    public_get_v1_history_markets_symbol_funding_rate = publicGetV1HistoryMarketsSymbolFundingRate = Entry(
    ...
    public_get_v1_index_prices_assetsymbol = publicGetV1IndexPricesAssetSymbol = Entry(
        "v1/index-prices/{assetSymbol}", "public", "GET", {"cost": 1}
    )
    public_get_v1_expiry_prices_symbol = publicGetV1ExpiryPricesSymbol = Entry(
    ...
    public_get_v1_option_ladder_symbol = publicGetV1OptionLadderSymbol = Entry(
    ...
    private_get_v2_amm_instructions_instructionid = privateGetV2AmmInstructionsInstructionId = Entry(
        "v2/amm-instructions/{instructionId}", "private", "GET", {"cost": 1}
    )
    private_get_v1_wallets_transactions = privateGetV1WalletsTransactions = Entry(
        "v1/wallets/transactions", "private", "GET", {"cost": 1}
    )
    private_get_v1_wallets_limits_symbol = privateGetV1WalletsLimitsSymbol = Entry(
        "v1/wallets/limits/{symbol}", "private", "GET", {"cost": 1}
    )
    private_get_v1_wallets_deposit_instructions_crypto_symbol = privateGetV1WalletsDepositInstructionsCryptoSymbol = Entry(
        "v1/wallets/deposit-instructions/crypto/{symbol}", "private", "GET", {"cost": 1}
    )
    private_get_v1_wallets_withdrawal_instructions_crypto_symbol = privateGetV1WalletsWithdrawalInstructionsCryptoSymbol = (
        Entry("v1/wallets/withdrawal-instructions/crypto/{symbol}", "private", "GET", {"cost": 1})
    )
    ...
    private_get_v1_wallets_withdrawal_instructions_fiat_symbol = privateGetV1WalletsWithdrawalInstructionsFiatSymbol = Entry(
        "v1/wallets/withdrawal-instructions/fiat/{symbol}", "private", "GET", {"cost": 1}
    )
    private_get_v1_wallets_self_hosted_verification_attempts = privateGetV1WalletsSelfHostedVerificationAttempts = Entry(
        "v1/wallets/self-hosted/verification-attempts", "private", "GET", {"cost": 1}
    )
    ...
    private_get_v1_trades_client_order_id_clientorderid = privateGetV1TradesClientOrderIdClientOrderId = Entry(
    ...
    private_get_v1_accounts_asset_symbol = privateGetV1AccountsAssetSymbol = Entry(
    ...
    private_get_v1_accounts_trading_accounts = privateGetV1AccountsTradingAccounts = Entry(
        "v1/accounts/trading-accounts", "private", "GET", {"cost": 1}
    )
    private_get_v1_accounts_trading_accounts_tradingaccountid = privateGetV1AccountsTradingAccountsTradingAccountId = Entry(
        "v1/accounts/trading-accounts/{tradingAccountId}", "private", "GET", {"cost": 1}
    )
    private_get_v1_derivatives_positions = privateGetV1DerivativesPositions = Entry(
        "v1/derivatives-positions", "private", "GET", {"cost": 1}
    )
    private_get_v1_history_derivatives_settlement = privateGetV1HistoryDerivativesSettlement = Entry(
    ...
    private_get_v1_history_borrow_interest = privateGetV1HistoryBorrowInterest = Entry(
        "v1/history/borrow-interest", "private", "GET", {"cost": 1}
    )
    private_get_v2_mmp_configuration = privateGetV2MmpConfiguration = Entry(
    ...
    private_get_v2_otc_trades_otctradeid = privateGetV2OtcTradesOtcTradeId = Entry(
    ...
    private_post_v2_amm_instructions = privatePostV2AmmInstructions = Entry(
        "v2/amm-instructions", "private", "POST", {"cost": 1}
    )
    private_post_v1_wallets_withdrawal = privatePostV1WalletsWithdrawal = Entry(
    ...
    private_post_v1_simulate_portfolio_margin = privatePostV1SimulatePortfolioMargin = Entry(
    ...
    private_post_v2_mmp_configuration = privatePostV2MmpConfiguration = Entry(
