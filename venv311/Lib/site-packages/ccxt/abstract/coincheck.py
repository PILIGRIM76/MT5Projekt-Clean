...
class ImplicitAPI:
    ...
    private_get_accounts_leverage_balance = privateGetAccountsLeverageBalance = Entry(
        "accounts/leverage_balance", "private", "GET", {}
    )
    ...
    private_get_exchange_orders_transactions = privateGetExchangeOrdersTransactions = Entry(
        "exchange/orders/transactions", "private", "GET", {}
    )
    private_get_exchange_orders_transactions_pagination = privateGetExchangeOrdersTransactionsPagination = Entry(
        "exchange/orders/transactions_pagination", "private", "GET", {}
    )
    private_get_exchange_leverage_positions = privateGetExchangeLeveragePositions = Entry(
        "exchange/leverage/positions", "private", "GET", {}
    )
    private_get_lending_borrows_matches = privateGetLendingBorrowsMatches = Entry(
        "lending/borrows/matches", "private", "GET", {}
    )
    ...
    private_post_deposit_money_id_fast = privatePostDepositMoneyIdFast = Entry(
        "deposit_money/{id}/fast", "private", "POST", {}
    )
    private_post_exchange_orders = privatePostExchangeOrders = Entry("exchange/orders", "private", "POST", {})
    private_post_exchange_transfers_to_leverage = privatePostExchangeTransfersToLeverage = Entry(
        "exchange/transfers/to_leverage", "private", "POST", {}
    )
    private_post_exchange_transfers_from_leverage = privatePostExchangeTransfersFromLeverage = Entry(
        "exchange/transfers/from_leverage", "private", "POST", {}
    )
    private_post_lending_borrows = privatePostLendingBorrows = Entry("lending/borrows", "private", "POST", {})
    private_post_lending_borrows_id_repay = privatePostLendingBorrowsIdRepay = Entry(
        "lending/borrows/{id}/repay", "private", "POST", {}
    )
