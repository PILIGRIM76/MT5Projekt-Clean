...
class ImplicitAPI:
    ...
    private_get_users_transactions_trade = privateGetUsersTransactionsTrade = Entry(
        "users/transactions/trade", "private", "GET", {"cost": 1}
    )
    private_post_users_transactions_crypto = privatePostUsersTransactionsCrypto = Entry(
        "users/transactions/crypto", "private", "POST", {"cost": 1}
    )
    private_post_users_transactions_fiat = privatePostUsersTransactionsFiat = Entry(
