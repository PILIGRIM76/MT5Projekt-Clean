...
class ImplicitAPI:
    ...
    public_get_bitcoin_charts_id_trades = publicGetBitcoinChartsIdTrades = Entry(
        "bitcoin_charts/{id}/trades", "public", "GET", {}
    )
    public_get_bitcoin_charts_id_depth = publicGetBitcoinChartsIdDepth = Entry(
        "bitcoin_charts/{id}/depth", "public", "GET", {}
    )
    ...
    private_get_user_addresses_address = privateGetUserAddressesAddress = Entry(
        "user/addresses/{address}", "private", "GET", {}
    )
    ...
    private_get_merchant_get_payment_uuid = privateGetMerchantGetPaymentUuid = Entry(
        "merchant/get_payment/{uuid}", "private", "GET", {}
    )
    ...
    private_post_merchant_create_payment = privatePostMerchantCreatePayment = Entry(
        "merchant/create_payment", "private", "POST", {}
    )
    private_delete_user_orders_uuid = privateDeleteUserOrdersUuid = Entry("user/orders/{uuid}", "private", "DELETE", {})
    private_delete_user_orders_uuid_cancel = privateDeleteUserOrdersUuidCancel = Entry(
        "user/orders/{uuid}/cancel", "private", "DELETE", {}
    )
    private_delete_user_price_alerts_id = privateDeleteUserPriceAlertsId = Entry(
        "user/price_alerts/{id}", "private", "DELETE", {}
    )
