...
class ImplicitAPI:
    ...
    public_get_funding_rate_market_symbol = publicGetFundingRateMarketSymbol = Entry(
        "funding_rate/{market_symbol}/", "public", "GET", {"cost": 1}
    )
    public_get_funding_rate_history_pair = publicGetFundingRateHistoryPair = Entry(
        "funding_rate_history/{pair}/", "public", "GET", {"cost": 1}
    )
    private_get_travel_rule_contacts = privateGetTravelRuleContacts = Entry(
        "travel_rule/contacts/", "private", "GET", {"cost": 1}
    )
    private_get_contacts_contact_uuid = privateGetContactsContactUuid = Entry(
    ...
    private_post_account_balances_currency = privatePostAccountBalancesCurrency = Entry(
    ...
    private_post_user_transactions_pair = privatePostUserTransactionsPair = Entry(
        "user_transactions/{pair}/", "private", "POST", {"cost": 1}
    )
    private_post_crypto_transactions = privatePostCryptoTransactions = Entry(
    ...
    private_post_cancel_all_orders_pair = privatePostCancelAllOrdersPair = Entry(
    ...
    private_post_transfer_from_main = privatePostTransferFromMain = Entry(
    ...
    private_post_fees_trading_market_symbol = privatePostFeesTradingMarketSymbol = Entry(
    ...
    private_post_fees_withdrawal_currency = privatePostFeesWithdrawalCurrency = Entry(
        "fees/withdrawal/{currency}/", "private", "POST", {"cost": 1}
    )
    private_post_withdrawal_requests = privatePostWithdrawalRequests = Entry(
    ...
    private_post_liquidation_address_new = privatePostLiquidationAddressNew = Entry(
        "liquidation_address/new/", "private", "POST", {"cost": 1}
    )
    private_post_liquidation_address_info = privatePostLiquidationAddressInfo = Entry(
    ...
    private_post_revoke_all_api_keys = privatePostRevokeAllApiKeys = Entry(
        "revoke_all_api_keys/", "private", "POST", {"cost": 1}
    )
    private_post_get_max_order_amount = privatePostGetMaxOrderAmount = Entry(
    ...
    private_post_travel_rule_contacts = privatePostTravelRuleContacts = Entry(
    ...
    private_post_earn_subscriptions_setting = privatePostEarnSubscriptionsSetting = Entry(
