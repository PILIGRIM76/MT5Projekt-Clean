...
class ImplicitAPI:
    ...
    private_post_account_market_order_history = privatePostAccountMarketOrderHistory = Entry(
        "account/market_order_history", "private", "POST", {"cost": 1}
    )
    private_post_account_market_deal_history = privatePostAccountMarketDealHistory = Entry(
    ...
    private_post_account_order_history = privatePostAccountOrderHistory = Entry(
        "account/order_history", "private", "POST", {"cost": 1}
    )
    private_post_account_executed_history = privatePostAccountExecutedHistory = Entry(
