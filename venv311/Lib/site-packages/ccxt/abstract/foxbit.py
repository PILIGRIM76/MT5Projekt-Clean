...
class ImplicitAPI:
    ...
    v3_public_get_markets_ticker_24hr = v3PublicGetMarketsTicker24hr = Entry(
        "markets/ticker/24hr", ["v3", "public"], "GET", {"cost": 60}
    )
    v3_public_get_markets_market_orderbook = v3PublicGetMarketsMarketOrderbook = Entry(
        "markets/{market}/orderbook", ["v3", "public"], "GET", {"cost": 6}
    )
    v3_public_get_markets_market_candlesticks = v3PublicGetMarketsMarketCandlesticks = Entry(
        "markets/{market}/candlesticks", ["v3", "public"], "GET", {"cost": 12}
    )
    v3_public_get_markets_market_trades_history = v3PublicGetMarketsMarketTradesHistory = Entry(
        "markets/{market}/trades/history", ["v3", "public"], "GET", {"cost": 12}
    )
    v3_public_get_markets_market_ticker_24hr = v3PublicGetMarketsMarketTicker24hr = Entry(
    ...
    v3_private_get_accounts_symbol_transactions = v3PrivateGetAccountsSymbolTransactions = Entry(
    ...
    v3_private_get_orders_by_order_id_id = v3PrivateGetOrdersByOrderIdId = Entry(
        "orders/by-order-id/{id}", ["v3", "private"], "GET", {"cost": 2}
    )
    v3_private_get_trades = v3PrivateGetTrades = Entry("trades", ["v3", "private"], "GET", {"cost": 6})
    v3_private_get_deposits_address = v3PrivateGetDepositsAddress = Entry(
    ...
    v3_private_get_me_fees_trading = v3PrivateGetMeFeesTrading = Entry(
    ...
    v3_private_post_orders_cancel_replace = v3PrivatePostOrdersCancelReplace = Entry(
