...
class ImplicitAPI:
    ...
    public_get_exchanges_pair_orderbook = publicGetExchangesPairOrderbook = Entry(
        "Exchanges/{pair}/orderbook", "public", "GET", {}
    )
    public_get_exchanges_pair_trades = publicGetExchangesPairTrades = Entry("Exchanges/{pair}/trades", "public", "GET", {})
    public_get_exchanges_pair_lasttrades = publicGetExchangesPairLasttrades = Entry(
        "Exchanges/{pair}/lasttrades", "public", "GET", {}
    )
    private_post_merchant_createcheckout = privatePostMerchantCreateCheckout = Entry(
        "Merchant/CreateCheckout", "private", "POST", {}
    )
    private_post_funds_addcoinfundsrequest = privatePostFundsAddCoinFundsRequest = Entry(
        "Funds/AddCoinFundsRequest", "private", "POST", {}
    )
    ...
    private_post_order_addordermarketpricebuy = privatePostOrderAddOrderMarketPriceBuy = Entry(
        "Order/AddOrderMarketPriceBuy", "private", "POST", {}
    )
    private_post_order_addordermarketpricesell = privatePostOrderAddOrderMarketPriceSell = Entry(
        "Order/AddOrderMarketPriceSell", "private", "POST", {}
    )
    private_post_order_cancelorder = privatePostOrderCancelOrder = Entry("Order/CancelOrder", "private", "POST", {})
    private_post_order_addcoinfundsrequest = privatePostOrderAddCoinFundsRequest = Entry(
        "Order/AddCoinFundsRequest", "private", "POST", {}
    )
