...
class ImplicitAPI:
    ...
    binance_get_depth = binanceGetDepth = Entry(
    ...
    binance_get_ticker_bookticker = binanceGetTickerBookTicker = Entry(
    ...
    public_get_open_v1_common_symbols = publicGetOpenV1CommonSymbols = Entry(
    ...
    public_get_open_v1_market_trades = publicGetOpenV1MarketTrades = Entry(
        "open/v1/market/trades", "public", "GET", {"cost": 1}
    )
    public_get_open_v1_market_agg_trades = publicGetOpenV1MarketAggTrades = Entry(
        "open/v1/market/agg-trades", "public", "GET", {"cost": 1}
    )
    public_get_open_v1_market_klines = publicGetOpenV1MarketKlines = Entry(
        "open/v1/market/klines", "public", "GET", {"cost": 1}
    )
    private_get_open_v1_orders_detail = privateGetOpenV1OrdersDetail = Entry(
    ...
    private_get_open_v1_account_spot = privateGetOpenV1AccountSpot = Entry(
        "open/v1/account/spot", "private", "GET", {"cost": 1}
    )
    private_get_open_v1_account_spot_asset = privateGetOpenV1AccountSpotAsset = Entry(
        "open/v1/account/spot/asset", "private", "GET", {"cost": 1}
    )
    private_get_open_v1_orders_trades = privateGetOpenV1OrdersTrades = Entry(
    ...
    private_get_open_v1_deposits_address = privateGetOpenV1DepositsAddress = Entry(
    ...
    private_post_open_v1_orders_cancel = privatePostOpenV1OrdersCancel = Entry(
    ...
    private_post_open_v1_user_data_stream = privatePostOpenV1UserDataStream = Entry(
