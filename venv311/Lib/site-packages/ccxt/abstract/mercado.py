...
class ImplicitAPI:
    ...
    public_get_coin_day_summary_year_month_day = publicGetCoinDaySummaryYearMonthDay = Entry(
        "{coin}/day-summary/{year}/{month}/{day}/", "public", "GET", {}
    )
    ...
    private_post_place_market_buy_order = privatePostPlaceMarketBuyOrder = Entry(
        "place_market_buy_order", "private", "POST", {}
    )
    private_post_place_market_sell_order = privatePostPlaceMarketSellOrder = Entry(
        "place_market_sell_order", "private", "POST", {}
    )
