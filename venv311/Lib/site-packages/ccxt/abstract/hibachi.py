...
class ImplicitAPI:
    ...
    public_get_market_data_orderbook = publicGetMarketDataOrderbook = Entry(
        "market/data/orderbook", "public", "GET", {"cost": 1}
    )
    public_get_market_data_open_interest = publicGetMarketDataOpenInterest = Entry(
        "market/data/open-interest", "public", "GET", {"cost": 1}
    )
    public_get_market_data_funding_rates = publicGetMarketDataFundingRates = Entry(
        "market/data/funding-rates", "public", "GET", {"cost": 1}
    )
    public_get_exchange_utc_timestamp = publicGetExchangeUtcTimestamp = Entry(
        "exchange/utc-timestamp", "public", "GET", {"cost": 1}
    )
    private_get_capital_deposit_info = privateGetCapitalDepositInfo = Entry(
    ...
    private_get_trade_account_trading_history = privateGetTradeAccountTradingHistory = Entry(
    ...
    private_get_trade_account_trades = privateGetTradeAccountTrades = Entry(
