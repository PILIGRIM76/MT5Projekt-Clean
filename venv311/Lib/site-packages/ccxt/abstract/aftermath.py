...
class ImplicitAPI:
    ...
    private_post_build_cancelorders = privatePostBuildCancelOrders = Entry(
        "build/cancelOrders", "private", "POST", {"cost": 1}
    )
    private_post_build_createaccount = privatePostBuildCreateAccount = Entry(
        "build/createAccount", "private", "POST", {"cost": 1}
    )
    private_post_build_createorders = privatePostBuildCreateOrders = Entry(
        "build/createOrders", "private", "POST", {"cost": 1}
    )
    ...
    private_post_submit_cancelorders = privatePostSubmitCancelOrders = Entry(
        "submit/cancelOrders", "private", "POST", {"cost": 1}
    )
    private_post_submit_createaccount = privatePostSubmitCreateAccount = Entry(
        "submit/createAccount", "private", "POST", {"cost": 1}
    )
    private_post_submit_createorders = privatePostSubmitCreateOrders = Entry(
        "submit/createOrders", "private", "POST", {"cost": 1}
    )
    ...
    private_post_submit_setleverage = privatePostSubmitSetLeverage = Entry(
        "submit/setLeverage", "private", "POST", {"cost": 1}
    )
