...
class ImplicitAPI:
    public_get_getvalidprimarycurrencycodes = publicGetGetValidPrimaryCurrencyCodes = Entry(
        "GetValidPrimaryCurrencyCodes", "public", "GET", {}
    )
    public_get_getvalidsecondarycurrencycodes = publicGetGetValidSecondaryCurrencyCodes = Entry(
        "GetValidSecondaryCurrencyCodes", "public", "GET", {}
    )
    public_get_getvalidlimitordertypes = publicGetGetValidLimitOrderTypes = Entry(
        "GetValidLimitOrderTypes", "public", "GET", {}
    )
    public_get_getvalidmarketordertypes = publicGetGetValidMarketOrderTypes = Entry(
        "GetValidMarketOrderTypes", "public", "GET", {}
    )
    public_get_getvalidordertypes = publicGetGetValidOrderTypes = Entry("GetValidOrderTypes", "public", "GET", {})
    public_get_getvalidtransactiontypes = publicGetGetValidTransactionTypes = Entry(
        "GetValidTransactionTypes", "public", "GET", {}
    )
    ...
    public_get_getcryptowithdrawalfees = publicGetGetCryptoWithdrawalFees = Entry(
        "GetCryptoWithdrawalFees", "public", "GET", {}
    )
    public_get_getcryptowithdrawalfees2 = publicGetGetCryptoWithdrawalFees2 = Entry(
        "GetCryptoWithdrawalFees2", "public", "GET", {}
    )
    public_get_getnetworks = publicGetGetNetworks = Entry("GetNetworks", "public", "GET", {})
    public_get_getprimarycurrencyconfig2 = publicGetGetPrimaryCurrencyConfig2 = Entry(
        "GetPrimaryCurrencyConfig2", "public", "GET", {}
    )
    ...
    private_post_getclosedfilledorders = privatePostGetClosedFilledOrders = Entry(
        "GetClosedFilledOrders", "private", "POST", {}
    )
    ...
    private_post_getdigitalcurrencydepositaddress = privatePostGetDigitalCurrencyDepositAddress = Entry(
        "GetDigitalCurrencyDepositAddress", "private", "POST", {}
    )
    private_post_getdigitalcurrencydepositaddress2 = privatePostGetDigitalCurrencyDepositAddress2 = Entry(
        "GetDigitalCurrencyDepositAddress2", "private", "POST", {}
    )
    private_post_getdigitalcurrencydepositaddresses = privatePostGetDigitalCurrencyDepositAddresses = Entry(
        "GetDigitalCurrencyDepositAddresses", "private", "POST", {}
    )
    private_post_getdigitalcurrencydepositaddresses2 = privatePostGetDigitalCurrencyDepositAddresses2 = Entry(
        "GetDigitalCurrencyDepositAddresses2", "private", "POST", {}
    )
    ...
    private_post_getdigitalcurrencywithdrawal = privatePostGetDigitalCurrencyWithdrawal = Entry(
        "GetDigitalCurrencyWithdrawal", "private", "POST", {}
    )
    ...
    ) = Entry("SynchDigitalCurrencyDepositAddressWithBlockchain", "private", "POST", {})
    private_post_requestfiatwithdrawal = privatePostRequestFiatWithdrawal = Entry(
        "RequestFiatWithdrawal", "private", "POST", {}
    )
    private_post_withdrawfiatcurrency = privatePostWithdrawFiatCurrency = Entry("WithdrawFiatCurrency", "private", "POST", {})
    private_post_withdrawdigitalcurrency = privatePostWithdrawDigitalCurrency = Entry(
        "WithdrawDigitalCurrency", "private", "POST", {}
    )
