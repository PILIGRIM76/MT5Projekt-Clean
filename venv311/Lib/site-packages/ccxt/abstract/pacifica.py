...
class ImplicitAPI:
    ...
    public_get_account_balance_history = publicGetAccountBalanceHistory = Entry(
    ...
    public_get_account_builder_codes_approvals = publicGetAccountBuilderCodesApprovals = Entry(
    ...
    private_post_account_subaccount_create = privatePostAccountSubaccountCreate = Entry(
        "account/subaccount/create", "private", "POST", {"cost": 1}
    )
    private_post_account_subaccount_list = privatePostAccountSubaccountList = Entry(
        "account/subaccount/list", "private", "POST", {"cost": 1}
    )
    private_post_account_subaccount_transfer = privatePostAccountSubaccountTransfer = Entry(
    ...
    private_post_orders_create_market = privatePostOrdersCreateMarket = Entry(
    ...
    private_post_orders_stop_cancel = privatePostOrdersStopCancel = Entry(
    ...
    private_post_account_builder_codes_approve = privatePostAccountBuilderCodesApprove = Entry(
        "account/builder_codes/approve", "private", "POST", {"cost": 1}
    )
    private_post_account_builder_codes_revoke = privatePostAccountBuilderCodesRevoke = Entry(
    ...
    private_post_account_api_keys_create = privatePostAccountApiKeysCreate = Entry(
        "account/api_keys/create", "private", "POST", {"cost": 1}
    )
    private_post_account_api_keys_revoke = privatePostAccountApiKeysRevoke = Entry(
