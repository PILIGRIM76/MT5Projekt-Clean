...
class ImplicitAPI:
    ...
    private_get_publicpoolsmetadata = privateGetPublicPoolsMetadata = Entry(
        "publicPoolsMetadata", "private", "GET", {"cost": 1}
    )
    private_get_accountactiveorders = privateGetAccountActiveOrders = Entry(
        "accountActiveOrders", "private", "GET", {"cost": 1}
    )
    private_get_accountinactiveorders = privateGetAccountInactiveOrders = Entry(
