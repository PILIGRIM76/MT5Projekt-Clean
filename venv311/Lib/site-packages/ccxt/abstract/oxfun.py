...
class ImplicitAPI:
    ...
    public_get_v3_markets_operational = publicGetV3MarketsOperational = Entry(
        "v3/markets/operational", "public", "GET", {"cost": 1}
    )
    ...
    private_get_v3_deposit_addresses = privateGetV3DepositAddresses = Entry(
        "v3/deposit-addresses", "private", "GET", {"cost": 1}
    )
    private_get_v3_deposit = privateGetV3Deposit = Entry("v3/deposit", "private", "GET", {"cost": 1})
    private_get_v3_withdrawal_addresses = privateGetV3WithdrawalAddresses = Entry(
        "v3/withdrawal-addresses", "private", "GET", {"cost": 1}
    )
    ...
    private_delete_v3_orders_cancel_all = privateDeleteV3OrdersCancelAll = Entry(
        "v3/orders/cancel-all", "private", "DELETE", {"cost": 1}
    )
