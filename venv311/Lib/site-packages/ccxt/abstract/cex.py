...
class ImplicitAPI:
    ...
    public_post_get_processing_info = publicPostGetProcessingInfo = Entry(
    ...
    private_post_get_my_account_status_v3 = privatePostGetMyAccountStatusV3 = Entry(
        "get_my_account_status_v3", "private", "POST", {"cost": 5}
    )
    private_post_get_my_wallet_balance = privatePostGetMyWalletBalance = Entry(
    ...
    private_post_do_cancel_all_orders = privatePostDoCancelAllOrders = Entry(
    ...
    private_post_get_my_transaction_history = privatePostGetMyTransactionHistory = Entry(
        "get_my_transaction_history", "private", "POST", {"cost": 1}
    )
    private_post_get_my_funding_history = privatePostGetMyFundingHistory = Entry(
        "get_my_funding_history", "private", "POST", {"cost": 5}
    )
    private_post_do_my_internal_transfer = privatePostDoMyInternalTransfer = Entry(
        "do_my_internal_transfer", "private", "POST", {"cost": 1}
    )
    private_post_get_processing_info = privatePostGetProcessingInfo = Entry(
        "get_processing_info", "private", "POST", {"cost": 10}
    )
    private_post_get_deposit_address = privatePostGetDepositAddress = Entry(
        "get_deposit_address", "private", "POST", {"cost": 5}
    )
    private_post_do_deposit_funds_from_wallet = privatePostDoDepositFundsFromWallet = Entry(
        "do_deposit_funds_from_wallet", "private", "POST", {"cost": 1}
    )
    private_post_do_withdrawal_funds_to_wallet = privatePostDoWithdrawalFundsToWallet = Entry(
