...
class ImplicitAPI:
    ...
    public_get_orderbook_baseid_quoteid = publicGetOrderbookBaseIdQuoteId = Entry(
        "orderbook/{baseId}_{quoteId}", "public", "GET", {}
    )
    public_get_transaction_history_baseid_quoteid = publicGetTransactionHistoryBaseIdQuoteId = Entry(
        "transaction_history/{baseId}_{quoteId}", "public", "GET", {}
    )
    public_get_network_info = publicGetNetworkInfo = Entry("network-info", "public", "GET", {})
    public_get_assetsstatus_multichain_all = publicGetAssetsstatusMultichainALL = Entry(
        "assetsstatus/multichain/ALL", "public", "GET", {}
    )
    public_get_assetsstatus_multichain_currency = publicGetAssetsstatusMultichainCurrency = Entry(
        "assetsstatus/multichain/{currency}", "public", "GET", {}
    )
    public_get_withdraw_minimum_all = publicGetWithdrawMinimumALL = Entry("withdraw/minimum/ALL", "public", "GET", {})
    public_get_withdraw_minimum_currency = publicGetWithdrawMinimumCurrency = Entry(
        "withdraw/minimum/{currency}", "public", "GET", {}
    )
    ...
    public_get_candlestick_baseid_quoteid_interval = publicGetCandlestickBaseIdQuoteIdInterval = Entry(
        "candlestick/{baseId}_{quoteId}/{interval}", "public", "GET", {}
    )
    ...
    private_post_info_user_transactions = privatePostInfoUserTransactions = Entry(
        "info/user_transactions", "private", "POST", {}
    )
