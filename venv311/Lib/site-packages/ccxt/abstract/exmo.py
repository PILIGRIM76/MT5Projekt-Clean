...
class ImplicitAPI:
    ...
    public_get_payments_providers_crypto_list = publicGetPaymentsProvidersCryptoList = Entry(
        "payments/providers/crypto/list", "public", "GET", {}
    )
    ...
    private_post_stop_market_order_create = privatePostStopMarketOrderCreate = Entry(
        "stop_market_order_create", "private", "POST", {}
    )
    private_post_stop_market_order_cancel = privatePostStopMarketOrderCancel = Entry(
        "stop_market_order_cancel", "private", "POST", {}
    )
    ...
    private_post_margin_user_order_create = privatePostMarginUserOrderCreate = Entry(
        "margin/user/order/create", "private", "POST", {}
    )
    private_post_margin_user_order_update = privatePostMarginUserOrderUpdate = Entry(
        "margin/user/order/update", "private", "POST", {}
    )
    private_post_margin_user_order_cancel = privatePostMarginUserOrderCancel = Entry(
        "margin/user/order/cancel", "private", "POST", {}
    )
    private_post_margin_user_position_close = privatePostMarginUserPositionClose = Entry(
        "margin/user/position/close", "private", "POST", {}
    )
    private_post_margin_user_position_margin_add = privatePostMarginUserPositionMarginAdd = Entry(
        "margin/user/position/margin_add", "private", "POST", {}
    )
    private_post_margin_user_position_margin_remove = privatePostMarginUserPositionMarginRemove = Entry(
        "margin/user/position/margin_remove", "private", "POST", {}
    )
    ...
    private_post_margin_user_order_list = privatePostMarginUserOrderList = Entry(
        "margin/user/order/list", "private", "POST", {}
    )
    private_post_margin_user_order_history = privatePostMarginUserOrderHistory = Entry(
        "margin/user/order/history", "private", "POST", {}
    )
    private_post_margin_user_order_trades = privatePostMarginUserOrderTrades = Entry(
        "margin/user/order/trades", "private", "POST", {}
    )
    private_post_margin_user_order_max_quantity = privatePostMarginUserOrderMaxQuantity = Entry(
        "margin/user/order/max_quantity", "private", "POST", {}
    )
    private_post_margin_user_position_list = privatePostMarginUserPositionList = Entry(
        "margin/user/position/list", "private", "POST", {}
    )
    private_post_margin_user_position_margin_remove_info = privatePostMarginUserPositionMarginRemoveInfo = Entry(
        "margin/user/position/margin_remove_info", "private", "POST", {}
    )
    private_post_margin_user_position_margin_add_info = privatePostMarginUserPositionMarginAddInfo = Entry(
        "margin/user/position/margin_add_info", "private", "POST", {}
    )
    private_post_margin_user_wallet_list = privatePostMarginUserWalletList = Entry(
        "margin/user/wallet/list", "private", "POST", {}
    )
    private_post_margin_user_wallet_history = privatePostMarginUserWalletHistory = Entry(
        "margin/user/wallet/history", "private", "POST", {}
    )
    private_post_margin_user_trade_list = privatePostMarginUserTradeList = Entry(
        "margin/user/trade/list", "private", "POST", {}
    )
    private_post_margin_trades = privatePostMarginTrades = Entry("margin/trades", "private", "POST", {})
    private_post_margin_liquidation_feed = privatePostMarginLiquidationFeed = Entry(
        "margin/liquidation/feed", "private", "POST", {}
    )
