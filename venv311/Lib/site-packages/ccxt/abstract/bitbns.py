...
class ImplicitAPI:
    ...
    v1_post_currentcoinbalance_everything = v1PostCurrentCoinBalanceEVERYTHING = Entry(
        "currentCoinBalance/EVERYTHING", "v1", "POST", {}
    )
    ...
    v1_post_cancelstoplossorder_symbol = v1PostCancelStopLossOrderSymbol = Entry(
        "cancelStopLossOrder/{symbol}", "v1", "POST", {}
    )
    ...
    v1_post_placemarketorderqnty_symbol = v1PostPlaceMarketOrderQntySymbol = Entry(
        "placeMarketOrderQnty/{symbol}", "v1", "POST", {}
    )
