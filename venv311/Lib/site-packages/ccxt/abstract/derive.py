...
class ImplicitAPI:
    ...
    public_post_build_register_session_key_tx = publicPostBuildRegisterSessionKeyTx = Entry(
        "build_register_session_key_tx", "public", "POST", {}
    )
    ...
    public_post_get_latest_signed_feeds = publicPostGetLatestSignedFeeds = Entry(
        "get_latest_signed_feeds", "public", "POST", {}
    )
    public_post_get_option_settlement_prices = publicPostGetOptionSettlementPrices = Entry(
        "get_option_settlement_prices", "public", "POST", {}
    )
    public_post_get_spot_feed_history = publicPostGetSpotFeedHistory = Entry("get_spot_feed_history", "public", "POST", {})
    public_post_get_spot_feed_history_candles = publicPostGetSpotFeedHistoryCandles = Entry(
        "get_spot_feed_history_candles", "public", "POST", {}
    )
    public_post_get_funding_rate_history = publicPostGetFundingRateHistory = Entry(
        "get_funding_rate_history", "public", "POST", {}
    )
    public_post_get_trade_history = publicPostGetTradeHistory = Entry("get_trade_history", "public", "POST", {})
    public_post_get_option_settlement_history = publicPostGetOptionSettlementHistory = Entry(
        "get_option_settlement_history", "public", "POST", {}
    )
    public_post_get_liquidation_history = publicPostGetLiquidationHistory = Entry(
        "get_liquidation_history", "public", "POST", {}
    )
    public_post_get_interest_rate_history = publicPostGetInterestRateHistory = Entry(
        "get_interest_rate_history", "public", "POST", {}
    )
    ...
    public_post_get_swell_percent_points = publicPostGetSwellPercentPoints = Entry(
        "get_swell_percent_points", "public", "POST", {}
    )
    public_post_get_vault_assets = publicPostGetVaultAssets = Entry("get_vault_assets", "public", "POST", {})
    public_post_get_etherfi_effective_balances = publicPostGetEtherfiEffectiveBalances = Entry(
        "get_etherfi_effective_balances", "public", "POST", {}
    )
    public_post_get_kelp_effective_balances = publicPostGetKelpEffectiveBalances = Entry(
        "get_kelp_effective_balances", "public", "POST", {}
    )
    public_post_get_bridge_balances = publicPostGetBridgeBalances = Entry("get_bridge_balances", "public", "POST", {})
    public_post_get_ethena_participants = publicPostGetEthenaParticipants = Entry(
        "get_ethena_participants", "public", "POST", {}
    )
    ...
    public_post_estimate_integrator_points = publicPostEstimateIntegratorPoints = Entry(
        "estimate_integrator_points", "public", "POST", {}
    )
    public_post_create_subaccount_debug = publicPostCreateSubaccountDebug = Entry(
        "create_subaccount_debug", "public", "POST", {}
    )
    ...
    public_post_get_maker_program_scores = publicPostGetMakerProgramScores = Entry(
        "get_maker_program_scores", "public", "POST", {}
    )
    ...
    private_post_change_subaccount_label = privatePostChangeSubaccountLabel = Entry(
        "change_subaccount_label", "private", "POST", {}
    )
    ...
    private_post_get_withdrawal_history = privatePostGetWithdrawalHistory = Entry(
        "get_withdrawal_history", "private", "POST", {}
    )
    ...
    private_post_get_option_settlement_history = privatePostGetOptionSettlementHistory = Entry(
        "get_option_settlement_history", "private", "POST", {}
    )
    private_post_get_subaccount_value_history = privatePostGetSubaccountValueHistory = Entry(
        "get_subaccount_value_history", "private", "POST", {}
    )
    private_post_expired_and_cancelled_history = privatePostExpiredAndCancelledHistory = Entry(
        "expired_and_cancelled_history", "private", "POST", {}
    )
    ...
    private_post_get_erc20_transfer_history = privatePostGetErc20TransferHistory = Entry(
        "get_erc20_transfer_history", "private", "POST", {}
    )
    private_post_get_liquidation_history = privatePostGetLiquidationHistory = Entry(
        "get_liquidation_history", "private", "POST", {}
    )
    private_post_liquidate = privatePostLiquidate = Entry("liquidate", "private", "POST", {})
    private_post_get_liquidator_history = privatePostGetLiquidatorHistory = Entry(
        "get_liquidator_history", "private", "POST", {}
    )
    ...
    private_post_register_scoped_session_key = privatePostRegisterScopedSessionKey = Entry(
        "register_scoped_session_key", "private", "POST", {}
    )
    ...
    private_post_set_cancel_on_disconnect = privatePostSetCancelOnDisconnect = Entry(
        "set_cancel_on_disconnect", "private", "POST", {}
    )
