...
class ImplicitAPI:
    ...
    public_get_markets_marketid_ticker = publicGetMarketsMarketIdTicker = Entry(
        "markets/{marketId}/ticker", "public", "GET", {}
    )
    public_get_markets_marketid_trades = publicGetMarketsMarketIdTrades = Entry(
        "markets/{marketId}/trades", "public", "GET", {}
    )
    public_get_markets_marketid_orderbook = publicGetMarketsMarketIdOrderbook = Entry(
        "markets/{marketId}/orderbook", "public", "GET", {}
    )
    public_get_markets_marketid_candles = publicGetMarketsMarketIdCandles = Entry(
        "markets/{marketId}/candles", "public", "GET", {}
    )
    ...
    private_get_accounts_me_trading_fees = privateGetAccountsMeTradingFees = Entry(
        "accounts/me/trading-fees", "private", "GET", {}
    )
    private_get_accounts_me_withdrawal_limits = privateGetAccountsMeWithdrawalLimits = Entry(
        "accounts/me/withdrawal-limits", "private", "GET", {}
    )
    private_get_accounts_me_balances = privateGetAccountsMeBalances = Entry("accounts/me/balances", "private", "GET", {})
    private_get_accounts_me_transactions = privateGetAccountsMeTransactions = Entry(
        "accounts/me/transactions", "private", "GET", {}
    )
