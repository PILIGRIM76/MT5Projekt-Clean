...
class ImplicitAPI:
    ...
    private_get_account_subs_balance = privateGetAccountSubsBalance = Entry(
        "account/subs/balance", "private", "GET", {"cost": 1}
    )
    private_get_account_subs_transfer_record = privateGetAccountSubsTransferRecord = Entry(
        "account/subs/transfer/record", "private", "GET", {"cost": 10}
    )
    private_get_wallet_query_deposit_withdraw = privateGetWalletQueryDepositWithdraw = Entry(
        "wallet/query/deposit-withdraw", "private", "GET", {"cost": 3}
    )
    private_post_orders_create = privatePostOrdersCreate = Entry("orders/create", "private", "POST", {"cost": 5})
    private_post_orders_batch_create = privatePostOrdersBatchCreate = Entry(
        "orders/batch-create", "private", "POST", {"cost": 50}
    )
    private_post_orders_cancel = privatePostOrdersCancel = Entry("orders/cancel", "private", "POST", {"cost": 1})
    private_post_orders_batch_cancel = privatePostOrdersBatchCancel = Entry(
        "orders/batch-cancel", "private", "POST", {"cost": 10}
    )
    private_post_orders_cancel_by_symbol = privatePostOrdersCancelBySymbol = Entry(
        "orders/cancel-by-symbol", "private", "POST", {"cost": 10}
    )
    private_post_account_subs_transfer = privatePostAccountSubsTransfer = Entry(
        "account/subs/transfer", "private", "POST", {"cost": 5}
    )
    private_post_wallet_withdraw_coin = privatePostWalletWithdrawCoin = Entry(
        "wallet/withdraw/coin", "private", "POST", {"cost": 3}
    )
    private_post_account_withdraw_coin = privatePostAccountWithdrawCoin = Entry(
        "account/withdraw/coin", "private", "POST", {"cost": 3}
    )
