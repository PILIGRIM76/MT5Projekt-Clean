...
from pytestqt.exceptions import ScreenshotError, TimeoutError
    ...
    **Raw QTest API**
    ...
    def waitSignal(
        ...
        *,
        ...
        """
        if signal is None:
            raise ValueError(f"Passing None as signal isn't supported anymore, use qtbot.wait({timeout}) instead.")
