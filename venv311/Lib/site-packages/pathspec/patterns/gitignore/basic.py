...
from pathspec._typing import (  # Removed in 3.18.  # Added in 3.12.
    AnyStr,
    assert_unreachable,
    override,
)
...
class GitIgnoreBasicPattern(_GitIgnoreBasePattern):
    ...
    def __normalize_segments(
        ...
        *pattern_segs* (:class:`list` of :class:`str`) contains the pattern
        ...
        elif seg_count == 3 and pattern_segs[0] == "**" and pattern_segs[1] == "*" and pattern_segs[2] == "**":
    ...
    def pattern_to_regex(
        ...
        *pattern* (:class:`str` or :class:`bytes`) is the pattern to convert into a
        ...
        try:
            ...
            raise GitIgnorePatternError((f"Invalid git pattern: {original_pattern!r}")) from e  # GitIgnorePatternError
        ...
        if override_regex is not None:
            ...
            assert_unreachable((f"{override_regex=} and {pattern_segs=} cannot both be null."))  # assert_unreachable
