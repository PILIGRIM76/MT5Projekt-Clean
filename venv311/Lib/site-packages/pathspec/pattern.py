...
import re
from typing import (  # Replaced by `X | None` in 3.10.  # Replaced by `X | Y` in 3.10.
    Any,
    Optional,
    TypeVar,
    Union,
...
from ._typing import (  # Removed in 3.18.  # Added in 3.13.  # Added in 3.12.
    AnyStr,
    deprecated,
    override,
)
...
class Pattern(object):
    ...
    @deprecated(("Pattern.match() is deprecated. Use Pattern.match_file() with a loop for " "similar results."))
