...
from ._typing import (  # Removed in 3.18.  # Added in 3.13.
    AnyStr,
    deprecated,
)
...
@deprecated(("pathspec.util.match_files() is deprecated. Use match_file() with a loop for " "better results."))
def match_files(
    patterns: Iterable[Pattern],
    files: Iterable[str],
) -> set[str]:
...
@deprecated(("pathspec.util.normalize_files() is deprecated. Use normalize_file() with a " "loop for better results."))
def normalize_files(
...
class AlreadyRegisteredError(Exception):
    ...
    def message(self) -> str:
        ...
        *message* (:class:`str`) is the error message.
        """
        return f"{self.name!r} is already registered for pattern factory=" f"{self.pattern_factory!r}."
...
class RecursionError(Exception):
    ...
    def message(self) -> str:
        ...
        *message* (:class:`str`) is the error message.
        """
        return f"Real path {self.real_path!r} was encountered at {self.first_path!r} " f"and then {self.second_path!r}."
