...
# LICENSE.txt
#
from ._util import HMODULE, PVOID, RESOURCE, check_false, check_null, check_zero, dlls, ffi, resource
...
def _UpdateResource(hUpdate, lpType, lpName, wLanguage, cData, cbData):
    ...
    check_false(
        dlls.kernel32.UpdateResourceW(PVOID(hUpdate), RESOURCE(lpType), RESOURCE(lpName), wLanguage, PVOID(lpData), cbData),
