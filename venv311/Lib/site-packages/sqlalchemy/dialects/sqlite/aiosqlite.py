...
from ...connectors.asyncio import AsyncAdapt_dbapi_module, AsyncAdapt_terminate
...
class AsyncAdapt_aiosqlite_connection(AsyncAdapt_terminate, AdaptedConnection):
    ...
    def _terminate_force_close(self) -> None:
        ...
        try:
            ...
            raise NotImplementedError("terminate_force_close() not implemented by this DBAPI shim") from ae
        else:
            meth()
