...
from ...sql import bindparam, coercions, compiler, elements, expression, functions, roles, sqltypes
...
class PGCompiler(compiler.SQLCompiler):
    ...
    def visit_json_getitem_op_binary(self, binary, operator, _cast_applied=False, **kw):
        ...
        if not _cast_applied and isinstance(binary.left.type, _json.JSONB) and self.dialect._supports_jsonb_subscripting:
            left = binary.left
...
class PGDialect(default.DefaultDialect):
    ...
    def _parse_fk(self, condef):
        ...
        onupdate = upddelval1 if upddelkey1 == "UPDATE" else upddelval2 if upddelkey2 == "UPDATE" else None
        ondelete = upddelval1 if upddelkey1 == "DELETE" else upddelval2 if upddelkey2 == "DELETE" else None
