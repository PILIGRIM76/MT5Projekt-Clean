...
if typing.TYPE_CHECKING:
    ...
    from .elements import BindParameter, ClauseElement, ColumnClause, ColumnElement, NamedColumn, SQLCoreOperations, TextClause
        ...
        if util.is_non_string_iterable(element):
            ...
            for o in element:
                if not _is_literal(o):
                    if not isinstance(o, util.preloaded.sql_elements.ColumnElement) and not hasattr(o, "__clause_element__"):
