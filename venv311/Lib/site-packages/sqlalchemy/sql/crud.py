        ...
        if check:
            ...
            if dml.isupdate(compile_state):
                ...
                if tables_mentioned and (
                    ...
                    raise exc.CompileError(f"{preamble}; cannot " f"""include columns from table(s) {
                    ...
                    raise exc.CompileError(f"Multi-table UPDATE statement does not include " "table(s) " f"""{
                            ", ".join(
                                f"'{t.description}'" for
