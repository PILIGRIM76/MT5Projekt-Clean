...
class AliasedReturnsRows(NoInit, NamedFromClause):
    ...
    def _populate_column_collection(
        ...
        self.element._generate_fromclause_column_proxies(self, columns, primary_key=primary_key, foreign_keys=foreign_keys)
...
class Values(roles.InElementRole, HasCTE, Generative, LateralFromClause):
    ...
    def __init__(
        ...
        *columns: _OnlyColumnArgument[Any],
        ...
        super().__init__()
        self._column_args = tuple(coercions.expect(roles.LabeledColumnExprRole, col) for col in columns)
