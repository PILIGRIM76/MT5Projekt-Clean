...
class SentenceTransformerModelCardData(BaseModelCardData):
    ...
    task_name: str = "semantic textual similarity, semantic search, paraphrase mining, classification, clustering, and more"
    tags: list[str] = field(
    ...
    def run_usage_snippet(self) -> None:
        ...
        if self.ir_model:
            query_embeddings = self.model.encode_query(prepared_examples[0], convert_to_tensor=True, show_progress_bar=False)
