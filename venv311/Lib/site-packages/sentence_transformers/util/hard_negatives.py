...
def mine_hard_negatives(
    ...
    if cross_encoder is not None and (absolute_margin is not None or relative_margin is not None or max_score is not None):
        if use_multi_process:
    ...
    if output_format == "triplet":
        ...
        for q_idx in range(n_queries):
            ...
            pos_indices[start_idx : start_idx + n_positives[q_idx]] = positive_indices[q_idx].repeat(num_negatives, 1).T
    ...
    if verbose:
        ...
        for param_name, param_value in [
            ...
            if param_name in log_counters:
                ...
                print(f"Skipped {skipped:,} potential negatives ({ratio:.2%}) due to the {param_name} of {param_value}.")
