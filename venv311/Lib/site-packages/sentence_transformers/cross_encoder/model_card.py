...
class CrossEncoderModelCardData(BaseModelCardData):
    ...
    def register_model(self, model) -> None:
        ...
        if self.task_name is None:
            self.task_name = "text reranking and semantic search" if model.num_labels == 1 else "text pair classification"
    ...
    def generate_usage_snippet(self) -> str:
        ...
        is_multimodal = any(isinstance(pair, list) and any(not isinstance(elem, str) for elem in pair) for pair in source)
