...
class BaseTrainingArguments(TransformersTrainingArguments):
    ...
    ] = field(default=MultiDatasetBatchSamplers.PROPORTIONAL, metadata={"help": "The multi-dataset batch sampler to use."})
    ...
    def __post_init__(self):
        ...
        self.batch_sampler = BatchSamplers(self.batch_sampler) if isinstance(self.batch_sampler, str) else self.batch_sampler
