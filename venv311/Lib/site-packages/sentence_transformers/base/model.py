...
class BaseModel(nn.Sequential, PeftAdapterMixin, ABC):
    ...
    def save(
        ...
        for idx, name in enumerate(self._modules):
            ...
            if idx == 0 and hasattr(module, "save_in_root") and module.save_in_root:  # Save first module in the main folder
    ...
    def save_to_hub(
        ...
        if organization:
            if "/" not in repo_id:
                ...
                raise ValueError("Providing an `organization` to `save_to_hub` is deprecated. Please use `repo_id` instead.")
            else:
                logger.warning(
