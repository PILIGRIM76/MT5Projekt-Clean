...
class SparseEncoder(BaseModel):
    ...
    @staticmethod
    def _multi_process_worker(target_device: str, model: SparseEncoder, input_queue: Queue, results_queue: Queue) -> None:
    ...
    def _load_default_modules(
        ...
        config: PretrainedConfig = AutoConfig.from_pretrained(model_name_or_path, cache_dir=cache_folder, **config_kwargs)
        ...
        if is_mlm_model:
            ...
            logger.info("No MLM architecture detected, using default Transformer + mean Pooling + SparseAutoEncoder (CSR)")
            transformer_model = Transformer(
                model_name_or_path,
