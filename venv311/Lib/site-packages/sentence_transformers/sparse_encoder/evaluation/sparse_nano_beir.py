...
class SparseNanoBEIREvaluator(NanoBEIREvaluator):
    ...
    def __call__(
        ...
        per_dataset_results = super().__call__(model, output_path=output_path, epoch=epoch, steps=steps, *args, **kwargs)
    ...
    def _load_dataset(self, dataset_name: DatasetNameType | str, **ir_evaluator_kwargs) -> SparseInformationRetrievalEvaluator:
