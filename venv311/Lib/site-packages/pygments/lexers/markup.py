...
class TiddlyWiki5Lexer(RegexLexer):
    ...
    tokens = {
        ...
        "keywords": [
            (
                words(
                    ("\\define", "\\end", "caption", "created", "modified", "tags", "title", "type"), prefix=r"^", suffix=r"\b"
                ),
                Keyword,
            ),
        ],
    ...
    tokens = {
        ...
        "inline": [
            ...
            (
                ...
                bygroups(
                    Punctuation, Name.Namespace, Punctuation, using(this, state=["wikilink-name"]), Punctuation, Name.Label
                ),
                "medialink-inner",
            ),
            # Wikilinks
            ...
            (
                ...
                bygroups(
                    Punctuation, Keyword, Punctuation, using(this, state=["root", "lc-raw"]), Operator, Name.Label, Punctuation
                ),
                "lc-inner",
            ),
