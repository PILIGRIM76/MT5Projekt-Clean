    ...
    return {
        "root": [
            ...
            (
                ...
                bygroups(
                    Whitespace, Name.Label, Whitespace, Name.Property, Whitespace, Name.Constant, Punctuation, Number.Hex
                ),
            ),
            # (Without offset)
            (
...
class LlvmMirBodyLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                words(("eq", "ne", "sgt", "sge", "slt", "sle", "ugt", "uge", "ult", "ule"), prefix=r"intpred\(", suffix=r"\)"),
                Name.Builtin,
            ),
            (
                words(
                    ("oeq", "one", "ogt", "oge", "olt", "ole", "ugt", "uge", "ult", "ule"), prefix=r"floatpred\(", suffix=r"\)"
                ),
                Name.Builtin,
            ),
            # Physical registers
        ...
        "mmo": [
            ...
            (
                words(
                    ("load", "store", "on", "into", "from", "align", "monotonic", "acquire", "release", "acq_rel", "seq_cst")
                ),
                Keyword,
            ),
            # IR references
...
class LlvmMirLexer(RegexLexer):
    ...
    tokens = {
        ...
        "llvm_mir": [
            ...
            (
                words(("legalized", "regBankSelected", "tracksRegLiveness", "selected", "exposesReturnsTwice"), suffix=":"),
                Keyword,
                "boolean",
            ),
