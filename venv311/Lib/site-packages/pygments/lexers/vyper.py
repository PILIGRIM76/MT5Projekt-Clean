...
class VyperLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                words(
                    ("public", "private", "view", "pure", "constant", "immutable", "nonpayable"), prefix=r"\b", suffix=r"\b"
                ),
                Keyword.Declaration,
            ),
            # Built-in Functions
            ...
            (
                words(("msg.sender", "msg.value", "block.timestamp", "block.number", "msg.gas"), prefix=r"\b", suffix=r"\b"),
                Name.Builtin.Pseudo,
            ),
            (
                words(
