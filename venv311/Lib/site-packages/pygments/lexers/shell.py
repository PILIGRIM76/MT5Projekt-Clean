...
class BatchLexer(RegexLexer):
    ...
    def _make_begin_state(
        ...
        return [
            ...
            (
                ...
                bygroups(
                    Keyword, using(this, state="text"), Keyword, using(this, state="text"), Keyword, using(this, state="text")
                ),
                ("(?", "if"),
            ),
            (
    ...
    def _make_label_state(
        compound, _label=_label, _label_compound=_label_compound, _nl=_nl, _punct=_punct, _string=_string, _variable=_variable
    ):
        state = []
        if compound:
            state.append((r"(?=\))", Text, "#pop"))
...
class TcshLexer(RegexLexer):
    ...
    tokens = {
        ...
        "basic": [
            (
                r"\b(if|endif|else|while|then|foreach|case|default|" r"break|continue|goto|breaksw|end|switch|endsw)\s*\b",
                Keyword,
            ),
            (
