    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider in OPENAI_COMPATIBLE_BATCH_AND_FILES_PROVIDERS:
            ...
            vertex_ai_project = optional_params.vertex_project or litellm.vertex_project or get_secret_str("VERTEXAI_PROJECT")
            vertex_ai_location = (
...
def _handle_retrieve_batch_providers_without_provider_config(
    ...
    if custom_llm_provider in OPENAI_COMPATIBLE_BATCH_AND_FILES_PROVIDERS:
        ...
        api_base = optional_params.api_base or ""
        vertex_ai_project = optional_params.vertex_project or litellm.vertex_project or get_secret_str("VERTEXAI_PROJECT")
        vertex_ai_location = optional_params.vertex_location or litellm.vertex_location or get_secret_str("VERTEXAI_LOCATION")
        vertex_credentials = optional_params.vertex_credentials or get_secret_str("VERTEXAI_CREDENTIALS")
        ...
        api_base = optional_params.api_base or litellm.api_base or get_secret_str("ANTHROPIC_API_BASE")
        ...
        raise litellm.exceptions.BadRequestError(
            message="LiteLLM doesn't support {} for 'create_batch'. Only 'openai' is supported.".format(custom_llm_provider),
            model="n/a",
            llm_provider=custom_llm_provider,
            response=httpx.Response(
                status_code=400,
...
def retrieve_batch(
    ...
    **kwargs,
    ...
    try:
        ...
        if batch_id.startswith("arn:aws") and ":bedrock:" in batch_id and ":async-invoke/" in batch_id:
...
def _handle_async_invoke_status(batch_id: str, aws_region_name: str, logging_obj=None, **kwargs) -> "LiteLLMBatch":
    ...
    async def _async_get_status():
        ...
        created_at, in_progress_at, completed_at, failed_at, _, _ = BedrockBatchesConfig()._parse_timestamps_and_status(
