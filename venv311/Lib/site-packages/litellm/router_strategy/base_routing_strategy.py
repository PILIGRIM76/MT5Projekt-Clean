...
class BaseRoutingStrategy(ABC):
    ...
    async def _increment_value_list_in_current_window(self, increment_list: List[Tuple[str, int]], ttl: int) -> List[float]:
        """
    ...
    async def periodic_sync_in_memory_spend_with_redis(self, default_sync_interval: Optional[Union[int, float]]):
        ...
        while True:
            try:
                ...
                await asyncio.sleep(default_sync_interval)  # Wait for DEFAULT_REDIS_SYNC_INTERVAL seconds before next sync
