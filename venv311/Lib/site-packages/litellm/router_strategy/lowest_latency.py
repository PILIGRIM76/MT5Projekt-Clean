...
class LowestLatencyLoggingHandler(CustomLogger):
        ...
        try:
            ...
            if kwargs["litellm_params"].get(metadata_field) is None:
                ...
                if time_to_first_token is not None:
                    if len(request_count_dict[id].get("time_to_first_token", [])) < self.routing_args.max_latency_list_size:
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):  # noqa: PLR0915
        try:
            ...
            verbose_logger.exception(
                "litellm.router_strategy.lowest_latency.py::async_log_success_event(): Exception occured - {}".format(str(e))
            )
            pass
    ...
    async def async_get_available_deployments(
        ...
        request_count_dict = await self.router_cache.async_get_cache(key=latency_key, parent_otel_span=parent_otel_span) or {}
