...
class DualCache(BaseCache):
    ...
    def __init__(
        ...
        self.redis_batch_cache_expiry = default_redis_batch_cache_expiry or litellm.default_redis_batch_cache_expiry or 10
    ...
    async def async_set_cache_pipeline(self, cache_list: list, local_only: bool = False, **kwargs):
        ...
        try:
            ...
            if self.redis_cache is not None and local_only is False:
                await self.redis_cache.async_set_cache_pipeline(cache_list=cache_list, ttl=kwargs.pop("ttl", None), **kwargs)
        except Exception as e:
            verbose_logger.exception(f"LiteLLM Cache: Excepton async add_cache: {str(e)}")
