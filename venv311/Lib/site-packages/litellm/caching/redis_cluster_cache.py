...
class RedisClusterCache(RedisCache):
    ...
    async def test_connection(self) -> dict:
        ...
        try:
            ...
            redis_client = redis_async.RedisCluster(startup_nodes=new_startup_nodes, **cluster_kwargs)  # type: ignore
            ...
            return {"status": "failed", "message": f"Redis Cluster connection failed: {str(e)}", "error": str(e)}
