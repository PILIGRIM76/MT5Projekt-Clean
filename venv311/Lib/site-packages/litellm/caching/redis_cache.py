...
class RedisCache(BaseCache):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if kwargs.get("service_logger_obj", None) is not None and isinstance(kwargs["service_logger_obj"], ServiceLogging):
    ...
    async def test_connection(self) -> dict:
        ...
        try:
            ...
            return {"status": "failed", "message": f"Redis connection failed: {str(e)}", "error": str(e)}
