                    ...
                    input_items.append(
                        {
                            "type": "message",
                            "role": role,
                            "content": self._convert_content_to_responses_format(content, role),  # type: ignore
                        }
                    )
            elif role == "tool":
    ...
    def transform_request(
        ...
        for key, value in optional_params.items():
            ...
            if key in ("max_tokens", "max_completion_tokens"):
                ...
                responses_api_request["tools"] = self._convert_tools_to_responses_format(cast(List[Dict[str, Any]], value))
            ...
            for i, item in enumerate(content):
                ...
                if isinstance(item, str):
                    ...
                    if original_type == "text":
                        ...
                        converted = cast(
                            dict,
                            self._convert_content_to_responses_format_image(cast(ChatCompletionImageObject, item), role),
                        )
                        result.append(converted)
...
class OpenAiResponsesToChatCompletionStreamIterator(BaseModelResponseIterator):
    ...
    def _handle_string_chunk(self, str_line: Union[str, "BaseModel"]) -> Union["GenericStreamingChunk", "ModelResponseStream"]:
        from pydantic import BaseModel
