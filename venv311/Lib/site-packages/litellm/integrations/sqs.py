...
class SQSLogger(CustomBatchLogger, BaseAWSLLM):
    ...
    def _init_sqs_params(
        ...
        self.sqs_aws_access_key_id = litellm.aws_sqs_callback_params.get("sqs_aws_access_key_id") or sqs_aws_access_key_id

        self.sqs_aws_secret_access_key = (
            litellm.aws_sqs_callback_params.get("sqs_aws_secret_access_key") or sqs_aws_secret_access_key
        )

        self.sqs_aws_session_token = litellm.aws_sqs_callback_params.get("sqs_aws_session_token") or sqs_aws_session_token
        ...
        self.sqs_app_encryption_aad = litellm.aws_sqs_callback_params.get("sqs_app_encryption_aad") or sqs_app_encryption_aad
    ...
    async def async_send_message(self, payload: StandardLoggingPayload) -> None:
        try:
            ...
            body = f"Action={SQS_SEND_MESSAGE_ACTION}&Version={SQS_API_VERSION}&MessageBody=" + quote(json_string, safe="")
