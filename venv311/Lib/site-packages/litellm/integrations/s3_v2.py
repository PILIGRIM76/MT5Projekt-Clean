...
class S3Logger(CustomBatchLogger, BaseAWSLLM):
        ...
        **kwargs,
        ...
        try:
            ...
            self.async_httpx_client = get_async_httpx_client(
                llm_provider=httpxSpecialProvider.LoggingCallback, params={"ssl_verify": self.s3_verify}
            )
    ...
    def _init_s3_params(
        ...
        self.s3_aws_secret_access_key = litellm.s3_callback_params.get("s3_aws_secret_access_key") or s3_aws_secret_access_key
        ...
        self.s3_use_team_prefix = bool(litellm.s3_callback_params.get("s3_use_team_prefix", False)) or s3_use_team_prefix
    ...
    def upload_data_to_s3(self, batch_logging_element: s3BatchLoggingElement):
        ...
        try:
            ...
            httpx_client = _get_httpx_client(params={"ssl_verify": self.s3_verify} if self.s3_verify is not None else None)
            # Make the request
