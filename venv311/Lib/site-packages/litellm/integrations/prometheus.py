...
class PrometheusLogger(CustomLogger):
    ...
    def _pretty_print_invalid_labels_error(self, metric_name: str, invalid_labels: List[str], valid_labels: List[str]) -> None:
    ...
    def _valid_metric_name(self, metric_name: str):
        ...
        if error:
            self._pretty_print_invalid_metric_error(invalid_metric_name=error.metric_name, valid_metrics=error.valid_metrics)
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        verbose_logger.debug(f"prometheus Logging - Enters success logging function for kwargs {kwargs}")
        ...
        _requester_metadata: Optional[dict] = standard_logging_payload["metadata"].get("requester_metadata")
        user_api_key_auth_metadata: Optional[dict] = standard_logging_payload["metadata"].get("user_api_key_auth_metadata")
        ...
        self.set_llm_deployment_success_metrics(kwargs, start_time, end_time, enum_values, output_tokens)
        ...
        if standard_logging_payload["stream"] is True:  # log successful streaming requests from logging event hook.
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_proxy_total_requests_metric"),
                enum_values=enum_values,
            )
    ...
    def _increment_token_metrics(
        ...
        _labels = prometheus_label_factory(
            supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_total_tokens_metric"),
            enum_values=enum_values,
        )
        self.litellm_tokens_metric.labels(**_labels).inc(standard_logging_payload["total_tokens"])

        _labels = prometheus_label_factory(
            supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_input_tokens_metric"),
            enum_values=enum_values,
        )
        self.litellm_input_tokens_metric.labels(**_labels).inc(standard_logging_payload["prompt_tokens"])

        _labels = prometheus_label_factory(
            supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_output_tokens_metric"),
            enum_values=enum_values,
        )

        self.litellm_output_tokens_metric.labels(**_labels).inc(standard_logging_payload["completion_tokens"])
    ...
    def _increment_cache_metrics(
        ...
        if cache_hit is True:
            ...
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_cache_hits_metric"),
                enum_values=enum_values,
            )
            ...
            if total_tokens > 0:
                _labels = prometheus_label_factory(
                    supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_cached_tokens_metric"),
                    enum_values=enum_values,
                )
            ...
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_cache_misses_metric"),
                enum_values=enum_values,
            )
    ...
    def _set_virtual_key_rate_limit_metrics(
        ...
        remaining_requests = metadata.get(remaining_requests_variable_name, sys.maxsize) or sys.maxsize
    ...
    def _set_latency_metrics(
        ...
        if time_to_first_token_seconds is not None and kwargs.get("stream", False) is True:  # only emit for streaming requests
            _ttft_labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_llm_api_time_to_first_token_metric"),
                enum_values=enum_values,
            )
            self.litellm_llm_api_time_to_first_token_metric.labels(**_ttft_labels).observe(time_to_first_token_seconds)
        else:
            verbose_logger.debug("Time to first token metric not emitted, stream option in model_parameters is not True")
    ...
    async def async_log_failure_event(self, kwargs, response_obj, start_time, end_time):
        ...
        verbose_logger.debug(f"prometheus Logging - Enters failure logging function for kwargs {kwargs}")
    ...
    async def async_post_call_failure_hook(
        ...
        try:
            ...
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_proxy_failed_requests_metric"),
                enum_values=enum_values,
            )
    ...
    async def async_post_call_success_hook(self, data: dict, user_api_key_dict: UserAPIKeyAuth, response):
        ...
        try:
            ...
            if self._should_skip_metrics_for_invalid_key(user_api_key_dict=user_api_key_dict):
                return
    ...
    def set_llm_deployment_failure_metrics(self, request_kwargs: dict):
        ...
        try:
            ...
            if exception is not None:
                _labels = prometheus_label_factory(
                    supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_deployment_failure_responses"),
                    enum_values=enum_values,
                )
                self.litellm_deployment_failure_responses.labels(**_labels).inc()

            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_deployment_total_requests"),
                enum_values=enum_values,
            )
            ...
            verbose_logger.debug("Prometheus Error: set_llm_deployment_failure_metrics. Exception occured - {}".format(str(e)))
    ...
    def set_llm_deployment_success_metrics(
        ...
        try:
            ...
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_deployment_success_responses"),
                enum_values=enum_values,
            )
    ...
    async def log_success_fallback_event(self, original_model_group: str, kwargs: dict, original_exception: Exception):
        ...
        _labels = prometheus_label_factory(
            supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_deployment_successful_fallbacks"),
            enum_values=enum_values,
        )
    ...
    async def log_failure_fallback_event(self, original_model_group: str, kwargs: dict, original_exception: Exception):
        ...
        _labels = prometheus_label_factory(
            supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_deployment_failed_fallbacks"),
            enum_values=enum_values,
        )
    ...
    def _set_team_budget_metrics(
        ...
        if team.budget_reset_at is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_team_budget_remaining_hours_metric"),
                enum_values=enum_values,
            )
    ...
    def _set_user_budget_metrics(
        ...
        if user.budget_reset_at is not None:
            _labels = prometheus_label_factory(
                supported_enum_labels=self.get_labels_for_metric(metric_name="litellm_user_budget_remaining_hours_metric"),
                enum_values=enum_values,
            )
...
def prometheus_label_factory(
    ...
    filtered_labels = {
        label: _sanitize_prometheus_label_value(value) for label, value in enum_dict.items() if label in supported_enum_labels
    }
