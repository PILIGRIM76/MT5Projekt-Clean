...
class AzureSentinelLogger(CustomBatchLogger):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.stream_name = stream_name or os.getenv("AZURE_SENTINEL_STREAM_NAME", "Custom-LiteLLM")
        self.endpoint = endpoint or os.getenv("AZURE_SENTINEL_ENDPOINT")
        self.tenant_id = tenant_id or os.getenv("AZURE_SENTINEL_TENANT_ID") or os.getenv("AZURE_TENANT_ID")
        self.client_id = client_id or os.getenv("AZURE_SENTINEL_CLIENT_ID") or os.getenv("AZURE_CLIENT_ID")
        self.client_secret = client_secret or os.getenv("AZURE_SENTINEL_CLIENT_SECRET") or os.getenv("AZURE_CLIENT_SECRET")
    ...
    async def async_send_batch(self):
        ...
        try:
            ...
            verbose_logger.debug("Azure Sentinel - about to flush %s events", len(self.log_queue))
            ...
            # Send the request
            response = await self.async_httpx_client.post(url=self.api_endpoint, data=body.encode("utf-8"), headers=headers)
