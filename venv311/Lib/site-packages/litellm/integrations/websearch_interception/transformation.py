...
class WebSearchTransformation:
    ...
    def _detect_from_non_streaming_response(
        ...
        for block in content:
            ...
            if block_type == "tool_use" and block_name in (LITELLM_WEB_SEARCH_TOOL_NAME, "WebSearch", "web_search"):
    ...
    def transform_response(
        ...
        if response_format == "openai":
            ...
            return WebSearchTransformation._transform_response_anthropic(tool_calls, search_results)
