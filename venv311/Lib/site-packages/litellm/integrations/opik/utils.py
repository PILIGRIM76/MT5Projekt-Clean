...
def get_opik_config_variable(key: str, user_value: Optional[str] = None, default_value: Optional[str] = None) -> Optional[str]:
    """
...
def get_traces_and_spans_from_payload(payload: List[Dict[str, Any]]) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
    """
