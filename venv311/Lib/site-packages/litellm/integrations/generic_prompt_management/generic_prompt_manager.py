...
class GenericPromptManager(CustomPromptManagement):
    ...
    async def async_fetch_prompt_from_api(self, prompt_id: Optional[str], prompt_spec: Optional[PromptSpec]) -> Dict[str, Any]:
        """
    ...
    async def async_get_chat_completion_prompt(
        ...
        return await PromptManagementBase.async_get_chat_completion_prompt(
            ...
            ignore_prompt_manager_model=(
                ignore_prompt_manager_model or prompt_spec.litellm_params.ignore_prompt_manager_model if prompt_spec else False
            ),
