...
class AnthropicCacheControlHook(CustomPromptManagement):
    def get_chat_completion_prompt(
        ...
        injection_points: List[CacheControlInjectionPoint] = non_default_params.pop("cache_control_injection_points", [])
        ...
        for point in injection_points:
            if point.get("location") == "message":
                ...
                processed_messages = self._process_message_injection(point=point, messages=processed_messages)
    ...
    def _process_message_injection(
        ...
        control: ChatCompletionCachedContent = point.get("control", None) or ChatCompletionCachedContent(type="ephemeral")
        ...
        if targetted_index is not None:
            ...
            if 0 <= targetted_index < len(messages):
                messages[targetted_index] = AnthropicCacheControlHook._safe_insert_cache_control_in_message(
        ...
        # Case 2: Target by role
            ...
            for msg in messages:
                if msg.get("role") == targetted_role:
                    msg = AnthropicCacheControlHook._safe_insert_cache_control_in_message(message=msg, control=control)
        return messages
