...
class LangfuseOtelLogger(OpenTelemetry):
    ...
    def _extract_langfuse_metadata(kwargs: dict) -> dict:
        ...
        try:
            from litellm.integrations.langfuse.langfuse import LangFuseLogger as _LFLogger
    ...
    def _create_open_telemetry_config_from_langfuse_env(self) -> OpenTelemetryConfig:
        ...
        auth_header = LangfuseOtelLogger._get_langfuse_authorization_header(public_key=public_key, secret_key=secret_key)
    ...
    def get_langfuse_otel_config() -> "OpenTelemetryConfig":
        ...
        if not public_key or not secret_key:
            raise ValueError("LANGFUSE_PUBLIC_KEY and LANGFUSE_SECRET_KEY must be set for Langfuse OpenTelemetry integration.")
