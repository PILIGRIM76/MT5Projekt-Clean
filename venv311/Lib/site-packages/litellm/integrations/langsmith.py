...
class LangsmithLogger(CustomBatchLogger):
    ...
    def get_credentials_from_env(
        ...
        _credentials_base_url = langsmith_base_url or os.getenv("LANGSMITH_BASE_URL") or "https://api.smith.langchain.com"
    ...
    def _prepare_log_data(
        ...
        try:
            ...
            verbose_logger.debug(f"Langsmith Logging - project_name: {project_name}, run_name {run_name}")
            ...
            if "trace_id" not in data or data["trace_id"] is None and (run_id is not None and isinstance(run_id, str)):
                data["trace_id"] = run_id

            if "dotted_order" not in data or data["dotted_order"] is None and (run_id is not None and isinstance(run_id, str)):
