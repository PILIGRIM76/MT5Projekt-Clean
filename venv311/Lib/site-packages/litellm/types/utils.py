        ...
        **kwargs,
        ...
        if "usage" in kwargs and kwargs["usage"] is not None:
            if isinstance(kwargs["usage"], dict):
                ...
                dump = kwargs["usage"].model_dump() if hasattr(kwargs["usage"], "model_dump") else kwargs["usage"].dict()
...
class SpecialEnums(Enum):
    ...
    LITELLM_MANAGED_RESPONSE_API_RESPONSE_ID_COMPLETE_STR = "litellm_proxy:responses_api:response_id:{};user_id:{};team_id:{}"
...
class GenericGuardrailAPIInputs(TypedDict, total=False):
    ...
    tool_calls: Union[List[ChatCompletionToolCallChunk], List[ChatCompletionMessageToolCall]]  # tool calls sent from the LLM
