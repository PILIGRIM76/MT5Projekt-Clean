...
class BedrockGuardrailConfigModel(BaseModel):
    ...
    aws_web_identity_token: Optional[str] = Field(default=None, description="Web identity token for AWS role assumption")
...
class ZscalerAIGuardConfigModel(BaseModel):
    ...
    send_user_api_key_alias: Optional[bool] = Field(default=False, description="Whether to send user_API_key_alias in headers")
...
class ContentFilterConfigModel(BaseModel):
    ...
    blocked_words_file: Optional[str] = Field(default=None, description="Path to YAML file containing blocked_words list")
...
class BaseLitellmParams(ContentFilterConfigModel):  # works for new and patch update guardrails
    ...
    # hide secrets params
    detect_secrets_config: Optional[dict] = Field(default=None, description="Configuration for detect-secrets guardrail")
