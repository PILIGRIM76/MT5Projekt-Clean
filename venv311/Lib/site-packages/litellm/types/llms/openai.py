...
from openai._legacy_response import HttpxBinaryResponseContent as _HttpxBinaryResponseContent
...
from openai.types.beta.thread_create_params import Message as OpenAICreateThreadParamsMessage
