...
class VectorStoreIndexEndpoints(TypedDict):
    ...
    read: List[Tuple[Literal["GET", "POST", "PUT", "DELETE", "PATCH"], str]]  # endpoints for reading a vector store index
    write: List[Tuple[Literal["GET", "POST", "PUT", "DELETE", "PATCH"], str]]  # endpoints for writing a vector store index
