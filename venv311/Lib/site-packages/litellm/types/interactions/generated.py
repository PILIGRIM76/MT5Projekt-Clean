...
class FunctionCallContent(BaseModel):
    ...
    type: Literal["function_call"] = Field(..., description="Used as the OpenAPI type discriminator for the content oneof.")
...
class TextDelta(BaseModel):
    ...
    annotations: Optional[List[Annotation]] = Field(None, description="Citation information for model-generated content.")
...
class UrlContextCallDelta(BaseModel):
    ...
    type: Literal["url_context_call"] = Field(..., description="Used as the OpenAPI type discriminator for the content oneof.")
    id: Optional[str] = Field(None, description="A unique ID for this specific tool call.")
...
class CodeExecutionCallContent(BaseModel):
    arguments: Optional[CodeExecutionCallArguments] = Field(None, description="The arguments to pass to the code execution.")
    type: Literal["code_execution_call"] = Field(
        ..., description="Used as the OpenAPI type discriminator for the content oneof."
    )
    id: Optional[str] = Field(None, description="A unique ID for this specific tool call.")
...
class FunctionResultContent(BaseModel):
    ...
    type: Literal["function_result"] = Field(..., description="Used as the OpenAPI type discriminator for the content oneof.")
...
class ThoughtSummaryDelta(BaseModel):
    type: Literal["thought_summary"] = Field(..., description="Used as the OpenAPI type discriminator for the content oneof.")
...
class Usage(BaseModel):
    ...
    total_output_tokens: Optional[int] = Field(None, description="Total number of tokens across all the generated responses.")
...
class GenerationConfig(BaseModel):
    ...
    max_output_tokens: Optional[int] = Field(None, description="The maximum number of tokens to include in the response.")
...
class Interaction(BaseModel):
    model: Optional[ModelOption] = Field(None, description="The name of the `Model` used for generating the interaction.")
    agent: Optional[AgentOption] = Field(None, description="The name of the `Agent` used for generating the interaction.")
    id: str = Field(
        ...,
    ...
    role: Optional[str] = Field(None, description="Output only. The role of the interaction.")
