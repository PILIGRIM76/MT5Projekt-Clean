...
async def _arealtime(
    ...
    **kwargs,
    ...
    if provider_config is not None:
        ...
        api_base = dynamic_api_base or litellm_params.api_base or get_secret_str("XAI_API_BASE") or "https://api.x.ai/v1"
        # set API KEY
...
async def _realtime_health_check(
    ...
    if custom_llm_provider == "azure":
        ...
        url = openai_realtime._construct_url(api_base=api_base or "https://api.openai.com/", query_params={"model": model})
