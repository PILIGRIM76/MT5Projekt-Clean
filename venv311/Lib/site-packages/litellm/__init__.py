...
from litellm.constants import OPENAI_CHAT_COMPLETION_PARAMS as _openai_completion_params  # backwards compatibility
from litellm.constants import OPENAI_FINISH_REASONS
from litellm.constants import OPENAI_FINISH_REASONS as _openai_finish_reasons  # backwards compatibility
from litellm.constants import (
...
enable_caching_on_provider_specific_optional_params: bool = False  # feature-flag for caching on optional params - e.g. 'top_k'
caching: bool = (
...
cost_margin_config: Dict[str, Union[float, Dict[str, float]]] = {}  # Provider-specific or global cost margins. Examples:
...
from .vector_store_files.main import aretrieve_content as avector_store_file_content
...
from .vector_store_files.main import retrieve_content as vector_store_file_content
...
disable_hf_tokenizer_download: Optional[bool] = None  # disable huggingface tokenizer download. Defaults to openai clk100
...
if TYPE_CHECKING:
    ...
    from .llms.openai.chat.o_series_transformation import OpenAIOSeriesConfig as OpenAIO1Config
    from .llms.openai.chat.o_series_transformation import OpenAIOSeriesConfig as OpenAIOSeriesConfig
    from .llms.openai.image_variations.transformation import OpenAIImageVariationConfig as OpenAIImageVariationConfig
    from .llms.openai.openai import MistralEmbeddingConfig as MistralEmbeddingConfig
    ...
    from .llms.volcengine.chat.transformation import VolcEngineChatConfig as VolcEngineChatConfig
