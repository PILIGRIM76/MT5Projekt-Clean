...
class SpendUpdateQueue(BaseUpdateQueue):
    ...
    def _get_aggregated_spend_update_queue_item(self, updates: List[SpendUpdateQueueItem]) -> List[SpendUpdateQueueItem]:
        """
    ...
    def get_aggregated_db_spend_update_transactions(self, updates: List[SpendUpdateQueueItem]) -> DBSpendUpdateTransactions:
