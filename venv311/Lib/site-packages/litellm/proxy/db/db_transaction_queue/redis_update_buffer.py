...
class RedisUpdateBuffer:
    ...
    def _should_commit_spend_updates_to_redis() -> bool:
        ...
        _use_redis_transaction_buffer: Optional[Union[bool, str]] = general_settings.get("use_redis_transaction_buffer", False)
    ...
    async def get_all_daily_spend_update_transactions_from_redis_buffer(
        ...
        return cast(
            ...
            DailySpendUpdateQueue.get_aggregated_daily_spend_update_transactions(list_of_daily_spend_update_transactions),
        )
