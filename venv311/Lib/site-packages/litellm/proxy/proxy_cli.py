...
def run_server(  # noqa: PLR0915
    ...
    if test is True:
        ...
        if config is not None:
            ...
            if litellm_settings is not None and "json_logs" in litellm_settings and litellm_settings["json_logs"] is True:
                import litellm
            ...
            if general_settings:
                ...
                proxy_config.initialize_secret_manager(key_management_system=key_management_system, config_file_path=config)
