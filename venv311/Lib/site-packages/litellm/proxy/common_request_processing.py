...
class ProxyBaseLLMRequestProcessing:
    ...
    def get_custom_headers(
        ...
        **kwargs,
        ...
        headers = {
            ...
            "x-litellm-response-cost-margin-amount": (str(margin_total_amount) if margin_total_amount is not None else None),
    ...
    async def base_process_llm_request(
        ...
        asyncio.create_task(
            proxy_logging_obj.update_request_status(litellm_call_id=self.data.get("litellm_call_id", ""), status="success")
        )
    ...
    async def _handle_llm_api_exception(
        ...
        verbose_proxy_logger.exception(f"litellm.proxy.proxy_server._handle_llm_api_exception(): Exception occured - {str(e)}")
