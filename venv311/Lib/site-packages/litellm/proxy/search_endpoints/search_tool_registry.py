...
class SearchToolRegistry:
    ...
    async def delete_search_tool_from_db(self, search_tool_id: str, prisma_client: PrismaClient):
        ...
        try:
            ...
            # Delete from DB
            await prisma_client.db.litellm_searchtoolstable.delete(where={"search_tool_id": search_tool_id})
    ...
    async def get_search_tool_by_id_from_db(self, search_tool_id: str, prisma_client: PrismaClient) -> Optional[SearchTool]:
        """
        ...
        """
        try:
            search_tool = await prisma_client.db.litellm_searchtoolstable.find_unique(where={"search_tool_id": search_tool_id})
