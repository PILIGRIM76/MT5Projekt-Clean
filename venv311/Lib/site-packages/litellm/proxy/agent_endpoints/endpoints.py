...
async def get_agents(
    ...
    try:
        ...
        verbose_proxy_logger.exception("litellm.proxy.agent_endpoints.get_agents(): Exception occurred - {}".format(str(e)))
...
async def create_agent(
    ...
    try:
        ...
        existing_agent = AGENT_REGISTRY.get_agent_by_name(agent_name=request.get("agent_name"))  # type: ignore
        ...
        result = await AGENT_REGISTRY.add_agent_to_db(agent=request, prisma_client=prisma_client, created_by=created_by)
        ...
        try:
            ...
            verbose_proxy_logger.warning(f"Failed to register agent '{agent_name}' (ID: {agent_id}) in memory: {reg_error}")
...
async def get_agent_by_id(agent_id: str):
    ...
    try:
        ...
        if agent is None:
            agent = await prisma_client.db.litellm_agentstable.find_unique(where={"agent_id": agent_id})
...
async def update_agent(
    ...
    try:
        ...
        existing_agent = await prisma_client.db.litellm_agentstable.find_unique(where={"agent_id": agent_id})
        if existing_agent is not None:
