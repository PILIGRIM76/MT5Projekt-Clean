...
class AgentRegistry:
    ...
    ############################################################
    async def add_agent_to_db(self, agent: AgentConfig, prisma_client: PrismaClient, created_by: str) -> AgentResponse:
        """
    ...
    async def delete_agent_from_db(self, agent_id: str, prisma_client: PrismaClient) -> Dict[str, Any]:
        ...
        """
        try:
            deleted_agent = await prisma_client.db.litellm_agentstable.delete(where={"agent_id": agent_id})
