...
async def get_marketplace():
    ...
    try:
        ...
        plugins = await prisma_client.db.litellm_claudecodeplugintable.find_many(where={"enabled": True})
...
async def register_plugin(
    ...
    try:
        ...
        existing = await prisma_client.db.litellm_claudecodeplugintable.find_unique(where={"name": request.name})
...
async def list_plugins(
    ...
    try:
        ...
        plugins = await prisma_client.db.litellm_claudecodeplugintable.find_many(where=where)
...
async def get_plugin(
    ...
    try:
        ...
        plugin = await prisma_client.db.litellm_claudecodeplugintable.find_unique(where={"name": plugin_name})
...
async def delete_plugin(
    ...
    try:
        ...
        await prisma_client.db.litellm_claudecodeplugintable.delete(where={"name": plugin_name})
