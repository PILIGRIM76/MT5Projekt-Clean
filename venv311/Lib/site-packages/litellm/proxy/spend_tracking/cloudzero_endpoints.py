...
async def _get_cloudzero_settings():
    ...
    cloudzero_config = await prisma_client.db.litellm_config.find_first(where={"param_name": "cloudzero_settings"})
...
async def cloudzero_export(
    ...
    try:
        ...
        return CloudZeroExportResponse(
            message="CloudZero export completed successfully", status="success", dry_run_data=None, summary=None
        )
...
async def delete_cloudzero_settings(
    ...
    try:
        ...
        await prisma_client.db.litellm_config.delete(where={"param_name": "cloudzero_settings"})
