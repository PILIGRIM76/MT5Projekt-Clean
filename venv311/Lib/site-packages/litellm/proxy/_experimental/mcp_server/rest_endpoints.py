...
if MCP_AVAILABLE:
        ...
        try:
            ...
            if server_id:
                ...
                for allowed_server_id in allowed_server_ids:
                    ...
                    try:
                        tools_result = await _get_tools_for_single_server(server, server_auth_header, raw_headers_from_request)
    ...
    async def call_tool_rest_api(
        ...
        try:
            ...
            data, logging_obj = await proxy_base_llm_response_processor.common_processing_pre_call_logic(
                request=request,
            ...
            allowed_mcp_servers = await _resolve_allowed_mcp_servers_with_ip_filter(request, user_api_key_dict, server_id)
