...
print(response)`})}),(0,o.jsx)(a.TabPanel,{children:(0,o.jsx)(h,{language:"python",code:`import os, dotenv
...
print(response)`})}),(0,o.jsx)(a.TabPanel,{children:(0,o.jsx)(h,{language:"python",code:`from langchain.chat_models import ChatOpenAI
...
print(response)`})})]})]})]})})})}],794357)},191905,e=>{"use strict";var o=e.i(843476),r=e.i(794357),l=e.i(271645);e.s(["default",0,()=>{let[e,n]=(0,l.useState)({PROXY_BASE_URL:"",PROXY_LOGOUT_URL:""});return(0,o.jsx)(r.default,{proxySettings:e})}])}]);
