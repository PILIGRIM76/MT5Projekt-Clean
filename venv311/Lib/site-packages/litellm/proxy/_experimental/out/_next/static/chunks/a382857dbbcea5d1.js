...
config = {
    "mcpServers": {
        "${ef.server_name}": {
            "url": "http://localhost:4000/${ef.server_name}/mcp",
            "headers": {
