...
class AttachmentRegistry:
    ...
    async def add_attachment_to_db(
        ...
        """
        try:
            created_attachment = await prisma_client.db.litellm_policyattachmenttable.create(
                data={
    ...
    async def delete_attachment_from_db(
        ...
        try:
            ...
            attachment = await prisma_client.db.litellm_policyattachmenttable.find_unique(
            ...
            # Delete from DB
            await prisma_client.db.litellm_policyattachmenttable.delete(where={"attachment_id": attachment_id})
    ...
    async def get_all_attachments_from_db(
        ...
        """
        try:
            attachments = await prisma_client.db.litellm_policyattachmenttable.find_many(
