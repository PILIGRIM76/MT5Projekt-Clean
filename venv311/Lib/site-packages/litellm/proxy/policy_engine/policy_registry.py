...
class PolicyRegistry:
    ...
    async def add_policy_to_db(
        ...
        try:
            ...
            created_policy = await prisma_client.db.litellm_policytable.create(data=data)
    ...
    async def delete_policy_from_db(
        ...
        try:
            ...
            policy = await prisma_client.db.litellm_policytable.find_unique(where={"policy_id": policy_id})

            if policy is None:
                raise Exception(f"Policy with ID {policy_id} not found")

            # Delete from DB
            await prisma_client.db.litellm_policytable.delete(where={"policy_id": policy_id})
    ...
    async def sync_policies_from_db(
        ...
        try:
            ...
            verbose_proxy_logger.info(f"Synced {len(policies)} policies from DB to in-memory registry")
        except Exception as e:
