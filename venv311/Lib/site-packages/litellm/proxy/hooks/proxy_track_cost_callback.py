...
class _ProxyDBLogger(CustomLogger):
    ...
    async def async_post_call_failure_hook(
        ...
        if "custom_llm_provider" not in request_data:
            request_data["custom_llm_provider"] = existing_litellm_params.get("custom_llm_provider") or request_data.get(
                "custom_llm_provider", ""
            )
    ...
    async def _PROXY_track_cost_callback(
        ...
        try:
            ...
            tags: Optional[List[str]] = sl_object.get("request_tags", None) if sl_object is not None else None
            ...
            if response_cost is not None:
                ...
                if kwargs["stream"] is not True or (kwargs["stream"] is True and "complete_streaming_response" in kwargs):
