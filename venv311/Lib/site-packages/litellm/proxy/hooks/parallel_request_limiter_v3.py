...
class _PROXY_MaxParallelRequestsHandler_v3(CustomLogger):
    ...
    def create_organization_rate_limit_descriptor(
        ...
        if (
            get_model_rate_limit_from_metadata(user_api_key_dict, "organization_metadata", "model_rpm_limit") is not None
            or get_model_rate_limit_from_metadata(user_api_key_dict, "organization_metadata", "model_tpm_limit") is not None
        ):
    ...
    def _add_model_per_key_rate_limit_descriptor(
        ...
        should_check_rate_limit = requested_model in _tpm_limit_for_key_model or requested_model in _rpm_limit_for_key_model
    ...
    def _create_rate_limit_descriptors(
        ...
        if get_team_model_rpm_limit(user_api_key_dict) is not None or get_team_model_tpm_limit(user_api_key_dict) is not None:
    ...
    def _get_total_tokens_from_usage(self, usage: Optional[Any], rate_limit_type: Literal["output", "input", "total"]) -> int:
        """
    ...
    async def async_increment_tokens_with_ttl_preservation(
        ...
        try:
            ...
            verbose_proxy_logger.debug(f"Successfully executed TTL-preserving increment for {len(pipeline_operations)} keys")
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            user_api_key_end_user_id = kwargs.get("user") or standard_logging_metadata.get("user_api_key_end_user_id")
