    ...
    async def async_set_cache_sadd(self, model: str, value: List):
        ...
        try:
            ...
            verbose_proxy_logger.exception(
                "litellm.proxy.hooks.dynamic_rate_limiter.py::async_set_cache_sadd(): Exception occured - {}".format(str(e))
            )
            raise e
...
class _PROXY_DynamicRateLimitHandler(CustomLogger):
    ...
    async def check_available_usage(
        ...
        try:
            ...
            verbose_proxy_logger.exception(
                "litellm.proxy.hooks.dynamic_rate_limiter.py::check_available_usage: Exception occurred - {}".format(str(e))
            )
