...
class _PROXY_MaxBudgetLimiter(CustomLogger):
    ...
    async def async_pre_call_hook(
        ...
        try:
            ...
            user_row = await cache.async_get_cache(cache_key, parent_otel_span=user_api_key_dict.parent_otel_span)
            ...
            verbose_logger.exception(
                "litellm.proxy.hooks.max_budget_limiter.py::async_pre_call_hook(): Exception occured - {}".format(str(e))
            )
