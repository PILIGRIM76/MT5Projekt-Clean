...
class ConfigGeneralSettings(LiteLLMPydanticObjectBase):
    ...
    database_connection_timeout: Optional[float] = Field(60, description="default timeout for a connection to the database")
    ...
    alerting_args: Optional[Dict] = Field(None, description="Controllable params for slack alerting - e.g. ttl in cache.")
...
class ProxyErrorTypes(str, enum.Enum):
    ...
    @classmethod
    def get_model_access_error_type_for_object(cls, object_type: Literal["key", "user", "team", "org"]) -> "ProxyErrorTypes":
        """
    ...
    @classmethod
    def get_vector_store_access_error_type_for_object(cls, object_type: Literal["key", "team", "org"]) -> "ProxyErrorTypes":
        """
...
class ProviderBudgetResponse(LiteLLMPydanticObjectBase):
    ...
    providers: Dict[str, ProviderBudgetResponseObject] = {}  # Dictionary mapping provider names to their budget configurations
