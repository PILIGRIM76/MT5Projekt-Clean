...
async def update_deployments_with_access_group(
    ...
    for model_name in model_names:
        ...
        deployments = await prisma_client.db.litellm_proxymodeltable.find_many(where={"model_name": model_name})
        ...
        for deployment in deployments:
            ...
            if was_modified:
                ...
                models_updated += 1
                verbose_proxy_logger.debug(f"Updated deployment {deployment.model_id} with access group: {access_group}")
...
async def update_access_group(
    ...
    try:
        ...
        verbose_proxy_logger.info(f"Successfully updated access group '{access_group}' with {models_updated} models updated")
...
async def delete_access_group(
    ...
    try:
        ...
        verbose_proxy_logger.info(f"Successfully deleted access group '{access_group}' from {models_updated} deployments")
