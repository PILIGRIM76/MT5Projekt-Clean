...
try:
    from litellm_enterprise.proxy.auth.user_api_key_auth import enterprise_custom_auth as _enterprise_custom_auth
...
async def _user_api_key_auth_builder(  # noqa: PLR0915
    ...
    try:
        ...
        if route in LiteLLMRoutes.public_routes.value or route_in_additonal_public_routes(current_route=route):  # type: ignore
