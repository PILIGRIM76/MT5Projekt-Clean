...
class LicenseCheck:
    ...
    def is_premium(self) -> bool:
        ...
        try:
            ...
            if self.license_str is None:
                return False
            elif self.verify_license_without_api_request(public_key=self.public_key, license_key=self.license_str) is True:
                return True
    ...
    def is_over_limit(self, total_users: int) -> bool:
        ...
        if self.airgapped_license_data is None:
            return False
        if "max_users" not in self.airgapped_license_data or not isinstance(self.airgapped_license_data["max_users"], int):
            return False
