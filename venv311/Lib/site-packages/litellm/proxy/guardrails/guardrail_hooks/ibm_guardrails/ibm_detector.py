...
class IBMGuardrailDetector(CustomGuardrail):
            ...
            if request_data:
                ...
                self.add_standard_logging_guardrail_information_to_request_data(
                    ...
                    guardrail_json_response={
                        "detections": [[detection for detection in message_detections] for message_detections in response_json]
                    },
    ...
    def _determine_guardrail_status_detector_server(self, response_json: List[List[IBMDetectorDetection]]) -> GuardrailStatus:
        """
    ...
    def _determine_guardrail_status_orchestrator(self, response_json: IBMDetectorResponseOrchestrator) -> GuardrailStatus:
        """
    ...
    async def async_post_call_success_hook(
        ...
        if isinstance(response, litellm.ModelResponse):
            ...
            if not has_text_content:
                verbose_proxy_logger.warning("IBM Guardrail Detector: not running guardrail. No output text in response")
                return
