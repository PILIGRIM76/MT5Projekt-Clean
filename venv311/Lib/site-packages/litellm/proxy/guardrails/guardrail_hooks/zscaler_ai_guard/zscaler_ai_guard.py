...
class ZscalerAIGuard(CustomGuardrail):
    def __init__(
        ...
        **kwargs,
        ...
        self.send_user_api_key_alias = send_user_api_key_alias or os.getenv("SEND_USER_API_KEY_ALIAS", "False").lower() in (
            "true",
            "1",
        )
        ...
        try:
            ...
            policy_id = (
                ...
                if "zguard_policy_id" in metadata
                    ...
                    else (team_metadata.get("zguard_policy_id") if "zguard_policy_id" in team_metadata else self.policy_id)
                )
            )
    ...
    async def make_zscaler_ai_guard_api_call(self, zscaler_ai_guard_url, api_key, policy_id, direction, content, **kwargs):
        """
