...
class CustomCodeGuardrail(CustomGuardrail):
    ...
    def _process_result(
        ...
        if action == "allow":
            ...
            verbose_proxy_logger.info(f"Custom code guardrail '{self.guardrail_name}': Blocking {input_type} - {reason}")
            ...
            verbose_proxy_logger.warning(
                f"Custom code guardrail '{self.guardrail_name}': " f"Unknown action '{action}'. Treating as allow."
            )
            return inputs
