...
class OpenAIModerationGuardrail(OpenAIGuardrailBase, CustomGuardrail):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        verbose_proxy_logger.debug(f"Initialized OpenAI Moderation Guardrail: {guardrail_name} with model: {self.model}")
    ...
    def _get_api_key(self) -> Optional[str]:
        ...
        return os.environ.get("OPENAI_API_KEY") or litellm.api_key or litellm.openai_key or get_secret_str("OPENAI_API_KEY")
    ...
    def _check_moderation_result(self, moderation_response: "OpenAIModerationResponse") -> None:
        ...
        if result.flagged:
            ...
            verbose_proxy_logger.warning("OpenAI Moderation: Content flagged for violations: %s", violation_details)
