...
class GraySwanGuardrail(CustomGuardrail):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not api_key_value:
            raise GraySwanGuardrailMissingSecrets("Gray Swan API key missing. Set `GRAYSWAN_API_KEY` or pass `api_key`.")
    ...
    def _process_response_internal(
        ...
        if self.on_flagged_action == "block":
            ...
            verbose_proxy_logger.info("Gray Swan Guardrail: Passthrough mode - replacing content with violation message")
