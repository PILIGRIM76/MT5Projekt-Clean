...
class PangeaHandler(CustomGuardrail):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(guardrail_name=guardrail_name, supported_event_hooks=supported_event_hooks, **kwargs)
    ...
    async def _call_pangea_ai_guard(self, api: str, payload: dict, hook_name: str) -> dict:
        ...
        verbose_proxy_logger.debug(f"Pangea Guardrail ({hook_name}): Calling endpoint {endpoint} with payload: {payload}")
    ...
    async def _async_pre_call_hook(self, user_api_key_dict: UserAPIKeyAuth, cache: DualCache, data: dict, call_type: str):
        transformer = None
        messages: Any = None
    ...
    async def async_pre_call_hook(
        ...
        if self.should_run_guardrail(data=data, event_type=event_type) is not True:
            verbose_proxy_logger.debug(f"Pangea Guardrail (async_pre_call_hook): Guardrail is disabled {self.guardrail_name}.")
            return data
