...
class PromptSecurityGuardrail(CustomGuardrail):
        ...
        for image_url in images:
            if image_url.startswith("data:"):
                try:
                    ...
                    result = await self.sanitize_file_content(file_data, filename, user_api_key_alias=user_api_key_alias)
    ...
    async def _process_image_url_item(self, item: dict, user_api_key_alias: Optional[str]) -> dict:
        ...
        try:
            ...
            sanitization_result = await self.sanitize_file_content(file_data, filename, user_api_key_alias=user_api_key_alias)
