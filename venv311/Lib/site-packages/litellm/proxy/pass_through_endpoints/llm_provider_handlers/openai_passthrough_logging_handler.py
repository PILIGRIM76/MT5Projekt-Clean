...
class OpenAIPassthroughLoggingHandler(BasePassthroughLoggingHandler):
    ...
    def is_openai_chat_completions_route(url_route: str) -> bool:
        ...
        return bool(
            parsed_url.hostname
            and ("api.openai.com" in parsed_url.hostname or "openai.azure.com" in parsed_url.hostname)
    ...
    def openai_passthrough_handler(  # noqa: PLR0915
        ...
        **kwargs,
        ...
        try:
            ...
            endpoint_type = (
                "chat_completions" if is_chat_completions else "image_generation" if is_image_generation else "image_editing"
            )
