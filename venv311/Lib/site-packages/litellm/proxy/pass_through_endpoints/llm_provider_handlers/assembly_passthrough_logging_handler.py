...
class AssemblyAIPassthroughLoggingHandler:
    ...
    def _handle_assemblyai_passthrough_logging(
        ...
        **kwargs,
        ...
        transcript_response = self._poll_assembly_for_transcript_response(transcript_id=transcript_id, url_route=url_route)
    ...
    def _get_assembly_transcript(
        ...
        try:
            ...
            verbose_proxy_logger.exception(f"[Non blocking logging error] Error getting AssemblyAI transcript: {str(e)}")
            return None
    ...
    def get_cost_per_second_for_assembly_model(speech_model: str) -> Optional[float]:
        ...
        try:
            ...
            verbose_proxy_logger.exception(f"[Non blocking logging error] Error getting AssemblyAI model info: {str(e)}")
            return None
