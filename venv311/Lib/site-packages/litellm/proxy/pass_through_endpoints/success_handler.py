...
class PassThroughEndpointLogging:
    ...
    def normalize_llm_passthrough_logging_payload(
        ...
        **kwargs,
        ...
        if self.is_gemini_route(url_route, custom_llm_provider):
            ...
            anthropic_passthrough_logging_handler_result = AnthropicPassthroughLoggingHandler.anthropic_passthrough_handler(
                httpx_response=httpx_response,
                response_body=response_body or {},
                logging_obj=logging_obj,
                url_route=url_route,
    ...
    async def pass_through_async_success_handler(
        ...
        **kwargs,
        ...
        if self.is_assemblyai_route(url_route):
            ...
            standard_logging_response_object = normalized_llm_passthrough_logging_payload["standard_logging_response_object"]
    ...
    def is_openai_route(self, url_route: str):
        ...
        if not url_route:
            return False
        parsed_url = urlparse(url_route)
        return parsed_url.hostname and ("api.openai.com" in parsed_url.hostname or "openai.azure.com" in parsed_url.hostname)
