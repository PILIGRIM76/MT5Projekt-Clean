...
class PerplexityResponsesConfig(OpenAIResponsesAPIConfig):
    ...
    def _transform_usage(self, usage_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if isinstance(cost_obj, dict) and "total_cost" in cost_obj:
            ...
            verbose_logger.debug("Transformed Perplexity cost object to float: %s -> %s", cost_obj, cost_obj["total_cost"])
    ...
    def transform_streaming_response(
        ...
        event_pydantic_model = PerplexityResponsesConfig.get_event_model_class(event_type=event_type)
                ...
                if isinstance(usage_obj, dict):
                    ...
                    if isinstance(cost_obj, dict) and "total_cost" in cost_obj:
                        ...
                        verbose_logger.debug(
                            "Transformed Perplexity cost object to float: %s -> %s", cost_obj, cost_obj["total_cost"]
                        )
        except Exception as e:
