...
class AzureBlobStorageBackend(BaseFileStorageBackend, AzureBlobStorageLogger):
    ...
    async def _upload_file_with_account_key(self, file_content: bytes, full_path: str) -> str:
        ...
        blob_url = (
            f"https://{self.azure_storage_account_name}.blob.core.windows.net/{self.azure_storage_file_system}/{full_path}"
        )
        return blob_url
    ...
    async def _upload_file_with_azure_ad(self, file_content: bytes, full_path: str) -> str:
        ...
        base_url = (
            f"https://{self.azure_storage_account_name}.dfs.core.windows.net/{self.azure_storage_file_system}/{full_path}"
        )
    ...
    async def _download_file_with_azure_ad(self, file_path: str) -> bytes:
        ...
        blob_url = (
            f"https://{self.azure_storage_account_name}.blob.core.windows.net/{self.azure_storage_file_system}/{file_path}"
        )
