...
class AzureAIAgentsHandler:
    ...
    def _build_model_response(
        ...
        model_response.choices = [Choices(finish_reason="stop", index=0, message=Message(content=content, role="assistant"))]
    ...
    async def acompletion_stream(
        ...
        if response.status_code not in [200, 201]:
            ...
            raise AzureAIAgentsError(
                status_code=response.status_code, message=f"Streaming request failed: {error_text.decode()}"
            )
