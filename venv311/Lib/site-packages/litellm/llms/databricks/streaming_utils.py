    ...
    def chunk_parser(self, chunk: dict) -> GenericStreamingChunk:
        try:
            ...
            if (
                ...
                and processed_chunk.choices[0].delta.tool_calls[0].function.arguments is not None  # type: ignore
            ):
                tool_use = ChatCompletionToolCallChunk(
                    id=processed_chunk.choices[0].delta.tool_calls[0].id,  # type: ignore
                    type="function",
                    function=ChatCompletionToolCallFunctionChunk(
                        name=processed_chunk.choices[0].delta.tool_calls[0].function.name,  # type: ignore
                        arguments=processed_chunk.choices[0].delta.tool_calls[0].function.arguments,  # type: ignore
                    ),
