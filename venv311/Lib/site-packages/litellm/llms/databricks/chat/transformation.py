...
class DatabricksConfig(DatabricksBase, OpenAILikeChatConfig, AnthropicConfig):
    ...
    def convert_anthropic_tool_to_databricks_tool(self, tool: Optional[AllAnthropicToolsValues]) -> Optional[DatabricksTool]:
        if tool is None:
            return None
    ...
    def map_openai_params(
        ...
        self.update_optional_params_with_thinking_tokens(non_default_params=non_default_params, optional_params=mapped_params)
    ...
    def _transform_dbrx_choices(self, choices: List[DatabricksChoice], json_mode: Optional[bool] = None) -> List[Choices]:
        transformed_choices = []
        ...
        try:
            ...
            for choice in chunk["choices"]:
                ...
                if tool_calls and self.json_mode:
                    ...
                    if self._last_function_name == RESPONSE_FORMAT_TOOL_NAME or function_name == RESPONSE_FORMAT_TOOL_NAME:
