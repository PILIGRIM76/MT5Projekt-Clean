...
class AzureBatchesAPI(BaseAzureLLM):
    ...
    def create_batch(
        ...
        azure_client: Optional[Union[AzureOpenAI, AsyncAzureOpenAI, OpenAI, AsyncOpenAI]] = self.get_azure_openai_client(
            api_key=api_key,
            api_base=api_base,
        ...
        if _is_async is True:
            ...
            return self.acreate_batch(create_batch_data=create_batch_data, azure_client=azure_client)  # type: ignore
    ...
    def retrieve_batch(
        ...
        if _is_async is True:
            ...
            return self.aretrieve_batch(retrieve_batch_data=retrieve_batch_data, client=azure_client)  # type: ignore
    ...
    def cancel_batch(
        ...
        if _is_async is True:
            ...
            return self.acancel_batch(cancel_batch_data=cancel_batch_data, client=azure_client)  # type: ignore

        # At this point, azure_client is guaranteed to be a sync client
        if not isinstance(azure_client, (AzureOpenAI, OpenAI)):
            raise ValueError("Azure client is not an instance of AzureOpenAI or OpenAI. Make sure you passed a sync client.")
