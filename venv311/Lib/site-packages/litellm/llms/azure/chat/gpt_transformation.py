...
class AzureOpenAIConfig(BaseConfig):
    ...
    def map_openai_params(
        ...
        for param, value in non_default_params.items():
            if param == "tool_choice":
                ...
                is_response_format_supported = is_response_format_supported_api_version and _is_response_format_supported_model
    ...
    def validate_environment(
        ...
        raise NotImplementedError("Azure OpenAI has custom logic for validating environment, as it uses the OpenAI SDK.")
