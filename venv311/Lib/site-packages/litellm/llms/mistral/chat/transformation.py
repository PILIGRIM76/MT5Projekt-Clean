...
class MistralConfig(OpenAIGPTConfig):
    ...
    def _get_openai_compatible_provider_info(
        ...
        api_base = (
            api_base or get_secret_str("MISTRAL_AZURE_API_BASE") or "https://api.mistral.ai/v1"  # for Azure AI Mistral
        )  # type: ignore
        ...
        dynamic_api_key = (
            api_key or get_secret_str("MISTRAL_AZURE_API_KEY") or get_secret_str("MISTRAL_API_KEY")  # for Azure AI Mistral
        )
