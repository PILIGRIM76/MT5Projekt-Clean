...
class AmazonNovaCanvasConfig:
    ...
    def transform_request_body(cls, text: str, optional_params: dict) -> AmazonNovaCanvasRequestBase:
        ...
        if task_type == "TEXT_IMAGE":
            ...
            try:
                text_to_image_params_typed = AmazonNovaCanvasTextToImageParams(**text_to_image_params)  # type: ignore
        ...
        if task_type == "COLOR_GUIDED_GENERATION":
            color_guided_generation_params: Dict[str, Any] = image_generation_config.pop("colorGuidedGenerationParams", {})
        ...
        if task_type == "INPAINTING":
            ...
            try:
                inpainting_params_typed = AmazonNovaCanvasInpaintingParams(**inpainting_params)  # type: ignore
            except Exception as e:
                raise ValueError(
    ...
    @classmethod
    def transform_response_dict_to_openai_response(cls, model_response: ImageResponse, response_dict: dict) -> ImageResponse:
        """
