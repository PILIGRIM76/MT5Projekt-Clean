...
class BedrockRealtimeConfig(BaseRealtimeConfig):
    ...
    def transform_content_start_event(
        ...
        content_part_added = OpenAIRealtimeResponseContentPartAdded(
            ...
            part=({"type": "text", "text": ""} if current_delta_type == "text" else {"type": "audio", "transcript": ""}),
            response_id=current_response_id,
        )
    ...
    def transform_realtime_response(
        ...
        if "sessionStart" in event:
            ...
            events, tool_call_id, tool_name = self.transform_tool_use_event(event, current_output_item_id, current_response_id)
            returned_messages.extend(events)
