...
class AmazonConverseConfig(BaseConfig):
    ...
    def _convert_consecutive_user_messages_to_guarded_text(
        ...
        for user_message_index in consecutive_user_message_indices:
            ...
            if isinstance(content, list):
                has_guarded_text = any(isinstance(item, dict) and item.get("type") == "guarded_text" for item in content)
                if has_guarded_text:
    ...
    def _handle_reasoning_effort_parameter(self, model: str, reasoning_effort: str, optional_params: dict) -> None:
        ...
        if "gpt-oss" in model:
            ...
            optional_params["thinking"] = AnthropicConfig._map_reasoning_effort(reasoning_effort=reasoning_effort, model=model)
    ...
    def map_openai_params(
        ...
        for param, value in non_default_params.items():
            ...
            if param == "thinking":
                ...
                self._handle_reasoning_effort_parameter(model=model, reasoning_effort=value, optional_params=optional_params)
    ...
    def _transform_thinking_blocks(
        ...
        for block in thinking_blocks:
            if "reasoningText" in block:
                ...
                _redacted_block = ChatCompletionRedactedThinkingBlock(type="redacted_thinking", data=block["redactedContent"])
