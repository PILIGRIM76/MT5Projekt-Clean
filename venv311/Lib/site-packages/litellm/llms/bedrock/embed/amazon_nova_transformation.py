        ...
        if (
            ...
            if input.startswith("data:"):
                ...
                if media_type.startswith("image/"):
                    ...
                    embedding_params["image"] = {"format": image_format, "source": {"bytes": base64_data}}
                elif media_type.startswith("video/"):
                    # Handle video data URLs
                    video_format = media_type.split("/")[1].lower()
                    embedding_params["video"] = {"format": video_format, "source": {"bytes": base64_data}}
                elif media_type.startswith("audio/"):
                    # Handle audio data URLs
                    audio_format = media_type.split("/")[1].lower()
                    embedding_params["audio"] = {"format": audio_format, "source": {"bytes": base64_data}}
                else:
                ...
                # Plain text input
                embedding_params["text"] = {"value": input, "truncationMode": "END"}  # Required by Nova API
