...
def get_cost_for_web_search_request(custom_llm_provider: str, usage: "Usage", model_info: "ModelInfo") -> Optional[float]:
    """
    ...
    if custom_llm_provider == "gemini":
        ...
        from .vertex_ai.gemini.cost_calculator import cost_per_web_search_request as cost_per_web_search_request_vertex_ai
