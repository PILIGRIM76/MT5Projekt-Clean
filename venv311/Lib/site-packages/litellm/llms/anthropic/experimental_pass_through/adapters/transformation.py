...
class LiteLLMAnthropicMessagesAdapter:
    ...
    def translate_thinking_for_model(
        ...
        if LiteLLMAnthropicMessagesAdapter.is_anthropic_claude_model(model):
            ...
            reasoning_effort = LiteLLMAnthropicMessagesAdapter.translate_anthropic_thinking_to_reasoning_effort(thinking)
            if reasoning_effort:
    ...
    def _translate_openai_content_to_anthropic(
        ...
        for choice in choices:
            ...
            if choice.message.content is not None:
                new_content.append(AnthropicResponseContentBlockText(type="text", text=choice.message.content).model_dump())
            ...
            if (
                ...
                if len(thinking_blocks) > 0:
                    ...
                    if thinking_block["type"] == "thinking":
                        ...
                        return "thinking", ChatCompletionThinkingBlock(type="thinking", thinking=thinking, signature=signature)
    ...
    def translate_streaming_openai_response_to_anthropic(
        ...
        if response.choices[0].finish_reason is not None:
            ...
            return MessageBlockDelta(type="message_delta", delta=delta, usage=usage_delta)  # type: ignore
        (
            type_of_content,
            content_block_delta,
