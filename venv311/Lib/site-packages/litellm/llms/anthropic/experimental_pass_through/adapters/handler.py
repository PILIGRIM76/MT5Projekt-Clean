...
class LiteLLMMessagesToCompletionTransformationHandler:
    ...
    def _route_openai_thinking_to_responses_api_if_needed(
        ...
        *,
        ...
        if custom_llm_provider is None:
            try:
                _, inferred_provider, _, _ = litellm.utils.get_llm_provider(model=cast(str, completion_kwargs.get("model")))
    ...
    def _prepare_completion_kwargs(
        *,
        ...
        openai_request, tool_name_mapping = ANTHROPIC_ADAPTER.translate_completion_input_params_with_tool_mapping(request_data)
    ...
    async def async_anthropic_messages_handler(
        ...
        **kwargs,
        ...
        completion_kwargs, tool_name_mapping = LiteLLMMessagesToCompletionTransformationHandler._prepare_completion_kwargs(
            max_tokens=max_tokens,
            messages=messages,
            model=model,
            metadata=metadata,
