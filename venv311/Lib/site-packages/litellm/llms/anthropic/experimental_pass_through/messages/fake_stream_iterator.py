    ...
    def _create_streaming_chunks(self) -> List[bytes]:
        ...
        message_start = {
            ...
            "message": {
                ...
                "stop_reason": None,
                "stop_sequence": None,
                "usage": {"input_tokens": usage.get("input_tokens", 0) if usage else 0, "output_tokens": 0},
            },
        }
        ...
        message_delta = {
            "type": "message_delta",
            "delta": {"stop_reason": response_dict.get("stop_reason"), "stop_sequence": response_dict.get("stop_sequence")},
