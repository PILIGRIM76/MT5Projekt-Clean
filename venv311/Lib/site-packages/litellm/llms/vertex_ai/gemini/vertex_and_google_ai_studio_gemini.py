...
class VertexGeminiConfig(VertexAIBaseConfig, BaseConfig):
    ...
    def _extract_google_maps_retrieval_config(self, google_maps_config: dict) -> Tuple[dict, Optional[dict]]:
        ...
        cleaned_config = {k: v for k, v in google_maps_config.items() if k not in ["latitude", "longitude", "languageCode"]}
    ...
    def _map_function(self, value: List[dict], optional_params: dict) -> List[Tools]:  # noqa: PLR0915
        """
        ...
        for tool in value:
            ...
            if "function" in tool:  # tools list
                _openai_function_object = ChatCompletionToolParamFunctionChunk(**tool["function"])  # type: ignore
    ...
    def _calculate_usage(  # noqa: PLR0915
        ...
        if candidates_token_count > 0:
            ...
            if response_tokens_details.text_tokens is None:
                ...
                calculated_text_tokens = candidates_token_count - completion_image_tokens - completion_audio_tokens
        ...
        elif cached_tokens is not None and prompt_text_tokens is not None and cached_text_tokens is None:
    ...
    def _process_candidates(  # noqa: PLR0915
        ...
        for idx, candidate in enumerate(_candidates):
            ...
            if "parts" in candidate["content"]:
                ...
                image_response = VertexGeminiConfig()._extract_image_response_from_parts(parts=candidate["content"]["parts"])
