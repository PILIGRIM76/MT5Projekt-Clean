...
class VertexBase:
    ...
    def _handle_reauthentication(
        ...
        """
        verbose_logger.debug(f"Handling reauthentication for project_id: {project_id}. " f"Clearing cache and retrying once.")
    ...
    def get_access_token(
        ...
        if credential_cache_key in self._credentials_project_mapping:
            ...
            verbose_logger.debug(f"Credential cache key not found for project_id: {project_id}, loading new credentials")
