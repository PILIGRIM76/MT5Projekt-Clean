...
class VertexFineTuningAPI(VertexLLM):
    ...
    def _transform_openai_hyperparameters_to_vertex_hyperparameters(
        ...
        if _oai_hyperparameters:
            ...
            if _oai_hyperparameters.learning_rate_multiplier:
                _vertex_hyperparameters["learning_rate_multiplier"] = float(_oai_hyperparameters.learning_rate_multiplier)
    ...
    def create_fine_tuning_job(
        ...
        if response.status_code != 200:
            raise Exception(f"Error creating fine tuning job. Status code: {response.status_code}. Response: {response.text}")
