...
class VertexAIFilesConfig(VertexBase, BaseFilesConfig):
    ...
    def transform_create_file_request(
        ...
        if FilesAPIUtils.is_batch_jsonl_file(
            ...
            # Split into lines and parse each line as JSON
            openai_jsonl_content = [json.loads(line) for line in file_content.splitlines() if line.strip()]
            vertex_jsonl_content = self._transform_openai_jsonl_content_to_vertex_ai_jsonl_content(openai_jsonl_content)
    ...
    def transform_create_file_response(
        ...
        return OpenAIFileObject(
            ...
            created_at=_convert_vertex_datetime_to_openai_datetime(vertex_datetime=response_object.get("timeCreated", "")),
            status="uploaded",
...
class VertexAIJsonlFilesTransformation(VertexGeminiConfig):
    ...
    def _transform_openai_jsonl_content_to_vertex_ai_jsonl_content(self, openai_jsonl_content: List[Dict[str, Any]]):
        """
        Transforms OpenAI JSONL content to VertexAI JSONL content
    ...
    def transform_gcs_bucket_response_to_openai_file_object(
        ...
        return OpenAIFileObject(
            ...
            created_at=_convert_vertex_datetime_to_openai_datetime(vertex_datetime=gcs_upload_response.get("timeCreated", "")),
            status="uploaded",
