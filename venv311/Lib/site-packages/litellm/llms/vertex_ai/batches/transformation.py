...
class VertexAIBatchTransformation:
    ...
    @classmethod
    def transform_vertex_ai_batch_list_response_to_openai_list_response(cls, response: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _get_output_file_id_from_vertex_ai_batch_response(cls, response: VertexBatchPredictionResponse) -> str:
        ...
        output_file_id: str = response.get("outputInfo", OutputInfo()).get("gcsOutputDirectory", "") + "/predictions.jsonl"
    ...
    @classmethod
    def _get_batch_job_status_from_vertex_ai_batch_response(cls, response: VertexBatchPredictionResponse) -> BatchJobStatus:
        """
