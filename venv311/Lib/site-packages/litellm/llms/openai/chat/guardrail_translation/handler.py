...
class OpenAIChatCompletionsHandler(BaseTranslation):
    ...
    async def process_input_messages(
        ...
        if texts_to_check or tool_calls_to_check:
            ...
            if messages:
                inputs["structured_messages"] = messages  # pass the openai /chat/completions messages to the guardrail, as-is
    ...
    async def process_output_streaming_response(
        ...
        if not has_any_text_content:
            verbose_proxy_logger.warning("OpenAI Chat Completions: No text content in streaming responses, skipping guardrail")
            return responses_so_far
    ...
    def _combine_streaming_texts(self, responses_so_far: List["ModelResponseStream"]) -> Dict[Tuple[int, Optional[int]], str]:
        """
