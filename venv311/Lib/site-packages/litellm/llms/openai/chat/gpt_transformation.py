...
class OpenAIGPTConfig(BaseLLMModelInfo, BaseConfig):
        ...
        if content_item.get("type") == "image_url":
            ...
            if isinstance(content_item["image_url"], str):
                ...
                new_image_url_obj = ChatCompletionImageUrlObject(
                    **{k: v for k, v in content_item["image_url"].items() if k not in litellm_specific_params}  # type: ignore
                )
            ...
            new_file_obj = ChatCompletionFileObjectFile(
                **{k: v for k, v in file_obj.items() if k not in litellm_specific_params}  # type: ignore
            )
    ...
    def remove_cache_control_flag_from_messages_and_tools(
        ...
        for i, message in enumerate(messages):
            messages[i] = cast(AllMessageValues, filter_value_from_dict(message, "cache_control"))  # type: ignore
