...
class OpenAIResponsesHandler(BaseTranslation):
    ...
    async def process_input_messages(
        ...
        structured_messages = LiteLLMCompletionResponsesConfig.transform_responses_api_input_to_messages(
            input=input_data,
    ...
    async def process_output_streaming_response(
        ...
        if final_chunk.get("type") == "response.output_item.done":
            ...
            if model_response_choices:
                ...
                if tool_calls:
                    guardrail_inputs["tool_calls"] = cast(List[ChatCompletionToolCallChunk], tool_calls)
                # Include model information from the response if available
