...
class HuggingFaceEmbeddingConfig(BaseConfig):
    ...
    hf_task: Optional[hf_tasks] = None  # litellm-specific param, used to know the api spec to use when calling huggingface api
        ...
        if task == "conversational":
            ...
            if task == "text-generation-inference":
                ...
                data["stream"] = (  # type: ignore
                    True if "stream" in optional_params and optional_params["stream"] is True else False  # type: ignore
                )
    ...
    def convert_to_model_response_object(  # noqa: PLR0915
        ...
        if task == "conversational":
            ...
            model_response.choices[0].message.content = json.dumps(completion_response)  # type: ignore
        else:
