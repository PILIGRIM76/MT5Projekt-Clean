...
class FireworksAIConfig(OpenAIGPTConfig):
    ...
    def _add_transform_inline_image_block(
        ...
        """
        if "vision" in model or disable_add_transform_inline_image_block:  # allow user to toggle this feature.
            return content
    ...
    def _transform_messages_helper(
        ...
        disable_add_transform_inline_image_block = cast(
            Optional[bool],
            litellm_params.get("disable_add_transform_inline_image_block") or litellm.disable_add_transform_inline_image_block,
        )
    ...
    def get_provider_info(self, model: str) -> ProviderSpecificModelInfo:
        ...
        supports_reasoning_value = any(reasoning_model in normalized_model for reasoning_model in reasoning_supported_models)
