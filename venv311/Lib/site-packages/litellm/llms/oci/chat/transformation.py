...
class OCIChatConfig(BaseConfig):
    ...
    def _sign_with_manual_credentials(
        ...
        api_base = api_base or litellm.api_base or f"https://inference.generativeai.{oci_region}.oci.oraclecloud.com"
    ...
    def _get_optional_params(self, vendor: OCIVendors, optional_params: dict) -> Dict:
        ...
        if vendor == OCIVendors.COHERE:
            ...
            selected_params = {"maxTokens": 600, "temperature": 1, "topK": 0, "topP": 0.75, "frequencyPenalty": 0}
        else:
            open_ai_to_oci_param_map = self.openai_to_oci_generic_param_map
        ...
        for msg in messages[:-1]:  # All messages except the last one
            ...
            if role == "assistant" and "tool_calls" in msg and msg.get("tool_calls"):  # type: ignore[union-attr,typeddict-item]
                ...
                for tool_call in msg["tool_calls"]:  # type: ignore[union-attr,typeddict-item]
                    ...
                    tool_calls.append(
                        CohereToolCall(name=str(tool_call.get("function", {}).get("name", "")), parameters=arguments)
                    )
            ...
            if role == "user":
                ...
                chat_history.append(
                    CohereMessage(role="TOOL", message=content, toolCalls=None)  # Tool messages don't have tool calls
                )
    ...
    def transform_request(
        ...
        if vendor == OCIVendors.COHERE:
            ...
            data = OCICompletionPayload(compartmentId=oci_compartment_id, servingMode=servingMode, chatRequest=chat_request)
        else:
    ...
    def _handle_cohere_response(self, json_response: dict, model: str, model_response: ModelResponse) -> ModelResponse:
                ...
                tool_calls.append(
                    {
                        ...
                        "type": "function",
                        "function": {"name": tool_call.name, "arguments": json.dumps(tool_call.parameters)},
                    }
                )
