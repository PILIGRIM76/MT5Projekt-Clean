...
class LiteLLMSkillsTransformationHandler:
    ...
    def list_skills_handler(
        ...
        **kwargs,
        ...
        return asyncio.get_event_loop().run_until_complete(self._async_list_skills(limit=limit, offset=offset))
    ...
    def get_skill_handler(
        ...
        **kwargs,
        ...
        return asyncio.get_event_loop().run_until_complete(self._async_get_skill(skill_id=skill_id))
    ...
    def delete_skill_handler(
        ...
        **kwargs,
        ...
        return asyncio.get_event_loop().run_until_complete(self._async_delete_skill(skill_id=skill_id))
    ...
    def _db_skill_to_response(self, db_skill: Any) -> Skill:
        ...
        if hasattr(db_skill, "created_at") and db_skill.created_at:
            created_at = (
                db_skill.created_at.isoformat() if hasattr(db_skill.created_at, "isoformat") else str(db_skill.created_at)
            )
        if hasattr(db_skill, "updated_at") and db_skill.updated_at:
            updated_at = (
                db_skill.updated_at.isoformat() if hasattr(db_skill.updated_at, "isoformat") else str(db_skill.updated_at)
            )
