...
class SkillPromptInjectionHandler:
    ...
    def extract_skill_content(self, skill: LiteLLM_SkillsTable) -> Optional[str]:
        ...
        try:
            ...
            verbose_logger.warning(f"SkillPromptInjectionHandler: Error extracting content from skill {skill.skill_id}: {e}")
    ...
    def extract_all_files(self, skill: LiteLLM_SkillsTable) -> Dict[str, bytes]:
        ...
        try:
            ...
            verbose_logger.warning(f"SkillPromptInjectionHandler: Error extracting files from skill {skill.skill_id}: {e}")
