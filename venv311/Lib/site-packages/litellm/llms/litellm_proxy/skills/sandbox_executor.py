...
class SkillsSandboxExecutor:
    ...
    def execute(
        ...
        try:
            ...
            verbose_logger.error("SkillsSandboxExecutor: llm-sandbox not installed. " "Install with: pip install llm-sandbox")
            return {
                "success": False,
                "output": "",
...
"""
                ...
                if success:
                    ...
                    verbose_logger.debug(f"SkillsSandboxExecutor: Code execution failed with exit code {result.exit_code}")
