...
def _get_api_params(params: dict, model: Optional[str] = None) -> WatsonXAPIParams:
    ...
    if project_id is None:
        project_id = get_secret_str("WATSONX_PROJECT_ID") or get_secret_str("WX_PROJECT_ID") or get_secret_str("PROJECT_ID")
    if region_name is None:
...
class IBMWatsonXMixin:
    ...
    @staticmethod
    def get_watsonx_credentials(optional_params: dict, api_key: Optional[str], api_base: Optional[str]) -> WatsonXCredentials:
        api_key = (
            api_key
