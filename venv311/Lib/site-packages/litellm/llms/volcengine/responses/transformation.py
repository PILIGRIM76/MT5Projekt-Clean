...
class VolcEngineResponsesAPIConfig(OpenAIResponsesAPIConfig):
    ...
    def get_error_class(self, error_message: str, status_code: int, headers: Union[dict, httpx.Headers]) -> VolcEngineError:
    ...
    def validate_environment(self, headers: dict, model: str, litellm_params: Optional[GenericLiteLLMParams]) -> dict:
        ...
        api_key = (
            litellm_params.api_key or litellm.api_key or get_secret_str("ARK_API_KEY") or get_secret_str("VOLCENGINE_API_KEY")
        )
    ...
    def map_openai_params(
        ...
        """
        params = {
            key: value for key, value in dict(response_api_optional_params).items() if key in self._SUPPORTED_OPTIONAL_PARAMS
        }
    ...
    def transform_delete_response_api_response(
        ...
        try:
            ...
            verbose_logger.debug("Volcengine Responses API: falling back to model_construct for delete response parsing.")
