...
def _get_redis_client_logic(**env_overrides):
    ...
    _service_name: Optional[str] = redis_kwargs.get("service_name", None) or get_secret("REDIS_SERVICE_NAME")  # type: ignore
...
def get_redis_async_client(
    ...
    **env_overrides,
    ...
    if "startup_nodes" in redis_kwargs:
        ...
        cluster_client = async_redis.RedisCluster(startup_nodes=new_startup_nodes, **cluster_kwargs)  # type: ignore
...
def get_redis_connection_pool(**env_overrides):
    ...
    if "url" in redis_kwargs and redis_kwargs["url"] is not None:
        return async_redis.BlockingConnectionPool.from_url(timeout=REDIS_CONNECTION_POOL_TIMEOUT, url=redis_kwargs["url"])
