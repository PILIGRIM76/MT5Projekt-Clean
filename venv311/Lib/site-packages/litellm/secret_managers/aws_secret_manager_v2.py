...
class AWSSecretsManagerV2(BaseAWSLLM, BaseSecretManager):
    ...
    def validate_environment(cls):
        ...
        if "AWS_REGION_NAME" not in os.environ and "AWS_REGION" not in os.environ and "AWS_DEFAULT_REGION" not in os.environ:
    ...
    def sync_read_secret(
        ...
        if primary_secret_name:
            return self.sync_read_secret_from_primary_secret(secret_name=secret_name, primary_secret_name=primary_secret_name)
