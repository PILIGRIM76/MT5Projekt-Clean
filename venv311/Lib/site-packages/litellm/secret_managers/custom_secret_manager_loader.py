...
def load_custom_secret_manager(config_file_path: Optional[str] = None) -> None:
    ...
    if litellm._key_management_settings is None:
        raise ValueError("CustomSecretManagerException - key_management_settings is required with custom_secret_manager field")
    ...
    if not custom_secret_manager_path:
        raise ValueError("CustomSecretManagerException - custom_secret_manager field is required in key_management_settings")
