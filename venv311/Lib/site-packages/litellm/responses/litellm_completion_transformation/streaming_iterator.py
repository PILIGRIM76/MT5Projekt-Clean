...
class LiteLLMCompletionStreamingIterator(ResponsesAPIStreamingIterator):
    ...
    def _default_response_created_event_data(self) -> dict:
        ...
        if "tool_choice" in self.responses_api_request:
            ...
            response_created_event_data["tool_choice"] = (
                LiteLLMCompletionResponsesConfig._transform_tool_choice(self.responses_api_request["tool_choice"]) or "auto"
            )
        else:
    ...
    def return_default_done_events(self, litellm_complete_object: ModelResponse) -> Optional[BaseLiteLLMOpenAIResponseObject]:
