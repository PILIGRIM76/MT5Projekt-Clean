...
def _get_openai_compatible_provider_info(  # noqa: PLR0915
    ...
    if custom_llm_provider == "perplexity":
        ...
        (
            ...
            dynamic_api_key,
            custom_llm_provider,
        ) = litellm.AzureAIStudioConfig()._get_openai_compatible_provider_info(model, api_base, api_key, custom_llm_provider)
        ...
        (
            ...
            dynamic_api_key,
            custom_llm_provider,
        ) = litellm.GithubCopilotConfig()._get_openai_compatible_provider_info(model, api_base, api_key, custom_llm_provider)
