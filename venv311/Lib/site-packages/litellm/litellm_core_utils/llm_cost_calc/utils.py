...
def _calculate_input_cost(
    ...
    ### AUDIO COST
    prompt_cost += calculate_cost_component(model_info, "input_cost_per_audio_token", prompt_tokens_details["audio_tokens"])
    ...
    prompt_cost += calculate_cost_component(model_info, "input_cost_per_character", prompt_tokens_details["character_count"])

    ### IMAGE COUNT COST
    prompt_cost += calculate_cost_component(model_info, "input_cost_per_image", prompt_tokens_details["image_count"])
...
class CostCalculatorUtils:
    ...
    def route_image_generation_cost_calculator(
        ...
        if custom_llm_provider == litellm.LlmProviders.VERTEX_AI.value:
            ...
            from litellm.llms.aiml.image_generation.cost_calculator import cost_calculator as aiml_image_cost_calculator
            ...
            if call_type in (
                ...
                from litellm.llms.gemini.image_edit.cost_calculator import cost_calculator as gemini_image_edit_cost_calculator
            ...
            from litellm.llms.fal_ai.cost_calculator import cost_calculator as fal_ai_image_cost_calculator
            ...
            from litellm.llms.runwayml.cost_calculator import cost_calculator as runwayml_image_cost_calculator
