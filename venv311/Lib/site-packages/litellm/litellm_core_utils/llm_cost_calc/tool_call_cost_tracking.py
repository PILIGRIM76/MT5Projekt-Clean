...
class StandardBuiltInToolCostTracking:
    ...
    def _handle_web_search_cost(
        ...
        model_info = StandardBuiltInToolCostTracking._safe_get_model_info(model=model, custom_llm_provider=custom_llm_provider)
    ...
    def get_cost_for_code_interpreter(
        ...
        if provider:
            cost_per_session = StandardBuiltInToolCostTracking._get_code_interpreter_cost_from_model_map(provider=provider)
