...
class ChunkProcessor:
    ...
    def calculate_usage(
        ...
        completion_tokens_details: Optional[CompletionTokensDetails] = calculated_usage_per_chunk["completion_tokens_details"]
        prompt_tokens_details: Optional[PromptTokensDetailsWrapper] = calculated_usage_per_chunk["prompt_tokens_details"]
        ...
        if reasoning_tokens is not None:
            if returned_usage.completion_tokens_details is None:
                returned_usage.completion_tokens_details = CompletionTokensDetailsWrapper(reasoning_tokens=reasoning_tokens)
            elif (
        ...
        if web_search_requests is not None:
            if returned_usage.prompt_tokens_details is None:
                returned_usage.prompt_tokens_details = PromptTokensDetailsWrapper(web_search_requests=web_search_requests)
            else:
