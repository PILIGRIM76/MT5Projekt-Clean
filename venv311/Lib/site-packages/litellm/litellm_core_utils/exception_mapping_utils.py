...
def exception_type(  # type: ignore  # noqa: PLR0915
    ...
    if litellm.suppress_debug_info is False:
        ...
        print("LiteLLM.Info: If you need to debug this error, use `litellm._turn_on_debug()'.")  # noqa  # noqa  # noqa
        print()  # noqa
        ...
        if model:
            ...
            if (
                ...
                if "Internal server error" in error_str:
                    ...
                    "The api_key client option must be set either by passing api_key to the client or by setting" in error_str
                ):
                    exception_mapping_worked = True
                    raise AuthenticationError(
...
def exception_logging(
    ...
    try:
        ...
        verbose_logger.debug(f"LiteLLM.LoggingError: [Non-Blocking] Exception occurred while logging {traceback.format_exc()}")
        pass
