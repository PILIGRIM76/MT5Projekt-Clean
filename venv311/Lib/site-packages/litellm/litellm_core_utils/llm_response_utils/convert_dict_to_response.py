...
def convert_to_model_response_object(  # noqa: PLR0915
    ...
    try:
        if response_type == "completion" and (
            ...
            assert response_object["choices"] is not None and isinstance(response_object["choices"], Iterable)
            ...
            if start_time is not None and end_time is not None:
                if isinstance(start_time, type(end_time)):
                    model_response_object._response_ms = (end_time - start_time).total_seconds() * 1000  # type: ignore
            ...
            if "usage" in response_object and response_object["usage"] is not None:
                tr_usage_object: Optional[Union[TranscriptionUsageDurationObject, TranscriptionUsageTokensObject]] = None
