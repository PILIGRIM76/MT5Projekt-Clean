...
from openai.types.completion_create_params import CompletionCreateParamsNonStreaming as TextCompletionCreateParamsNonStreaming
from openai.types.completion_create_params import CompletionCreateParamsStreaming as TextCompletionCreateParamsStreaming
...
class ModelParamHelper:
    ...
    def _get_relevant_args_to_use_for_logging() -> Set[str]:
        ...
        combined_kwargs = all_openai_llm_api_params.difference(set(ModelParamHelper.get_exclude_params_for_model_parameters()))
    ...
    def _get_litellm_supported_text_completion_kwargs() -> Set[str]:
        ...
        This follows the OpenAI API Spec
        """
        all_text_completion_kwargs = set(getattr(TextCompletionCreateParamsNonStreaming, "__annotations__", {}).keys()).union(
            set(getattr(TextCompletionCreateParamsStreaming, "__annotations__", {}).keys())
        )
