...
def _get_modified_max_tokens() -> Any:
    ...
    if _get_modified_max_tokens_func is None:
        from litellm.litellm_core_utils.token_counter import get_modified_max_tokens as _get_modified_max_tokens_imported
...
def _get_token_counter_new() -> Any:
    ...
    if _token_counter_new_func is None:
        from litellm.litellm_core_utils.token_counter import token_counter as _token_counter_imported
