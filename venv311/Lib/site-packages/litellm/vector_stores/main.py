    ...
    **kwargs,
    ...
    try:
        ...
        if litellm_params.mock_response and isinstance(litellm_params.mock_response, dict):
            return mock_vector_store_create_response(mock_response=VectorStoreCreateResponse(**litellm_params.mock_response))
...
def search(
    ...
    **kwargs,
    ...
    try:
        ...
        if litellm.vector_store_registry is not None and vector_store_id_for_credentials is not None:
            try:
