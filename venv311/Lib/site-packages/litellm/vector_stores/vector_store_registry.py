...
class VectorStoreIndexRegistry:
    ...
    async def _get_vector_store_indexes_from_db(
        ...
        if prisma_client is not None:
            _vector_stores_from_db = await prisma_client.db.litellm_managedvectorstoreindextable.find_many(
...
class VectorStoreRegistry:
    ...
    def get_litellm_managed_vector_store_from_registry(self, vector_store_id: str) -> Optional[LiteLLM_ManagedVectorStore]:
        """
    ...
    async def pop_vector_stores_to_run_with_db_fallback(
        self, non_default_params: Dict, tools: Optional[List[Dict]] = None, prisma_client: Optional[PrismaClient] = None
    ) -> List[LiteLLM_ManagedVectorStore]:
        """
        Pops the vector stores to run with their tool parameters merged.
    ...
    def delete_vector_store_from_registry(self, vector_store_id: str):
        ...
        """
        self.vector_stores = [
            vector_store for vector_store in self.vector_stores if vector_store.get("vector_store_id") != vector_store_id
        ]
