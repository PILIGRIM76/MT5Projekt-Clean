...
class A2ACompletionBridgeHandler:
    ...
    async def handle_non_streaming(
        ...
        a2a_provider_config = A2AProviderConfigManager.get_provider_config(custom_llm_provider=custom_llm_provider)
        ...
        litellm_params_to_add = {k: v for k, v in litellm_params.items() if k not in ("model", "custom_llm_provider")}
