...
MAX_SIZE_PER_ITEM_IN_MEMORY_CACHE_IN_KB = int(os.getenv("MAX_SIZE_PER_ITEM_IN_MEMORY_CACHE_IN_KB", 1024))  # 1MB = 1024KB
...
DEFAULT_MCP_SEMANTIC_FILTER_SIMILARITY_THRESHOLD = float(os.getenv("DEFAULT_MCP_SEMANTIC_FILTER_SIMILARITY_THRESHOLD", 0.3))
...
DEFAULT_REASONING_EFFORT_MINIMAL_THINKING_BUDGET = int(os.getenv("DEFAULT_REASONING_EFFORT_MINIMAL_THINKING_BUDGET", 128))
...
DEFAULT_REASONING_EFFORT_MEDIUM_THINKING_BUDGET = int(os.getenv("DEFAULT_REASONING_EFFORT_MEDIUM_THINKING_BUDGET", 2048))
...
DEFAULT_TRIM_RATIO = float(os.getenv("DEFAULT_TRIM_RATIO", 0.75))  # default ratio of tokens to trim from the end of a prompt
...
AZURE_FILE_SEARCH_COST_PER_GB_PER_DAY = float(os.getenv("AZURE_FILE_SEARCH_COST_PER_GB_PER_DAY", 0.1))  # $0.1 USD per 1 GB/Day
...
DEFAULT_POLLING_INTERVAL = float(os.getenv("DEFAULT_POLLING_INTERVAL", 0.03))  # default polling interval for the scheduler
...
NON_LLM_CONNECTION_TIMEOUT = int(os.getenv("NON_LLM_CONNECTION_TIMEOUT", 15))  # timeout for adjacent services (e.g. jwt auth)
...
DD_TRACER_STREAMING_CHUNK_YIELD_RESOURCE = os.getenv("DD_TRACER_STREAMING_CHUNK_YIELD_RESOURCE", "streaming.chunk.yield")
...
clarifai_models: set = set(
    [
        ...
        "clarifai/qwen.qwenLM.Qwen3-30B-A3B-Thinking-2507" "clarifai/openai.chat-completion.gpt-5-nano",
...
PROMETHEUS_BUDGET_METRICS_REFRESH_INTERVAL_MINUTES = int(os.getenv("PROMETHEUS_BUDGET_METRICS_REFRESH_INTERVAL_MINUTES", 5))
...
CLI_JWT_EXPIRATION_HOURS = int(os.getenv("CLI_JWT_EXPIRATION_HOURS") or os.getenv("LITELLM_CLI_JWT_EXPIRATION_HOURS") or 24)
...
DEFAULT_MODEL_CREATED_AT_TIME = int(os.getenv("DEFAULT_MODEL_CREATED_AT_TIME", 1677610602))  # returns on `/models` endpoint
