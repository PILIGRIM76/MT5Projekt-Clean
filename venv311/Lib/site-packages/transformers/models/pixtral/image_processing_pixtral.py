...
class PixtralImageProcessor(TorchvisionBackend):
    ...
    def resize(
        ...
        **kwargs,
        ...
        return super().resize(image, size=SizeDict(height=output_size[0], width=output_size[1]), resample=resample, **kwargs)
    ...
    def _preprocess(
        ...
        **kwargs,
        ...
        for shape, stacked_images in grouped_images.items():
            if do_resize:
                stacked_images = self.resize(image=stacked_images, size=size, patch_size=patch_size_sd, resample=resample)
        ...
        return BatchFeature(data={"pixel_values": padded_images, "image_sizes": batch_image_sizes}, tensor_type=return_tensors)
