...
class FSMTDecoder(nn.Module):
    ...
    def __init__(self, config: FSMTConfig):
        ...
        self.layers = nn.ModuleList(
            [DecoderLayer(config, layer_idx=i) for i in range(config.decoder_layers)]
    ...
    def forward(
        ...
        **kwargs,
        ...
        if not return_dict:
            return tuple(v for v in [x, past_key_values, all_hidden_states, all_self_attns, all_cross_attns] if v is not None)
