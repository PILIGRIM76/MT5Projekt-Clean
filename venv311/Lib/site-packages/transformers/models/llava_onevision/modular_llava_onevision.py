        ...
        **kwargs,
        ...
        for i, image in enumerate(images):
            if need_patching[i]:
                ...
                padded_image = self.pad_to_square(images=image, background_color=tuple(int(x * 255) for x in self.image_mean))
        ...
        **kwargs,
        ...
        for i, image in enumerate(images):
            if need_patching[i]:
                ...
                padded_image = self.pad_to_square(image=image, background_color=tuple(int(x * 255) for x in self.image_mean))
                image_patches = [padded_image]
