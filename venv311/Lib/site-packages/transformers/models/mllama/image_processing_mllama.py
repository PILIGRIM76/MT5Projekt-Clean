...
class MllamaImageProcessor(TorchvisionBackend):
    ...
    def resize(
        ...
        image = super().resize(image, SizeDict(height=new_height, width=new_width), resample=resample, antialias=antialias)
    ...
    def _preprocess(
        ...
        **kwargs,
        ...
        grouped_images, grouped_images_index = group_images_by_shape(images, is_nested=True, disable_grouping=disable_grouping)
        ...
        aspect_ratio_mask = build_aspect_ratio_mask(aspect_ratios, max_image_tiles=max_image_tiles, device=pixel_values_device)
