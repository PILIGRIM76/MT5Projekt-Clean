        ...
        if mecab_dic is not None:
            if mecab_dic == "ipadic":
                ...
                if not os.path.isdir(dic_dir):
                    raise RuntimeError(
                        "The unidic dictionary itself is not found. " "See https://github.com/polm/unidic-py for installation."
                    )
...
class JumanppTokenizer:
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "You need to install rhoknp to use JumanppTokenizer. " "See https://github.com/ku-nlp/rhoknp for installation."
            )
