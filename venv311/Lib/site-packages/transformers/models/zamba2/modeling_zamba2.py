...
class Zamba2MambaMixer(nn.Module):
    ...
    def __init__(self, config: Zamba2Config, layer_idx: int | None = None):
        ...
        self.norm = Zamba2RMSNormGated(self.intermediate_size, group_size=self.intermediate_size // self.n_groups, eps=1e-5)
    ...
    def get_layers(self):
        ...
        for layer_id, layer_type in enumerate(self.layers_block_type):
            ...
            if layer_type == "hybrid":
                ...
                if not isinstance(unique_hybrid_blocks, list) or len(unique_hybrid_blocks) >= self.config.num_mem_blocks:
