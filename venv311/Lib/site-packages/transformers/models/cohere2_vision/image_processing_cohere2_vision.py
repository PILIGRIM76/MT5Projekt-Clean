...
class Cohere2VisionImageProcessor(TorchvisionBackend):
    ...
    def _preprocess(
        ...
        **kwargs,
        ...
        return BatchFeature(data={"pixel_values": processed_images, "num_patches": num_patches}, tensor_type=return_tensors)
    ...
    def get_number_of_image_patches(self, height: int, width: int, images_kwargs=None):
        ...
        crop_to_patches = images_kwargs.get("crop_to_patches", self.crop_to_patches) if images_kwargs else self.crop_to_patches
