...
class MLukeTokenizer(TokenizersBackend):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        entity_token_1 = (
            AddedToken(entity_token_1, lstrip=False, rstrip=False) if isinstance(entity_token_1, str) else entity_token_1
        )
        entity_token_2 = (
            AddedToken(entity_token_2, lstrip=False, rstrip=False) if isinstance(entity_token_2, str) else entity_token_2
        )
        ...
        for entity_special_token in [entity_unk_token, entity_pad_token, entity_mask_token, entity_mask2_token]:
            if entity_special_token not in self.entity_vocab:
                raise ValueError(f"Specified entity special token ``{entity_special_token}`` is not found in entity_vocab.")
    ...
    def __call__(
        ...
        **kwargs,
        ...
        is_valid_batch_text = isinstance(text, (list, tuple)) and (len(text) == 0 or isinstance(text[0], (str, list, tuple)))
    ...
    def _batch_encode_plus(
        ...
        **kwargs,
        ...
        if batch_entity_spans_or_entity_spans_pairs is None and batch_entities_or_entities_pairs is None and self.task is None:
    ...
    def _create_input_sequence(
        ...
        **kwargs,
        ...
        if self.task is None:
            ...
            first_ids = first_ids[:entity_token_end] + [self.extra_special_tokens_ids[0]] + first_ids[entity_token_end:]
            first_ids = first_ids[:entity_token_start] + [self.extra_special_tokens_ids[0]] + first_ids[entity_token_start:]
