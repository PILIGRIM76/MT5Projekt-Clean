...
class FunnelEmbeddings(nn.Module):
    ...
    def forward(self, input_ids: torch.Tensor | None = None, inputs_embeds: torch.Tensor | None = None) -> torch.Tensor:
    ...
    def forward(
        ...
        **kwargs,
        ...
        return BaseModelOutput(
            ...
            hidden_states=(encoder_outputs.hidden_states + decoder_outputs.hidden_states) if output_hidden_states else None,
