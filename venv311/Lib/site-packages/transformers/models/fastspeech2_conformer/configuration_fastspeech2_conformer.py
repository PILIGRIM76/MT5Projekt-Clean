...
class FastSpeech2ConformerConfig(PreTrainedConfig):
    ...
    def validate_architecture(self):
        ...
        if self.energy_predictor_kernel_size % 2 == 0:
            raise ValueError(f"energy_predictor_kernel_size must be odd, but got {self.energy_predictor_kernel_size} instead.")
        ...
        if self.pitch_predictor_kernel_size % 2 == 0:
            raise ValueError(f"pitch_predictor_kernel_size must be odd, but got {self.pitch_predictor_kernel_size} instead.")
