    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.max_column_id = (
            ...
            else model_max_length if model_max_length is not None else VERY_LARGE_INTEGER
        )
        self.max_row_id = (
            max_row_id if max_row_id is not None else model_max_length if model_max_length is not None else VERY_LARGE_INTEGER
        )
