...
class MMGroundingDinoTextEnhancerLayer(nn.Module):
    ...
    def __init__(self, config):
        super().__init__()
        self.self_attn = MMGroundingDinoMultiheadAttention(config, num_attention_heads=config.encoder_attention_heads // 2)
...
class MMGroundingDinoDecoderLayer(nn.Module):
    def __init__(self, config: MMGroundingDinoConfig):
        ...
        self.encoder_attn_text = MMGroundingDinoMultiheadAttention(config, num_attention_heads=config.decoder_attention_heads)
...
class MMGroundingDinoForObjectDetection(MMGroundingDinoPreTrainedModel):
    ...
    def __init__(self, config: MMGroundingDinoConfig):
        ...
        self.class_embed = nn.ModuleList([MMGroundingDinoContrastiveEmbedding(config) for _ in range(config.decoder_layers)])
