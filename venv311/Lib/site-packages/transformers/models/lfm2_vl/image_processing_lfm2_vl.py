...
def convert_image_to_patches(images: "torch.Tensor", patch_size: int) -> "torch.Tensor":
    ...
    patched_image = images.reshape(batch_size, num_channels, num_patches_height, patch_size, num_patches_width, patch_size)
    ...
    def _preprocess(
        ...
        **kwargs,
        ...
        if do_pad:
            ...
            processed_spatial_shapes = torch.cat([torch.tensor(spatial_shape) for spatial_shape in processed_spatial_shapes])
