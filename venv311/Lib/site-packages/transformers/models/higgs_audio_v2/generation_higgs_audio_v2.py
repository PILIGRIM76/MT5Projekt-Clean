    ...
    def __call__(self, input_ids: torch.LongTensor, scores: torch.FloatTensor) -> torch.FloatTensor:
        ...
        if self.bos_delay_pattern is None:
            ...
            if len(audio_bos_idxs) > 0:
                ...
                self.bos_delay_pattern[unique_batch_idxs] = self.bos_delay_pattern[unique_batch_idxs] - current_after_bos.to(
                    self.bos_delay_pattern.device
                )
            else:
        ...
        if self.eos_delay_pattern is None:
            ...
            if len(audio_eos_idxs) > 0:
                ...
                self.eos_delay_pattern[unique_batch_idxs] = self.eos_delay_pattern[unique_batch_idxs] - current_after_eos.to(
                    self.eos_delay_pattern.device
                )
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            ras_win_max_num_repeat = (
                generation_config.ras_win_max_num_repeat if hasattr(generation_config, "ras_win_max_num_repeat") else None
            )
