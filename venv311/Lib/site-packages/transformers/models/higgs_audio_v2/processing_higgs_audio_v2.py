...
class HiggsAudioV2Processor(ProcessorMixin):
    ...
    def __init__(
        ...
        self.audio_delay_token = tokenizer.audio_delay_token if hasattr(tokenizer, "audio_delay_token") else audio_delay_token
    ...
    def get_audio_tokens(self, num_audio_tokens):
        ...
        return self.audio_token * (num_audio_tokens - (num_codebooks - 1)) + self.audio_delay_token * (num_codebooks - 1)
    ...
    def batch_decode(self, audio_input_ids):
        ...
        with torch.no_grad():
            ...
            for batch_idx in range(audio_input_ids.shape[0]):
                ...
                audio_i = (
                    self.audio_tokenizer.decode(audio_token_ids.transpose(0, 1).unsqueeze(0)).audio_values.cpu().squeeze()
                )
