...
class Qwen3_5MoeAttention(nn.Module):
    ...
    def __init__(self, config: Qwen3_5MoeConfig, layer_idx: int):
        ...
        self.k_norm = Qwen3_5MoeRMSNorm(self.head_dim, eps=config.rms_norm_eps)  # thus post q_norm does not need reshape
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if pixel_values is not None:
            image_outputs: BaseModelOutputWithPooling = self.get_image_features(pixel_values, image_grid_thw, return_dict=True)
