...
class SamImageProcessor(TorchvisionBackend):
    ...
    def resize(
        ...
        **kwargs,
        ...
        return super().resize(image, size=SizeDict(height=output_height, width=output_width), resample=resample, **kwargs)
    ...
    def _preprocess_image_like_inputs(
        ...
        **kwargs,
        ...
        if segmentation_maps is not None:
            ...
            processed_segmentation_maps, _ = self._preprocess(images=processed_segmentation_maps, **segmentation_maps_kwargs)
