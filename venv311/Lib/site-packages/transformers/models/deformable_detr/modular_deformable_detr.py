...
class DeformableDetrDecoder(DeformableDetrPreTrainedModel):
    ...
    _can_record_outputs = {
        ...
        "cross_attentions": OutputRecorder(DeformableDetrMultiscaleDeformableAttention, layer_name="encoder_attn", index=1),
    }
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if self.config.num_feature_levels > len(sources):
            ...
            for level in range(_len_sources, self.config.num_feature_levels):
                ...
                pos_l = self.position_embedding(shape=source.shape, device=device, dtype=pixel_values.dtype, mask=mask).to(
                    source.dtype
                )
