...
class EdgeTamVisionNeck(nn.Module):
    def __init__(self, config: EdgeTamVisionConfig):
        ...
        self.position_encoding = EdgeTamSinePositionEmbedding(num_pos_feats=config.fpn_hidden_size // 2, normalize=True)
...
class EdgeTamMaskEmbedding(nn.Module):
    def __init__(self, config: EdgeTamPromptEncoderConfig):
        ...
        self.layer_norm1 = EdgeTamLayerNorm(self.mask_input_channels, eps=config.layer_norm_eps, data_format="channels_first")
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if pixel_values is not None:
            image_outputs: EdgeTamVisionEncoderOutput = self.get_image_features(pixel_values, return_dict=True, **kwargs)
            feature_maps = image_outputs.fpn_hidden_states
