...
class InternVLVisionConfig(PreTrainedConfig):
    ...
    def __post_init__(self, **kwargs):
        self.image_size = self.image_size if isinstance(self.image_size, (list, tuple)) else (self.image_size, self.image_size)
        self.patch_size = self.patch_size if isinstance(self.patch_size, (list, tuple)) else (self.patch_size, self.patch_size)
