...
class VibeVoiceAsrConfig(PretrainedConfig):
    ...
    def __post_init__(self, **kwargs):
        if isinstance(self.acoustic_tokenizer_encoder_config, dict):
            ...
            self.acoustic_tokenizer_encoder_config = CONFIG_MAPPING[self.acoustic_tokenizer_encoder_config["model_type"]](
        ...
        if isinstance(self.semantic_tokenizer_encoder_config, dict):
            ...
            self.semantic_tokenizer_encoder_config = CONFIG_MAPPING[self.semantic_tokenizer_encoder_config["model_type"]](
                **self.semantic_tokenizer_encoder_config
            )
        elif self.semantic_tokenizer_encoder_config is None:
            self.semantic_tokenizer_encoder_config = CONFIG_MAPPING["vibevoice_acoustic_tokenizer_encoder"](hidden_size=128)
