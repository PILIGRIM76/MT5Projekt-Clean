...
class SmolVLMImageProcessor(TorchvisionBackend):
    ...
    def split_images(
        ...
        if height > max_height or width > max_width:
            ...
            images = self.resize(images, SizeDict(height=global_image_height, width=global_image_width), resample=resample)
        ...
        if do_pad:
            ...
            for i, images in enumerate(processed_images):
                for j, image in enumerate(images):
                    processed_images_padded[i, j], pixel_attention_masks[i, j] = self.pad(image, (max_height, max_width))
