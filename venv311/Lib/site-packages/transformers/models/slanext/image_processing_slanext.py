...
class SLANeXtImageProcessor(TorchvisionBackend):
    ...
    def _resize(
        ...
        src_col_floor = torch.where(src_col_floor >= width - 1, torch.full_like(src_col_floor, width - 2), src_col_floor)
        # fixed-point weights
        ...
        src_row_floor = torch.where(src_row_floor >= height - 1, torch.full_like(src_row_floor, height - 2), src_row_floor)
        ...
        interp = weight_top_3d * (weight_left_3d * pixel_top_left + weight_right_3d * pixel_top_right) + weight_bottom_3d * (
            weight_left_3d * pixel_bottom_left + weight_right_3d * pixel_bottom_right
        )
