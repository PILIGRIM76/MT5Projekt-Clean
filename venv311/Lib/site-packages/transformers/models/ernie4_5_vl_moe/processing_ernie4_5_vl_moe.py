...
class Ernie4_5_VLMoeProcessor(ProcessorMixin):
    ...
    def _get_num_multimodal_tokens(self, image_sizes=None, video_sizes=None, **kwargs):
        ...
        if video_sizes is not None:
            ...
            temporal_merge_size = videos_kwargs.get("temporal_patch_size", None) or self.video_processor.temporal_patch_size

            num_video_patches = [
                self.video_processor.get_number_of_video_patches(*video_size, videos_kwargs) for video_size in video_sizes
            ]
            num_video_tokens = [(num_patches // merge_size**2 // temporal_merge_size) for num_patches in num_video_patches]
