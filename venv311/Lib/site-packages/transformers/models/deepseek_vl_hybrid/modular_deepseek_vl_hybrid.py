...
class DeepseekVLHybridConfig(DeepseekVLConfig):
    ...
    def __post_init__(self, **kwargs):
        ...
        if isinstance(self.high_res_vision_config, dict):
            self.high_res_vision_config["model_type"] = self.high_res_vision_config.get("model_type", "sam_vision_model")
        ...
        **kwargs,
        ...
        for image in images:
            ...
            if do_resize:
                ...
                if do_pad:
                    high_res_image = self.pad_to_square(high_res_image, background_color=self.high_res_background_color)
