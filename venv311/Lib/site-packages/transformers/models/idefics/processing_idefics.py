...
class IdeficsProcessor(ProcessorMixin):
    def __init__(self, image_processor, tokenizer=None, image_size=224, add_end_of_utterance_token=None, **kwargs):
        ...
        self.image_token_id = (
            tokenizer.image_token_id if hasattr(tokenizer, "image_token") else tokenizer.convert_tokens_to_ids(IMAGE_TOKEN)
        )
        ...
        self.tokenizer_was_trained_with_end_of_utterance_token = "<end_of_utterance>" in self.tokenizer.special_tokens_map.get(
