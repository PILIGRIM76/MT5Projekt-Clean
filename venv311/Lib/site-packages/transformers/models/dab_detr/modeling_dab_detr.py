...
class DabDetrDecoder(DabDetrPreTrainedModel):
    ...
    def __init__(self, config: DabDetrConfig):
        ...
        self.ref_point_head = DabDetrMLP(config.query_dim // 2 * self.hidden_size, self.hidden_size, self.hidden_size, 2)
    ...
    def forward(
        ...
        **kwargs,
        ...
        for layer_id, decoder_layer in enumerate(self.layers):
            ...
            query_sine_embed[..., self.hidden_size // 2 :] *= (reference_anchor_size[..., 0] / obj_center[..., 2]).unsqueeze(
                -1
            )
            query_sine_embed[..., : self.hidden_size // 2] *= (reference_anchor_size[..., 1] / obj_center[..., 3]).unsqueeze(
                -1
            )
