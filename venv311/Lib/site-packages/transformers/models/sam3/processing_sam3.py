...
class Sam3Processor(ProcessorMixin):
    def __init__(self, image_processor, tokenizer, target_size: int | None = None, point_pad_value: int = -10, **kwargs):
        r"""
        ...
        **kwargs,
        ...
        if input_boxes is not None:
            ...
            if processed_boxes is not None:
                ...
                self._normalize_tensor_coordinates(final_boxes, original_sizes, is_bounding_box=True, preserve_padding=True)
        ...
        for img_idx in range(len(original_sizes)):
            if img_idx < tensor.shape[0]:
                ...
                if preserve_padding:
                    ...
                    tensor[img_idx] = torch.where(img_mask.expand_as(tensor[img_idx]), normalized_coords, tensor[img_idx])
                else:
    ...
    def post_process_instance_segmentation(
        ...
        ```
        """
        return self.image_processor.post_process_instance_segmentation(outputs, threshold, mask_threshold, target_sizes)
