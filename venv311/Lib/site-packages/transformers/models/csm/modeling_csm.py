...
class CsmDepthDecoderModel(CsmPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.layers = nn.ModuleList([CsmDecoderLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)])
...
class CsmForConditionalGeneration(CsmPreTrainedModel, CsmGenerationMixin):
    _tied_weights_keys = {"backbone_model.embed_tokens.embed_audio_tokens.weight": "depth_decoder.model.embed_tokens.weight"}
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if input_ids is not None and input_ids.ndim == 2:
            merged_inputs = self._merge_input_ids_with_input_values(input_ids, input_values, input_values_cutoffs, labels)
