...
class SamHQMaskEmbedding(nn.Module):
    def __init__(self, config: SamHQPromptEncoderConfig):
        ...
        self.layer_norm1 = SamHQLayerNorm(self.mask_input_channels, eps=config.layer_norm_eps, data_format="channels_first")
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if input_boxes is not None and len(input_boxes.shape) != 3:
            raise ValueError(
                "The input_boxes must be a 3D tensor. Of shape `batch_size`, `nb_boxes`, `4`." f" got {input_boxes.shape}."
            )
