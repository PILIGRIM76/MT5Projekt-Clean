...
class Qwen2AudioForConditionalGeneration(Qwen2AudioPreTrainedModel, GenerationMixin):
    ...
    def _merge_input_ids_with_audio_features(
        ...
        batch_indices, non_audio_indices = torch.where((input_ids != self.config.audio_token_id) & (attention_mask == 1))
        ...
        if left_padding:
            ...
            val = (max_token_num - seq_indices) <= (token_placeholder_num.sum(-1) - (attention_mask == 0).long().sum(-1))[
                :, None
            ]
        else:
