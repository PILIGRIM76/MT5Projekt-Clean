...
class RotaryEmbeddingConfigMixin:
    ...
    def validate_rope(self: "PreTrainedConfig"):
        ...
        if getattr(self, "layer_types", None) is not None and set(rope_parameters_dict.keys()).issubset(self.layer_types):
            pass
        else:
        ...
        for rope_parameters in rope_parameters_dict.values():
            ...
            if validation_fn is not None:
                ...
                logger.warning(f"Missing validation function in 'RotaryEmbeddingConfigMixin' for 'rope_type'='{rope_type}'")
