...
class TokenizersBackend(PreTrainedTokenizerBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._should_update_post_processor = self._should_update_post_processor or self._tokenizer.post_processor is None
    ...
    def convert_tokens_to_string(self, tokens: list[str]) -> str:
        return (
            self.backend_tokenizer.decoder.decode(tokens) if self.backend_tokenizer.decoder is not None else " ".join(tokens)
        )
