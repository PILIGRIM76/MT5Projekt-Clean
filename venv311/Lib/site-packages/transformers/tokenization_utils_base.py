...
class PreTrainedTokenizerBase(PushToHubMixin):
        ...
        **kwargs,
        ...
        if "added_tokens_decoder" in init_kwargs:
            ...
            if special_tokens_map_file is not None:
                ...
                if isinstance(init_kwargs.get("extra_special_tokens"), dict):
                    init_kwargs.setdefault("model_specific_special_tokens", {}).update(init_kwargs.pop("extra_special_tokens"))
    ...
    def encode_message_with_chat_template(
        ...
        **Note:** This method does not support `add_generation_prompt`. If you want to add a generation prompt,
        ...
        if conversation_history is None or len(conversation_history) == 0:
            return self.apply_chat_template([message], add_generation_prompt=False, tokenize=True, return_dict=False, **kwargs)
    ...
    def parse_response(
        ...
        """
        batched = (isinstance(response, list) and not isinstance(response[0], int)) or getattr(
            response, "ndim", 0
        ) > 1  # For torch/numpy tensors
