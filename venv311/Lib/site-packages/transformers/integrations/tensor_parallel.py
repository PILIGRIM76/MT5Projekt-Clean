...
class TensorParallelLayer:
    ...
    def shard_tensor(self, param: torch.Tensor, tensor_idx: int | None = None, device=None, dtype=None) -> torch.Tensor:
        raise NotImplementedError
...
def gather_full_tensor(local_tensor: torch.Tensor, shard_dim: int, device_mesh: dist.device_mesh.DeviceMesh) -> torch.Tensor:
    """
