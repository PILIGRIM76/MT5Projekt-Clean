        ...
        **kwargs,
        ...
        if isinstance(module, Mxfp4GptOssExperts):
            ...
            if "gate_up_proj" in full_layer_name:
                ...
                state_dict[f"{name}_scales"] = module.gate_up_proj_precision_config.weight_scale.storage.layout.unswizzle_data(
                ...
                state_dict[f"{name}_scales"] = module.down_proj_precision_config.weight_scale.storage.layout.unswizzle_data(
