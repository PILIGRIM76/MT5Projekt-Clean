...
class AutomaticSpeechRecognitionPipeline(ChunkPipeline):
    ...
    def postprocess(self, model_outputs, decoder_kwargs: dict | None = None, return_timestamps=None, return_language=None):
        ...
        if self.type == "ctc_with_lm":
            ...
            if return_timestamps:
                offsets = self.tokenizer.decode(items, skip_special_tokens=skip_special_tokens, output_char_offsets=True)[
                    "char_offsets"
                ]
                if return_timestamps == "word":
