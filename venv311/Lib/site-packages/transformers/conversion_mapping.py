...
def _build_checkpoint_conversion_mapping():
    mapping = {
        ...
        "pi0": [
            ...
            WeightRenaming(source_patterns=r"action_time_mlp_in", target_patterns="embed_action_time.action_time_mlp_in"),
            WeightRenaming(source_patterns=r"action_time_mlp_out", target_patterns="embed_action_time.action_time_mlp_out"),
        ...
        "conditional_detr": [
            ...
            WeightRenaming(r"decoder.layers.(\d+).ca_qpos_sine_proj", r"decoder.layers.\1.encoder_attn.q_pos_sine_proj"),
