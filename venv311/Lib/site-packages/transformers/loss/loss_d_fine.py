...
def _set_aux_loss2(outputs_class, outputs_coord, outputs_corners, outputs_ref, teacher_corners=None, teacher_logits=None):
    return [
        {
            "logits": a,
            "pred_boxes": b,
    ...
    **kwargs,
    ...
    if config.auxiliary_loss:
        if denoising_meta_values is not None:
            ...
            outputs_loss["auxiliary_outputs"].extend(_set_aux_loss([enc_topk_logits], [enc_topk_bboxes.clamp(min=0, max=1)]))
