...
class BaseVideoProcessor(TorchvisionBackend):
    ...
    def _decode_and_sample_videos(
        ...
        if is_valid_video(videos[0]) and do_sample_frames:
            ...
            if isinstance(videos[0], list):
                ...
                videos = [
                    torch.stack([tvF.pil_to_tensor(image) for image in images], dim=0) for images in self.fetch_images(videos)
                ]
                if do_sample_frames:
    ...
    def get_video_processor_dict(
        ...
        if is_local:
            ...
            logger.info(f"loading configuration file {video_processor_file} from cache at {resolved_video_processor_file}")
