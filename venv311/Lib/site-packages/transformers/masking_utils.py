...
def create_causal_mask(
    ...
    *,
    ...
    early_exit, attention_mask, packed_sequence_mask, q_length, kv_length, q_offset, kv_offset = _preprocess_mask_arguments(
                ...
                if j > 0:
                    ...
                    row += (
                        ...
                        if tensor[i, j] == 1
                            ...
                            WHITE_SQUARE if tensor[i, j] == 0 else (UPPER_TRIANGLE if tensor[i, j + 1] == 1 else LOW_TRIANGLE)
                        )
                    )
        result.append(row)
