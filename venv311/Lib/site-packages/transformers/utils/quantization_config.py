...
class TorchAoConfig(QuantizationConfigMixin):
    ...
    def from_dict(cls, config_dict, return_unused_kwargs=False, **kwargs):
        ...
        assert len(quant_type) == 1 and "default" in quant_type, "Expected only one key 'default' in quant_type dictionary"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if is_torch_available() and is_quark_available():
            ...
            raise ImportError("Quark is not installed. Please refer to https://quark.docs.amd.com/latest/install.html.")
...
class SinqConfig(QuantizationConfigMixin):
    ...
    def post_init(self):
        ...
        if self.group_size is not None and self.group_size % 8 != 0:
            logger.warning(f"SINQ: group_size={self.group_size} is not a multiple of 8; this may be rejected by the backend.")
