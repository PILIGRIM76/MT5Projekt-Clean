...
def _convert_type_hints_to_json_schema(func: Callable) -> dict:
    ...
    if first_param_name in {"self", "cls"} and signature.parameters[first_param_name].annotation == inspect.Parameter.empty:
...
def _cached_compile_jinja_template(chat_template):
    ...
    if version.parse(jinja2.__version__) < version.parse("3.1.0"):
        raise ImportError(f"apply_chat_template requires jinja2>=3.1.0 to be installed. Your version is {jinja2.__version__}.")
