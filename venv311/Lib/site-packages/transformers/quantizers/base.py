...
def get_keys_to_not_convert(model) -> list:
    ...
    output_emb_keys = {
        name for name, module in model.named_modules() if output_emb_module is not None and id(module) == id(output_emb_module)
    }
...
class HfQuantizer(ABC):
    ...
    def get_quantize_ops(self):
        raise NotImplementedError(f"{self.quantization_config.quant_method} is not available yet and will be supported soon.")
