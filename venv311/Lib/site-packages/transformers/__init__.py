...
if TYPE_CHECKING:
    ...
    from .data.data_collator import DataCollatorForPermutationLanguageModeling as DataCollatorForPermutationLanguageModeling
    ...
    from .generation import UnbatchedClassifierFreeGuidanceLogitsProcessor as UnbatchedClassifierFreeGuidanceLogitsProcessor
    ...
    from .optimization import get_cosine_with_min_lr_schedule_with_warmup as get_cosine_with_min_lr_schedule_with_warmup
    from .optimization import (
