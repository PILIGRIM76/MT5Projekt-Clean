...
class BlockManager:
    ...
    def get_free_blocks(self, n_blocks: int, last_block_id: int | None, shareable: bool, group_id: int) -> list[int] | None:
...
class CacheAllocator(ABC):
    ...
    def free_blocks(self, request_id: str, block_manager: BlockManager) -> None:
        ...
        if request_id in self.block_table:
            ...
            logger.warning(f"CacheAllocator {self._index} attempted to free blocks for non-existent request_id: {request_id}")
