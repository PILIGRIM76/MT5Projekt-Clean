...
class PromptSession(Generic[_T]):
    ...
    def _create_default_buffer(self) -> Buffer:
        ...
        def accept(buff: Buffer) -> bool:
            ...
            cast(Application[str], get_app()).exit(result=buff.document.text, style="class:accepted")
        ...
        return Buffer(
            ...
            completer=DynamicCompleter(
                lambda: ThreadedCompleter(self.completer) if self.complete_in_thread and self.completer else self.completer
            ),
...
def create_confirm_session(message: AnyFormattedText, suffix: str = " (y/n) ") -> PromptSession[bool]:
    """
