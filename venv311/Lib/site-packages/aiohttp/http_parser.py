...
class DeflateBuffer:
    ...
    def feed_data(self, chunk: bytes, size: int) -> None:
        ...
        try:
            ...
            chunk = self.decompressor.decompress_sync(chunk, max_length=self._max_decompress_size + 1)
        except Exception:
        ...
        if len(chunk) > self._max_decompress_size:
            raise DecompressSizeError("Decompressed data exceeds the configured limit of %d bytes" % self._max_decompress_size)
