...
class StreamReader(AsyncStreamReaderMixin):
    ...
    def end_http_chunk_receiving(self) -> None:
        ...
        if len(self._http_chunk_splits) > self._high_water_chunks and not self._protocol._reading_paused:
            self._protocol.pause_reading()
    ...
    def _read_nowait_chunk(self, n: int) -> bytes:
        ...
        if (
            ...
            and (self._http_chunk_splits is None or len(self._http_chunk_splits) < self._low_water_chunks)
        ):
            self._protocol.resume_reading()
        return data
