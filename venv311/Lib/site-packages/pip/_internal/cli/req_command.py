...
from pip._internal.req.pep723 import (
    PEP723Exception,
    pep723_metadata,
)
...
class RequirementCommand(IndexGroupCommand):
    ...
    def get_requirements(
        ...
        if not (
            args or options.editables or options.requirements or options.dependency_groups or options.requirements_from_scripts
        ):
            opts = {"name": self.name}
