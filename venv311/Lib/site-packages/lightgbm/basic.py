...
class Dataset:
    ...
    def set_reference(self, reference: "Dataset") -> "Dataset":
        ...
        """
        self.set_categorical_feature(reference.categorical_feature).set_feature_name(reference.feature_name)._set_predictor(
...
class Booster:
    ...
    def trees_to_dataframe(self) -> pd_DataFrame:
        ...
        for tree in model_dict["tree_info"]:
            model_list.extend(
                tree_dict_to_node_list(tree=tree["tree_structure"], tree_index=tree["tree_index"], feature_names=feature_names)
            )
    ...
    def eval_valid(
        ...
        """
        return [
            item for i in range(1, self.__num_dataset) for item in self.__inner_eval(self.name_valid_sets[i - 1], i, feval)
        ]
