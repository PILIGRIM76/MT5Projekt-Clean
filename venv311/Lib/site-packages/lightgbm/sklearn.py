...
class LGBMModel(_LGBMModelBase):
    ...
    def __sklearn_tags__(self) -> Optional["_sklearn_Tags"]:
        ...
        if not hasattr(_LGBMModelBase, "__sklearn_tags__"):
            err_msg = (
                "__sklearn_tags__() should not be called when using scikit-learn<1.6. " f"Detected version: {_sklearn_version}"
            )
...
class LGBMRegressor(_LGBMRegressorBase, LGBMModel):
    ...
    _base_doc = (
        _base_doc[: _base_doc.find("group :")] + _base_doc[_base_doc.find("eval_set :") :]  # type: ignore
    )  # type: ignore
...
class LGBMRanker(LGBMModel):
    ...
    fit.__doc__ = (
        _base_doc[: _base_doc.find("eval_class_weight :")] + _base_doc[_base_doc.find("eval_init_score :") :]  # type: ignore
    )  # type: ignore
