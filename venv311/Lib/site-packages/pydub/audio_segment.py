...
class AudioSegment(object):
    ...
    def from_file(cls, file, format=None, codec=None, parameters=None, start_second=None, duration=None, **kwargs):
        ...
        conversion_command += ["-vn", "-f", "wav"]  # Drop any video streams if there are any  # output options (filename last)
    ...
    def from_raw(cls, file, **kwargs):
        return cls.from_file(
            file, "raw", sample_width=kwargs["sample_width"], frame_rate=kwargs["frame_rate"], channels=kwargs["channels"]
        )
    ...
    def export(
        self, out_f=None, format="mp3", codec=None, bitrate=None, parameters=None, tags=None, id3v2_version="4", cover=None
    ):
        """
