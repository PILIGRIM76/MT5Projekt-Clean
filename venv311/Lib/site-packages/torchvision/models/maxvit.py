...
class MaxVit(nn.Module):
    ...
    def __init__(
        ...
        self.stem = nn.Sequential(
            ...
            Conv2dNormActivation(stem_channels, stem_channels, 3, stride=1, norm_layer=None, activation_layer=None, bias=True),
        )
...
class MaxVit_T_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
        ...
        transforms=partial(ImageClassification, crop_size=224, resize_size=224, interpolation=InterpolationMode.BICUBIC),
        meta={
