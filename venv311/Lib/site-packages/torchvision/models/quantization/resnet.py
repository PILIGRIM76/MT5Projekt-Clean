...
@handle_legacy_interface(
    weights=(
        "pretrained",
        lambda kwargs: (
            ResNet18_QuantizedWeights.IMAGENET1K_FBGEMM_V1 if kwargs.get("quantize", False) else ResNet18_Weights.IMAGENET1K_V1
        ),
    )
)
def resnet18(
...
@handle_legacy_interface(
    weights=(
        "pretrained",
        lambda kwargs: (
            ResNet50_QuantizedWeights.IMAGENET1K_FBGEMM_V1 if kwargs.get("quantize", False) else ResNet50_Weights.IMAGENET1K_V1
        ),
    )
)
def resnet50(
