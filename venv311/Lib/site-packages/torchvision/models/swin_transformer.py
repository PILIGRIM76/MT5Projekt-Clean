...
class Swin_T_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
        ...
        transforms=partial(ImageClassification, crop_size=224, resize_size=232, interpolation=InterpolationMode.BICUBIC),
        meta={
            **_COMMON_META,
            "num_params": 28288354,
            "min_size": (224, 224),
...
class Swin_S_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
        ...
        transforms=partial(ImageClassification, crop_size=224, resize_size=246, interpolation=InterpolationMode.BICUBIC),
        meta={
            **_COMMON_META,
            "num_params": 49606258,
            "min_size": (224, 224),
...
class Swin_B_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
        ...
        transforms=partial(ImageClassification, crop_size=224, resize_size=238, interpolation=InterpolationMode.BICUBIC),
        meta={
            **_COMMON_META,
            "num_params": 87768224,
            "min_size": (224, 224),
...
class Swin_V2_T_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
        ...
        transforms=partial(ImageClassification, crop_size=256, resize_size=260, interpolation=InterpolationMode.BICUBIC),
        meta={
            **_COMMON_META,
            "num_params": 28351570,
            "min_size": (256, 256),
...
class Swin_V2_B_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
        ...
        transforms=partial(ImageClassification, crop_size=256, resize_size=272, interpolation=InterpolationMode.BICUBIC),
        meta={
            **_COMMON_META,
            "num_params": 87930848,
            "min_size": (256, 256),
