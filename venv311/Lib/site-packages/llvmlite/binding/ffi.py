...
class _lib_wrapper(object):
    ...
    def _load_lib(self):
        ...
        with _suppress_cleanup_errors(_importlib_resources_path(mod_name, lib_name)) as lib_path:
            try:
                ...
                # a shared library.
                msg = (
                    f"Could not find/load shared object file '{lib_name}' "
                ...
                # exist.
                msg = (
                    "During testing of symbol lookup, the symbol "
