...
def _reject_illegal_characters(
    ...
    for header in headers:
        ...
        if field_value := header[1]:
            ...
            if field_value[0] == 0x20 or field_value[0] == 0x09 or field_value[-1] == 0x20 or field_value[-1] == 0x09:
...
def normalize_outbound_headers(
    headers: Iterable[Header], hdr_validation_flags: HeaderValidationFlags | None, should_split_outbound_cookies: bool = False
) -> Generator[Header, None, None]:
    """
