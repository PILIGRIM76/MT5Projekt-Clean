            ...
            "cmd_optional": (
                ...
                CmdBufferOut(
                    (
                        ...
                        "-NoProfile",
                        "-Command",
                        "'FreeVirtualMemory ' + " "(Get-CimInstance -ClassName " "Win32_OperatingSystem).FreeVirtualMemory",
                    )
                ),
            ),
            "kwds": {
...
def display_sysinfo(info=None, sep_pos=45):
    ...
    template = (
        ...
        (
            "Memory Available (MB)" if info.get(_os_name, "") != "Darwin" or info.get(_psutil, False) else "Free Memory (MB)",
