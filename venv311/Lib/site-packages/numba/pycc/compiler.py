...
class _ModuleCompiler(object):
    ...
    def _emit_environment_array(self, llvm_module, builder, pyapi):
        ...
        env_defs.extend([pyapi.serialize_uncached(env.consts) for env in self.extra_environments.values()])
    ...
    def _emit_envgvs_array(self, llvm_module, builder, pyapi):
        ...
        env_setters.extend(
            [
                self.context.declare_env_global(llvm_module, envgv_name).bitcast(lt._void_star)
