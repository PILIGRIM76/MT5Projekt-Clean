...
def _drop_ignored_attrs(dct):
    ...
    for att in ("__annotations__", "__annotate_func__", "__annotations_cache__"):
        if att in dct:
            drop.add(att)
...
class ClassBuilder(object):
    ...
    def _implement_method(self, registry, attr):
        ...
        def _getsetitem_gen(getset):
            ...
            imputils.lower_builtin((types.ClassInstanceType, _dunder_meth), types.ClassInstanceType, types.VarArg(types.Any))(
                get_imp()
            )
