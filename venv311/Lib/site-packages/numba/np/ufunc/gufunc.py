    ...
    class GUFuncKernel(npyimpl._Kernel):
        ...
        def generate(self, *args):
            if self.cres.objectmode:
                msg = "Calling a guvectorize function in object mode is not " "supported yet."
...
class GUFunc(serialize.ReduceMixin, UfuncBase):
    ...
    def __init__(self, py_func, signature, identity=None, cache=None, is_dynamic=False, targetoptions=None, writable_args=()):
    ...
    def _install_type(self, typingctx=None):
        ...
        _ty_cls = type("GUFuncTyping_" + self.__name__, (AbstractTemplate,), dict(key=self, generic=self._type_me))
    ...
    def _type_me(self, argtys, kws):
        ...
        _handle_inputs_result = npydecl.Numpy_rules_ufunc._handle_inputs(ufunc, argtys, kws)
...
def _is_array_wrapper(obj):
    ...
    """
    return not isinstance(obj, type) and hasattr(obj, "__dask_graph__") and hasattr(obj, "__array_ufunc__")
