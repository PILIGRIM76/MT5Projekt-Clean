...
from numba.core.config import DEVELOPER_MODE, MACHINE_BITS, PYVERSION  # noqa: F401  # noqa: F401
...
def order_by_target_specificity(target, templates, fnkey=""):
    ...
    if not order:
        msg = f"Function resolution cannot find any matches for function " f"'{fnkey}' for the current target: '{target}'."
