...
class PythonAPI(object):
    ...
    def set_next_entry(self, set, posptr, keyptr, hashptr):
        fnty = ir.FunctionType(
            ir.IntType(32), [self.pyobj, self.py_ssize_t.as_pointer(), self.pyobj.as_pointer(), self.py_hash_t.as_pointer()]
        )
    ...
    def from_native_generator(self, val, typ, env=None):
        ...
        *env* is an optional _dynfunc.Environment instance to be wrapped
        ...
        fnty = ir.FunctionType(
            self.pyobj, [self.py_ssize_t, self.voidptr, ir.PointerType(genfnty), ir.PointerType(finalizerty), self.voidptr]
        )
