...
class CPUCodeLibrary(CodeLibrary):
    ...
    def _optimize_final_module(self):
        ...
        mpm_cheap, mpb_cheap = self._codegen._module_pass_manager(
            loop_vectorize=self._codegen._loopvect, slp_vectorize=False, opt=self._codegen._opt_level, cost="cheap"
        )
...
class CPUCodegen(Codegen):
    ...
    def _init(self, llvm_module):
        ...
        self._engine.set_object_cache(self._library_class._object_compiled_hook, self._library_class._object_getbuffer_hook)
    ...
    def _pass_builder(self, **kwargs):
        ...
        pb = create_pass_builder(self._tm, opt=opt_level, loop_vectorize=loop_vectorize, slp_vectorize=slp_vectorize, **kwargs)
