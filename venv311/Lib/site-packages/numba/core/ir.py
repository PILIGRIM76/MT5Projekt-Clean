...
from numba.core.errors import ConstantInferenceError, NotDefinedError, RedefinedError, VerificationError
...
class Expr(Inst):
    ...
    def inplace_binop(cls, fn, immutable_fn, lhs, rhs, loc):
        ...
        op = "inplace_binop"
        return cls(
            op=op, loc=loc, fn=fn, immutable_fn=immutable_fn, lhs=lhs, rhs=rhs, static_lhs=UNDEFINED, static_rhs=UNDEFINED
        )
...
class FunctionIR(object):
    ...
    def derive(self, blocks, arg_count=None, arg_names=None, force_non_generator=False, loc=None):
        """
