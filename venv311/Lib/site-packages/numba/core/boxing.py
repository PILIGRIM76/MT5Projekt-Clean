...
def box_unicodecharseq(typ, val, c):
    ...
    unicode_kind = {1: c.pyapi.py_unicode_1byte_kind, 2: c.pyapi.py_unicode_2byte_kind, 4: c.pyapi.py_unicode_4byte_kind}[
...
def unbox_array(typ, obj, c):
    ...
    with c.builder.if_then(failed, likely=False):
        c.pyapi.err_set_string(
            "PyExc_TypeError", "can't unbox array from PyObject into " "native value.  The object maybe of a " "different type"
        )
