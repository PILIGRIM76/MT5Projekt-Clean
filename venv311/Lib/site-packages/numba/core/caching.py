...
class CacheImpl(metaclass=ABCMeta):
    ...
    def __init__(self, py_func):
            ...
            for locator_class_path in config.CACHE_LOCATOR_CLASSES.split(","):
                ...
                if "." in locator_class_path:
                    ...
                    try:
                        ...
                        raise RuntimeError(
                            f"Failed to import '{locator_class_path}' specified via "
                    ...
                    if cls is None:
                        raise RuntimeError(
                            f"Unknown cache locator class: '{locator_class_path}' specified via "
                            "NUMBA_CACHE_LOCATOR_CLASSES env variable"
                        )
        ...
        for cls in locator_classes:
            ...
            raise RuntimeError("cannot cache function %r: no locator available " "for file %r" % (qualname, source_path))
