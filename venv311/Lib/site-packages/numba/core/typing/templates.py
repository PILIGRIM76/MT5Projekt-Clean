...
def fold_arguments(pysig, args, kws, normal_handler, default_handler, stararg_handler):
    ...
    try:
        ...
        # doesn't just halt.
        msg = f"Cannot bind 'args={bind_args} kws={bind_kws}' to " f"signature '{pysig}' due to \"{type(e).__name__}: {e}\"."
...
def make_overload_attribute_template(
    typ, attr, overload_func, inline="never", prefer_literal=False, base=_OverloadAttributeTemplate, **kwargs
):
    """
