...
def _ensure_critical_deps():
    ...
    if PYVERSION < (3, 10):
        msg = "Numba needs Python 3.10 or greater. Got Python " f"{PYVERSION[0]}.{PYVERSION[1]}."
    ...
    if numpy_version > (2, 4):
        msg = f"Numba needs NumPy 2.4 or less. Got NumPy " f"{numpy_version[0]}.{numpy_version[1]}."
        raise ImportError(msg)
