...
def redirect_type_ctor(context, builder, sig, args):
    ...
    if len(ctor_args) > 0:
        args = (context.get_dummy_value(), context.make_tuple(builder, ctor_args, args))  # Type object has no runtime repr.
    else:
        args = (context.get_dummy_value(), context.make_tuple(builder, ctor_args, ()))  # Type object has no runtime repr.
