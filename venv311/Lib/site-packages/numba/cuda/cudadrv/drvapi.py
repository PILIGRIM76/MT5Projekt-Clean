from ctypes import CFUNCTYPE, POINTER, c_byte, c_char_p, c_float, c_int, c_size_t, c_uint, c_uint8, c_void_p, py_object
...
API_PROTOTYPES = {
    ...
    "cuLinkAddFile": (c_int, cu_link_state, cu_jit_input_type, c_char_p, c_uint, POINTER(cu_jit_option), POINTER(c_void_p)),
    #    CUresult CUDAAPI
