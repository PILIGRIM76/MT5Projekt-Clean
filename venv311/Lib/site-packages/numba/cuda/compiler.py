...
from numba.core.compiler import CompilerBase, CompileResult, DefaultPassBuilder, Flags, Option, sanitize_compile_result_entries
...
def compile_for_current_device(
    pyfunc, sig, debug=False, lineinfo=False, device=True, fastmath=False, opt=True, abi="c", abi_info=None, output="ptx"
):
...
def compile_ptx(
    pyfunc, sig, debug=False, lineinfo=False, device=False, fastmath=False, cc=None, opt=True, abi="numba", abi_info=None
):
...
def compile_ptx_for_current_device(
    pyfunc, sig, debug=False, lineinfo=False, device=False, fastmath=False, opt=True, abi="numba", abi_info=None
):
