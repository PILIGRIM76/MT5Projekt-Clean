...
@require_context
def managed_array(shape, dtype=np.float64, strides=None, order="C", stream=0, attach_global=True):
...
@require_context
def mapped_array(shape, dtype=np.float64, strides=None, order="C", stream=0, portable=False, wc=False):
