...
class PointId(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["num", b"num", "point_id_options", b"point_id_options", "uuid", b"uuid"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["num", b"num", "point_id_options", b"point_id_options", "uuid", b"uuid"]
    ) -> None: ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["point_id_options", b"point_id_options"]
    ) -> typing_extensions.Literal["num", "uuid"] | None: ...
...
class Filter(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["_min_should", b"_min_should", "min_should", b"min_should"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_min_should", b"_min_should"]
    ) -> typing_extensions.Literal["min_should"] | None: ...
...
class MinShould(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["conditions", b"conditions", "min_count", b"min_count"]
    ) -> None: ...
...
class Condition(google.protobuf.message.Message):
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["condition_one_of", b"condition_one_of"]
    ) -> typing_extensions.Literal["field", "is_empty", "has_id", "filter", "is_null", "nested", "has_vector"] | None: ...
...
class FieldCondition(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_is_empty", b"_is_empty"]
    ) -> typing_extensions.Literal["is_empty"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_is_null", b"_is_null"]
    ) -> typing_extensions.Literal["is_null"] | None: ...
...
class Match(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["match_value", b"match_value"]) -> (
...
class Range(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_gte", b"_gte"]
    ) -> typing_extensions.Literal["gte"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_lt", b"_lt"]) -> typing_extensions.Literal["lt"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_lte", b"_lte"]
    ) -> typing_extensions.Literal["lte"] | None: ...
...
class GeoBoundingBox(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["bottom_right", b"bottom_right", "top_left", b"top_left"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["bottom_right", b"bottom_right", "top_left", b"top_left"]
    ) -> None: ...
...
class GeoPolygon(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["exterior", b"exterior", "interiors", b"interiors"]
    ) -> None: ...
