...
class DeleteSnapshotRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["collection_name", b"collection_name", "snapshot_name", b"snapshot_name"]
    ) -> None: ...
...
class SnapshotDescription(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing_extensions.Literal[
            "_checksum", b"_checksum", "checksum", b"checksum", "creation_time", b"creation_time"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_checksum", b"_checksum"]
    ) -> typing_extensions.Literal["checksum"] | None: ...
...
class CreateSnapshotResponse(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["snapshot_description", b"snapshot_description"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["snapshot_description", b"snapshot_description", "time", b"time"]
    ) -> None: ...
...
class ListSnapshotsResponse(google.protobuf.message.Message):
    ...
    TIME_FIELD_NUMBER: builtins.int
    @property
    def snapshot_descriptions(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SnapshotDescription]: ...
    time: builtins.float
    """Time spent to process"""
    def __init__(
        self,
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["snapshot_descriptions", b"snapshot_descriptions", "time", b"time"]
    ) -> None: ...
