import sys
from typing import Sequence, TypeAlias, Union, get_args
...
PointsSelector: TypeAlias = list[PointId] | rest.Filter | grpc.Filter | rest.PointsSelector | grpc.PointsSelector
...
AliasOperations: TypeAlias = (
    rest.CreateAliasOperation | rest.RenameAliasOperation | rest.DeleteAliasOperation | grpc.AliasOperations
)
