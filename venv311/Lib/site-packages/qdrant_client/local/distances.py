...
class FeedbackContextPair:
    def __init__(self, positive: types.NumpyArray, negative: types.NumpyArray, partial_computation: float):
...
def calculate_distance(query: types.NumpyArray, vectors: types.NumpyArray, distance_type: models.Distance) -> types.NumpyArray:
