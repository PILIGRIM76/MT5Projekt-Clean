...
class QdrantLocal(QdrantBase):
        ...
        if not os.path.exists(meta_path):
            ...
            with open(meta_path, "r") as f:
                ...
                for collection_name, config_json in meta["collections"].items():
                    for key in deprecated_config_fields:  # fixes backward compatibility by removing parameters deleted
    ...
    def recreate_collection(
        ...
        **kwargs: Any,
        ...
        return self.create_collection(collection_name, vectors_config, sparse_vectors_config, metadata=metadata)
    ...
    def create_snapshot(self, collection_name: str, **kwargs: Any) -> types.SnapshotDescription | None:
    ...
    def create_shard_snapshot(self, collection_name: str, shard_id: int, **kwargs: Any) -> types.SnapshotDescription | None:
        raise NotImplementedError(
