...
def upload_batch_grpc(
    ...
    points = [
        grpc.PointStruct(
            id=RestToGrpc.convert_extended_point_id(idx) if not isinstance(idx, grpc.PointId) else idx,
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._shard_key_selector = (
            RestToGrpc.convert_shard_key_selector(shard_key_selector) if shard_key_selector is not None else None
        )
