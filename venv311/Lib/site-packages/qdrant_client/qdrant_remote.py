...
class QdrantRemote(QdrantBase):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if limits is None:
            ...
            raise ValueError(
                "`pool_size` and `limits` are mutually exclusive. " f"`pool_size`: {pool_size}, `limit`: {limits}"
            )
        ...
        if grpc_compression is not None and not isinstance(grpc_compression, Compression):
            raise TypeError(
                f"Expected 'grpc_compression' to be of type " f"grpc.Compression or None, but got {type(grpc_compression)}"
            )
    ...
    def scroll(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            scroll_result: models.ScrollResult | None = self.openapi_client.points_api.scroll_points(
                collection_name=collection_name,
                consistency=consistency,
    ...
    def get_collection_aliases(self, collection_name: str, **kwargs: Any) -> types.CollectionsAliasesResponse:
        ...
        result: types.CollectionsAliasesResponse | None = self.http.aliases_api.get_collection_aliases(
            collection_name=collection_name
        ).result
    ...
    def get_aliases(self, **kwargs: Any) -> types.CollectionsAliasesResponse:
        if self._prefer_grpc:
            response = self.grpc_collections.ListAliases(grpc.ListAliasesRequest(), timeout=self._timeout).aliases
            return types.CollectionsAliasesResponse(
                aliases=[GrpcToRest.convert_alias_description(description) for description in response]
            )
        result: types.CollectionsAliasesResponse | None = self.http.aliases_api.get_collections_aliases().result
        assert result is not None, "Get aliases returned None"
        return result

    def get_collections(self, **kwargs: Any) -> types.CollectionsResponse:
        if self._prefer_grpc:
            response = self.grpc_collections.List(grpc.ListCollectionsRequest(), timeout=self._timeout).collections
        ...
        result: types.CollectionsResponse | None = self.http.collections_api.get_collections().result
    ...
    def get_collection(self, collection_name: str, **kwargs: Any) -> types.CollectionInfo:
        ...
        result: types.CollectionInfo | None = self.http.collections_api.get_collection(collection_name=collection_name).result
    ...
    def delete_collection(self, collection_name: str, timeout: int | None = None, **kwargs: Any) -> bool:
        ...
        result: bool | None = self.http.collections_api.delete_collection(collection_name, timeout=timeout).result
    ...
    def create_payload_index(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            return GrpcToRest.convert_update_result(self.grpc_points.CreateFieldIndex(request, timeout=self._timeout).result)
    ...
    def delete_payload_index(
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            return GrpcToRest.convert_update_result(self.grpc_points.DeleteFieldIndex(request, timeout=self._timeout).result)
    ...
    def create_snapshot(self, collection_name: str, wait: bool = True, **kwargs: Any) -> types.SnapshotDescription | None:
        if self._prefer_grpc:
    ...
    def delete_snapshot(self, collection_name: str, snapshot_name: str, wait: bool = True, **kwargs: Any) -> bool | None:
        if self._prefer_grpc:
    ...
    def delete_full_snapshot(self, snapshot_name: str, wait: bool = True, **kwargs: Any) -> bool | None:
        if self._prefer_grpc:
    ...
    def info(self) -> types.VersionInfo:
        if self._prefer_grpc:
            version_info = self.grpc_root.HealthCheck(grpc.HealthCheckRequest(), timeout=self._timeout)
        ...
        **kwargs: Any,
        ...
        if self._prefer_grpc:
            ...
            return self.grpc_collections.UpdateCollectionClusterSetup(
                grpc.UpdateCollectionClusterSetupRequest(collection_name=collection_name, timeout=timeout, **grpc_operation),
                timeout=timeout if timeout is not None else self._timeout,
            ).result
    ...
    def collection_cluster_info(self, collection_name: str) -> types.CollectionClusterInfo:
        ...
        collection_info = self.rest.distributed_api.collection_cluster_info(collection_name=collection_name).result
