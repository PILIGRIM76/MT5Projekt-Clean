...
DEFS = {
    ...
    "DatetimeKeyExpression": {
        "additionalProperties": False,
        "properties": {"datetime_key": {"description": "", "title": "Datetime Key", "type": "string"}},
    ...
    "GaussDecayExpression": {
        "additionalProperties": False,
        "properties": {"gauss_decay": {"$ref": "#/$defs/DecayParamsExpression", "description": ""}},
    ...
    "PayloadField": {
        ...
        "properties": {"key": {"description": "Payload field name", "title": "Key", "type": "string"}},
        "required": ["key"],
        "title": "PayloadField",
        "type": "object",
    },
    ...
    "ProductQuantization": {
        "additionalProperties": False,
        "properties": {"product": {"$ref": "#/$defs/ProductQuantizationConfig", "description": ""}},
        "required": ["product"],
    ...
    "NaiveFeedbackStrategy": {
        "additionalProperties": False,
        "properties": {"naive": {"$ref": "#/$defs/NaiveFeedbackStrategyParams", "description": ""}},
        "required": ["naive"],
    ...
    "RelevanceFeedbackQuery": {
        "additionalProperties": False,
        "properties": {"relevance_feedback": {"$ref": "#/$defs/RelevanceFeedbackInput", "description": ""}},
