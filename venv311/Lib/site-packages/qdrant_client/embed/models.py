...
NumericVectorInput: TypeAlias = list[StrictFloat] | SparseVector | list[list[StrictFloat]] | ExtendedPointId
NumericVectorStruct: TypeAlias = list[StrictFloat] | list[list[StrictFloat]] | dict[StrictStr, NumericVector]
