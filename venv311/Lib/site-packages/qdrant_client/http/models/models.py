...
class Bm25Config(BaseModel, extra="forbid"):
    ...
    lowercase: Optional[bool] = Field(default=None, description="Lowercase the text before tokenization. Default is `true`.")
...
class ClusterStatusOneOf1(BaseModel):
    ...
    status: Literal["enabled",] = Field(..., description="Description of enabled cluster")
...
class CollectionConfig(BaseModel):
    ...
    wal_config: Optional["WalConfig"] = Field(default=None, description="Information about the collection configuration")
...
class CollectionInfo(BaseModel):
    ...
    optimizer_status: "OptimizersStatus" = Field(..., description="Current statistics and configuration of the collection")
    warnings: Optional[List["CollectionWarning"]] = Field(default=None, description="Warnings related to the collection")
...
class CreateCollection(BaseModel, extra="forbid"):
    ...
    replication_factor: Optional[int] = Field(default=None, description="Number of shards replicas. Default is 1 Minimum is 1")
    write_consistency_factor: Optional[int] = Field(
        default=None,
        description="Defines how many replicas should apply the operation for us to consider it successful. Increasing this number will make the collection more resilient to inconsistencies, but will also make it fail if not enough replicas are available. Does not have any performance impact.",
    )
    ...
    sparse_vectors: Optional[Dict[str, "SparseVectorParams"]] = Field(default=None, description="Sparse vector data config.")
...
class DecayParamsExpression(BaseModel, extra="forbid"):
    ...
    target: Optional["Expression"] = Field(default=None, description="The target value to start decaying from. Defaults to 0.")
...
class DeletePayload(BaseModel, extra="forbid"):
    ...
    points: Optional[List["ExtendedPointId"]] = Field(default=None, description="Deletes values from each point in this list")
...
class DistributedReplicaTelemetry(BaseModel):
    ...
    num_vectors_by_name: Optional[Dict[str, int]] = Field(default=None, description="Approximate number of vectors by name")
    ...
    partial_snapshot: Optional["PartialSnapshotTelemetry"] = Field(default=None, description="Partial snapshot telemetry")
...
class KeywordIndexParams(BaseModel, extra="forbid"):
    ...
    is_tenant: Optional[bool] = Field(default=None, description="If true - used for tenant optimization. Default: false.")
    on_disk: Optional[bool] = Field(default=None, description="If true, store the index on disk. Default: false.")
    enable_hnsw: Optional[bool] = Field(
        default=None,
        description="Enable HNSW graph building for this payload field. If true, builds additional HNSW links (Need payload_m &gt; 0). Default: true.",
...
class MessageSendErrors(BaseModel):
    ...
    latest_error_timestamp: Optional[Union[datetime, date]] = Field(default=None, description="Timestamp of the latest error")
...
class Prefetch(BaseModel, extra="forbid"):
    ...
    score_threshold: Optional[float] = Field(default=None, description="Return points with scores better than this threshold.")
...
class ProgressTree(BaseModel):
    ...
    duration_sec: Optional[float] = Field(default=None, description="For finished operations, how long they took, in seconds.")
...
class QuantizationSearchParams(BaseModel, extra="forbid"):
    ...
    ignore: Optional[bool] = Field(default=False, description="If true, quantized vectors are ignored. Default is false.")
...
class QueryGroupsRequest(BaseModel, extra="forbid"):
    ...
    group_size: Optional[int] = Field(default=None, description="Maximum amount of points to return per group. Default is 3.")
...
class SearchMatrixRequest(BaseModel, extra="forbid"):
    ...
    filter: Optional["Filter"] = Field(default=None, description="Look only for points which satisfies this conditions")
    sample: Optional[int] = Field(default=None, description="How many points to select and search within. Default is 10.")
...
class SegmentInfo(BaseModel):
    ...
    payloads_size_bytes: int = Field(..., description="An estimation of the effective amount of bytes used for payloads")
...
class SetPayload(BaseModel, extra="forbid"):
    ...
    points: Optional[List["ExtendedPointId"]] = Field(default=None, description="Assigns payload to each point in this list")
    filter: Optional["Filter"] = Field(
    ...
    key: Optional[str] = Field(default=None, description="Assigns payload to each point that satisfy this path of property")
...
class StrictModeConfig(BaseModel, extra="forbid"):
    ...
    search_max_hnsw_ef: Optional[int] = Field(default=None, description="Max HNSW ef value allowed in search parameters.")
    search_allow_exact: Optional[bool] = Field(default=None, description="Whether exact search is allowed.")
    search_max_oversampling: Optional[float] = Field(default=None, description="Max oversampling value allowed in search.")
    ...
    read_rate_limit: Optional[int] = Field(default=None, description="Max number of read operations per minute per replica")
    write_rate_limit: Optional[int] = Field(default=None, description="Max number of write operations per minute per replica")
    ...
    condition_max_size: Optional[int] = Field(default=None, description="Max size of a condition, eg. items in `MatchAny`.")
    ...
    max_payload_index_count: Optional[int] = Field(default=None, description="Max number of payload indexes in a collection")
...
class StrictModeConfigOutput(BaseModel):
    ...
    sparse_config: Optional["StrictModeSparseConfigOutput"] = Field(default=None, description="Sparse vector configuration")
    max_payload_index_count: Optional[int] = Field(default=None, description="Max number of payload indexes in a collection")
...
class TextIndexParams(BaseModel, extra="forbid"):
    ...
    phrase_matching: Optional[bool] = Field(default=None, description="If true, support phrase matching. Default: false.")
    stopwords: Optional["StopwordsInterface"] = Field(
        default=None,
        description="Ignore this set of tokens. Can select from predefined languages and/or provide a custom set.",
    )
    on_disk: Optional[bool] = Field(default=None, description="If true, store the index on disk. Default: false.")
    stemmer: Optional["StemmingAlgorithm"] = Field(default=None, description="Algorithm for stemming. Default: disabled.")
    enable_hnsw: Optional[bool] = Field(
        default=None,
        description="Enable HNSW graph building for this payload field. If true, builds additional HNSW links (Need payload_m &gt; 0). Default: true.",
    )
...
class VectorParams(BaseModel, extra="forbid"):
    ...
    multivector_config: Optional["MultiVectorConfig"] = Field(default=None, description="Params of single vector data storage")
...
FeedbackStrategy = Union[NaiveFeedbackStrategy,]
GroupId = Union[
    StrictInt,
    StrictStr,
]
