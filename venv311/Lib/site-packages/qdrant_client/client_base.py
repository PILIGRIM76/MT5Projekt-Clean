...
class QdrantBase:
    ...
    def delete_snapshot(self, collection_name: str, snapshot_name: str, **kwargs: Any) -> bool | None:
        raise NotImplementedError()
    ...
    def delete_shard_snapshot(self, collection_name: str, shard_id: int, snapshot_name: str, **kwargs: Any) -> bool | None:
        raise NotImplementedError()
