...
class DataLoaderAdapter:
    ...
    def __init__(self, dataset, use_stateful_dataloader=False, batch_sampler=None, **kwargs):
        ...
        if use_stateful_dataloader:
            ...
            if "in_order" in kwargs and compare_versions(torchdata_version, "<", "0.11") and is_torch_version(">=", "2.6.0"):
                kwargs.pop("in_order")
...
def prepare_data_loader(
    ...
    if isinstance(dataloader.sampler, RandomSampler) and state.distributed_type == DistributedType.XLA:
        ...
        generator = torch.Generator(device=torch.get_default_device() if hasattr(torch, "get_default_device") else "cpu")
