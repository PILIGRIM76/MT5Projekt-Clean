...
def launch_command_parser(subparsers=None):
    ...
    resource_args.add_argument(
        ...
        help="Choose a backend to optimize your training with dynamo, see more at " "https://github.com/pytorch/torchdynamo.",
    )
    resource_args.add_argument(
        "--dynamo_mode",
        type=str,
    ...
    megatron_lm_args.add_argument(
        ...
        default=None,
        type=str,
        help="Megatron-LM's recompute granularity (full, selective). " "(useful only when `use_megatron_lm` flag is passed).",
    )
    megatron_lm_args.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "The full path to the script to be launched in parallel, followed by all the arguments for the training " "script."
        ),
    )
