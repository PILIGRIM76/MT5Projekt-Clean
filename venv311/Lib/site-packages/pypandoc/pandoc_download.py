...
def _get_pandoc_urls(version="latest"):
    ...
    response = urllib.request.urlopen(f"https://github.com/jgm/pandoc/releases/expanded_assets/{version}")
    ...
    regex = re.compile(rf"/jgm/pandoc/releases/download/.*" rf"(?:{processor_architecture}|x86|mac).*\.(?:msi|deb|pkg)")
