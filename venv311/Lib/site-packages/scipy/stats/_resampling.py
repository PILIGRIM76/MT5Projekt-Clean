...
def _bca_interval(data, statistic, axis, alpha, theta_hat_b, batch):
    ...
    U_ji = [
        (n - 1) * (theta_hat_dot - theta_hat_i) for theta_hat_dot, theta_hat_i, n in zip(theta_hat_j_dot, theta_hat_ji, n_j)
    ]
...
def _bootstrap_iv(
    data, statistic, vectorized, paired, axis, confidence_level, alternative, n_resamples, batch, method, bootstrap_result, rng
):
...
def _power_iv(rvs, test, n_observations, significance, vectorized, n_resamples, batch, kwargs):
    ...
    return (wrapped_rvs, test_vectorized, nobs, significance, vectorized, n_resamples_int, batch_iv, vals, keys, shape[1:])
...
def permutation_test(
    ...
    *difference* between two paired elements. Accordingly, if ``data`` contains
    ...
    """
    args = _permutation_test_iv(data, statistic, permutation_type, vectorized, n_resamples, batch, alternative, axis, rng)
