...
class BSpline:
    ...
    **Implementation details**
    ...
    def __call__(self, x, nu=0, extrapolate=None):
        ...
        _dierckx.evaluate_spline(self.t, cc.reshape(cc.shape[0], -1), self.k, x, nu, extrapolate, out.view(float))
...
def make_interp_spline(x, y, k=3, t=None, bc_type=None, axis=0, check_finite=True):
    ...
    if nt - n != nleft + nright:
        raise ValueError("The number of derivatives at boundaries does not " f"match: expected {nt-n}, got {nleft}+{nright}")
