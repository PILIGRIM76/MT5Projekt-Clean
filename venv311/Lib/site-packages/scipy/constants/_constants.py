...
def convert_temperature(
    ...
    if old_scale.lower() in ["celsius", "c"]:
        ...
        raise NotImplementedError(
            f"{old_scale=} is unsupported: supported scales " "are Celsius, Kelvin, Fahrenheit, and " "Rankine"
        )
    ...
    if new_scale.lower() in ["celsius", "c"]:
        ...
        raise NotImplementedError(
            f"{new_scale=} is unsupported: supported " "scales are 'Celsius', 'Kelvin', " "'Fahrenheit', and 'Rankine'"
        )
