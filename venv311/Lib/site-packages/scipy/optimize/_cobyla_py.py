...
@synchronized
def fmin_cobyla(
    func, x0, cons, args=(), consargs=None, rhobeg=1.0, rhoend=1e-4, maxfun=1000, disp=None, catol=2e-4, *, callback=None
):
    """
    ...
    **unknown_options,
    ...
    return OptimizeResult(
        ...
        message={
            ...
            4: "Did not converge to a solution " "satisfying the constraints. See " "`maxcv` for magnitude of violation.",
