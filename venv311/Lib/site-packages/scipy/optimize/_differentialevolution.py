...
class DifferentialEvolutionSolver:
    ...
    def _calculate_population_energies(self, population):
        ...
        if calc_energies.size != S:
            if self.vectorized:
                raise RuntimeError(
                    "The vectorized function must return an" " array of shape (S,) when given an array" " of shape (len(x), S)"
                )
        ...
        if self._updating == "immediate":
            ...
            for candidate in range(self.num_population_members):
                ...
                if self._accept_trial(
                    ...
                    if self._accept_trial(
                        energy, feasible, cv, self.population_energies[0], self.feasible[0], self.constraint_violation[0]
                    ):
                        self._promote_lowest_energy()
