...
def pytest_configure(config):
    ...
    if not PARALLEL_RUN_AVAILABLE:
        config.addinivalue_line(
            "markers", "parallel_threads(n): run the given test function in parallel " "using `n` threads."
        )
        config.addinivalue_line(
            "markers",
...
if HAVE_SCPDT:
    ...
    def warnings_errors_and_rng(test=None):
        ...
        for name in integration_w:
            known_warnings[name] = dict(category=integrate.IntegrationWarning, message="The occurrence of roundoff")
        ...
        dct = {
            ...
            # tutorials
            "linalg.rst": dict(message="the matrix subclass is not", category=PendingDeprecationWarning),
            "stats.rst": dict(message="The maximum number of subdivisions", category=integrate.IntegrationWarning),
        }
