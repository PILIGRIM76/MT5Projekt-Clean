...
def affine_transform_signature(input, matrix, offset=0.0, output_shape=None, output=None, *args, **kwds):
...
def binary_dilation_signature(input, structure=None, iterations=1, mask=None, output=None, *args, **kwds):
...
def binary_hit_or_miss_signature(input, structure1=None, structure2=None, output=None, *args, **kwds):
...
def generic_filter_signature(input, function, size=None, footprint=None, output=None, *args, **kwds):
...
def morphological_gradient_signature(input, size=None, footprint=None, structure=None, output=None, *args, **kwds):
...
def percentile_filter_signature(input, percentile, size=None, footprint=None, output=None, *args, **kwds):
    return array_namespace(input, footprint, _skip_if_dtype(output))
