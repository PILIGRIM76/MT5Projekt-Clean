...
def cumulative_simpson(y, *, x=None, dx=1.0, axis=-1, initial=None):
    ...
    if y.shape[-1] < 3:
        ...
        message = (
            "If provided, `dx` must either be a scalar or have the same " "shape as `y` but with only 1 point along `axis`."
        )
...
_builtincoeffs = {
    ...
    11: (
        11,
        87091200,
        [2171465, 13486539, -3237113, 25226685, -9595542, 15493566, 15493566, -9595542, 25226685, -3237113, 13486539, 2171465],
        -2224234463,
        237758976000,
    ),
    12: (
