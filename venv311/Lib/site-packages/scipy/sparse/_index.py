...
class IndexMixin:
    ...
    def _validate_indices(self, key):
        ...
        if index_ndim > self.ndim:
            raise IndexError(f"invalid index ndim. Array is {self.ndim}D. Index needs {index_ndim}D")
        if len(array_indices) > 1:
            ...
            if any(idx_arrays[0].shape != ix.shape for ix in idx_arrays[1:]):
                ...
                msg = f"shape mismatch: indexing arrays could not be broadcast " f"together with shapes {shapes}"
