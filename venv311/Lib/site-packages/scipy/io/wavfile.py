...
def _read_data_chunk(fid, format_tag, channels, bit_depth, is_big_endian, is_rf64, block_align, mmap=False):
    """
    Notes
    -----
    ...
    try:
        ...
        while fid.tell() < file_size:
            ...
            if chunk_id == b"fmt ":
                ...
                data = _read_data_chunk(fid, format_tag, channels, bit_depth, is_big_endian, is_rf64, block_align, mmap)
