...
class EnglishStemmer(_StandardStemmer):
    ...
    def stem(self, word):
            ...
            if word.endswith(suffix):
                if suffix in ("eed", "eedly"):
                    ...
                    if step1b_vowel_found:
                        ...
                        ) or (r1 == "" and len(word) == 2 and word[0] in self.__vowels and word[1] not in self.__vowels):
                            word = "".join((word, "e"))
        ...
        if r2.endswith("l") and word[-2] == "l":
            ...
            if len(word) >= 4 and (
                word[-2] in self.__vowels or word[-2] in "wxY" or word[-3] not in self.__vowels or word[-4] in self.__vowels
            ):
                word = word[:-1]
...
class SpanishStemmer(_StandardStemmer):
    ...
    def __replace_accented(self, word):
        ...
        """
        return word.replace("\xe1", "a").replace("\xe9", "e").replace("\xed", "i").replace("\xf3", "o").replace("\xfa", "u")
