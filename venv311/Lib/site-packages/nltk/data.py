...
def split_resource_url(resource_url):
    ...
    if len(protocol) == 1 and protocol.isalpha() and (path_.startswith("/") or path_.startswith("\\")):
...
FORMATS = {
    ...
    "fcfg": "A feature CFG.",
    "fol": "A list of first order logic expressions, parsed with " "nltk.sem.logic.Expression.fromstring.",
