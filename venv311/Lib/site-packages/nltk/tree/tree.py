...
class Tree(list):
    ...
    def __init__(self, node, children=None):
        if children is None:
            ...
            raise TypeError("%s() argument 2 should be a list, not a " "string" % type(self).__name__)
        else:
    ...
    def fromstring(
        ...
        token_re = re.compile(r"%s\s*(%s)?|%s|(%s)" % (open_pattern, node_pattern, close_pattern, leaf_pattern))
