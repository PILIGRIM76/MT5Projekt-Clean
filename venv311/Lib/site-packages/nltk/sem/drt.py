...
class DRS(DrtExpression, Expression):
    ...
    def _pretty(self):
        ...
        cond_lines = [
            cond for cond_line in [filter(lambda s: s.strip(), cond._pretty()) for cond in self.conds] for cond in cond_line
        ]
...
class DrtBinaryExpression(DrtExpression, BinaryExpression):
    ...
    def _assemble_pretty(first_lines, op, second_lines):
        ...
        return (
            [" " + first_line + " " + blank + " " + second_line + " " for first_line, second_line in first_second_lines[:2]]
