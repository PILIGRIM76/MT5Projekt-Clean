    ...
    def handle_variable(self, tok, context):
        ...
        if self.inRange(0) and self.token(0) == Tokens.OPEN:
            ...
            if not isinstance(accum, FunctionVariableExpression) and not isinstance(accum, ConstantExpression):
                raise LogicalExpressionException(
                    self._currentIndex,
                    "'%s' is an illegal predicate name.  " "Individual variables may not be used as " "predicates." % tok,
                )
...
class ApplicationExpression(Expression):
    ...
    def __eq__(self, other):
        return isinstance(other, ApplicationExpression) and self.function == other.function and self.argument == other.argument
