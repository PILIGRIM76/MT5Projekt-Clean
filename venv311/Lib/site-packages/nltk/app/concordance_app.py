...
_CORPORA = {
    ...
    "English: Brown Corpus (Religion, simplified)": lambda: brown.tagged_sents(categories="religion", tagset="universal"),
...
class ConcordanceSearchView:
    ...
    def _init_corpus_select(self, parent):
        ...
        om = OptionMenu(
            innerframe, self.var, self.model.DEFAULT_CORPUS, command=self.corpus_selected, *self.model.non_default_corpora()
        )
        om["borderwidth"] = 0
