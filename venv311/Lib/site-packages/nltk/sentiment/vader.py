...
class SentimentIntensityAnalyzer:
    ...
    def polarity_scores(self, text):
        ...
        for item in words_and_emoticons:
            ...
            if (
                i < len(words_and_emoticons) - 1 and item.lower() == "kind" and words_and_emoticons[i + 1].lower() == "of"
    ...
    def _least_check(self, valence, words_and_emoticons, i):
        ...
        if i > 1 and words_and_emoticons[i - 1].lower() not in self.lexicon and words_and_emoticons[i - 1].lower() == "least":
            ...
            i > 0 and words_and_emoticons[i - 1].lower() not in self.lexicon and words_and_emoticons[i - 1].lower() == "least"
        ):
            valence = valence * self.constants.N_SCALAR
        return valence
