...
class MTECorpusReader(TaggedCorpusReader):
    ...
    def words(self, fileids=None):
        ...
        :rtype: list(str)
        """
        return concat([MTEFileReader(os.path.join(str(self._root), f)).words() for f in self.__fileids(fileids)])
    ...
    def sents(self, fileids=None):
        ...
        :rtype: list(list(str))
        """
        return concat([MTEFileReader(os.path.join(str(self._root), f)).sents() for f in self.__fileids(fileids)])
    ...
    def paras(self, fileids=None):
        ...
        """
        return concat([MTEFileReader(os.path.join(str(self._root), f)).paras() for f in self.__fileids(fileids)])
    ...
    def lemma_words(self, fileids=None):
        ...
        """
        return concat([MTEFileReader(os.path.join(str(self._root), f)).lemma_words() for f in self.__fileids(fileids)])
    ...
    def tagged_words(self, fileids=None, tagset="msd", tags=""):
        ...
        if tagset == "universal" or tagset == "msd":
            return concat(
                [MTEFileReader(os.path.join(str(self._root), f)).tagged_words(tagset, tags) for f in self.__fileids(fileids)]
            )
        else:
    ...
    def lemma_sents(self, fileids=None):
        ...
        """
        return concat([MTEFileReader(os.path.join(str(self._root), f)).lemma_sents() for f in self.__fileids(fileids)])
    ...
    def tagged_sents(self, fileids=None, tagset="msd", tags=""):
        ...
        if tagset == "universal" or tagset == "msd":
            return concat(
                [MTEFileReader(os.path.join(str(self._root), f)).tagged_sents(tagset, tags) for f in self.__fileids(fileids)]
            )
        else:
            print("Unknown tagset specified.")
    ...
    def lemma_paras(self, fileids=None):
        ...
        """
        return concat([MTEFileReader(os.path.join(str(self._root), f)).lemma_paras() for f in self.__fileids(fileids)])
    ...
    def tagged_paras(self, fileids=None, tagset="msd", tags=""):
        ...
        if tagset == "universal" or tagset == "msd":
            return concat(
                [MTEFileReader(os.path.join(str(self._root), f)).tagged_paras(tagset, tags) for f in self.__fileids(fileids)]
            )
        else:
            print("Unknown tagset specified.")
