...
extended_omw: CorpusReader = LazyCorpusLoader("extended_omw", CorpusReader, r".*/wn-[a-z\-]*\.tab", encoding="utf8")
...
gutenberg: PlaintextCorpusReader = LazyCorpusLoader("gutenberg", PlaintextCorpusReader, r"(?!\.).*\.txt", encoding="latin1")
ieer: IEERCorpusReader = LazyCorpusLoader("ieer", IEERCorpusReader, r"(?!README|\.).*")
inaugural: PlaintextCorpusReader = LazyCorpusLoader("inaugural", PlaintextCorpusReader, r"(?!\.).*\.txt", encoding="latin1")
...
jeita: ChasenCorpusReader = LazyCorpusLoader("jeita", ChasenCorpusReader, r".*\.chasen", encoding="utf-8")
knbc: KNBCorpusReader = LazyCorpusLoader("knbc/corpus1", KNBCorpusReader, r".*/KN.*", encoding="euc-jp")
lin_thesaurus: LinThesaurusCorpusReader = LazyCorpusLoader("lin_thesaurus", LinThesaurusCorpusReader, r".*\.lsp")
...
multext_east: MTECorpusReader = LazyCorpusLoader("mte_teip5", MTECorpusReader, r"(oana).*\.xml", encoding="utf-8")
names: WordListCorpusReader = LazyCorpusLoader("names", WordListCorpusReader, r"(?!\.).*\.txt", encoding="ascii")
nps_chat: NPSChatCorpusReader = LazyCorpusLoader("nps_chat", NPSChatCorpusReader, r"(?!README|\.).*\.xml", tagset="wsj")
...
ppattach: PPAttachmentCorpusReader = LazyCorpusLoader("ppattach", PPAttachmentCorpusReader, ["training", "test", "devset"])
...
ptb: CategorizedBracketParseCorpusReader = LazyCorpusLoader(  # Penn Treebank v3: WSJ and Brown portions
    "ptb",
...
senseval: SensevalCorpusReader = LazyCorpusLoader("senseval", SensevalCorpusReader, r"(?!\.).*\.pos")
...
stopwords: WordListCorpusReader = LazyCorpusLoader("stopwords", WordListCorpusReader, r"(?!README|\.).*", encoding="utf8")
...
swadesh: SwadeshCorpusReader = LazyCorpusLoader("swadesh", SwadeshCorpusReader, r"(?!README|\.).*", encoding="utf8")
...
switchboard: SwitchboardCorpusReader = LazyCorpusLoader("switchboard", SwitchboardCorpusReader, tagset="wsj")
...
toolbox: ToolboxCorpusReader = LazyCorpusLoader("toolbox", ToolboxCorpusReader, r"(?!.*(README|\.)).*\.(dic|txt)")
...
treebank_raw: PlaintextCorpusReader = LazyCorpusLoader("treebank/raw", PlaintextCorpusReader, r"wsj_.*", encoding="ISO-8859-2")
twitter_samples: TwitterCorpusReader = LazyCorpusLoader("twitter_samples", TwitterCorpusReader, r".*\.json")
udhr: UdhrCorpusReader = LazyCorpusLoader("udhr", UdhrCorpusReader)
udhr2: PlaintextCorpusReader = LazyCorpusLoader("udhr2", PlaintextCorpusReader, r".*\.txt", encoding="utf8")
...
wordnet_ic: WordNetICCorpusReader = LazyCorpusLoader("wordnet_ic", WordNetICCorpusReader, r".*\.dat")
words: WordListCorpusReader = LazyCorpusLoader("words", WordListCorpusReader, r"(?!README|\.).*", encoding="ascii")
