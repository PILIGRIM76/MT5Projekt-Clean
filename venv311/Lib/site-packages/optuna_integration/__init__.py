...
if TYPE_CHECKING:
    from optuna_integration.allennlp import AllenNLPExecutor, AllenNLPPruningCallback
    ...
    from optuna_integration.fastaiv2 import FastAIPruningCallback, FastAIV2PruningCallback
    from optuna_integration.keras import KerasPruningCallback
    from optuna_integration.lightgbm import LightGBMPruningCallback, LightGBMTuner, LightGBMTunerCV
