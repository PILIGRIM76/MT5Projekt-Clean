...
with try_import() as _imports_logei:
    from botorch.acquisition.analytic import LogConstrainedExpectedImprovement, LogExpectedImprovement
...
def logei_candidates_func(
    ...
    if n_constraints > 0:
        ...
        if train_obj_feas.numel() == 0:
            _logger.warning("No objective values are feasible. Using 0 as the best objective in logEI.")
                ...
                if self._constraints_func is not None:
                    ...
                    if constraints is not None:
                        ...
                        if con is None:
                            ...
                            raise RuntimeError(f"Expected {con.shape[1]} constraints " f"but received {n_constraints}.")
