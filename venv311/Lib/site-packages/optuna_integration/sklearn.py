...
class _Objective:
    ...
    def _get_params(self, trial: Trial) -> dict[str, Any]:
        return {name: trial._suggest(name, distribution) for name, distribution in self.param_distributions.items()}
...
class OptunaSearchCV(BaseEstimator):
    ...
    def fit(
        ...
        **fit_params: Any,
        ...
        _logger.info("Searching the best hyperparameters using {} " "samples...".format(_num_samples(self.sample_indices_)))
