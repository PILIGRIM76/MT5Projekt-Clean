...
from typing import Any, Container, Dict, Generator, Iterable, List, Optional, Sequence, Tuple, Union
...
class DaskStorage(BaseStorage):
    ...
    def get_n_trials(self, study_id: int, state: Optional[Union[Tuple[TrialState, ...], TrialState]] = None) -> int:
