...
class PyTorchLightningPruningCallback(Callback):
    ...
    def on_fit_start(self, trainer: Trainer, pl_module: "pl.LightningModule") -> None:
        ...
        if self.is_ddp_backend:
            if version.parse(pl.__version__) < version.parse("1.6.0"):  # type: ignore[attr-defined]
            ...
            if not (
                ...
                raise ValueError(
                    "optuna_integration.PyTorchLightningPruningCallback" " supports only optuna.storages.RDBStorage in DDP."
                )
