...
from src.core.services.base_service import BaseService, HealthStatus, ServiceManager, ServiceMetrics, ServiceState
...
class MockService(BaseService):
    ...
    def _health_check(self) -> HealthStatus:
        ...
        return HealthStatus(is_healthy=True, checks={"mock_check": True}, message="OK")
