...
from src.db.database_manager import Base, TradeAudit, TradeHistory
...
class TestCommandManager:
    ...
    def test_update_trade_close(self, command_manager):
        ...
        result = command_manager.update_trade_close(ticket=12346, exit_price=1.1050, profit=50.0, close_reason="TP")
    ...
    def test_create_audit_log(self, command_manager):
        ...
        audit_id = command_manager.create_audit_log(
            ...
            risk_checks={"pre_mortem_passed": True, "var_check_passed": True},
    ...
    def test_update_strategy_status(self, command_manager):
        ...
        result = command_manager.update_strategy_status(
            strategy_name="TestStrategy", symbol="EURUSD", market_regime="Strong Trend", status="paused"
        )
