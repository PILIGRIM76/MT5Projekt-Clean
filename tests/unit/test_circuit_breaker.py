...
from src.risk.circuit_breaker import CircuitBreaker, CircuitBreakerReason, CircuitBreakerState, CircuitBreakerTrip
...
class TestCircuitBreakerChecks:
    ...
    def test_check_conditions_all_safe(self, sample_config, mock_trading_system):
        ...
        with (
            patch.object(cb, "_check_mt5_connection", return_value=True),
