            ...
            try:
                for key, df in data_dict.items():
                    ...
                    if tick and info and info.point > 0:
                        ...
                        liquidity_score = max(0.0, 1.0 - (spread_pips - ideal_max_spread_pips) / (ideal_max_spread_pips * 4))

                    total_score = (
                        (volatility_score * vol_weight) + (trend_score * trend_weight) + (liquidity_score * liq_weight)
                    )
                    ...
                    current_item_data = {
                        ...
                        "normalized_atr_percent": normalized_atr,
