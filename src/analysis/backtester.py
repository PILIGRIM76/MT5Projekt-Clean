...
class StrategyBacktester(ABC):
    ...
    def __init__(self, strategy: BaseStrategy, data: pd.DataFrame, timeframe: int, config: Settings,
        ...
        for i in range(1, len(self.data)):
            ...
            if open_trade:
                ...
                if exit_price is not None or i == len(self.data) - 1:
                    ...
                    pnl = (exit_price - open_trade['entry_price']) if open_trade['type'] == SignalType.BUY else (
