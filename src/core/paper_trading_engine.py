...
class PaperTradingEngine:
    ...
    def execute_trade(self, signal: TradeSignal, lot_size: Optional[float] = None,
    ...
    def export_to_csv(self, filepath: str) -> bool:
        ...
        try:
            with open(filepath, 'w', newline='', encoding='utf-8') as f:
                ...
                # Заголовок
                writer.writerow([
                    'Ticket', 'Symbol', 'Type', 'Lot', 'Entry Price', 'Entry Time',
                    'Close Price', 'Close Time', 'PnL', 'PnL %', 'Commission', 'Reason'
                ])
