...
class IPositionSizer(ABC):
    ...
    def calculate(self, 
                  ...
                  strategy_stats: Optional[Dict[str, Any]] = None) -> PositionSizeResult:
        """
...
class PositionSizer:
    ...
    def __init__(self, config: Settings):
        ...
        self.sizers: Dict[SizingMethod, IPositionSizer] = {
            ...
            SizingMethod.VOLATILITY_ADJUSTED: VolatilityAdjustedSizer(
                target_risk_percent=self.fixed_risk_percent,
                atr_multiplier=self.volatility_atr_multiplier
            ),
            SizingMethod.RISK_PARITY: RiskParitySizer(
                total_risk_percent=self.risk_parity_total,
                max_positions=self.risk_parity_max_positions
            )
        }
    ...
    def calculate_with_method(self,
                               method: SizingMethod,
                               symbol: str,
                               signal_type: SignalType,
                               account_equity: float,
    ...
    def compare_methods(self,
                        ...
                        stop_loss_price: float,
                        atr: Optional[float] = None,
                        strategy_stats: Optional[Dict[str, Any]] = None) -> Dict[str, PositionSizeResult]:
        """
