...
if 'matplotlib._api.deprecation' not in sys.modules:
    ...
    def deprecated(since, *, addendum=None, pending=False, obj_type=None, 
                   obj_name=None, arg_name=None, alternate=None, removal=None):
    ...
    # Функция deprecation
    def deprecation(message, *, addendum=None, pending=False, obj_type=None,
                    obj_name=None, arg_name=None, alternate=None, removal=None):
        """Функция-заглушка для deprecation"""
        return mplDeprecation()
    
    # Функция warn_deprecated
    def warn_deprecated(since, *, message='', addendum='', 
                        obj_type='', obj_name='', arg_name='',
                        alternate='', removal='', warning_stacklevel=2):
        """Функция-заглушка для warn_deprecated"""
        if message:
            warnings.warn(f"[DEPRECATED since {since}] {message}", 
                         DeprecationWarning, stacklevel=warning_stacklevel)
    ...
    def rename_parameter(since, *, old_param_name, new_param_name, 
                         addendum='', pending=False, removal=None):
    ...
    def make_keyword_only(since, *, param_name, addendum='', 
                          pending=False, removal=None):
    ...
    def delete_parameter(since, *, param_name, addendum='', 
                         pending=False, removal=None):
    ...
    def change_parameter_signature(since, *, param_name, new_type,
                                    addendum='', pending=False, removal=None):
    ...
    mpl_api_deprecation.__all__ = ['mplDeprecation', 'deprecated', 'deprecation', 
                                    'warn_deprecated', 'warn_external',
                                    'rename_parameter', 'make_keyword_only',
                                    'delete_parameter', 'change_parameter_signature']
